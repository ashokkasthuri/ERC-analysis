...
// Chain: BSC - File: src/tokens/ERC1155MintableToken.sol
// SPDX-License-Identifier: MIT
...
contract ERC1155MintableToken is ERC1155Supply, ERC1155URIStorage, Ownable {
    string _contractURI;
    ...
    function mint(address account, uint256 id, uint256 amount, string memory uri) public onlyOwner {
