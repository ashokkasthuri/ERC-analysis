...
// Source: 0x75492153f5af575ee405935ed57388c5d80247bd
// Contract Name: HSKImplementationV1
// This is a flattened version of all source files
// Generated on: 2026-05-06 13:21:37
...
import "./NonBlackList.sol";

/// @title Implement ERC20 token of HashKey EcoPoints.
abstract contract ERC20 is NonBlackList, IERC20 {
    ...
    string  private constant NAME            = "HashKey EcoPoints";
...
/// @title Hashkey EcoPoints Contract
...
================================================================================
// FILE: contracts/interface/IERC20Permit.sol
================================================================================
...
================================================================================
// FILE: contracts/library/CheckSig.sol
================================================================================
...
================================================================================
// FILE: contracts/library/Mint.sol
================================================================================
...
================================================================================
// FILE: contracts/library/Vesting.sol
================================================================================
...
================================================================================
// FILE: contracts/NonBlackList.sol
================================================================================
...
abstract contract NonBlackList is Access {

    /// @dev Reserved storage slot for black list.
    mapping(address => bool) private _blackListCap;
}
