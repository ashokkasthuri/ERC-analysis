...
// SATs by The Spot on Avax, thespot.art
...
contract SingleAssetTokensV1 is ERC1155, Ownable, IERC2981, ReentrancyGuard {
    struct TokenInfo {
        address creator;
        string uri;
        uint256 maxSupply;
    ...
    constructor(address _treasuryAddress, uint256 _explosionDelay) ERC1155("Single Asset Tokens") Ownable(msg.sender) {
