...
contract Legitimate1155NFTDistribution is ERC1155, AccessControl {
    ...
    string public name = "0n1ForceJP x NIKO24 PoM";

    // METADATA
    string public nftTitle = "Proof-of-Meet : 0N1FORCE x NIKO24"; // Title of the NFT collection
    ...
    string public nftImageUri = "https://ipfs.legitimate.tech/ipfs/QmXikKCKoPzFZk2aurFaQXs3wGCQwaQX3r5C8CoKEqbdhy"; // IPFS or HTTP URL
