...
// Source: 0x8857aa51dc3999b9d281ec68a63ab82bccb78c27
// Contract Name: TheGoat
// Generated on: 2026-05-14 12:05:21
...
contract TheGoat is ERC721, ERC721Enumerable, Ownable, EIP712, ERC721Votes {
    ...
    constructor() ERC721("The GOAT", "GOAT") EIP712("TheGoat", "1") {
        ...
        art.skins = [[[102, 72, 33], [135, 103, 46]], [[98, 98, 98], [160, 160, 160]], [[119, 39, 23], [162, 70, 28]], [[176, 173, 134], [205, 202, 166]]];
    }
    ...
    function getGoatsSinceDeployment() public view returns (uint256) {
        return getDayId() + getDayId() / intervalFee;
    }
    ...
    function bid() public payable {
        ...
        require(msg.value > day[currentDay].highestBid, "Your bid is too low.");
        require(
            day[currentDay].winner != msg.sender,
            "You are already the winner."
        );

        if (day[currentDay].winner != address(0)) {
            payable(day[currentDay].winner).transfer(
                day[currentDay].highestBid
            );
        }
    ...
    function mint(uint256 goatId) public {
        ...
        claimed[goatId] += dayReward[goatId];
    }
