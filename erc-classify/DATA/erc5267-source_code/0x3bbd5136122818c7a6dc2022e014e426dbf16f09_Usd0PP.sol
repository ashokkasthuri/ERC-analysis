...
// Source: 0x3bbd5136122818c7a6dc2022e014e426dbf16f09
// Contract Name: Usd0PP
// Generated on: 2026-05-14 11:59:48


// ============================================================================
// FILE: src/token/Usd0PP.sol
// ============================================================================
    ...
    ReentrancyGuardUpgradeable
{
        ...
        override(ERC20PausableUpgradeable, ERC20Upgradeable)
    {
        ...
        if (sender != address(0) && !$.registryAccess.hasRole(ALLOWLISTED, sender)) {
            revert NotAllowlisted(sender);
        }
        if (recipient != address(0) && !$.registryAccess.hasRole(ALLOWLISTED, recipient)) {
            revert NotAllowlisted(recipient);
        }
...
// ============================================================================
// FILE: src/interfaces/token/IUsd0PP.sol
// ============================================================================
