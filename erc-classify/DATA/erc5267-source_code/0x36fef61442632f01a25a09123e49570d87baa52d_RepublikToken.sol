...
// Source: 0x36fef61442632f01a25a09123e49570d87baa52d
// Contract Name: RepublikToken
// Generated on: 2026-05-14 12:05:10


// ============================================================================
// FILE: src/RepublikToken.sol
// ============================================================================
...
contract RepublikToken is ERC20Permit, Ownable2Step {
    ...
    function burn(address account, uint256 amount) external onlyOwner returns (bool) {
        ...
        emit Burn(_msgSender(), account, amount);
        return true;
    }
