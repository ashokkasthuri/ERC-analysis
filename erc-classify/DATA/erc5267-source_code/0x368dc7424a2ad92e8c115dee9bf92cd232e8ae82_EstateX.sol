...
// Source: 0x368dc7424a2ad92e8c115dee9bf92cd232e8ae82
// Contract Name: EstateX
...
// ============================================================================
// FILE: contracts/token_eth_xerc20.sol
// ============================================================================
...
contract EstateX is ERC20, IXERC20,Ownable,ERC20Permit {

  /** * @notice The duration it takes for the limits to fully replenish*/
  uint256 private constant _DURATION = 1 days;

  /*** @notice The max total supply of the token*/
  uint256 public constant MAX_SUPPLY = 6300000000 * 10 ** 9; //6.3 billions
  ...
  constructor() ERC20("EstateX","ESX") ERC20Permit("ESX") Ownable(msg.sender){
  }
