...
// Source: 0xa17f4646d1a693446dd8c749ff38bf7c2a21c98e
// Contract Name: Usd0
// Generated on: 2026-05-14 11:57:37


// ============================================================================
// FILE: src/token/Usd0.sol
// ============================================================================
...
contract Usd0 is ERC20PausableUpgradeable, ERC20PermitUpgradeable, IUsd0 {
    ...
    function mint(address to, uint256 amount) public {
        ...
        if (msg.sender != $.registryContract.getContract(CONTRACT_DAO_COLLATERAL)) {
            uint256 wadPriceInUSD = uint256(oracle.getPrice(USYC));
            // @dev We can hardcode 6 decimals since we know we are using USYC
            uint8 decimals = 6;

            uint256 rwaBackingInUSD = (
                wadPriceInUSD
                    * IERC20(USYC).balanceOf($.registryContract.getContract(CONTRACT_TREASURY))
            ) / 10 ** decimals;
            if (totalSupply() + amount > rwaBackingInUSD) {
...
// ============================================================================
// FILE: src/interfaces/token/IUsd0.sol
// ============================================================================
...
// ============================================================================
// FILE: src/utils/CheckAccessControl.sol
// ============================================================================
