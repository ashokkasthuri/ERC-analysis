...
// File: contracts/PandaSeaCoin.sol
...
contract PandaSeaCoin is Initializable, ERC20Upgradeable, ERC20PermitUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
   /// @custom:oz-upgrades-unsafe-allow constructor
   constructor() {
       _disableInitializers();
   }
   ...
   function initialize(address initialOwner) initializer public {
       __ERC20_init("PandaSea Coin", "PANDA");
       __ERC20Permit_init("PandaSea Coin");
