...
// Source: 0xc91736585bf0869ba685452cf5cbe7b7f5091b3e
// Contract Name: PrimordiaKey
...
// ============================================================================
// FILE: @chocolate-factory/contracts/supply/SupplyUpgradable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/PrimordiaKey.sol
// ============================================================================
    ...
    PausableUpgradeable
{
    ...
    address public primordiaLandAddress;
    ...
    function burn(
        address account,
        uint256 amount
    ) external onlyFromPrimordiaLand {
    ...
    function setPrimordiaLandAddress(
        address primordiaLandAddress_
    ) external onlyAdmin {
        primordiaLandAddress = primordiaLandAddress_;
    }
    ...
    function lockTransfers() external onlyAdmin {
        emit Locked(TOKEN_ID);
    }
    ...
    modifier onlyFromPrimordiaLand() {
        require(
            primordiaLandAddress == msg.sender,
            "Burn only allowed from primordia land contract"
        );
        _;
    }
