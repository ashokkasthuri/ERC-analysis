...
// Source: 0xf1a658aba107b242bb5d91c5ac3b58a4dfc39e81
// Contract Name: VirtualRollup
// Generated on: 2026-05-14 11:58:47
    ...
    EIP712Upgradeable
{
    ...
    mapping(address => mapping(uint32 => bool)) public usedRn; // user => rn => true or false
    ...
    event Lock(address indexed user, address indexed token, uint96 amount);
    event Unlock(address indexed user, address indexed token, uint96 amount);
    ...
    //     require(usedRn[_participant][_rn] == false, "Invalid RN");
    ...
    function _deposit(address _user, address _token, uint96 _amount) internal {
        ...
        lockedFunds[_token] += _amount;
        emit Lock(_user, _token, _amount);
    }
    ...
    function _unlock(address _user, address _token, uint96 _amount) internal {
        ...
        lockedFunds[_token] -= _amount;
        userDeposits[_user][_token] += _amount;
        emit Unlock(_user, _token, _amount);
    }
