...
// Source: 0xc565035232f9d6c10453bd73b84d6a46989663d7
// Contract Name: Token
// Generated on: 2026-05-14 12:07:12
...
contract Token is BasedOFT, ERC20Permit {
	struct Taxes {
	...
	uint internal constant MAX_TAX = 1000;
	...
	constructor(
		...
		ERC20Permit(_name)
	{
		_mint(multisig, _totalSupply);

		isExcludedFromFee[_msgSender()] = true;
		emit SetExcludedFromFee(_msgSender(), true);

		isExcludedFromFee[multisig] = true;
		emit SetExcludedFromFee(multisig, true);

		taxReceiver = multisig;
		emit SetTaxReceiver(multisig);
	...
	function setTaxes(address _who, uint _from, uint _to) external onlyOwner {
		...
		require(_from <= MAX_TAX && _to <= MAX_TAX, "lower than 10%");
