...
// Source: 0x9f8519acfe48a1a4c579763324607ac9e3471736
// Contract Name: VolatileAsset
// Generated on: 2026-05-14 11:57:57
...
contract Asset is Ownable, ERC20, ERC20Permit, IAsset {
    ...
    uint120 private constant MINIMUM_LIQUIDITY = 1e9;
    ...
    /**
     * @dev Invoke this function to put a small amount in the contract to initialize liquidity
     * in case of dust amount manipulation
     */
    function initializeLiquidity() external onlyOwner {
        require(cash == 0 && liability == 0 && totalSupply() == 0, 'Wombat: alrealdy initialized');
        cash = MINIMUM_LIQUIDITY;
        liability = MINIMUM_LIQUIDITY;
