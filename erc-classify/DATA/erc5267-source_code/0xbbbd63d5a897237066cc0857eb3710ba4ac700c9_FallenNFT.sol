...
// Source: 0xbbbd63d5a897237066cc0857eb3710ba4ac700c9
// Contract Name: FallenNFT
// Generated on: 2026-05-14 12:06:07
...
// ============================================================================
// FILE: contracts/FallenNFT/FallenNFT.sol
// ============================================================================
    ...
    UUPSUpgradeable
{
    ...
    event UpdateBaseURI(string indexed _oldURI, string indexed _newURI);
    ...
    function updateBaseURI(string memory _tokenBaseURI) external onlyRole(DEFAULT_ADMIN_ROLE){
        emit UpdateBaseURI(tokenBaseURI, _tokenBaseURI);
    ...
    function _beforeTokenTransfer(address from, address to, uint256 firstTokenId, uint256 batchSize) internal override ( ERC721EnumerableUpgradeable, ERC721Upgradeable, ERC721PausableUpgradeable){
        super._beforeTokenTransfer(from, to, firstTokenId, batchSize);
    }

    function _afterTokenTransfer(address from, address to, uint256 firstTokenId, uint256 batchSize) internal override (ERC721Upgradeable, ERC721VotesUpgradeable){
        super._afterTokenTransfer(from, to, firstTokenId, batchSize);
    }
