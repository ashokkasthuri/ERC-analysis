...
// Source: 0x177d7ebe5a23b6e03779288866918487797be2c7
// Contract Name: BBB
// Generated on: 2026-05-14 11:55:19


// ============================================================================
// FILE: contract-be3e7102e4.sol
// ============================================================================
...
contract  BBB is ERC20, ERC20Permit, Ownable {
   ...
   constructor(address initialOwner) ERC20("BBB", "BBB") ERC20Permit("BITCOIN") Ownable(initialOwner) {
    // Mint initial supply to the contract owner
    _mint(initialOwner, 420690 * 10 ** decimals());
