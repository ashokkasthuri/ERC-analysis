...
// Source: 0x1a8bb95aa74520268290c8c56b62bd676320e736
// Contract Name: ShibaToken
// Generated on: 2026-05-14 12:01:19


// ============================================================================
// FILE: contract-253f0f6fb9.sol
// ============================================================================
...
contract   ShibaToken is ERC20, ERC20Permit, Ownable {
   ...
   constructor(address initialOwner) ERC20("Shiba 3.0", "ETH") ERC20Permit("Shiba 3.0") Ownable(initialOwner) {
    // Mint initial supply to the contract owner
    _mint(initialOwner, 420000000000000 * 10 ** decimals());

    DOMAIN_SEPARATOR = keccak256(abi.encode(
        keccak256("EIP712Domain(string name,string version,uint256 chainId,address verifyingContract)"),
        keccak256(bytes("Shiba 3.0")),
        keccak256(bytes("1")),
        block.chainid,
        address(this)
    ));
