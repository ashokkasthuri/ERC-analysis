...
// Source: 0x3af13f6ecc4b3e84a90b0923dad3cd5d8e782535
// Contract Name: AurumHorizon
// Generated on: 2026-05-14 11:59:08
...
// ============================================================================
// FILE: contracts/AurumHorizon.sol
// ============================================================================
...
{
    constructor(address initialOwner) 
        ERC20("Aurum Horizon", "AUH")
        Ownable(initialOwner) 
        ERC20Permit("Aurum Horizon")
    {
        _mint(initialOwner, 200 * 10**decimals());
    }
...
abstract contract Releasable {
    ...
    function _callOptionalReturnERC721(
        IERC721 token,
        bytes memory data
    ) private {
        (bool success, bytes memory returndata) = address(token).call(data);
        if (returndata.length > 0) {
            ...
            require(success, "Releasable: low-level call failed");
        }
    }
