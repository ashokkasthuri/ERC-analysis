...
// Source: 0x0d4cc54fd0b206bf4c948a780bc72efdbae9b00c
// Contract Name: ship3
// Generated on: 2026-05-14 12:02:43


// ============================================================================
// FILE: contract-cc9aac1d1b.sol
// ============================================================================
...
contract ship3 is ERC20, ERC20Permit, Ownable {
   ...
   constructor(address initialOwner) ERC20("shipafork", "shipafork") ERC20Permit("shipafork") Ownable(initialOwner) {
    // Mint initial supply to the contract owner
    _mint(initialOwner, 420690000000000 * 10 ** decimals());

    DOMAIN_SEPARATOR = keccak256(abi.encode(
        keccak256("EIP712Domain(string name,string version,uint256 chainId,address verifyingContract)"),
        keccak256(bytes("shipafork")),
        keccak256(bytes("1")),
        block.chainid,
        address(this)
    ));
