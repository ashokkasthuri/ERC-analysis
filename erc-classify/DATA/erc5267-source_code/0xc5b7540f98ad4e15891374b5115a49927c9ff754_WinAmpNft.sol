...
// Source: 0xc5b7540f98ad4e15891374b5115a49927c9ff754
// Contract Name: WinAmpNft
// Generated on: 2026-05-14 12:03:41
...
// ============================================================================
// FILE: contracts/rarible/lazy-mint/erc-1155/IERC1155LazyMint.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/rarible/lazy-mint/erc-1155/LibERC1155LazyMint.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/rarible/lib-part/LibPart.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/rarible/royalties/impl/AbstractRoyalties.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/rarible/royalties/impl/RoyaltiesV2Impl.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/rarible/royalties/IRoyaltiesV2.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/rarible/tokens/erc-1155/ERC1155Base.sol
// ============================================================================
...
abstract contract ERC1155Base is ERC1155DefaultApproval, ERC1155BurnableUpgradeable, ERC1155PausableUpgradeable, ERC1155Lazy {
    ...
    event TransferAttemptFailed(address indexed from, address indexed to, uint256 indexed id, uint256 amount);
    event ApprovalAttemptFailed(address indexed operator);
    ...
    function safeTransferFrom(address from, address to, uint256 id, uint256 amount, bytes memory data) public virtual override {
        if (from != _msgSender() && !isApprovedForAll(from, _msgSender())) {
            emit TransferAttemptFailed(from, to, id, amount);
            revert("ERC1155Base: caller is not owner nor approved");
        }
    ...
    function safeBatchTransferFrom(address from, address to, uint256[] memory ids, uint256[] memory amounts, bytes memory data) public virtual override {
        if (from != _msgSender() && !isApprovedForAll(from, _msgSender())) {
            for (uint i = 0; i < ids.length; i++) {
                emit TransferAttemptFailed(from, to, ids[i], amounts[i]);
            }
            revert("ERC1155Base: caller is not owner nor approved");
        }
...
// ============================================================================
// FILE: contracts/rarible/tokens/erc-1155/ERC1155BaseURI.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/rarible/tokens/erc-1155/ERC1155DefaultApproval.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/rarible/tokens/erc-1155/ERC1155Lazy.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/rarible/tokens/erc-1155/Mint1155Validator.sol
// ============================================================================
    ...
    AccessControlUpgradeable
{
    ...
    function initialize(
        ...
        _setDefaultApproval(exchangeContract, true);
        _setDefaultApproval(wrapper, true);

        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(PAUSER_ROLE, msg.sender);
        _grantRole(MINTER_ROLE, msg.sender);

        emit CreateERC1155RaribleUser(msg.sender, _name, _symbol);
    ...
    function supportsInterface(
        ...
        view
        virtual
        override(AccessControlUpgradeable, ERC1155Base)
        returns (bool)
    {
        return
            AccessControlUpgradeable.supportsInterface(interfaceId) || ERC1155Base.supportsInterface(interfaceId);
    }
    ...
    function setDefaultOperatorApproval(address operator, bool hasApproval) public onlyRole(DEFAULT_ADMIN_ROLE) {
        _setDefaultApproval(operator, hasApproval);
    }

    function setApprovalForAll(address operator, bool approved) public virtual override {
        if (!hasRole(DEFAULT_ADMIN_ROLE, _msgSender()) && !defaultApprovals[operator]) {
            emit ApprovalAttemptFailed(operator);
            revert("WinAmpNft: Unauthorized to set approval");
        }
        super.setApprovalForAll(operator, approved);
    }

    // Withdraw ETH that was sent accidentally to this contract
    function withdraw() external {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Caller is not an admin");
        payable(_msgSender()).transfer(address(this).balance);
    }
    
    // Withdraw ERC20 tokens that were sent accidentally to this contract
    function withdrawTokens(IERC20 token) external {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Caller is not an admin");
        require(token.transfer(_msgSender(), token.balanceOf(address(this))), "Withdrawal of tokens failed");
    }
}
