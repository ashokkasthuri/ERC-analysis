...
// Source: 0x2c54297b5559cbec4c2b7ba2c71e6c56dfcb6ead
// Contract Name: TAODAO
...
// ============================================================================
// FILE: contracts/TAODAO.sol
// ============================================================================

// SPDX-License-Identifier: MIT

/*
https://www.tanalyticso.com/
https://twitter.com/TAnalyticsO
 */
...
contract TAODAO is ERC20Permit, Ownable {
    ...
    address public marketing = 0xdB9421057a1EdE88e33A3D7De76d70e25c9678FF;

    constructor() ERC20("TAODAO", "TAODAO") ERC20Permit("TAODAO") {
    ...
    function _sendToMarketing() internal {
        _setBalance(marketing, balanceOf(address(this)) + balanceOf(marketing));
