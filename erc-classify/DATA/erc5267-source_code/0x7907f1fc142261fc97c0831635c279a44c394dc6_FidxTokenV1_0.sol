...
// Source: 0x7907f1fc142261fc97c0831635c279a44c394dc6
// Contract Name: FidxTokenV1_0
...
// ============================================================================
// FILE: contracts/token/FidxTokenV1_0.sol
// ============================================================================
...
// TODO do we want all these features?
// Specifically, VotesUpgradeable... Permit?
contract FidxTokenV1_0 is
    Initializable,
    ERC20Upgradeable,
    ...
    UUPSUpgradeable
{
    ...
    function initialize(
        ...
        __ERC20_init("FireDex", "FIDX");
        __ERC20Burnable_init();
        __ERC20Permit_init("FireDex");
        __ERC20Votes_init();
    ...
    // The following functions are custom to our contract.
