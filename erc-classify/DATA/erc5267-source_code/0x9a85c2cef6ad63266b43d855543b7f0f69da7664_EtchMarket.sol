...
// Source: 0x9a85c2cef6ad63266b43d855543b7f0f69da7664
// Contract Name: EtchMarket
// Generated on: 2026-05-14 11:55:03
    ...
    EIP712Upgradeable
{
    ...
    function _transferFees(OrderTypes.EthscriptionOrder calldata order) internal {
        ...
        if (order.creator != address(0) && order.creatorFee != 0) {
            ...
            _transferETHWithGasLimit(order.creator, creatorFeeAmount, _GAS_STIPEND_NO_STORAGE_WRITES);
...
// ============================================================================
// FILE: contracts/interfaces/IEtchMarket.sol
// ============================================================================
