...
// Source: 0x3df193de5891c1cdffd7514265fe96d6353e8535
// Contract Name: MoonpassNFTDropCollection
// Generated on: 2026-05-14 11:57:55


// ============================================================================
// FILE: src/nft/MoonpassNFTDropCollection.sol
// ============================================================================
  ...
  MoonpassNFTCollection
{
    ...
    external
  {
    ...
    _verifySigner(MoonpassRoles.NFT_MINTER_TRUSTEE_ROLE, data, signature);
    ...
    external
  {
    bytes memory data = abi.encode(
      ...
      keccak256(abi.encodePacked(request.quantity)),
      _encodeContext(signature)
    );
    _verifySigner(MoonpassRoles.NFT_MINTER_TRUSTEE_ROLE, data, signature);
...
// ============================================================================
// FILE: src/nft/MoonpassNFTCollection.sol
// ============================================================================
  ...
  MoonpassContract
{
    ...
    external
  {
    ...
    _verifySigner(MoonpassRoles.NFT_TRUSTEE_ROLE, data, signature);
...
// ============================================================================
// FILE: lib/openzeppelin-contracts-upgradeable/contracts/token/common/ERC2981Upgradeable.sol
// ============================================================================
...
import { MoonpassAccessControl } from "./auth/MoonpassAccessControl.sol";
import { MoonpassRoles } from "./auth/MoonpassRoles.sol";

contract MoonpassContract is
  IMoonpassContract,
  MoonpassAccessControl,
  NoncesUpgradeable,
  OwnableUpgradeable,
  EIP712Upgradeable
{
    ...
    onlyInitializing
  {
    ...
    __MoonpassAccessControl_init(data.authorizer);
  }
    ...
    external
  {
    ...
    _verifySigner(MoonpassRoles.AUTH_MANAGER_ROLE, data, signature);
  ...
  function _verifySigner(
    ...
    internal
  {
    _checkRole(role, _signerFrom(data, signature));
...
// ============================================================================
// FILE: src/auth/MoonpassAccessControl.sol
// ============================================================================
...
import { MoonpassAccessCheck } from "./MoonpassAccessCheck.sol";

contract MoonpassAccessControl is
  ContextUpgradeable,
  MoonpassAccessCheck
{
  using ERC165Checker for address;

  bytes32 private constant MoonpassAccessControlStorageLocation = 0xcf1e3c2eec56b7a457652c54121209bbbd2922d418d6ab903c014713a5d410e2;

  struct MoonpassAccessControlStorage {
    address _authorizer;
  }

  function _getMoonpassAccessControlStorage()
    private
    pure 
    returns (MoonpassAccessControlStorage storage $) 
  {
    assembly {
      $.slot := MoonpassAccessControlStorageLocation
    }
  }

  function __MoonpassAccessControl_init(
    address authorizerAddress
  )
    internal
    onlyInitializing
  ...
  function _authorizer()
    ...
    returns(address authorizerAddress)
  {
    MoonpassAccessControlStorage storage $ = _getMoonpassAccessControlStorage();
    authorizerAddress = $._authorizer;
  }
  ...
  function _hasRole(
    ...
    returns (bool)
  {
    return IAccessControl(_authorizer()).hasRole(role, account);
  }
...
// ============================================================================
// FILE: src/auth/MoonpassAccessCheck.sol
// ============================================================================
...
abstract contract MoonpassAccessCheck
{
