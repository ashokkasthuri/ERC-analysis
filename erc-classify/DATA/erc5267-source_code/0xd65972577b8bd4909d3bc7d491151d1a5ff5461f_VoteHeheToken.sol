...
// Source: 0xd65972577b8bd4909d3bc7d491151d1a5ff5461f
// Contract Name: VoteHeheToken
// Generated on: 2026-05-14 11:58:59
...
// ============================================================================
// FILE: @openzeppelin/contracts-upgradeable/token/ERC20/extensions/ERC20WrapperUpgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dao/VoteHeheToken.sol
// ============================================================================
    ...
    AccessControlUpgradeable
{
    ...
    function initialize(IERC20 _token, address _owner) public initializer {
        __ERC20_init("Vote-Escrowed HEHE", "veHEHE");
        __ERC20Permit_init("Vote-Escrowed HEHE");
    ...
    function transfer(
        address to,
        uint256 value
    ) public override onlyRole(TRUSTED_ROLE) returns (bool) {
    ...
    function delegateFor(address account, address delegatee) external {
        _delegate(account, delegatee);
    }
