...
// Source: 0x63583a828de07897acabd1c030e5cf14343bc856
// Contract Name: WstUSR
...
// ============================================================================
// FILE: contracts/interfaces/IDefaultErrors.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/interfaces/IERC20Rebasing.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/interfaces/IWstUSR.sol
// ============================================================================
...
contract WstUSR is IWstUSR, ERC20PermitUpgradeable, IDefaultErrors {
    ...
    function totalAssets() external view returns (uint256 totalManagedUsrAmount) {
        return IERC20Rebasing(stUSRAddress).convertToUnderlyingToken(totalSupply());
    }

    function convertToShares(uint256 _usrAmount) external view returns (uint256 wstUSRAmount) {
    ...
    function convertToAssets(uint256 _wstUSRAmount) public view returns (uint256 usrAmount) {
        return IERC20Rebasing(stUSRAddress).convertToUnderlyingToken(_wstUSRAmount);
    }
    ...
    function previewDeposit(uint256 _usrAmount) public view returns (uint256 wstUSRAmount) {
        return IStUSR(stUSRAddress).previewDeposit(_usrAmount);
    }
    ...
    function previewMint(uint256 _wstUSRAmount) public view returns (uint256 usrAmount) {
        ...
        return _wstUSRAmount.mulDiv(
            stUSR.totalSupply() + 1,
            stUSR.totalShares() + 1000,
            Math.Rounding.Ceil
        );
    }

    function previewWithdraw(uint256 _usrAmount) public view returns (uint256 wstUSRAmount) {
        return IStUSR(stUSRAddress).previewWithdraw(_usrAmount);
    }
    ...
    function wrap(uint256 _stUSRAmount, address _receiver) public returns (uint256 wstUSRAmount) {
        ...
        wstUSRAmount = stUSR.convertToShares(_stUSRAmount);
    ...
    function unwrap(uint256 _wstUSRAmount, address _receiver) public returns (uint256 stUSRAmount) {
        ...
        uint256 stUSRAmountBefore = stUSR.balanceOf(_receiver);
        _burn(msg.sender, _wstUSRAmount);
        IERC20(stUSRAddress).safeTransfer(_receiver, stUSRAmount);

        stUSRAmount = stUSR.balanceOf(_receiver) - stUSRAmountBefore;
