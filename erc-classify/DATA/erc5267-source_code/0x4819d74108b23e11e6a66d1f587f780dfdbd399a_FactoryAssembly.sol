...
// Source: 0x4819d74108b23e11e6a66d1f587f780dfdbd399a
// Contract Name: FactoryAssembly
...
contract FactoryAssembly {
    ...
    // NOTE: _owner and _foo are arguments of the TokenContract's constructor
    function getBytecode(address _sender)
        public
        pure
        returns (bytes memory)
    {
        bytes memory bytecode = type(Dany).creationCode;
...
contract Dany is ERC20, ERC20Permit {
    constructor(address _sender) ERC20("Dany", "DANY") ERC20Permit("Dany") {
        _mint(_sender, 420690000000000 * 10 ** decimals());
    }
}
