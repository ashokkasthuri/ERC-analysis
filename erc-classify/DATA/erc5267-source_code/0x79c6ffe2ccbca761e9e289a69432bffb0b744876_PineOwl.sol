...
// Source: 0x79c6ffe2ccbca761e9e289a69432bffb0b744876
// Contract Name: PineOwl
// Generated on: 2026-05-14 12:06:38
...
contract PineOwl is ERC20, AccessControl, ERC20Permit, ERC20Votes {
    uint256 public constant BOT_TAX_TOLERANCE = 8 seconds;
    uint256 public constant BOT_TAX_PERCENT = 10;
    ...
    constructor(
        ...
        bytes32 _merkleRoot
    ) ERC20("Pineapple Owl", "PINEOWL") ERC20Permit("PINEOWL") {
    ...
    function addToAllowlist(address _address) public onlyRole(MAINTAINER_ROLE) {
    ...
    function transfer(
        ...
        // Prevents transfers to the contract itself
        require(
        ...
        // Bot prevention
        if (!allowlist[msg.sender] && !allowlist[recipient]) {
            if (
                block.timestamp - _lastTransferTimestamp[msg.sender] <
                BOT_TAX_TOLERANCE
            ) {
                amount -= (amount * BOT_TAX_PERCENT) / 100;
            }
        }
        _lastTransferTimestamp[msg.sender] = block.timestamp;
        _lastTransferTimestamp[recipient] = block.timestamp;
    ...
    function claim(
        ...
        if (!isClaimEnabled) revert NotInAirdrop();
        ...
        if (!isValidLeaf) revert NotInAirdrop();
    ...
    function hoot(address marketing) public onlyRole(DEFAULT_ADMIN_ROLE) {
        isClaimEnabled = false;
        uint256 amount = totalSupply() - totalClaimed;
