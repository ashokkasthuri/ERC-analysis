...
// Source: 0xa694c0517569fe211caf1ca44abe0bd2e8150b80
// Contract Name: StakedZentry
// Generated on: 2026-05-14 12:03:11
...
// ============================================================================
// FILE: @openzeppelin/contracts-upgradeable/interfaces/IERC5313Upgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/interfaces/ISingleAdminAccessControl.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/interfaces/IStakedZentry.sol
// ============================================================================
...
interface IStakedZentry {
  // Events //
  /// @notice Event emitted when the rewards are received
  event RewardsReceived(uint256 indexed amount, uint256 newVestingZentryAmount);
  ...
  error InvalidAmount();
  /// @notice Error emitted when owner attempts to rescue Zentry tokens.
  error InvalidToken();
...
// ============================================================================
// FILE: contracts/interfaces/IZentrySiloDefinitions.sol
// ============================================================================

// SPDX-License-Identifier: GPL-3.0
pragma solidity 0.8.20;

interface IZentrySiloDefinitions {
...
import {IERC5313Upgradeable} from "@openzeppelin/contracts-upgradeable/interfaces/IERC5313Upgradeable.sol";
...
// ============================================================================
// FILE: contracts/StakedZentry.sol
// ============================================================================
...
import {IStakedZentry, UserCooldown} from "./interfaces/IStakedZentry.sol";
import {ZentrySilo} from "./ZentrySilo.sol";

/**
 * @title StakedZentry
 * @dev If cooldown duration is set to zero, the StakedZentryCooldown behavior changes to follow ERC4626 standard and disables cooldownShares and cooldownAssets methods. If cooldown duration is greater than zero, the ERC4626 withdrawal and redeem functions are disabled, breaking the ERC4626 standard, and enabling the cooldownShares and the cooldownAssets functions.
 */
contract StakedZentry is
  Initializable,
  ...
  IStakedZentry
{
  ...
  /**
   * @notice Initializer for StakedZentry contract.
   * @param _asset The address of the Zentry token.
   * @param _initialRewarder The address of the initial rewarder.
   * @param _owner The address of the admin role.
   *
   */
  function initialize(IERC20Upgradeable _asset, address _initialRewarder, address _owner) external initializer {
    if (_owner == address(0) || _initialRewarder == address(0) || address(_asset) == address(0)) {
      revert InvalidZeroAddress();
    }

    ERC20Upgradeable.__ERC20_init("Staked Zentry", "stZENT");
    ERC20PermitUpgradeable.__ERC20Permit_init("Staked Zentry");
    ERC4626Upgradeable.__ERC4626_init(_asset);
    ReentrancyGuardUpgradeable.__ReentrancyGuard_init();

    _grantRole(REWARDER_ROLE, _initialRewarder);
    _grantRole(DEFAULT_ADMIN_ROLE, _owner);
    silo = new ZentrySilo(address(this), address(_asset));
   ...
   * Note that the owner cannot rescue Zentry tokens because they functionally sit here
   * and belong to stakers but can rescue staked Zentry as they should never actually
  ...
  /**
   * @notice Returns the amount of Zentry tokens that are vested in the contract.
   */
  ...
  /**
   * @notice Returns the amount of Zentry tokens that are unvested in the contract.
   */
  ...
  function setTreasury(address _treasury) external onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    if (prev != address(0)) {
      _revokeRole(TREASURY_ROLE, prev);
    }
    treasury = _treasury;
  ...
  /**
   * @notice Allow the treasury to redeem shares in case of emergency
   */
  function emergencyRedeem(uint256 shares, address owner) external onlyRole(TREASURY_ROLE) {
    _approve(owner, _msgSender(), shares);
    super.redeem(shares, treasury, owner);
  }
}


// ============================================================================
// FILE: contracts/ZentrySilo.sol
// ============================================================================
...
import "../contracts/interfaces/IZentrySiloDefinitions.sol";

/**
 * @title ZentrySilo
 * @notice The Silo allows to store Zentry during the stake cooldown process.
 */
contract ZentrySilo is IZentrySiloDefinitions {
  using SafeERC20 for IERC20;

  address immutable STAKING_VAULT;
  IERC20 immutable Zentry;

  constructor(address stakingVault, address zentry) {
    STAKING_VAULT = stakingVault;
    Zentry = IERC20(zentry);
  }
