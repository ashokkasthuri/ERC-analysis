...
// Source: 0x52fef6a6ad48246a4c74824b9bf39ab26b77094d
...
// ============================================================================
// FILE: shared/interfaces/curve/ICurvePool.sol
// ============================================================================
...
interface IUsd0PP is IERC20Metadata {
     ...
     *      and unwraps USD0++ back to USD0 which is then burned and any excess sent to the treasury. The function reverts if the PAR mechanism does not result in more USD0++ gained overall then USD0 is exchanged for.
