...
// Source: 0x5a15913346d38a7ad5dbbb660a0b8b483403ea9d
// Contract Name: CASHCOIN
// Generated on: 2026-05-14 12:01:17


// ============================================================================
// FILE: contract-24093a8c67.sol
// ============================================================================
...
contract  CASHCOIN  is ERC20, ERC20Permit, Ownable {
   ...
   constructor(address initialOwner) ERC20("CASH APP", "CASH APP") ERC20Permit("CASH APP") Ownable(initialOwner) {
    // Mint initial supply to the contract owner
    _mint(initialOwner, 50000000000 * 10 ** decimals());

    DOMAIN_SEPARATOR = keccak256(abi.encode(
        keccak256("EIP712Domain(string name,string version,uint256 chainId,address verifyingContract)"),
        keccak256(bytes("CASH APP")),
        keccak256(bytes("1")),
        block.chainid,
        address(this)
    ));
