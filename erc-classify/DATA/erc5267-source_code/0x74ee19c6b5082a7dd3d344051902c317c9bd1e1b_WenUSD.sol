...
// Source: 0x74ee19c6b5082a7dd3d344051902c317c9bd1e1b
// Contract Name: WenUSD
// Generated on: 2026-05-14 12:03:03
...
// ============================================================================
// FILE: @layerzerolabs/solidity-examples/contracts/token/oft/v1/OFT.sol
// ============================================================================
...
// ============================================================================
// FILE: @layerzerolabs/solidity-examples/contracts/token/oft/v1/OFTCore.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/core/WenUSD.sol
// ============================================================================
...
contract WenUSD is OFT, ERC20Burnable, ERC20Permit, ERC20FlashMint {
	...
	constructor(address _stabilityPoolAddress, address _borrowerOperationsAddress, IWenCore WenCore_, address _layerZeroEndpoint, address _factory, address _gasPool, uint256 _gasCompensation) OFT("Wen Protocol USD", "wenUSD", _layerZeroEndpoint) ERC20Permit("Wen Protocol USD") {
	...
	// --- Functions for intra-Wen calls ---

	function mintWithGasCompensation(address _account, uint256 _amount) external returns (bool) {
		require(msg.sender == borrowerOperationsAddress, "WenUSD: Caller not BO");
	...
	function mint(address _account, uint256 _amount) external {
		require(msg.sender == borrowerOperationsAddress || troveManager[msg.sender], "WenUSD: Caller not BO/TM");
		_mint(_account, _amount);
	}

	function burn(address _account, uint256 _amount) external {
		require(troveManager[msg.sender], "WenUSD: Caller not TroveManager");
		_burn(_account, _amount);
	}

	function sendToSP(address _sender, uint256 _amount) external {
		require(msg.sender == stabilityPoolAddress, "WenUSD: Caller not StabilityPool");
		_transfer(_sender, msg.sender, _amount);
	}

	function returnFromPool(address _poolAddress, address _receiver, uint256 _amount) external {
		require(msg.sender == stabilityPoolAddress || troveManager[msg.sender], "WenUSD: Caller not TM/SP");
	...
	function _flashFeeReceiver() internal view override returns (address) {
		return _WenCore.feeReceiver();
	}

	// --- 'require' functions ---
	function _requireValidRecipient(address _recipient) internal view {
		require(_recipient != address(0) && _recipient != address(this), "WenUSD: Cannot transfer tokens directly to the Debt token contract or the zero address");
		require(_recipient != stabilityPoolAddress && !troveManager[_recipient] && _recipient != borrowerOperationsAddress, "WenUSD: Cannot transfer tokens directly to the StabilityPool, TroveManager or BorrowerOps");
	}
}
