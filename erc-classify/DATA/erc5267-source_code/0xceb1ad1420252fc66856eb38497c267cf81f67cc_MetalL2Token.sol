...
// Source: 0xceb1ad1420252fc66856eb38497c267cf81f67cc
// Contract Name: MetalL2Token
// Generated on: 2026-05-14 11:54:32
...
// ============================================================================
// FILE: contracts/ERC20MetalL2.sol
// ============================================================================
...
contract MetalL2Token is ERC20, ERC20Permit, Ownable {
     ...
     */
    constructor() ERC20("Metal", "MTL") ERC20Permit("Metal") Ownable(msg.sender) {
        _lastReleaseTime = block.timestamp;
        _mint(msg.sender, 78_588_888 * 10 ** decimals());
    }
