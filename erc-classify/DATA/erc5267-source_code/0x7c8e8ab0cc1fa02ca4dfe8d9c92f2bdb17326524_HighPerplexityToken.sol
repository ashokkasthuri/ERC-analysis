...
// Source: 0x7c8e8ab0cc1fa02ca4dfe8d9c92f2bdb17326524
// Contract Name: HighPerplexityToken
// Generated on: 2026-05-14 11:54:50
...
// ============================================================================
// FILE: contracts/HighPerplexityToken.sol
// ============================================================================
...
contract HighPerplexityToken is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit, ERC20Votes {
    event ETHReceived(address sender, uint256 amount);
    event TokensMinted(address recipient, uint256 amount);
    event TokensBurned(address target, uint256 amount);
    event TokenTransfer(address token, address to, uint256 amount);

    constructor(address initialOwner)
    ERC20("highPerplexityToken", "hP")
    Ownable(initialOwner)
    ERC20Permit("highPerplexityToken")
    {}
    ...
    function transferERC20(IERC20 token, address to, uint256 amount) public onlyOwner {
        ...
        emit TokenTransfer(address(token), to, amount);
    }
