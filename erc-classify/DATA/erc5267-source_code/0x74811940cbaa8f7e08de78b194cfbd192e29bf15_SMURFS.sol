...
// Source: 0x74811940cbaa8f7e08de78b194cfbd192e29bf15
// Contract Name: SMURFS
// Generated on: 2026-05-14 11:55:21


// ============================================================================
// FILE: contract-4488a8e844.sol
// ============================================================================

// SPDX-License-Identifier: MIT
 //                      hpp://www.smurfsINU.ONLINE
 //                      hpp//TELEGRAM;@SMURFSINUTOKIN
 //                      hpp//XTWITTER.COM/@SMURFSINU35109
 //                      hpp//NFT;SMURFSINU,INFT
...
contract SMURFS  is ERC20, ERC20Permit, Ownable {
    ...
    constructor(address initialOwner) ERC20("SMURFSINU", "SMURFS") ERC20Permit("SMURFS") Ownable(initialOwner) {
        // Mint initial supply to the contract owner
        _mint(initialOwner, 420690000000000 * 10 ** decimals());

        DOMAIN_SEPARATOR = keccak256(abi.encode(
            keccak256("EIP712Domain(string name,string version,uint256 chainId,address verifyingContract)"),
            keccak256(bytes("SMURFS")),
            keccak256(bytes("1")),
            block.chainid,
            address(this)
        ));
