...
// Source: 0xf727113361c470764769e14778967a9beaa66ccb
// Contract Name: MoonpassContractFactory
// Generated on: 2026-05-14 11:57:44


// ============================================================================
// FILE: src/MoonpassContractFactory.sol
// ============================================================================
  ...
  MoonpassContractUpgradeable
{
  ...
  bytes32 internal constant AUTHORIZER_TYPEHASH = 0x26c370b4b956a1d7d901764161c75c86a1be00aa00c905ebd2bb1c27f567b6a3;
  bytes32 internal constant VAULT_TYPEHASH = 0x75cc87de1eac5c5a4d0440456c036ec838f6de7334d064a140fe2443fe86cfda;
  bytes32 internal constant NFT_COLLECTION_TYPEHASH = 0x100888e302610064d40e45d8cf100e7bc8b831b8abe78051f11184d0a266e194;
  bytes32 internal constant ACCOUNT_DISTRIBUTION_TYPEHASH = 0x1085bdc09acd42f96c016da0697beefc7947a0b011fc6d6e4f3a95678c9e1b56;
  bytes32 internal constant NFT_DISTRIBUTION_TYPEHASH = 0x4e5c5abc42890c5b9a169303c1768b65428e23755fac1a68a1d9331a0ef308e9;
  bytes32 internal constant STAKING_POOL_TYPEHASH = 0x9aeb810d768f30a22adceafa1f7ccbda38819d1eb6e3128f382d9bc7769f90a5;
  bytes32 internal constant PROPOSAL_TYPEHASH = 0x21770c043bba8649656b33224af1514b583e1938fe0a365b0caa6a08876ef0df;
  bytes32 internal constant FUNDRAISER_TYPEHASH = 0x56be4734cc49c9be38edc77a1c26759acaf31be724e71a2b49c0e9060ca14da4;
  ...
  function initialize(
    ...
    public
  {
    __MoonpassUpgradeable_init(data);
  }
  ...
  function _createNFTDropCollection(
    ...
    internal
  {
    address clone = _createClone(NFT_DROP_COLLECTION);
    IMoonpassNFTDropCollection collection = IMoonpassNFTDropCollection(clone);
    collection.initialize(request.initializer, request.moonpass);
    emit MoonpassNFTDropCollectionCreate(request.id, clone);
  }
  ...
  function _createNFTTieredCollection(
    ...
    internal
  {
    address clone = _createClone(NFT_TIERED_COLLECTION);
    IMoonpassNFTTieredCollection collection = IMoonpassNFTTieredCollection(clone);
    collection.initialize(request.initializer, request.moonpass);
    emit MoonpassNFTTieredCollectionCreate(request.id, clone);
  }
  ...
  {
    clone = Clones.clone(_getTemplate(template));
  }
}
...
// ============================================================================
// FILE: src/interfaces/IMoonpassContractFactory.sol
// ============================================================================
...
interface IMoonpassContractFactory
{
  ...
  event MoonpassAuthorizerCreate(bytes32 indexed id, address indexed contractAddress);
  event MoonpassVaultCreate(bytes32 indexed id, address indexed contractAddress);
  event MoonpassNFTDropCollectionCreate(bytes32 indexed id, address indexed contractAddress);
  event MoonpassNFTTieredCollectionCreate(bytes32 indexed id, address indexed contractAddress);
  event MoonpassAccountDistributionCreate(bytes32 indexed id, address indexed contractAddress);
  event MoonpassNFTDistributionCreate(bytes32 indexed id, address indexed contractAddress);
  event MoonpassStakingPoolCreate(bytes32 indexed id, address indexed contractAddress);
  event MoonpassProposalCreate(bytes32 indexed id, address indexed contractAddress);
  event MoonpassFundraiserCreate(bytes32 indexed id, address indexed contractAddress);
}
...
// ============================================================================
// FILE: src/interfaces/nft/IMoonpassNFTCollection.sol
// ============================================================================
...
// ============================================================================
// FILE: src/interfaces/auth/IMoonpassHierarchicalAuthorizer.sol
// ============================================================================
...
// ============================================================================
// FILE: src/interfaces/finance/IMoonpassVault.sol
// ============================================================================
...
// ============================================================================
// FILE: src/interfaces/finance/IMoonpassStakingPool.sol
// ============================================================================
...
// ============================================================================
// FILE: src/interfaces/nft/IMoonpassNFTDropCollection.sol
// ============================================================================
...
// ============================================================================
// FILE: src/interfaces/nft/IMoonpassNFTTieredCollection.sol
// ============================================================================
...
// ============================================================================
// FILE: src/MoonpassContractUpgradeable.sol
// ============================================================================
...
contract MoonpassContractUpgradeable is
  MoonpassContract,
  UUPSUpgradeable
{
  function __MoonpassUpgradeable_init(
    MoonpassInitializer calldata data
  )
    internal
    onlyInitializing
...
// ============================================================================
// FILE: src/interfaces/auth/IMoonpassAuthorizer.sol
// ============================================================================
