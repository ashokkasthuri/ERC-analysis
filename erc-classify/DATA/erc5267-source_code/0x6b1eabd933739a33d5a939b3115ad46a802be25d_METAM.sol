...
// Source: 0x6b1eabd933739a33d5a939b3115ad46a802be25d
// Contract Name: METAM
// Generated on: 2026-05-14 12:02:01


// ============================================================================
// FILE: src/METAM/TokenFlat.sol
// ============================================================================

/**

Telegram:  https://t.me/MetaMixApp

Website:   https://metamix.app

Twitter:   https://twitter.com/MetaMixApp

TG Bot:    https://t.me/MetaMixBot

Gitbook:   https://docs.metamix.app

?  Mix tokens via Binance in minutes with our live, working mixer: https://metamix.app

?  Or, use the MetaMix Bot on Telegram: https://t.me/MetaMixBot

?  Fast. Private. Registration-free. KYC-free.

?  Hold $METAM for premium features, rebates, and revenue share.
...
contract METAM is Context, IERC20, IERC20Metadata, IERC20Permit, IERC20Errors, Ownable, EIP712, Nonces {
    ...
    uint256 private constant _tTotal = 100000000 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    string private _name = "MetaMix";
    string private constant _symbol = "METAM";
    ...
    uint256 public MAX_WALLET = _tTotal / 100;
    ...
    modifier await(bool swap, bool supply, bool atomic) {
        if (swap) {
            _inSwap = true;
            if (atomic) _inAtomicSwap = true;
        }
        if (supply) _inAtomicSupply = true;
        _;
        if (swap) {
            _inSwap = false;
            if (atomic) _inAtomicSwap = false;
        }
        if (supply) _inAtomicSupply = false;
    }
    ...
    function _update(address from, address to, uint256 value) internal virtual {
        ...
        if (!_noTax[from] && !_noTax[to]) {
            ...
            if ((_contractTokenBalance >= (_tTotal / 2000)) && !_inSwap && !_fromPair) {
                uint256 _marketingTokens = _contractTokenBalance;

                _inAtomicSwap = true;
                _convertTokensToETH(_marketingTokens);
                _inAtomicSwap = false;
