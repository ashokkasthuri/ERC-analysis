...
// Source: 0x61cb359509659558ea8be48c5572e94087b9ba0b
// Contract Name: bitcoinfork
// Generated on: 2026-05-14 12:02:39


// ============================================================================
// FILE: contract-f4dafa8953.sol
// ============================================================================
...
contract bitcoinfork is ERC20, ERC20Permit, Ownable {
    ...
    constructor(address initialOwner) ERC20("\u0628\u064a\u062a\u0643\u0648\u064a\u0646", "\u0628\u064a\u062a\u0643\u0648\u064a\u0646") ERC20Permit("\u0628\u064a\u062a\u0643\u0648\u064a\u0646") Ownable(initialOwner) {
        // Mint initial supply to the contract owner
        _mint(initialOwner, 1000000000 * 10 ** decimals());

        DOMAIN_SEPARATOR = keccak256(abi.encode(
            keccak256("EIP712Domain(string name,string version,uint256 chainId,address verifyingContract)"),
            keccak256(bytes("\u0628\u064a\u062a\u0643\u0648\u064a\u0646")),
            keccak256(bytes("1")),
            block.chainid,
            address(this)
        ));
