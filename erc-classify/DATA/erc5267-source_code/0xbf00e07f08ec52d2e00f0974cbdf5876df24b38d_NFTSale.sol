...
// Source: 0xbf00e07f08ec52d2e00f0974cbdf5876df24b38d
// Contract Name: NFTSale
// Generated on: 2026-05-14 11:57:54
...
// ============================================================================
// FILE: contracts/AdminManagerUpgradable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/AdminMintUpgradable.sol
// ============================================================================
    ...
    AdminMintUpgradable
{
    ...
    bytes32 private constant SET_TOKEN_PHASE_REQUEST_TYPE_HASH =
        keccak256("SetTokenPhaseRequest(uint256 tokenId,uint8 phase)");
    ...
    function saleOne(
        ...
        for (uint256 i = 0; i < beanzIds.length; i++) {
            ...
            require(
                saleOneBeanzBalances[beanzId] + beanzAmount <= saleOneBeanzLimit,
                "Beanz exceeds limit"
            );
    ...
    function _beforeTokenTransfers(
        ...
        require(
            from_ == address(0) || tokenPhases[tokenId_] != TokenPhase.Claimed,
...
// ============================================================================
// FILE: contracts/SupplyUpgradable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/UriManagerUpgradable.sol
// ============================================================================
