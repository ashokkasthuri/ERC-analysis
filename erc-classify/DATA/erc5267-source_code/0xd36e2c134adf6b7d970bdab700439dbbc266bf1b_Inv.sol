...
contract Inv is ERC20, ERC20Permit, ERC20Votes, Ownable {
    constructor(address initialOwner)
        ERC20("Invitas Coin", "INV")
        ERC20Permit("Invitas Coin")
        Ownable(initialOwner)
    {
        _mint(msg.sender, 24800000000 * 10 ** decimals());
    }
