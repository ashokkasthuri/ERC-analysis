...
// Source: 0xcb04caa8f0f75dc7b9f6f30fe080137dfed310b5
// Contract Name: BottoManifestoCollection
// Generated on: 2026-05-14 11:58:49
...
// ============================================================================
// FILE: contracts/BottoManifestoCollection.sol
// ============================================================================
...
contract BottoManifestoCollection is
    ...
    EIP712Upgradeable
{
    ...
    /// The collection name
    string public constant name = "The Manifesto Collection";
    ...
    function initialize(
        ...
        EIP712Upgradeable.__EIP712_init("BottoManifestoCollection", "1.0.0");
    ...
    function setURI(string memory newuri_) external virtual {
        require(
            ...
            "BottoManifestoCollection: must have uri setter role"
        );
    ...
    function setSupply(
        ...
        require(
            ...
            "BottoManifestoCollection: must have supply setter role"
        );
     ...
     */
    function revokePermitsUnderNonce(
        uint256 tokenId_,
        uint256 nonce_
    ) external virtual {
        require(
            hasRole(MINTER_ROLE, _msgSender()),
            "BottoManifestoCollection: must have minter role"
        );
    ...
    function redeem(
        ...
        require(
            ...
            "BottoManifestoCollection: signature invalid"
        );

        // Check if permit is revoked
        require(
            permit_.nonce >= _mintPermitMinimumNonces[permit_.tokenId],
            "BottoManifestoCollection: permit revoked"
        );
        ...
        require(
            ...
            "BottoManifestoCollection: permit expired"
        );
        ...
        if (permit_.recipient != address(0)) {
            require(
                ...
                "BottoManifestoCollection: recipient does not match permit"
            );
        }
        ...
        require(
            ...
            "BottoManifestoCollection: redeem cap reached for this address"
        );
        ...
        if (permit_.minimumPrice != 0) {
            if (permit_.currency == address(0)) {
                require(
                    ...
                    "BottoManifestoCollection: transaction value under minimum price"
                );

                (bool success, ) = permit_.payee.call{value: msg.value}("");
                require(success, "BottoManifestoCollection: transfer failed.");
            } else {
    ...
    function recover(
        ...
        require(
            ...
            "BottoManifestoCollection: must have admin role"
        );

        require(amount_ > 0, "BottoManifestoCollection: invalid amount");
        ...
        if (from == address(0)) {
            for (uint256 i = 0; i < ids.length; ++i) {
                ...
                require(
                    ...
                    "BottoManifestoCollection: exceeding total supply cap"
                );
            }
        }
    }
