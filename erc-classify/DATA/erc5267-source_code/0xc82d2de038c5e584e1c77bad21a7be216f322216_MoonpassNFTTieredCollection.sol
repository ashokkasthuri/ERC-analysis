...
// Source: 0xc82d2de038c5e584e1c77bad21a7be216f322216
// Contract Name: MoonpassNFTTieredCollection
// Generated on: 2026-05-14 11:57:40


// ============================================================================
// FILE: src/nft/MoonpassNFTTieredCollection.sol
// ============================================================================
  ...
  MoonpassNFTCollection
{
    ...
    )
  {
    ...
    tier = ($._tokenTiers[tokenId / 64] >> (tokenId % 64 * 4) & 15);
  }
    ...
    internal
  {
    ...
    uint256 slot = tokenId / 64;
    uint256 bits = tokenId % 64 * 4;
    MoonpassNFTTieredCollectionStorage storage $ = _getMoonpassNFTTieredCollectionStorage();
    $._tokenTiers[slot] = ($._tokenTiers[slot] & ~(15 << bits)) | (tier << bits);
