...
/// @custom:security-contact company@any-any.com
contract ANY is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit, ERC20FlashMint {
    constructor(address initialOwner)
        ERC20("ANY", "ANY")
        Ownable(initialOwner)
        ERC20Permit("ANY")
    {
        _mint(msg.sender, 8100000000 * 10 ** decimals());
    }
