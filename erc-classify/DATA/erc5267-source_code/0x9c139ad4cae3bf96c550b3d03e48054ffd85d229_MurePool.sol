...
// Source: 0x9c139ad4cae3bf96c550b3d03e48054ffd85d229
// Contract Name: MurePool
// Generated on: 2026-05-14 11:55:22
...
import {PoolMetrics, PoolParameters, PoolParameter, PoolErrorReason} from "./interfaces/Poolable.sol";
import {PoolState} from "./interfaces/PoolMetadata.sol";
 ...
 * these deployments.
 *
 * Facilitates secure and configurable pool management, supporting operations such as
 ...
 * ReentrancyGuardUpgradeable to prevent reentrancy attacks, and exclusive ownership control
    ...
    PoolApp
{
    ...
    /**
     * @notice Initializes RBAC for v1 upgrades.
     * @dev grants pool operator role to existing owner
     * @param admin address for managing roles
     */
    function initializeV2(address admin) external onlyOwner reinitializer(2) {
        __AccessControl_init();
