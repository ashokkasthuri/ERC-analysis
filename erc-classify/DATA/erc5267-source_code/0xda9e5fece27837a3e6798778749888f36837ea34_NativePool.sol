...
// Source: 0xda9e5fece27837a3e6798778749888f36837ea34
// Contract Name: NativePool
// Generated on: 2026-05-14 12:04:49
...
interface INativeRouter is ISwapCallback {
    ...
    error onlyOwnerOrPauserCanCall();
    error InvalidOrderBuyerOrFunctionSelector(address orderBuyer, bytes4 selector);
...
// ============================================================================
// FILE: contracts/libraries/IWETH9.sol
// ============================================================================
    ...
    NativePoolStorage
{
    ...
    function executeSwapFromTreasury(
        ...
        require((treasuryBalanceInitial - treasuryBalanceFinal) >= FullMath.mulDiv(amount, 999990, 1000000),
