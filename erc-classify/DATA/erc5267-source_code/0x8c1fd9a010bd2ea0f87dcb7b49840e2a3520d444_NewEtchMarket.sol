...
// Source: 0x8c1fd9a010bd2ea0f87dcb7b49840e2a3520d444
// Contract Name: NewEtchMarket
// Generated on: 2026-05-14 12:04:37


// ============================================================================
// FILE: contracts/contracts/NewEtchMarket.sol
// ============================================================================

// SPDX-License-Identifier: MIT
pragma solidity ^0.8.17;

import "../dependencies/contracts-upgradeable/proxy/utils/UUPSUpgradeable.sol";
import "../dependencies/contracts-upgradeable/access/OwnableUpgradeable.sol";
import "../dependencies/contracts-upgradeable/security/PausableUpgradeable.sol";
import "../dependencies/contracts-upgradeable/security/ReentrancyGuardUpgradeable.sol";
import "../dependencies/contracts-upgradeable/token/ERC20/utils/SafeERC20Upgradeable.sol";
import "../dependencies/contracts-upgradeable/utils/cryptography/draft-EIP712Upgradeable.sol";
import "./interfaces/ICurrencyManager.sol";
import "./interfaces/INewEtchMarket.sol";
import "./libraries/OrderTypes.sol";
import "./libraries/NewMerkleProof.sol";
...
EIP712Upgradeable
{
    ...
    using NewBatchOrder for NewBatchOrder.EthscriptionOrder;
    ...
    keccak256("WithdrawEthscription(bytes32 ethscriptionIds,address recipient,uint64 expiration)");

    ICurrencyManager public currencyManager;
    uint16 public creatorFeeBps;
    uint16 public protocolFeeBps;
    uint16 public discountProtocolFeeBps;
    address public protocolFeeRecipient;
    address private trustedVerifier;
    address public ogPassAddr;
    ...
    function executeOrderWithMerkle(
        NewBatchOrder.EthscriptionOrder[] calldata orders,
        NewBatchOrder.MerkleTree[] calldata merkleTrees,
        address recipient
    ) public payable override nonReentrant whenNotPaused {
        require(
            orders.length == merkleTrees.length,
            "Input array lengths do not match."
        );
        for (uint256 i = 0; i < orders.length; i++) {
            bytes32 orderHash = _verifyMerkleProofOrOrderHash(orders[i], merkleTrees[i]);
            _executeBatchOrder(orders[i], orderHash, recipient);
        }
    }
    ...
    function cancelMultipleMakerOrders(uint256[] calldata orderNonces) public override {
        ...
        emit CancelMultipleOrder(msg.sender, orderNonces, uint64(block.timestamp));
    }

    /**
    * @notice Withdraw an Ethscription
    * @param ethscriptionIds Identifier of the Ethscription to withdraw
    * @param expiration Expiration timestamp for the trusted signature
    * @param trustedSign Trusted signature for the withdrawal
    */
    function withdrawEthscriptionBatch(
        ...
        for(uint256 i = 0; i < ethscriptionIds.length; i++){
            (bytes32 r, bytes32 s, uint8 v) = _splitSignature(trustedSign[i]);
            bytes32 digest = keccak256(abi.encode(WITHDRAW_ETHSCRIPTION_HASH, ethscriptionIds[i], msg.sender, expiration));
            ...
            emit ethscriptions_protocol_TransferEthscriptionForPreviousOwner(msg.sender, msg.sender, ethscriptionIds[i]);
    ...
    function updateProtocolFeeBps(uint16 _protocolFeeBps,uint16 _discountProtocolFeeBps) external onlyOwner {
        protocolFeeBps = _protocolFeeBps;
        discountProtocolFeeBps = _discountProtocolFeeBps;
        emit NewProtocolBpsFee(_protocolFeeBps,discountProtocolFeeBps);
    }
    ...
    function _executeBatchOrder(
        NewBatchOrder.EthscriptionOrder calldata order,
        bytes32 orderHash,
        address recipient
    ) internal {
       if (order.price != msg.value) {
        ...
        // Get user's OGPASS balance
        (bool success, bytes memory result) = address(ogPassAddr).staticcall(
            abi.encodeWithSignature("balanceOf(address,uint256)", order.signer, 1)
        );
        require(success, "OGPASS get balance call failed");

        // Check if the signer has OGPASS
        uint256 ogPassBalance = abi.decode(result, (uint256));
        uint8 protocolFeeDiscounted;

        if (ogPassBalance > 0) {
            // If there is OGPASS, no need to pay transaction fees
            protocolFeeDiscounted = 1;
        } else {
            // If there is no OGPASS, transaction fees are required
            protocolFeeDiscounted = 0;
        }

        // Pay fees
        _transferFees(order.signer, order.creator, order.price, protocolFeeDiscounted, order.creatorFee);

        if (
            block.number <
            (_ethscriptionWithdrawOnBlockNumber[order.ethscriptionId] + TRANSFER_BLOCK_CONFIRMATIONS)
        ) {
            revert OrderExpired();
        }
    ...
    function _transferFees(
        ...
        // Pay protocol fee
        if (protocolFeeRecipient != address(0) && protocolFeeBps != 0) {

            uint16 protocolFeeBpsToUse = (protocolFeeDiscounted == 1) ? discountProtocolFeeBps : protocolFeeBps;
            uint256 protocolFeeAmount = (protocolFeeBpsToUse * price) / 10000;
            finalSellerAmount -= protocolFeeAmount;
            if (protocolFeeAmount > 0) {
                _transferETHWithGasLimit(protocolFeeRecipient, protocolFeeAmount, 5000);
            }
        }
     ...
     */
    function _verifyOrderHash(NewBatchOrder.EthscriptionOrder calldata order) internal view returns (bytes32) {
    ...
    function _verifyMerkleProofOrOrderHash(
        NewBatchOrder.EthscriptionOrder calldata order,
        NewBatchOrder.MerkleTree calldata merkleTree
        ...
        if (!MerkleProof.verifyCalldata(merkleTree.proof, merkleTree.root, order.hash())) {
            revert MerkleProofInvalid();
        }

        // Verify the validity of the signature
        digest = _verifyOrderHash(order);
    ...
    // 设置OGPASS合约地址
    function setOgPassAddr(address _ogPassAddr) external onlyOwner {
        ogPassAddr = _ogPassAddr;
    }
...
// ============================================================================
// FILE: contracts/contracts/libraries/SignatureChecker.sol
// ============================================================================

// SPDX-License-Identifier: MIT
pragma solidity ^0.8.17;

import {Address} from "../../dependencies/contracts/utils/Address.sol";
import {IERC1271} from "../../dependencies/contracts/interfaces/IERC1271.sol";
...
// ============================================================================
// FILE: contracts/contracts/libraries/NewMerkleProof.sol
// ============================================================================

// SPDX-License-Identifier: MIT
pragma solidity ^0.8.17;

import "./NewBatchOrder.sol";
...
library MerkleProof {
    ...
    function verifyCalldata(
        NewBatchOrder.MerkleTreeNode[] calldata proof,
        bytes32 root,
        bytes32 leaf
    ) internal pure returns (bool) {
        if(processProofCalldata(proof, leaf) == "process"){
            return true;
        }else{
    ...
    function processProofCalldata(
        ...
        for (uint256 i = 0; i < length; ) {
            if(proof[i].position == 2){
                return "process";
            }else if (proof[i].position == 0) {
                computedHash = _efficientHash(proof[i].value, computedHash);
            }else if (proof[i].position == 1) {
...
// ============================================================================
// FILE: contracts/contracts/libraries/OrderTypes.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/contracts/interfaces/INewEtchMarket.sol
// ============================================================================
...
import "../libraries/OrderTypes.sol";
import "../libraries/NewBatchOrder.sol";
...
interface IEtchMarket {
    ...
    event CancelMultipleOrder(address user, uint256[] orderNonces, uint64 timestamp);

    event NewCurrencyManager(address indexed currencyManager);
    event NewProtocolBpsFee(uint96 protocolFeeBps, uint96 discountProtocolFeeBps);
    ...
    function withdrawEthscriptionBatch(bytes32[] calldata ethscriptionIds, uint64 expiration, bytes[] calldata trustedSign) external;
}


// ============================================================================
// FILE: contracts/contracts/interfaces/ICurrencyManager.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts-upgradeable/utils/cryptography/draft-EIP712Upgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts-upgradeable/token/ERC20/utils/SafeERC20Upgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts-upgradeable/security/ReentrancyGuardUpgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts-upgradeable/security/PausableUpgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts-upgradeable/access/OwnableUpgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts-upgradeable/proxy/utils/UUPSUpgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts-upgradeable/utils/cryptography/EIP712Upgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts-upgradeable/utils/AddressUpgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts-upgradeable/token/ERC20/extensions/IERC20PermitUpgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts-upgradeable/token/ERC20/IERC20Upgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts-upgradeable/proxy/utils/Initializable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts-upgradeable/utils/ContextUpgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts-upgradeable/proxy/ERC1967/ERC1967UpgradeUpgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts-upgradeable/interfaces/draft-IERC1822Upgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts/interfaces/IERC1271.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts/utils/Address.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/contracts/libraries/NewBatchOrder.sol
// ============================================================================
...
library NewBatchOrder {
    ...
    struct EthscriptionOrder {
        address signer; // signer of the ethscription seller
        address creator; // deployer of the ethscription collection
        bytes32 ethscriptionId; // ethscription bundles
        uint256 quantity; // if the ethscription is nft: 1, else if is ft: >= 1
        address currency; // currency (e.g., ETH)
        uint256 price; // price
        uint256 nonce; // order nonce (must be unique unless new maker order is meant to override existing one e.g., lower ask price)
...
// ============================================================================
// FILE: contracts/dependencies/contracts-upgradeable/interfaces/IERC5267Upgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts-upgradeable/utils/cryptography/ECDSAUpgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts-upgradeable/utils/StorageSlotUpgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts-upgradeable/interfaces/IERC1967Upgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts-upgradeable/proxy/beacon/IBeaconUpgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts-upgradeable/utils/StringsUpgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts-upgradeable/utils/math/SignedMathUpgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/dependencies/contracts-upgradeable/utils/math/MathUpgradeable.sol
// ============================================================================
