...
// Source: 0x72b7a5d87a703bf8d3cad0e1577e16dd9be54abb
// Contract Name: NativeBridge
// Generated on: 2026-05-14 12:02:19
...
// ============================================================================
// FILE: contracts/Bridge/NativeBridge.sol
// ============================================================================
...
import {NativeBridgeStorage} from "contracts/storage/NativeBridgeStorage.sol";
import {INativeRfqPool} from "contracts/interfaces/INativeRfqPool.sol";
import {INativeRouter} from "contracts/interfaces/INativeRouter.sol";
    ...
    INativeBridge
{
    ...
    function _fill(INativeRfqPool.RFQTQuote memory dstRouterData) internal returns (address, uint256) {
        ...
        uint256 initialRecepientBalance = IERC20(dstRouterData.buyerToken).balanceOf(dstRouterData.recipient);
        ...
        (bool success,) = nativeRouter.call(abi.encodeWithSelector(INativeRfqPool.tradeRFQT.selector, dstRouterData));
        if (!success) revert BridgeCallFail();
...
// ============================================================================
// FILE: contracts/interfaces/IERC7683.sol
// ============================================================================
...
/**
 * The following standard allows for the implementation of a standard API for cross-chain trade execution systems.
 *  This standard provides a generic CrossChainOrder struct, as well as a standard ISettlementContract smart contract interface.
 */
...
// ============================================================================
// FILE: contracts/interfaces/INativeBridge.sol
// ============================================================================
...
import {
    ISettlementContract, CrossChainOrder, ResolvedCrossChainOrder, Input, Output
...
interface INativeBridge {
    ...
    enum ErrorCodes {
        ...
        BalanceMismatch, // 12
        InvalidQuoteId, // 13
        InsufficientOutput, // 14
        MMBalanceMismatch, // 15
        ClaimDeadlineNotExpired, // 16
        SolverNotWhitelisted // 17
    }
...
// ============================================================================
// FILE: contracts/interfaces/INativeRfqPool.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/interfaces/INativeRouter.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/interfaces/ISwapCallback.sol
// ============================================================================
...
// ============================================================================
// FILE: contracts/storage/NativeBridgeStorage.sol
// ============================================================================
