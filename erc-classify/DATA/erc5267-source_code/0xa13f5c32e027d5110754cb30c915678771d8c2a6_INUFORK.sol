...
// Source: 0xa13f5c32e027d5110754cb30c915678771d8c2a6
// Contract Name: INUFORK
// Generated on: 2026-05-14 12:02:43


// ============================================================================
// FILE: contract-c2ca223a9e.sol
// ============================================================================
...
contract INUFORK is ERC20, ERC20Permit, Ownable {
   ...
   constructor(address initialOwner) ERC20("INU", "fork") ERC20Permit("fork") Ownable(initialOwner) {
    // Mint initial supply to the contract owner
    _mint(initialOwner, 1000000000000000000 * 10 ** decimals());

    DOMAIN_SEPARATOR = keccak256(abi.encode(
        keccak256("EIP712Domain(string name,string version,uint256 chainId,address verifyingContract)"),
        keccak256(bytes("fork")),
        keccak256(bytes("1")),
        block.chainid,
        address(this)
    ));
