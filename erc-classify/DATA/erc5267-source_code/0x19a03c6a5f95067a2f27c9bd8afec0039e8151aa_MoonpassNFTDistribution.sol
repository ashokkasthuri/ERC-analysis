...
// Source: 0x19a03c6a5f95067a2f27c9bd8afec0039e8151aa
// Contract Name: MoonpassNFTDistribution
// Generated on: 2026-05-14 11:54:52


// ============================================================================
// FILE: src/token-distribution/nft/MoonpassNFTDistribution.sol
// ============================================================================
  ...
  MoonpassTokenDistribution
{
  ...
  function _setNFTCollection(
    ...
    internal
  {
    if(nftNetworkId == 0 || nftAddress == address(0)) {
      revert InvalidAddressError();
    }
    MoonpassNFTDistributionStorage storage $ = _getMoonpassNFTDistributionStorage();
    ...
    internal    
  {
    ...
    $$._totalDepositsValue += amount * $._decimalsGap;
  }
  ...
  MoonpassContract
{
  ...
  {
    withdrawableAmount = _releasedAt(allocation, timestamp) - _resolveWithdrawn(allocation);
  }
