...
// Source: 0xcee96aa5ad502a9e00f981dfb558474b864c98b8
// Contract Name: ELSAROBOT
// Generated on: 2026-05-14 12:04:06


// ============================================================================
// FILE: contract-f9a16fb391.sol
// ============================================================================
...
contract ELSAROBOT is ERC20, ERC20Permit, Ownable {
   ...
   constructor(address initialOwner) ERC20("ELSA ROBOT", "ELSA") ERC20Permit("ELSA ROBOT") Ownable(initialOwner) {
    // Mint initial supply to the contract owner
    _mint(initialOwner, 1000000000 * 10 ** decimals());

    DOMAIN_SEPARATOR = keccak256(abi.encode(
        keccak256("EIP712Domain(string name,string version,uint256 chainId,address verifyingContract)"),
        keccak256(bytes("ELSA ROBOT")),
        keccak256(bytes("1")),
        block.chainid,
        address(this)
    ));
