...
// Source: 0x7ccaf58bb9f485eb4dafb6be661c7e4630e4c299
// Contract Name: MemeRun
// Generated on: 2026-05-14 12:02:18
...
// ============================================================================
// FILE: @openzeppelin/contracts-upgradeable/interfaces/draft-IERC6093Upgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: @openzeppelin/contracts-upgradeable/proxy/ERC1967/ERC1967UtilsUpgradeable.sol
// ============================================================================
...
// ============================================================================
// FILE: @openzeppelin/contracts-upgradeable/utils/cryptography/MessageHashUtilsUpgradeable.sol
// ============================================================================
 ...
 * specifications.
 */
library MessageHashUtilsUpgradeable {
    /**
...
// ============================================================================
// FILE: src/TaxableUpgradeable.sol
// ============================================================================
...
abstract contract TaxableUpgradeable is ContextUpgradeable {
    ...
    struct TaxableStorage {
        bool _taxed; // Stores whether tax is enabled/disabled in a boolean.
        uint _thetax; // Stores tax amount as a uint256 integer.
        uint _maxtax; // Stores maximum tax amount as a uint256 integer.
        uint _mintax; // Stores minimum tax amount as a uint256 integer.
        address _taxdestination; // Stores tax destination as a blockchain address type.
    }

    bytes32 private constant TaxableStorageLocation =
        0x4184109913e5cbfcf24578ce83a97d284b644c9e7f0ac86f6d42df1cadbdab00;

    function _getTaxableStorage()
        private
        pure
        returns (TaxableStorage storage $)
    {
        assembly {
            $.slot := TaxableStorageLocation
        }
    }

    function __Taxable_init(
        bool __taxed,
        uint __thetax,
        uint __maxtax,
        uint __mintax,
    ...
    function __Taxable_init_unchained(
        bool __taxed,
        uint __thetax,
        uint __maxtax,
        uint __mintax,
        ...
        TaxableStorage storage $ = _getTaxableStorage();
