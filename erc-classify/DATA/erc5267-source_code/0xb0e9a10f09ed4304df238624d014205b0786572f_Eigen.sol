...
// Source: 0xb0e9a10f09ed4304df238624d014205b0786572f
// Contract Name: Eigen
// Generated on: 2026-05-14 12:06:13
...
contract Eigen is OwnableUpgradeable, ERC20VotesUpgradeable {
    ...
    /**
     * @notice This function allows the owner to set the transfer restrictions to be disabled after one year in the future
     */
    function setTransferRestrictionsDisabledAfterToOneYearInFuture() external onlyOwner {
        require(transferRestrictionsDisabledAfter == type(uint256).max, "Eigen.setTransferRestrictionsDisabledAfterToOneYearInFuture: transfer restrictions are already disabled");
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal override {
        ...
        if (block.timestamp <= transferRestrictionsDisabledAfter) {
            ...
            require(allowedFrom[from] || allowedTo[to] || from == address(0), "Eigen._beforeTokenTransfer: from or to must be whitelisted");
        }
