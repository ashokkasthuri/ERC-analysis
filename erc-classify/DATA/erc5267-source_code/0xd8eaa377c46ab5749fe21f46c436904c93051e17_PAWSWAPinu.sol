...
// Source: 0xd8eaa377c46ab5749fe21f46c436904c93051e17
// Contract Name: PAWSWAPinu
// Generated on: 2026-05-14 11:55:18


// ============================================================================
// FILE: contract-51018cfef4.sol
// ============================================================================
...
contract  PAWSWAPinu  is ERC20, ERC20Permit, Ownable {
   ...
   constructor(address initialOwner) ERC20("PAWSWAP", "PAWSWAP") ERC20Permit("PAWSWAP") Ownable(initialOwner) {
    // Mint initial supply to the contract owner
    _mint(initialOwner, 1000000000000000 * 10 ** decimals());

    DOMAIN_SEPARATOR = keccak256(abi.encode(
        keccak256("EIP712Domain(string name,string version,uint256 chainId,address verifyingContract)"),
        keccak256(bytes("pawswap")),
        keccak256(bytes("1")),
        block.chainid,
        address(this)
    ));
