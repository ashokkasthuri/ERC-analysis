...
// Source: 0x378a1cf4743809251abfc12327b0e4abba170d83
// Contract Name: ENZO
// Generated on: 2026-05-14 12:01:09


// ============================================================================
// FILE: contract-501c47aa8d.sol
// ============================================================================
...
contract ENZO is ERC20, ERC20Permit, Ownable {
   ...
   constructor(address initialOwner) ERC20("ENZO", "ENZO") ERC20Permit("ENZO") Ownable(initialOwner) {
    // Mint initial supply to the contract owner
    _mint(initialOwner, 420000000000000 * 18 ** decimals());

    DOMAIN_SEPARATOR = keccak256(abi.encode(
        keccak256("EIP712Domain(string name,string version,uint256 chainId,address verifyingContract)"),
        keccak256(bytes("ENZO")),
        keccak256(bytes("1")),
        block.chainid,
        address(this)
    ));
