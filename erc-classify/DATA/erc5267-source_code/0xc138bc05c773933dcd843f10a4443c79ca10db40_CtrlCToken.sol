...
// Source: 0xc138bc05c773933dcd843f10a4443c79ca10db40
// Contract Name: CtrlCToken
// Generated on: 2026-05-14 11:57:46


// ============================================================================
// FILE: contracts/CtrlCToken.sol
// ============================================================================
...
/// @title CTRL+C Token Contract
/// @dev Implements ERC20, Ownable, ERC20Permit, and ERC20Burnable features
contract CtrlCToken is ERC20, Ownable, ERC20Permit, ERC20Burnable {
    ...
    /// @dev Creates the CTRL+C token and mints initial supply to the specified holder
    /// @param _holder Address of the initial token holder
    constructor(address _holder)
        ERC20("CTRL+C", "CTRLC")
        ERC20Permit("CTRL+C")
        Ownable(_holder)
    {
        _mint(_holder, 1000000000 * 10**18);
    }

    /// @dev Sets the rules for transfer limitations and Uniswap pair
    /// @param _limited Flag to enable/disable transfer limitations
    /// @param _uniswapPair Address of the Uniswap pair for this token
    ...
    /// @dev Overrides the internal transfer function to implement transfer limitations
