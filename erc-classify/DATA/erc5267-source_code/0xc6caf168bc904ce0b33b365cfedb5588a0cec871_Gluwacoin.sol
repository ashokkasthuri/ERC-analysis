...
// Source: 0xc6caf168bc904ce0b33b365cfedb5588a0cec871
// Contract Name: Gluwacoin
// Generated on: 2026-05-14 12:07:09
...
abstract contract EIP712 is Initializable, IERC5267 {
    ...
    function _EIP712Name() internal pure virtual returns (string memory);
...
contract ERC20Reservable is GluwacoinBase, SignerNonce, ERC20Upgradeable {
    ...
    function reserve(
        ...
        require(
            executor != address(0),
            "EthlessReservable: cannot execute from zero address"
        );
        require(
            deadline_ >= block.number + MINIMUM_BLOCK_FOR_RESERVATION,
            "EthlessReservable: invalid block expiry number"
        );
    ...
    function _execute(address from_, Reservation storage reservation) private {
        ...
        require(
            ...
            "ERC20Reservable: reservation has expired or invalid reservation status"
        );
        ...
        require(
            sender == from_ ||
                (sender == reservation.executor &&
                    block.number >= reservation.expiryBlockNum),
            "ERC20Reservable: only the sender or the expired reservation's executor can reclaim"
        );
