...
// Source: 0x1d64fa3f24bc10851197fe9fe95440b3e1eb54eb
// Contract Name: OPLRouter
// Generated on: 2026-05-14 12:03:05
...
contract OPLRouter is EIP712Upgradeable {
  ...
  function _v2Swap(
    ...
    if (from == address(this)) {
      ...
      IERC20(tokenIn).transferFrom(from, address(pair), amountIn);
    }
  ...
  function executeStep(
    ...
    if (refund > 0) {
      ...
      if (tokenIn == wnative) {
        ...
        IERC20(tokenIn).transfer(refundRecipient, refund);
      }
    }
  ...
  function detectV3Callback() internal returns (bool) {
    if (msg.data.length > 0) {
      ...
      if (callback.sender == address(this)) {
        IERC20(callback.token).transfer(msg.sender, callback.amount);
      } else {
