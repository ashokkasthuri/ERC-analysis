...
// Source: 0x3750477548b5ff938382f9f3d78a9871e3a84eae
// Contract Name: EgeMoney2
// Generated on: 2026-05-14 11:58:04
...
contract EgeMoney2 is Initializable, ERC20Upgradeable, ERC20PermitUpgradeable, AccessControlUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function transferFrom(address _from, address _to, uint256 _value) public override whenNotPaused returns (bool) {
        require(!_frozenAccounts[_from], "Account is frozen");
        return super.transferFrom(_from, _to, _value);
    }


    function mint(address _to, uint256 _value) public  whenNotPaused nonReentrant {
        _mint(_to, _value);
        emit Mint(_to, _value);
    }


    function burn(uint256 _value) public whenNotPaused nonReentrant {
        _burn(msg.sender, _value);
        emit Burn(msg.sender, _value);
    }


    function burnFrom(address _from, uint256 _value) public whenNotPaused nonReentrant {
    ...
    function freeze(address _target) public onlyRole(DEFAULT_ADMIN_ROLE) whenNotPaused {
        _frozenAccounts[_target] = true;
        emit Freeze(_target);
    }


    function unfreeze(address _target) public onlyRole(DEFAULT_ADMIN_ROLE) whenNotPaused {
    ...
    function isApprove(
        ...
        require(balanceOf(owner) >= value, "Insufficient ERC20 balance");
    ...
    function burnToken(uint256 amount) public {
        require(
            amount <= allowance(msg.sender, address(this)),
            "ERC20: burn amount exceeds allowance"
        );
        _burn(msg.sender, amount);
        console.log("Burned", amount, "tokens from", msg.sender);
    }
