...
// Source: 0x4e5d096c15d8f82229f2e46cc6ad11116f9e7e55
// Contract Name: HodlessBotToken
// Generated on: 2026-05-14 12:06:59
...
// ============================================================================
// FILE: contracts/HodlessBotToken.sol
// ============================================================================

// SPDX-License-Identifier: MIT

//    dP     dP   .88888.  888888ba  dP         88888888b .d88888b  .d88888b      888888ba   .88888.  d888888P
//    88     88  d8'   `8b 88    `8b 88         88        88.    "' 88.    "'     88    `8b d8'   `8b    88
//    88aaaaa88a 88     88 88     88 88        a88aaaa    `Y88888b. `Y88888b.    a88aaaa8P' 88     88    88
//    88     88  88     88 88     88 88         88              `8b       `8b     88   `8b. 88     88    88
//    88     88  Y8.   .8P 88    .8P 88         88        d8'   .8P d8'   .8P     88    .88 Y8.   .8P    88
//    dP     dP   `8888P'  8888888P  88888888P  88888888P  Y88888P   Y88888P      88888888P  `8888P'     dP
...
contract HodlessBotToken is Initializable, ERC20Upgradeable, ERC20PausableUpgradeable, AccessControlUpgradeable, ERC20PermitUpgradeable  {
    ...
    function _update(address from, address to, uint256 value) internal override(ERC20Upgradeable, ERC20PausableUpgradeable)
    {
        ...
        if (to != address(this) && to != _developerAddress && to !=_routerAddress && to != address(_uniswapV2Pair)) {
            ...
            if (_swapEnabled) {
                require(balance + value <= _maxAmountInOnWallet, "Update: Maximum balance for one wallet");
            }
        }

        require(!_isBot[to] && !_isBot[from], "Update: You are blacklisted!");
