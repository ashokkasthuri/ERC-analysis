...
// Source: 0x40dc02f1c16d936dbe4be405ccf1567b4366f84f
// Contract Name: BoxERC20
// Generated on: 2026-05-14 11:58:27


// ============================================================================
// FILE: src/BoxToken.sol
// ============================================================================
...
/**
 * @title BoxToken
 * @author https://www.box404.xyz/
 */
contract BoxERC20 is ERC20Permit("BOX") {
...
contract BoxVault is Ownable(msg.sender) {
    bytes32 public immutable ROOT;
    address public immutable BOX;

    mapping(address => uint256) public claimed;

    constructor(bytes32 _root, address box) {
        ROOT = _root;
        BOX = box;
    }

    function claim(bytes32[] memory proof, uint256 amount) external {
        require(block.timestamp <= 1707543506, "REJ");
        require(claimed[msg.sender] == 0, "has claimed");
        ...
        require(IERC20(BOX).transfer(msg.sender, amount), "transfer failed");
    }

    function withdraw() external onlyOwner {
        require(block.timestamp > 1707543506, "REJ");
        uint256 amount = IERC20(BOX).balanceOf(address(this));
