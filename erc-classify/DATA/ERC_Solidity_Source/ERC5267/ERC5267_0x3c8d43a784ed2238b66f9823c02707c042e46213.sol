...
// File: contracts/marketplace/AssetMatcher.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/marketplace/Exchange.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/marketplace/ExchangeCore.sol
// SPDX-License-Identifier: MIT
    ...
    PausableUpgradeable
{
    ...
    function matchOrderExtension(
        ...
        if (orderRight.maker != address(0)) {
            require(_msgSender() == orderRight.maker, "maker is not tx sender");
        } else {
            orderRight.maker = _msgSender();
        }
    ...
    */
    ...
    function _validateFull(LibOrder.Order memory order, bytes memory signature)
        internal
        view
    {
...
// File: contracts/marketplace/interfaces/IERC1271.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/marketplace/interfaces/IExchange.sol
// SPDX-License-Identifier: MIT
...
interface IExchange {
    //events
    event Cancel(uint256 salt, bytes4 typeSale);
    event Match(
        address from,
        uint256 salt,
        bytes4 typeSale,
...
// File: contracts/marketplace/lib/LibAsset.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/marketplace/lib/LibFill.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/marketplace/lib/LibMath.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/marketplace/lib/LibOrderData.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/marketplace/lib/LibPart.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/marketplace/lib/LibSignature.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/marketplace/lib/LibTransfer.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/marketplace/OrderValidator.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/marketplace/TransferExecutor.sol
// SPDX-License-Identifier: MIT
...
abstract contract TransferExecutor {
    ...
    function _transferNFT(
        ...
        if (asset.assetType.assetClass == LibAsset.ERC721_ASSET_CLASS) {
            ...
            require(asset.value == 1, "erc721 value error");
            INFT721(asset.token).mint(from, to, typeMint);
...
// File: contracts/marketplace/TransferManager.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/token/erc721/interfaces/INFT721.sol
// SPDX-License-Identifier: MIT
