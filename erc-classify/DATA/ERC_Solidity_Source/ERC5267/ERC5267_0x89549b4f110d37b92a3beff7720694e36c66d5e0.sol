// File: contracts/bridge/xerc20/XERC20.sol
...
contract XERC20 is Initializable, ERC20Upgradeable, OwnableUpgradeable, IXERC20, ERC20PermitUpgradeable {
    ...
    // constructor(string memory _name, string memory _symbol, address _factory) ERC20Upgradeable(_name, _symbol)
    // ERC20PermitUpgradeable(_name) {
...
// File: contracts/bridge/xerc20/interfaces/IXERC20.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity >=0.8.4 <0.9.0;
