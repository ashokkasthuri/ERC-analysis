    ...
    IERC721Receiver
{
    ...
    function wrapETH2LD(
        ...
        // transfer the tdns record back to the new owner (this contract)
     ...
     * @param resolver The resolver address to set on the TDNS registry (optional).
    ...
    /**
     * @notice Sets records for the name in the TDNS Registry
...
// File: contracts/registry/TDNS.sol
pragma solidity >=0.8.4;
...
library BytesUtils {
    ...
    */
    ...
    /**
     * @dev Returns the TDNS namehash of a DNS-encoded name.
