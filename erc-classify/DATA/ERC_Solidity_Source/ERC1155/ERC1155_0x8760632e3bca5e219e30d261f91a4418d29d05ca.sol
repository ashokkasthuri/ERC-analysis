// File: src/minters/redeem/CreatorRedeemMinterFactory.sol
...
// File: src/minters/redeem/CreatorRedeemMinterStrategy.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.17;
...
contract CreatorRedeemMinterStrategy is SaleStrategy, Initializable {
    ...
    function requestMint(
        ...
        returns (ICreatorCommands.CommandSet memory commands)
    {
        (RedeemInstructions memory redeemInstructions, uint256[][] memory tokenIds, uint256[][] memory amounts) =
            abi.decode(minterArguments, (RedeemInstructions, uint256[][], uint256[][]));
