...
contract P5flowers is IERC721A { 
    ...
    string private constant _name = "P5 FLOWERS";
    string private constant _symbol = "P5FLOWERS";
    string private _baseURI = "Qme18SadzyQYoSaPasW3dQXe7iAAUcGug5XXLjpjwBWgkP";
    ...
    function mint(uint256 amount) external payable{
        ...
        require(amount <= 10, "Max 10 per Buy");
