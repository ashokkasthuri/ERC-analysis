...
// File: contracts/nft/GeneralERC721.sol
// SPDX-License-Identifier: MIT OR Apache-2.0
pragma solidity 0.8.9;
import "@openzeppelin/contracts-upgradeable/access/AccessControlUpgradeable.sol";
import "@openzeppelin/contracts-upgradeable/token/ERC721/extensions/ERC721URIStorageUpgradeable.sol";

contract GeneralERC721 is Initializable, ERC721URIStorageUpgradeable, AccessControlUpgradeable {
    ...
    function mint(address player, string memory tokenURI) external returns (uint256) {
        if (!isMintingPublic) {
