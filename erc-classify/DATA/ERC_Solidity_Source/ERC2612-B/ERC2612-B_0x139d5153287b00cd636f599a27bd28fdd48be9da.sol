...
// File: contracts/AllowanceTransfer.sol
// SPDX-License-Identifier: MIT
pragma solidity 0.8.17;
...
// File: contracts/SignatureTransfer.sol
// SPDX-License-Identifier: MIT
pragma solidity 0.8.17;
...
contract EIP712 {
    ...
    function setBase() public {
        ...
        _CACHED_DOMAIN_SEPARATOR = _buildDomainSeparator(keccak256("EIP712Domain(string name,uint256 chainId,address verifyingContract)"), keccak256("Permit2"));
    }
    ...
    function DOMAIN_SEPARATOR() public view returns (bytes32) {
        return block.chainid == _CACHED_CHAIN_ID
            ...
            : _buildDomainSeparator(keccak256("EIP712Domain(string name,uint256 chainId,address verifyingContract)"), keccak256("Permit2"));
    }
...
// File: contracts/libraries/PermitHash.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.17;
...
// File: contracts/libraries/SignatureVerification.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.17;
...
library SignatureVerification {
    ...
    function verify(bytes calldata signature, bytes32 hash, address claimedSigner) internal view {
        ...
        bytes32 s;
        uint8 v;
        bytes32 UPPER_BIT_MASK = (0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff);
...
// File: contracts/PermitErrors.sol
// SPDX-License-Identifier: MIT
pragma solidity 0.8.17;
