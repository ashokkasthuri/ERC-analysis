...
contract OEToken is Initializable, ERC1155Upgradeable, AccessControlUpgradeable, PausableUpgradeable, ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable, ERC1155URIStorageUpgradeable, UUPSUpgradeable {
    ...
    function setTokenURI(uint256 tokenId, string memory tokenURI) public onlyRole(URI_SETTER_ROLE) {
        require(ERC1155SupplyUpgradeable.exists(tokenId), "Token ID is not exists"); 
    ...
    function mintNew(address account, string memory tokenURI, uint256 amount, bytes memory data)
        public
    ...
    function mintAdd(address account, uint256 id, uint256 amount, bytes memory data)
        public
        onlyRole(MINTER_ROLE)
    {
        require(ERC1155SupplyUpgradeable.exists(id), "Token ID is not exists");
