...
// File: contracts/IITEMErrorCodes.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.13;
 ...
 */
interface IITEMErrorCodes {
    error ITEM__AlreadyUsed();
    error ITEM__AmountIsTooBig();
    error ITEM__CannotMintAnymore();
    error ITEM__InsufficientMintPrice();
    error ITEM__InsufficientMintsLeft();
    error ITEM__InvalidAddress();
    error ITEM__InvalidMerkleProof();
    error ITEM__MismatchedArrayLengths();
    error ITEM__MintAmountIsTooSmall();
    error ITEM__MustMintWithinMaxSupply();
    error ITEM__NoAvailableTokens();
    error ITEM__NotEnoughITEM();
    error ITEM__NotOwnerOrBurnableContract();
    error ITEM__NotReadyYet();
    error ITEM__NotITEMId();
    error ITEM__ReachedMaxTokens();
    error ITEM__TokenIdAlreadyExists();
    error ITEM__WithdrawFailed();
}


// File: contracts/operatorFilterer/RevokableDefaultOperatorFiltererUpgradeable.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.13;
...
// File: contracts/operatorFilterer/RevokableOperatorFiltererUpgradeable.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.13;
...
// File: contracts/operatorFilterer/Constants.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.13;
...
// File: contracts/operatorFilterer/OperatorFiltererUpgradeable.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.13;
...
// File: contracts/operatorFilterer/IOperatorFilterRegistry.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.13;
