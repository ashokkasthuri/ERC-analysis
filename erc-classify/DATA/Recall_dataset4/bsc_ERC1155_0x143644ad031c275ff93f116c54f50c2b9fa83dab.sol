// Chain: BSC - File: /contracts/FunnyNFTs.sol
...
contract FunnyNFTs is ERC1155, Ownable {

  uint256 public constant LUNATIC = 0;

  constructor() ERC1155("https://w0ksfxakpj6r.usemoralis.com{id}.json"){

    _mint(msg.sender, LUNATIC, 10, "");
