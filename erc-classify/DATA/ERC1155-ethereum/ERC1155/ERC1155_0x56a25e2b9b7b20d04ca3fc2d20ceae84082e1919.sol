    ...
    AccessControl
{
    ...
    function mint(
        ...
        verifySign(_tokenURI, msg.sender, supply, sign);
    ...
    function verifySign(
        ...
        bytes32 hash = keccak256(
            abi.encodePacked(this, caller, _tokenURI, supply, sign.nonce)
        );
        require(
            signer ==
                ecrecover(
     ...
     * - `receivers` cannot be the zero address.
     * - `royaltyFeePermiles` cannot be greater than the fee denominator.
     */
    ...
    function royaltyInfo(uint256 _tokenId,uint256 price) external view
