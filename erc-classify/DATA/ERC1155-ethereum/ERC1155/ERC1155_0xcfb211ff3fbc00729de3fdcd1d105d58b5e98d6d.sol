...
// File: contracts/Base58Encoder.sol
// SPDX-License-Identifier: MIT
 ...
 * @title Base58Encoder
 *
 * @dev https://github.com/storyicon/base58-solidity
 *
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    // ipfs cid to bytes
    // can be Base58 encoded to string starts with `Qm`
    bytes internal _baseUri;

    /**
     * @dev See {_setURI}.
     */
    constructor(bytes memory baseUri_) {
        _setURI(baseUri_);
    }
    ...
    function baseURI() public view virtual returns (string memory) {
        return
            string(abi.encodePacked("ipfs://", _baseUri.encodeToString(), "/"));
    }
     ...
     */
    function _setURI(bytes memory newUri) internal virtual {
        _baseUri = newUri;
    }
...
// File: contracts/ERC1155Rebased.sol
...
/**
 * @dev Rebased ERC1155 Rebased Contract
 *
 *      ERC1155Rebased <= ERC1155Royalty
 *          <= ERC1155Supply <= ERC1155Metadata <= ERC1155
 */
abstract contract ERC1155Rebased is ERC1155Royalty, Ownable {
    function setURI(bytes memory uri_) external onlyOwner {
        _setURI(uri_);
    }
...
// SPDX-License-Identifier: MIT
// Localized from OpenZeppelin Contracts (last updated v4.7.0) (token/common/ERC2981.sol)
 ...
 * _Available since v4.5._
 *
 * ERC1155Royalty <= ERC1155Supply <= ERC1155Metadata <= ERC1155
 */
abstract contract ERC1155Royalty is ERC1155Supply, IERC2981 {
    struct RoyaltyInfo {
        address receiver;
...
// File: contracts/ERC1155Supply.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/ERC1155WithOperatorFilter.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.0;

import "./ERC1155Rebased.sol";
import "operator-filter-registry/src/DefaultOperatorFilterer.sol";

/**
 * @dev ERC1155 with OperatorFilter provided by OpenSEA
 *
 *      ERC1155WithOperatorFilter <= ERC1155Rebased <= ERC1155Royalty
 *          <= ERC1155Supply <= ERC1155Metadata <= ERC1155
 */
abstract contract ERC1155WithOperatorFilter is
...
// File: contracts/MonarchMixer.sol
// SPDX-License-Identifier: UNLICENSED
