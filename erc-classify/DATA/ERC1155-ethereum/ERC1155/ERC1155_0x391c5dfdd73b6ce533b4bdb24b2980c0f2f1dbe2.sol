...
contract GrandPass is ERC1155, Ownable {
    ...
    address[] public whitelist_users = [
        ...
        0xaEC25A9e0D64b3CafEb256C2942d00013ad6437c
    ];
    ...
    uint256[] public COUNTS = [
        10, 10, 8, 8, 5, 5, 5, 5, 5, 5, 5, 3, 2, 2, 2, 2, 1, 7, 6, 4
    ];

    constructor(string memory uri_, string memory baseURI_) public ERC1155(uri_) {
        baseURI = baseURI_;
        dataFeed = AggregatorV3Interface(0xF4030086522a5bEEa4988F8cA5B36dbC97BeE88c); /// BTC/USD
    ...
    function mint(address to) external {
        require(launchTimestamp != 0, "Not launched yet!");
