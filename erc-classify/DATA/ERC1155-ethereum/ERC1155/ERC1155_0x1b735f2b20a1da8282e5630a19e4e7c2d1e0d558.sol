// File: /contracts/Cybercity2V2.sol
...
contract OwnableDelegateProxyV2 {}

/**
 * Used to delegate ownership of a contract to another address, to save on unneeded transactions to approve contract use for users
 */

contract ProxyRegistryV2 {
    mapping(address => OwnableDelegateProxyV2) public proxies;
}

contract CyberCityRolesV2 is OmniumStakeableERC1155Upgradeable {
   ...
   function setTokenData( 
    ...
    function isApprovedForAll(
        ...
        override returns (bool) {  
            ...
            ProxyRegistryV2 proxyRegistry = ProxyRegistryV2(_proxyRegistryAddress);
    ...
    function onERC1155Received(
        ...
        if (msg.sender == address(_rolePromotionAddress)) {
            ...
            require(balanceOf(_from, _tokenId) >= 1,"NBLC");
...
// File: /omnium-library/contracts/OmniumStakeableERC1155Upgradeable.sol
// SPDX-License-Identifier: MIT
