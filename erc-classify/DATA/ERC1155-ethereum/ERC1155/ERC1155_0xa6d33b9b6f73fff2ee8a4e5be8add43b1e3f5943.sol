...
contract ArtToken is ERCX {
    ...
    string private constant _name = "ArtToken";
    string private constant _ticker = "ArtToken";
    ...
    constructor() ERCX("", _name, _ticker, _decimals, _totalTokens, _tokensPerNFT) {
        dataURI = "https://gateway.pinata.cloud/ipfs/";
    ...
    function tokenURI(uint256 id) public view returns (string memory) {
        ...
        if (bytes(baseTokenURI).length > 0)
            ...
            if (seed <= 10) {
                image = "QmS1yodShYoxoocjUQQRHVReJNKk5mZeUGxbBHqbR1idv1";
                color = "classic";
                description = "Timeless Art NFTs, an ERC1155 tribute where ancient grace meets modern vibrance. Each piece is a digital testament to enduring artistry, blending classic reverence with contemporary innovation.";
            } else if (seed <= 127) {
                image = "QmVUCXBTHfVXAiM7ChmzEkWcn66hxv9c7eV5sbRKCyGpHn";
                color = "modern1";
                description = "Timeless Art NFTs, an ERC1155 tribute where ancient grace meets modern vibrance. Each piece is a digital testament to enduring artistry, blending classic reverence with contemporary innovation.";
            } else if (seed <= 191) {
                image = "QmdnoTuzapdP8VxRrBcRMEMJBc9gVpjMAZqq8NzYZ3xWff";
                color = "modern2";
                description = "Timeless Art NFTs, an ERC1155 tribute where ancient grace meets modern vibrance. Each piece is a digital testament to enduring artistry, blending classic reverence with contemporary innovation.";
            } else if (seed <= 255) {
                image = "QmfLr92G528iBWew3SoY6F4nCBQ9yUmT7cqGgcLrBtLngh";
                color = "crazy";
                description = "Timeless Art NFTs, an ERC1155 tribute where ancient grace meets modern vibrance. Each piece is a digital testament to enduring artistry, blending classic reverence with contemporary innovation.";
            }

            string memory jsonPreImage = string(abi.encodePacked('{"name": "ArtToken #', id.toString(), '","description":"', description, '","external_url":"https://9gag.com/gag/6950084","image":"', dataURI, image));
