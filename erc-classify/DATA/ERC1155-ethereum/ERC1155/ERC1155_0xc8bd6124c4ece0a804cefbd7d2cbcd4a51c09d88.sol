...
contract DRAUPRecycle is ERC1155, ERC2981, Ownable, OperatorFilterer {
    string public name;
    ...
    function uri(uint256 tokenId) public view override returns (string memory) {
        if (tokenId != 0) revert URIQueryForNonexistentToken();
        return string.concat(_tokenBaseURI, Strings.toString(tokenId));
    }
...
// File: lib/closedsea/src/OperatorFilterer.sol
// SPDX-License-Identifier: MIT
