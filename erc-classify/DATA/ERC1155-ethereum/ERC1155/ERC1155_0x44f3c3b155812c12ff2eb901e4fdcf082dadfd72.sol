...
contract PAPER is ERCX {
    ...
    string private constant _ticker = "PAPER";

    uint256 public maxWallet = totalSupply * 3 / 1000;
            ...
            return
                ...
                string(
                    abi.encodePacked(
                        ...
                        '","image" : "',
                        dataURI,
                        ' ","external_url": "paper.xyz","description":"Use this token to claim your paper."',
                        "}"
                    )
                )
            );
