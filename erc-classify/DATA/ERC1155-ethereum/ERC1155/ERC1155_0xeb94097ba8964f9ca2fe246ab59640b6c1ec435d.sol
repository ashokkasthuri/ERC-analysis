...
contract Nft is Initializable, ERC1155Upgradeable, ERC1155BurnableUpgradeable, OwnableUpgradeable {
    ...
    function initialize(address _erc20Token) initializer public {
        ...
        admin = msg.sender;
        internalValue = 1; //1000
        externalValue = 1; //1000
    }
    ...
    function remint(
        ...
        uint256 priceOfTotalRemintNft = tryEgemOfSingleNft * fraction;
