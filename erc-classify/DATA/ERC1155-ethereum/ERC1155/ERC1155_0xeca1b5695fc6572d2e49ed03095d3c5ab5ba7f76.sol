...
//*********************************************************************//
//
// girls original artist receive 20% royalty and 80% goes to Flowers For the Future
//
//
// Disclaimer : The NFT token buyer shall possess a limited right to the artwork. The NFT token owner will receive a digital certificate of the Token, highlighting their contribution to Flowers for The Future. 
// It is important to note that the NFT does not grant any additional rights or uses of the artwork. However, the physical copy of the painting is available for purchase separately at an additional cost. 
// All NFT sales are final, and no legal claims after the exchange are allowed.
//
//*********************************************************************//
//*********************************************************************//
...
// File: contracts/FlowersForTheFutureContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract FlowersForTheFutureContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Flowers For The Future ";
    string public symbol = "Flowers";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/61yOFRd6iS2gTGeGCF5Q/contract-metadata";
  }
