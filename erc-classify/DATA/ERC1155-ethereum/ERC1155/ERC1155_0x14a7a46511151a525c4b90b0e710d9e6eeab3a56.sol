...
// File: contracts/tokens/YardboisResources.sol
...
contract YardboisResources is ERC1155BurnableUpgradeable, AccessControlUpgradeable {
    using StringsUpgradeable for uint256;

    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    string public constant name = "Yardbois Resources";
    string public constant symbol = "STUFF";
    ...
    function mint(address _recipient, uint256 _tokenId, uint256 _amount) external onlyRole(MINTER_ROLE) {
