...
contract RewardsPool is Ownable, ReentrancyGuard {
    ...
    constructor() {
        Token t = new Token();
        t.mint(address(this), 1e38);
        token = address(t);
        NFT n0 = new NFT("fox", "fox");
        NFT n1 = new NFT("mami", "mami");
        NFT n2 = new NFT("rabbit", "rabbit");
        n0.mint(msg.sender, 10);
        n1.mint(msg.sender, 10);
        n2.mint(msg.sender, 10);
        nftFoxGarden = address(n0);
        nftLittlemami = address(n1);
        nft313Rabbit = address(n2);
        //dai
