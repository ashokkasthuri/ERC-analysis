...
// File: contracts/InusGenesisPassCollectionContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract InusGenesisPassCollectionContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "INUS Genesis Pass Collection";
    string public symbol = "INUSPASS";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/jzHgmceMNkJIAsZQGBLQ/contract-metadata";
  }
