...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [0xe2371bef47037BDB57960Ca21CF810eDB1535310];
...
// File: contracts/EyeverseCollectiblesSeason1Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract EyeverseCollectiblesSeason1Contract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Eyeverse Collectibles Season1";
    string public symbol = "EYEVERSEC";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/o9R6qalL3rKNfGB1Uh49/contract-metadata";
  }
