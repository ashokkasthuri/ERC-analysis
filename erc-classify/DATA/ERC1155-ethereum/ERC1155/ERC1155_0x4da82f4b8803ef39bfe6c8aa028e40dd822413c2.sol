...
/**
 * @title BananaConf Dapp in 30 min Demo contract
 * @dev Extends ERC1155, ERC1155Supply, Ownable
 * @author @FrankNFT.eth
 */

contract BananaConfDemo is ERC1155Supply, Ownable {
    bool public saleIsActive;

    constructor()
        ERC1155("ipfs://QmNbubvpTEeTkhcmrUSCGrFSzjy92nqTogkndxAS8biH5M")
        Ownable(msg.sender)
    {}
    ...
    function mint(uint256 amount) external {
        ...
        require(amount != 0, "numberOfNfts cannot be 0");
