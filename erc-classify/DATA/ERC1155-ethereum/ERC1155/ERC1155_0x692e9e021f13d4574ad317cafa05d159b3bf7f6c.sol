...
import "./interfaces/ERC1155/ERC1155Upgradeable.sol";
import "./interfaces/ERC1155/ERC1155SupplyUpgradeable.sol";
import "./interfaces/ERC1155/ERC1155URIStorageUpgradeable.sol";


contract RakuzaDaoMembership is
    Initializable,
    ERC1155Upgradeable,
    ...
    OwnerOperator
{
    ...
    bool public isAllowedTransfer;
    mapping(address => bool) private whitelistTransferedAddress;

    error ArrayLengthMismatch();
    error TokenDoesNotExists();

    event AdminMint(address to, uint256 id, uint256 amount);
    event AdminMintBatch(address to, uint256[] ids,  uint256[] values);
    event AdminBurn(address to, uint256 id, uint256 amount);
    event AdminBurnBatch(address to, uint256[] ids);
    ...
    modifier checkAllowedTransfer() {
        if (
            msg.sender == owner() ||
            operators[msg.sender] == true ||
            whitelistTransferedAddress[msg.sender] == true
        ){
            _;
        }
        else {
            require(
                isAllowedTransfer,
                "Token is not allowed to be transferred"
            );
            _;
        }
    }
    ...
    function mint(
        ...
        uint256 tokenId = _incrementTokenId(1);
        _mint(to, tokenId, amount, data);
        emit AdminMint(to, tokenId, amount);
    }
    ...
    function mintBatch(
        ...
        _incrementTokenId(ids.length);
        _mintBatch(to, ids, values, data);
        emit AdminMintBatch(to, ids, values);
    }
    ...
    function safeTransferFrom(
        ...
        uint256 value,
        bytes memory data
    ) public override checkAllowedTransfer {
    ...
    function setAllowedTransfer(bool approved) public onlyOwner {
        isAllowedTransfer = approved;
    }

    function setWhitelistTransfer(address _address, bool approved) public onlyOwner {
        require(_address != address(0), "Invalid Address");
        whitelistTransferedAddress[_address] = approved;
    }
    ...
    function _incrementTokenId(uint256 quantity) internal returns (uint256) {
...
// File: contracts/interfaces/ERC1155/draft-IERC6093.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/interfaces/ERC1155/ERC1155SupplyUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/interfaces/ERC1155/ERC1155Upgradeable.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/interfaces/ERC1155/ERC1155URIStorageUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/interfaces/ERC1155/ERC165Upgradeable.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/interfaces/ERC1155/IERC165.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/utils/OwnerOperator.sol
//SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;
