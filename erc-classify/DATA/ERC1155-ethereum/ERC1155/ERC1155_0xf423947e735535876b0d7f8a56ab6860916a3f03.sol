...
// File: contracts/TukuruERC1155.sol
...
contract TukuruERC1155 is ERC1155, AccessControl, Ownable, Pausable, IERC5192, ERC2981 {
    ...
    function setSalesInfo(uint256 _tokenId, uint256 _mintCost, uint256 _maxSupply) external onlyRole(ADMIN) {
...
// File: contracts/TukuruERC1155Factory.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.20;
...
contract TukuruERC1155ContractFactory is AccessControl, Ownable {
    ...
    event TukuruCreated(address indexed contractAddress, address indexed owner, string name, string symbol, bool isLocked, uint96 royaltyFee, address withdrawAddress, uint256 systemRoyalty, address royaltyReceiver);
    ...
    function createWithPayment(
        ...
        emit TukuruCreated(clone, msg.sender, _name, _symbol, _isLocked, _royaltyFee, _withdrawAddress, 0, royaltyReceiver);
    }
    ...
    function createWithSystemRoyalty(
        ...
        emit TukuruCreated(clone, msg.sender, _name, _symbol, _isLocked, _royaltyFee, _withdrawAddress, systemRoyalty, royaltyReceiver);
    }
}
