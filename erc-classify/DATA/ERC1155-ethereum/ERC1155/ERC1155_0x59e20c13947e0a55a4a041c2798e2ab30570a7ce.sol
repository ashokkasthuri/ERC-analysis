...
// File: src/contracts/ZeusPepe.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
contract ZeusPepe is ERC1155, Ownable {
    uint16 mintedAmount;
    ...
    function mint(
        ...
        require(
            _tokenId > 20000 && _tokenId <= 25000,
            "Token ID expected between 20K and 25K"
        );
        require(
            mintedAmount + 1 <= MAX_NFTS, // Max NFTs per collection is 2K
            "Amount expected upto 5K"
        );
