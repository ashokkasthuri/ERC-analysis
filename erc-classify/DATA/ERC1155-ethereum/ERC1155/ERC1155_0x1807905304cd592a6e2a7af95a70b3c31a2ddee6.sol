// File: src/DragonScale.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.23;

import { IDragonScale } from "./interfaces/IDragonScale.sol";
    ...
    ERC2981
{
    ...
    constructor(
        ...
        _name = "Dragon Scale";
        _setDefaultRoyalty(royaltyReceiver_, feeNumerator);
    ...
    function mint(
        ...
        require(
            ...
            "Dragon Scale: Max supply reached"
        );
        _mint(account, id, amount, data);
    }

    // Batch mint new tokens
    function mintBatch(
        address to,
        uint256[] memory ids,
        ...
        for (uint256 i = 0; i < ids.length; i++) {
            uint256 totalSupply = totalSupply(ids[i]);
            require(
...
// File: src/interfaces/IDragonScale.sol
//SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.23;

import "@openzeppelin/contracts/token/ERC1155/IERC1155.sol";

interface IDragonScale is IERC1155 {
    function mint(
        address account,
        uint256 id,
        uint256 amount,
