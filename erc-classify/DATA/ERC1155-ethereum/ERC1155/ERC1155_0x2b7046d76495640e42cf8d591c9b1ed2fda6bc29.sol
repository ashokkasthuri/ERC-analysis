...
// File: contracts/partnernft/ERC2981Base.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/partnernft/IERC2981Royalties.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.4;
...
// File: contracts/partnernft/LorePartnerPass.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.4;
...
contract LorePartnerPass is ERC1155Upgradeable, OwnableUpgradeable, PausableUpgradeable, ERC2981Base {
    ...
    function initialize(string memory _name,string memory _symbol,string memory baseUri) initializer public {
    ...
    whenNotPaused
    {
        ...
        require(_verify(tokenId, to, proof), "Invalid merkle proof");
    ...
    returns (bool)
    {
        return !_hasMinted[to][tokenId] && _verify(tokenId, to, proof);
    }
