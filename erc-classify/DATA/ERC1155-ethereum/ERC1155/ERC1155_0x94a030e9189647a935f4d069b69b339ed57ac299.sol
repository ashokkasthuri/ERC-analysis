...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0xe07AD9B7D326DBea055C037e8abf1E06909B2307];
...
// File: contracts/AzracapContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract AzracapContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/hniEQlVYZmvnQXCXbJ6x/contract-metadata";
  }
