...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x112dC0acac7DC10236779a1C36158E2Fea09b689];
...
// File: contracts/Mega404CollectorEditionsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract Mega404CollectorEditionsContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "MEGA 404  Collector Editions";
    string public symbol = "M404CE";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/pYlf8hYyl43Fv2phceGo/contract-metadata";
  }
