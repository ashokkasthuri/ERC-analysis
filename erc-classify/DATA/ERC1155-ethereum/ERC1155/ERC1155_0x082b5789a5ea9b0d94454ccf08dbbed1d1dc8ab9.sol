...
// File: contracts/library/Base_ZingNFT_1155.sol
// SPDX-License-Identifier: MIT
...
abstract contract Base_ZingNFT_1155 is
    IERC2981,
    Ownable,
    ERC1155,
    Pausable,
...
// File: contracts/library/ContextMixin.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/ZingArt_NFT1155.sol
// SPDX-License-Identifier: MIT
...
contract ZingArt_NFT1155 is Base_ZingNFT_1155 {
    ...
    ) ERC1155("%id%") ERC2771Context(owner()) {
        _name = _tokenName;
    ...
    function mint(TokenData calldata _data) external payable {
        ...
        if (!success) {
            revert("ZingNFT_1155: Failed to pay mint fee");
        }
    ...
    */
    ...
    function _exists(uint256 _id) public view returns (bool) {
        return _tokenCreators[_id] != address(0);
    }
