 ...
 * @notice This contract handles minting PaintedRocks tokens.
 */
contract PaintedRocks is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x96faba9EDdfE27eA9a23cA687da432230D1764Cb;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xc22EA3401821E9309f4E5836faA6F9941d9a503b;
    ...
    address[] public payoutAddresses = [
        0xc22EA3401821E9309f4E5836faA6F9941d9a503b
    ];
    ...
    string public name = "PaintedRocks";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeibsdlhdcghfuc2ujpysmvmg4ryhcuaxed3qurap7ortxhg7opiylq/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicPrice[1] = 0.0006 ether;
        tokenPublicMintsPerAddress[1] = 0;
        tokenPublicPrice[2] = 0.0006 ether;
        tokenPublicMintsPerAddress[2] = 0;
        tokenPublicPrice[3] = 0.0006 ether;
        tokenPublicMintsPerAddress[3] = 0;
        tokenPublicPrice[4] = 0.0006 ether;
        tokenPublicMintsPerAddress[4] = 0;
        tokenPublicPrice[5] = 0.0006 ether;
        tokenPublicMintsPerAddress[5] = 0;
        tokenPublicPrice[6] = 0.0006 ether;
        tokenPublicMintsPerAddress[6] = 0;
        tokenPublicPrice[7] = 0.0006 ether;
        tokenPublicMintsPerAddress[7] = 0;
        tokenPublicPrice[8] = 0.0006 ether;
        tokenPublicMintsPerAddress[8] = 0;
        tokenPublicPrice[9] = 0.0006 ether;
        tokenPublicMintsPerAddress[9] = 0;
        tokenPublicPrice[10] = 0.0006 ether;
        tokenPublicMintsPerAddress[10] = 0;
        tokenPublicPrice[11] = 0.0006 ether;
        tokenPublicMintsPerAddress[11] = 0;
        tokenPublicPrice[12] = 0.0006 ether;
        tokenPublicMintsPerAddress[12] = 0;
        tokenPublicPrice[13] = 0.0006 ether;
        tokenPublicMintsPerAddress[13] = 0;
        tokenPublicPrice[14] = 0.0006 ether;
        tokenPublicMintsPerAddress[14] = 0;
        tokenPublicPrice[15] = 0.0006 ether;
        tokenPublicMintsPerAddress[15] = 0;
        tokenPublicPrice[16] = 0.0006 ether;
        tokenPublicMintsPerAddress[16] = 0;
        tokenPublicPrice[17] = 0.0006 ether;
        tokenPublicMintsPerAddress[17] = 0;
        tokenPublicPrice[18] = 0.0006 ether;
        tokenPublicMintsPerAddress[18] = 0;
        tokenPublicPrice[19] = 0.0006 ether;
        tokenPublicMintsPerAddress[19] = 0;
        tokenPublicPrice[20] = 0.0006 ether;
        tokenPublicMintsPerAddress[20] = 0;
        tokenPublicPrice[21] = 0.0006 ether;
        tokenPublicMintsPerAddress[21] = 0;
        tokenPublicPrice[22] = 0.0006 ether;
        tokenPublicMintsPerAddress[22] = 0;
        tokenPublicPrice[23] = 0.0006 ether;
        tokenPublicMintsPerAddress[23] = 0;
        tokenPublicPrice[24] = 0.0006 ether;
        tokenPublicMintsPerAddress[24] = 0;
        tokenPublicPrice[25] = 0.0006 ether;
        tokenPublicMintsPerAddress[25] = 0;
        tokenPublicPrice[26] = 0.0006 ether;
        tokenPublicMintsPerAddress[26] = 0;
        tokenPublicPrice[27] = 0.0006 ether;
        tokenPublicMintsPerAddress[27] = 0;
        tokenPublicPrice[28] = 0.0006 ether;
        tokenPublicMintsPerAddress[28] = 0;
        tokenPublicPrice[29] = 0.0006 ether;
        tokenPublicMintsPerAddress[29] = 0;
        tokenPublicPrice[30] = 0.0006 ether;
        tokenPublicMintsPerAddress[30] = 0;
        require(
