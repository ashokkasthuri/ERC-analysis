...
// File: contracts/ByWassieAirdrop.sol
// SPDX-License-Identifier: MIT
/**
                                                                              ((                                        
 ((((((            ((              (.          ((,    (((((((    ((         ((  ((( (((                         ((((((((
...
/**
 *
 * @dev By Wassies drop contract one
 *
...
contract ByWassieAirdrop is ERC1155, Ownable, ERC1155Burnable, ERC1155Supply {
  using Address for address;
  ...
  function validateAirdrop(
    ...
    for (uint256 i = 0; i < airdropDetails_.length; ) {
      if (airdropDetails_[i].receiver.isContract()) {
        try
          IERC1155Receiver(airdropDetails_[i].receiver).onERC1155Received(
            address(this),
            address(this),
            tokenId_,
            airdropDetails_[i].quantity,
        ...
        returns (bytes4 response) {
          if (response != IERC1155Receiver.onERC1155Received.selector) {
            success_ = false;
            failingAddresses_[failingIndex] = airdropDetails_[i].receiver;
            unchecked {
              failingIndex++;
            }
          }
