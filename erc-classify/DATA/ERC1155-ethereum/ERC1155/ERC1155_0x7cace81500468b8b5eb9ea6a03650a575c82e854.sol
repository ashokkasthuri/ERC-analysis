...
// File: contracts/KultDolceResources.sol
// SPDX-License-Identifier: MIT
...
/// @custom:security-contact security@kultdolce.io
    ...
    EIP712
{
    ...
    function setTokens(Token[] memory _tokens) public onlyRole(OPERATOR_ROLE) {
        delete tokens;
    ...
    function deleteDefaultRoyalty() public onlyRole(OPERATOR_ROLE) {
    ...
    function resetTokenRoyalty(uint256 tokenId) public onlyRole(OPERATOR_ROLE) {
