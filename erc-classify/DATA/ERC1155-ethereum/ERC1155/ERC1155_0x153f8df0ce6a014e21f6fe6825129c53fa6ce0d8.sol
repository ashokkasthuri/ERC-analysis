...
contract KILLAGEAR is ERC1155, Ownable {
    ...
    /// @dev Tokenize traits, called by KILLABITS contract
    function tokenize(
        address addr,
        uint256 typeId,
        uint256 n
    ...
    /// @dev Detokenize traits, called by KILLABITS contract
    function detokenize(
        address addr,
        uint256 typeId,
        uint256 amount
    ...
    /// @notice Toggle compatibility for given traits
