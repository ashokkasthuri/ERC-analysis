...
contract SSEternals is
    Initializable,
    OwnableUpgradeable,
    ERC1155Upgradeable,
    ERC1155SupplyUpgradeable
{
    string public constant name = "Steady Stack Eternals";
...
function adminMint(address[] calldata recipients, uint256 amount) external onlyOwner {
    for (uint256 i = 0; i < recipients.length; i++) {
        _mint(recipients[i], 1, amount, "");
    }
}
}
