...
/*
  ...
  * Liquid Loot Chests contract v2 (OpenSea Creator Fees) *
*/
...
contract MythicLootChest is ERC1155, Ownable {
    using Strings for uint256;

    address private openLootAddy = 0x866cfDa1B7cD90Cd250485cd8b700211480845D7;
    address private newLootAddy = 0x866cfDa1B7cD90Cd250485cd8b700211480845D7;
    string private baseURI = "https://apeliquid.io/lootchest/json/";
    string public name = "Mythic Loot Chest";
    ...
    constructor(string memory _baseURI) ERC1155(_baseURI) {
        ...
        validLootChests[4] = true;
        validLootChests[5] = true;
    ...
    /**
     * @notice Set the address of the lootAddress (contract)
     * @param lootAddress The address for the upstream contract
    */
    function setNewLootAddress(address lootAddress) external onlyOwner {
        newLootAddy = lootAddress;
    }
     ...
     */
    function newLootChest(address addy, uint256 tokenId, uint256 qty) external {
        require(msg.sender == newLootAddy, "Incorrect contract owner");
    ...
    /**
     * @notice Set the address of the openLootAddress (contract)
     * @param openLootAddress The address for the upstream contract
    */
     ...
     * @param tokenId which token is this
