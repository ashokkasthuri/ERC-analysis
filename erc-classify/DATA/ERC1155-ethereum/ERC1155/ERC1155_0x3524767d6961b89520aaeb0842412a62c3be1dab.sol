...
contract ROBBITX is ERCX {
    ...
    string private constant _name = "ROBBITERCX";
    string private constant _ticker = "ROBBITX";
    ...
    function tokenURI(uint256 id) public view returns (string memory) {
        ...
        if (bytes(baseTokenURI).length > 0)
            ...
            string memory description = "10,000 mischievous ROBBITs on the blockchain, following the ERCX standard (a new and efficient adaption of ERC404).\n\n100 BILLION $XROBBIT = 1 XROBBIT NFT.\n\nMAX SUPPLY = 1 QUADRILLION $XROBBIT.";
            ...
            string memory jsonPreImage = string(abi.encodePacked('{"name": "ROBBITX #', id.toString(), '","description":"', description, '","image":"', dataURI, image));
