// File: src/nft/Creator1155Impl.sol
...
// File: lib/openzeppelin-contracts-upgradeable/contracts/interfaces/IERC1155MetadataURIUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// File: src/interfaces/ICreator1155.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.17;
...
// File: src/interfaces/ICreator1155Initializer.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.17;
...
abstract contract CreatorRoyaltiesControl is CreatorRoyaltiesStorageV1, SharedBaseConstants {
    ...
    function _updateRoyalties(uint256 tokenId, RoyaltyConfiguration memory configuration) internal {
        ...
        if (
            configuration.royaltyRecipient == address(0)
                && (configuration.royaltyMintSchedule > 0 || configuration.royaltyBPS > 0)
        ) {
            revert InvalidMintSchedule();
        }
...
contract MintFeeManager is IMintFeeManager {
    ...
    /// @notice Sends the mint fee to the mint fee recipient and returns the amount of ETH remaining that can be used in
    /// this transaction
    ...
    function _handleFeeAndGetValueSent(uint256 _quantity) internal returns (uint256 ethValueSent) {
        ...
        if (mintFeeRecipient != address(0)) {
            ...
            if (
                !TransferHelperUtils.safeSendETH(
                    mintFeeRecipient, totalFee, TransferHelperUtils.FUNDS_SEND_LOW_GAS_LIMIT
                )
            ) {
...
// File: src/nft/Creator1155StorageV1.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.17;
...
// File: src/nft/ICreator1155TypesV1.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.17;
