...
// This is a collection of 2000 NFTs to help me manage my community ELYSIUM (0xEly Private), first real usecase of utilise 404 and ERC-X contract. 
// Several people might know that I incubate projects. In my Elysium space, you will be prioritized with every new launch.
// Having one NFT = 1 Token will allow you to join Elysium space.
// My links: https://0xely.io/ - https://t.me/earlycallsby0xEly - https://twitter.com/0xElyy
...
contract Token is ERCX {
    ...
    uint256 private constant _totalTokens = 2000;
    uint256 private constant _tokensPerNFT = 1;
    string private constant _name = "Elysium";
    string private constant _ticker = "0xEly";
    ...
    function tokenURI(uint256 id) public view returns (string memory) {
        ...
        if (bytes(baseTokenURI).length > 0)
            ...
            if (seed < 37) {
                image = "THgYGus.jpeg";
                planet = "Elysium";
                description = "0xEly NFT powered by ERC1155.";
            } else if (seed < 146) {
                image = "AEwWzMk.jpeg";
                planet = "Saturn";
                description = "0xEly NFT powered by ERC1155.";
            ...
            string memory jsonPreImage = string(
                abi.encodePacked(
                    ...
                    '","description":"',
                    description,
                    '","external_url":"https://0xely.io/","image":"',
                    dataURI,
                    image
                )
            );
            return
                string(
                    abi.encodePacked(
                        ...
                        jsonPreImage,
                        '","attributes":[{"trait_type":"planet","value":"',
                        planet,
                        '"}]}'
                    )
                );
