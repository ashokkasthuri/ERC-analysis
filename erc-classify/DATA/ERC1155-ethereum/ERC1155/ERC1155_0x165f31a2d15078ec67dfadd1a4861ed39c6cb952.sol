...
// File: contracts/RiftValleyMotelCoin.sol
// SPDX-License-Identifier: MIT
//                                                                       %%
//             .@@@@@@@@@         @@@@@@     @@@@@@@@@@@@@@@@@@@   @@@@@@@@@@@@@@
//            @@@@@@@@@@@(       @@@@@@@    .@@@@@@@@@@@@@@@@@@@ @@@@@@@@@@@@@@@@@
...
/// @title Rift Valley Motel Coin
/// @notice An ERC1155 token contract for the Rift Valley Motel Coin.
/// @dev This contract includes extensions for supply, burning, EIP2981 royalties, OpenSea operator filtering and pausing.
contract RiftValleyMotelCoin is
    ERC1155,
    ERC1155Supply,
    ERC1155Burnable,
    ERC2981,
