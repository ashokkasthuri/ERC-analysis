...
// File: contracts/interfaces/IPromotion.sol
// SPDX-License-Identifier: MIT
pragma solidity 0.8.16;

import "@openzeppelin/contracts-upgradeable/token/ERC1155/IERC1155Upgradeable.sol";

interface IMetaWealthPromotion is IERC1155Upgradeable {
...
import "./interfaces/IPromotion.sol";

contract MetaWealthPromotionMainStorage {
...
contract MetaWealthPromotion is
    MetaWealthPromotionMainStorage,
    ERC1155Upgradeable,
    OwnableUpgradeable,
    IMetaWealthPromotion
{
    ...
    function setBaseURI(string memory newBaseURI) external onlyOwner {
        string memory before = _baseURI;
        _baseURI = newBaseURI;

        emit BaseURIChanged(_msgSender(), newBaseURI, before);
    }
    ...
    function setContractURI(string memory newURI) external onlyOwner {
        ...
        emit ContractURIChanged(_msgSender(), newURI, before);
    }
    ...
    function mintBatch(
        ...
        require(to.length == ids.length, "ERC1155: ids and to length mismatch");
        require(
    ...
    function mintBatch(
        ...
        require(
            ...
            "ERC1155: amount and to length mismatch"
        );
