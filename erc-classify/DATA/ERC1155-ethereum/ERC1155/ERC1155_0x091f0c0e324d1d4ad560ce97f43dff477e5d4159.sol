...
// File: contracts/EvelonNFT/ERC1155SupplyUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/EvelonNFT/ERC1155Upgradeable.sol
// SPDX-License-Identifier: MIT
    ...
    IERC1155Errors
{
    ...
    struct ERC1155Storage {
        ...
        mapping(uint256 id => address account) _idToCreator;
        mapping(address account => uint256[] ids) _creatorIds;
    ...
    function getAllTokens(
        ...
        NFTData[] memory nftData = new NFTData[]($._creatorIds[creator].length);
        for (uint256 i; i < $._creatorIds[creator].length; i++) {
            nftData[i] = NFTData(
                $._creatorIds[creator][i],
                uri($._creatorIds[creator][i])
            );
        }
        return nftData;
    }
...
// File: contracts/EvelonNFT/EvelonNFT.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;
...
// File: contracts/EvelonNFT/utils/nftStruct.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;
struct NFTData {
    uint256 id;
