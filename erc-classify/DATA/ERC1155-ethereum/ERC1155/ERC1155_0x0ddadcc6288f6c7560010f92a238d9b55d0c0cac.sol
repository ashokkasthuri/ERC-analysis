    ...
    OwnableUpgradeable
{
    ...
    mapping(uint256 => bool) auctionedNFT;//mapping to keep track of all the Auctioned NFTs
 ...
 */
    ...
    function fixBuyFlow(
        ...
        //NAA--> NFT Already Auctioned
        require(!auctionedNFT[primaryListingvoucher.tokenId],"NAA");
 ...
 */
    ...
    function buyAuctionFlow(
        ...
        //NAA--> NFT Already Auctioned
        require(!auctionedNFT[seller.tokenId],"NAA");
        ...
        auctionedNFT[seller.tokenId] = true;
        }
        ...
        return
            _hashTypedDataV4(
                keccak256(
                    abi.encode(
                        keccak256(
                            "auctionItemSeller(uint96 royaltyFees,uint256 tokenId,uint256 nftBatchAmount,uint256 minimumBid,address nftAddress,address owner,address royaltyKeeper,string tokenURI,bool isEth)"
                        ),
                        voucher.royaltyFees,
                        voucher.tokenId,
