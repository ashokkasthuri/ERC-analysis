// File: contracts/YokaiCards/SanshuInuYokaiCards.sol
...
// File: contracts/shared/ERC1155/ERC1155Tradable.sol
// SPDX-License-Identifier: MIT
...
import { ContextMixin } from './common/ContentMixin.sol';
...
// File: contracts/shared/ERC1155/common/ContentMixin.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/shared/ERC1155/common/NativeMetaTransaction.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/shared/ERC1155/common/EIP712Base.sol
// SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

import { Initialisable } from './Initialisable.sol';

contract EIP712Base is Initialisable {
  struct EIP712Domain {
    string name;
    string version;
  ...
  // supposed to be called once while initialising.
  // one of the contracts that inherits this contract follows proxy pattern
  // so it is not possible to do this in a constructor
  function _initialiseEIP712(string memory name) internal initialiser {
...
// File: contracts/shared/ERC1155/common/Initialisable.sol
// SPDX-License-Identifier: MIT
