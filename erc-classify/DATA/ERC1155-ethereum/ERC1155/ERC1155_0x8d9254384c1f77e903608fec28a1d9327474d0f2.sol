...
contract NFTStorage {
    string public constant nftURI = "https://asset.tomogaku.io/s1/{id}.json";
    string public constant notRevelednftURI = "https://asset.tomogaku.io/tomogakuen/mint.json";
    bool public isReveled = false;

    uint256 internal nftcount;
    uint256 public constant nftlimit = 7777;
