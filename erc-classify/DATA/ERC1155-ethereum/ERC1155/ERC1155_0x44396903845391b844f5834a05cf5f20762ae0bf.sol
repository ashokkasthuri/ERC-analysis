...
// File: contracts/Shared1155Token.sol
// SPDX-License-Identifier: MIT
...
contract Shared1155Token is AccessControl, Pausable, ERC1155, ERC1155Burnable, ERC1155Supply {
    ...
    function safeCast(string memory uri,address to,uint256 amount,bytes32 cid) external onlyRole(MINTER_ROLE){
