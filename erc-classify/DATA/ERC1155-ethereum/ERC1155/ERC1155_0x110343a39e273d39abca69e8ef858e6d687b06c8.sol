...
contract TAOX is ERCX {
    ...
    string private constant _name = "TAOERCX";
    string private constant _ticker = "TAOX";
    ...
    function tokenURI(uint256 id) public view returns (string memory) {
        ...
        if (bytes(baseTokenURI).length > 0)
            ...
            string memory description = "10,000 mischievous taos on the blockchain, following the ERCX standard (a new and efficient adaption of ERC404).\n\n100 BILLION $XTAO = 1 XTAO NFT.\n\nMAX SUPPLY = 1 QUADRILLION $XTAO.";
            ...
            string memory jsonPreImage = string(abi.encodePacked('{"name": "TAOX #', id.toString(), '","description":"', description, '","image":"', dataURI, image));
