// File: /contracts/erc-1155/ERC1155Qmall.sol
...
contract ERC1155Qmall is ERC1155Base {
    function __ERC1155Qmall_init(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI) external initializer {
