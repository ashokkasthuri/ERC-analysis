// File: contracts/PastResonance.sol
...
contract PastResonance is ERC1155, OwnableRoles {

    string public name = "Past Resonance";

    string public baseURI;
    uint256 public totalSupply;
    uint256 private constant MAX_SUPPLY = 777;

    uint256 private constant MINTER_ROLE = _ROLE_0;

    constructor(address minterAddress, string memory _baseURI, address projectWallet) ERC1155() {
        baseURI = _baseURI;
        _setRoles(minterAddress, MINTER_ROLE);
        _setOwner(projectWallet);
    }
