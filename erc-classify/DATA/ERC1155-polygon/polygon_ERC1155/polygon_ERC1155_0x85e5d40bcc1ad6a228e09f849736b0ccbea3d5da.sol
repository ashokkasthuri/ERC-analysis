// Chain: POLYGON - File: HoodiezWL.sol
 ...
 * @notice This contract handles minting Hoodiez WL tokens.
 */
contract HoodiezWL is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x88BaBe77D9efd90f3257c1b72843bEf2b61d0Db8;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xA1290883b6a64fc27D6dfEd96F8D7E66B3282BbF;
    ...
    address[] public payoutAddresses = [
        0xA1290883b6a64fc27D6dfEd96F8D7E66B3282BbF
    ];
    ...
    string public name = "Hoodiez WL";
    string public symbol = "HOODWL";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeihtoxjbg5ctajtwf5wo3l24nthpuosjfuxyp5zu4yzhxetluxf3ba/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPresaleMintsPerAddress[1] = 100;
        require(
