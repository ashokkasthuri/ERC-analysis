// Chain: POLYGON - File: contracts/Darabase.sol
...
contract Darabase is NFTContract {
    ...
    function buyBackRentals(
        ...
        // Check if it is a secondary sale order.
        require(sellOrder.orderType == LibOrder.SECONDARY_TYPE, "Err_39");
        ...
        emit TransferSingle(address(this), sellOrder.maker, msg.sender, pdrId, numberOfRentalsOwnerBuying);
...
// Chain: POLYGON - File: contracts/NFTContract.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
contract NFTContract is ERC1155, Ownable, Pausable{
    ...
    function burn(
        ...
        if(getTokenType(id) == TokenType.RWO) {
            ...
            address pdrOwnerForRental  = getPdrOwner(rentalIdToPDRId[id]);
            // Return the balance to the pdr balance
            _balances[rentalIdToPDRId[id]][pdrOwnerForRental] += amount;
            emit TransferSingle(address(this), rentalOwner, pdrOwnerForRental, rentalIdToPDRId[id], amount);
...
// Chain: POLYGON - File: contracts/LibOrder.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: contracts/ECDSA.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/Ownable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/Pausable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/Strings.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/Context.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/Initializable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/IERC1155.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/IERC1155Receiver.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/Address.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/ERC165.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/IERC165.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/IERC20.sol
// SPDX-License-Identifier: MIT
