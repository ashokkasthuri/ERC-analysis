...
/// @notice Contract for Hunters OnChain equipments
/// @author zetsub0ii.eth
contract Equipments is ERC1155, AccessControl, ERC1155Burnable, ERC1155Supply {
    ...
    constructor(address admin, address minter, address locker) ERC1155("Equipments") {
    ...
    function increaseLocked(address account, uint256 id, uint256 amount) external onlyRole(LOCKER_ROLE) {
        ...
        require(balanceOf(account, id) >= amount, "Not enough equipments");
        ...
        onlyRole(LOCKER_ROLE)
    {
        ...
        for (uint256 i = 0; i < length;) {
            require(balanceOf(account, ids[i]) >= amounts[i], "Not enough equipments");
