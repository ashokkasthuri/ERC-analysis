// Chain: POLYGON - File: contracts/FatCats.sol
...
contract FatCats is ERC1155, IERC2981, Ownable, Pausable, ContextMixin {
    ...
    function contractURI() public pure returns (string memory) {
        return "ar://sOS_xExMX2q42qakOSWfIS_ntn797wLDQ-8GGlMzEg0"; // Contract-level metadata for FatCats
    }
}
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    constructor(string memory uri_) {
        ...
        _uriBase = "ipfs://QmPg2gtMVmCekeHxszFaf1o2HgtqEQQbUTF7UWDC1CXQm9/"; // AR base for ElonatorV1 collection
