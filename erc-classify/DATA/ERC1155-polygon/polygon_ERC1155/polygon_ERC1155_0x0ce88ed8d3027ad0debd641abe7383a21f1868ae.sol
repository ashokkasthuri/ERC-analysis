// Chain: POLYGON - File: contracts/DegoVerseGameCard.sol
/*
          ___
      _.-'___'-._
    .'--.`   `.--'.
...
contract DegoVerseGameCard is ERC1155, AccessControl, Pausable, ERC1155Burnable, ERC1155Supply, ContextMixin, NativeMetaTransaction {
    // Roles
    ...
    function _beforeTokenTransfer(address operator_ROLE, address from, address to, uint256[] memory ids, uint256[] memory amounts, bytes memory data)
        internal
        whenNotPaused
        override(ERC1155, ERC1155Supply)
    {
        super._beforeTokenTransfer(operator_ROLE, from, to, ids, amounts, data);
    }
...
// Chain: POLYGON - File: contracts/libs/ContextMixin.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/libs/NativeMetaTransaction.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/libs/EIP712Base.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/libs/Initializable.sol
// SPDX-License-Identifier: MIT
