...
// Chain: POLYGON - File: contracts/PurchasesEscrow.sol
...
// Chain: POLYGON - File: contracts/RoyaltiesEscrow.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.18;
...
contract WINToken is ERC1155, ERC2981, AccessControl {
    ...
    function createProduct(
        ...
        for (uint i = 0; i < royaltyAddresses.length; i++) {
            ...
            require(
                ...
                "Royalty Address can't be zero addr"
            );
    ...
    function generateToken(
        ...
        uint256 _amount,
        address _erc20Token
    ) external productExist(_productId) {
        ...
        require(_erc20Token != address(0), "Erc20 Cant be zero");
        ...
        purchasesEscrowContract.deposit(
            _erc20Token,
            payment,
            to,
            _productId,
...
// Chain: POLYGON - File: contracts/WINTokenProductsConfig.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.18;
