// Chain: POLYGON - File: BlastBox.sol
 ...
 * @notice This contract handles minting BlastBox tokens.
 */
contract BlastBox is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xCA7Bd929CD9A3Dbc1B40298EB4e15C29569edF55;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xE30D1D11993238Eab4B88114D3d81c6D1fb537Ec;
    address[] public payoutAddresses = [
        0xE30D1D11993238Eab4B88114D3d81c6D1fb537Ec
    ];
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeid7xii46zqor2p6unb2wiv2mutw5ua655fnbjspud5m6a2kdbsc4q/{id}"
        )
        RevokableOperatorFilterer(
