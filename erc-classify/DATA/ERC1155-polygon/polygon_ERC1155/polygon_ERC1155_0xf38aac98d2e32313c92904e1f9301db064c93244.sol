...
// Chain: POLYGON - File: contracts/ArtLicenseNFT.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
import "@openzeppelin/contracts/access/AccessControl.sol";
import "@openzeppelin/contracts/token/ERC1155/extensions/ERC1155Supply.sol";

contract ArtLicenseNFT is AccessControl, ERC1155Supply {
    ...
    function setTokenURI(uint256 _tokenId, string memory _newuri) public onlyRole(URI_SETTER_ROLE) {
