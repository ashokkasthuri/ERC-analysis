...
// Chain: POLYGON - File: contracts/v1/Data/ContractMetadata_Upgradeable.sol
...
// Chain: POLYGON - File: contracts/v1/Deschool_Protocol_Upgradeable.sol
//SPDX-License-Identifier: Unlicense
pragma solidity ^0.8.0;

import "./interfaces/IDeschool_Protocol.sol";
...
contract Deschool_Protocol_Upgradeable_V1 is 
    IDeschool_Protocol,
    ERC1155Upgradeable,
    ...
    EIP712Upgradeable
{
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(AccessControlUpgradeable, ERC1155Upgradeable) returns (bool) {
        return
            ...
            // interfaceId == type(ERC1155Upgradeable).interfaceId ||
    ...
    function setContractURI(string memory contractURI_) external override onlyRole(DEFAULT_ADMIN_ROLE) {
        _setContractURI(contractURI_);
    }
}

// Chain: POLYGON - File: contracts/v1/ERC1155_Upgradeable/ERC1155Upgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/v1/ERC1155_Upgradeable/extensions/ERC1155PausableUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/v1/ERC1155_Upgradeable/extensions/ERC1155SupplyUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/v1/ERC1155_Upgradeable/extensions/IERC1155MetadataURIUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/v1/ERC1155_Upgradeable/IERC1155ReceiverUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/v1/ERC1155_Upgradeable/IERC1155Upgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/v1/interfaces/IDeschool_Protocol.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.17;

interface IDeschool_Protocol {
    /* ================ EVENTS ================ */
