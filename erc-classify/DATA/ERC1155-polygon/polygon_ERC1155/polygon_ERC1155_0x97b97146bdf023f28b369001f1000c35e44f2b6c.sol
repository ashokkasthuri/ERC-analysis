// Chain: POLYGON - File: contracts/CmorqRewards.sol
...
/**
 * @title CmorqRewards
 * CmorqRewards - ERC1155 contract with create and mint functionality
 */
contract CmorqRewards is ERC1155, Ownable {
    ...
    function create(
        ...
        totalTokenSupply[_id] = _totalSupply;
        return _id;
    }
    ...
    function safeBatchTransferTo(
        ...
        for (uint256 i = 0; i < toAddresses.length; ++i) {
            _safeTransferFrom(from, toAddresses[i], id, amount, data);
        }
    }
