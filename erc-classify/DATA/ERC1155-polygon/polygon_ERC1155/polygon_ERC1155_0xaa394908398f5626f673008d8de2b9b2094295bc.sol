// Chain: POLYGON - File: contracts/MercyFromRomaco.sol
...
contract MercyFromRomaco is ERC1155, AccessControl, Ownable, Pausable {
    ...
    // Metadata
    string public name = "Mercy From Romaco";
    string public symbol = "MFR";
    string public baseURI;
    string public baseExtension = ".json";

    // Modifier
    modifier enoughEth(uint256 _tokenId, uint256 _amount) {
        require(mintCosts[_tokenId] > 0, 'Cost Not Set Yet');
