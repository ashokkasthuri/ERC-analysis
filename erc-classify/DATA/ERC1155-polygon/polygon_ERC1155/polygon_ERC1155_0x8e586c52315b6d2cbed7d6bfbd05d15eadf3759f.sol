// Chain: POLYGON - File: contracts/ERC1155/BaseEnigmaNFT1155.sol
...
abstract contract BaseEnigmaNFT1155 is IRoyaltyAwareNFT, ERC1155BurnableUpgradeable, OwnableUpgradeable, MintNFTEvent {
...
// Chain: POLYGON - File: @openzeppelin/contracts-upgradeable/token/ERC1155/ERC1155BurnableUpgradeable.sol
...
// Chain: POLYGON - File: @openzeppelin/contracts-upgradeable/utils/EnumerableMapUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/proxy/IBeacon.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts-upgradeable/math/SafeMathUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/interfaces/ITransferGatekeeper.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
...
// Chain: POLYGON - File: contracts/interfaces/IRoyaltyAwareNFT.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: contracts/utils/MintNFTEvent.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
...
// Chain: POLYGON - File: @openzeppelin/contracts-upgradeable/proxy/Initializable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts-upgradeable/token/ERC1155/IERC1155MetadataURIUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts-upgradeable/introspection/ERC165Upgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts-upgradeable/introspection/IERC165Upgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/ERC1155/EnigmaUserToken1155.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
contract EnigmaUserToken1155 is BaseEnigmaNFT1155 {
    ...
    function _mintItem(MintItem calldata item, address rightsHolder) internal {
        ...
        emit MintNFT(item.tokenId, owner(), item.recipient, item.uri, item.amount, item.fee, rightsHolder, 0);
    }
    ...
    function mint(
        ...
        mintCustomized(uri_, supply_, fee_, msg.sender, msg.sender);
    }
    ...
    function mintCustomized(
        ...
        emit MintNFT(tokenId, msg.sender, to_, uri_, supply_, fee_, rightsHolder_, 0);
        return tokenId;
    }
}


// Chain: POLYGON - File: contracts/ERC1155/EnigmaNFT1155.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
contract EnigmaNFT1155 is BaseEnigmaNFT1155, AuthorizedMintingNFT {
    ...
    function mint(
        ...
        mintCustomized(uri_, supply_, fee_, msg.sender, msg.sender, nonce, sign_);
    }
    ...
    function mintCustomized(
        ...
        verifySign(uri_, msg.sender, supply_, nonce, sign_, owner());
        AuthorizationBitmap.setAuthProcessed(processedNonces, nonce);
        uint256 tokenId = _mintNew(to_, _increaseNextId(), supply_, uri_, fee_, rightsHolder_);
        creators[tokenId] = msg.sender;
        emit MintNFT(tokenId, msg.sender, to_, uri_, supply_, fee_, rightsHolder_, nonce);
        return tokenId;
    }
...
// Chain: POLYGON - File: contracts/utils/AuthorizedMintingNFT.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: contracts/utils/AuthorizationBitmap.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
...
// Chain: POLYGON - File: @openzeppelin/contracts-upgradeable/cryptography/ECDSAUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/utils/EIP712.sol
// SPDX-License-Identifier: MIT
// solhint-disable
...
// Chain: POLYGON - File: contracts/test/TestEnigmaNFT1155.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: contracts/vault/Vault.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: @openzeppelin/contracts-upgradeable/token/ERC1155/ERC1155HolderUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts-upgradeable/token/ERC721/ERC721HolderUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/utils/Types.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: @openzeppelin/contracts-upgradeable/utils/EnumerableSetUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts-upgradeable/token/ERC1155/ERC1155ReceiverUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts-upgradeable/token/ERC721/IERC721ReceiverUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/market/TradeV4.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
abstract contract TradeV4 is ReentrancyGuardUpgradeable, OwnableUpgradeable, TradeSignaturesVerifier {
    ...
    function buyAssetWithETH(
        ...
        require(order.limitTimeToBeSold >= block.timestamp, "TradeV4: Order expired");
        ...
        verifyDirectSalePlatformFeesSignature(
            platformFees,
            order.tokenId,
            order.nftAddress,
            order.seller,
            order.limitAmountToSell,
            order.nonce,
            owner()
        );
        ...
        tradeAssetWithETH(order, royaltyReceiver, fees);
        return true;
    }
...
// Chain: POLYGON - File: contracts/market/utils/TradeSignaturesVerifier.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
contract TradeSignaturesVerifier is EIP712, ITradeSignaturesVerifier {
    ...
    bytes32 private constant DIRECT_SALE_PLATFORM_FEES_TYPE_HASH =
        // solhint-disable max-line-length
        keccak256(
            "DirectSalePlatformFees(address assetAddress,address seller,uint256 tokenId,uint256 limitAmountToSell,uint256 sellOrderNonce,uint8 buyerFeePermille,uint8 sellerFeePermille)"
        );

    bytes32 private constant SELL_ORDER_TYPE_HASH =
        keccak256(
            // solhint-disable max-line-length
            "SellOrder(address assetAddress,uint256 tokenId,address paymentAssetAddress,uint256 unitPrice,uint256 limitAmountToSell,uint8 sellerFeePermille,uint256 nonce,uint256 limitTimeToBeSold,address paymentReceiver)"
        );
     ...
     * Reverts if the sign verification fails.
     * @param platformFees Struct that has information about platform fees
     * @param tokenId Id of the tokens authorized to be sold
     * @param assetAddress Address of the contract of the token to be sold
     * @param seller Authorized seller
     * @param limitAmountToSell Amount authorized to sell
     * @param sellOrderNonce Nonce of the sell order
     * @param authorizer address of the wallet that authorizes minters
     */
...
// Chain: POLYGON - File: contracts/interfaces/ITransferProxy.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: contracts/market/utils/ITradeSignaturesVerifier.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: contracts/ERC721/BaseEnigmaNFT721.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
...
abstract contract BaseEnigmaNFT721 is IRoyaltyAwareNFT, ERC721BurnableUpgradeable, OwnableUpgradeable, MintNFTEvent {
    using SafeMathUpgradeable for uint256;
...
// Chain: POLYGON - File: @openzeppelin/contracts-upgradeable/token/ERC721/ERC721BurnableUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts-upgradeable/token/ERC721/ERC721Upgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts-upgradeable/token/ERC721/IERC721Upgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts-upgradeable/token/ERC721/IERC721MetadataUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts-upgradeable/token/ERC721/IERC721EnumerableUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/test/TestEnigmaNFT721.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
contract TestEnigmaNFT721 is BaseEnigmaNFT721 {
     ...
     * @param fee_ uint256 royalty of the token to be minted.
     */
    function mint(string memory tokenURI_, uint256 fee_) external returns (uint256) {
...
// Chain: POLYGON - File: contracts/ERC721/EnigmaUserToken721.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
contract EnigmaUserToken721 is BaseEnigmaNFT721 {
     ...
     * @param fee_ uint256 royalty of the token to be minted.
     */
    function mint(string memory tokenURI_, uint256 fee_) external onlyOwner returns (uint256) {
        return mintCustomized(tokenURI_, fee_, owner(), msg.sender);
    }
    ...
    function mintCustomized(
        ...
        _setTokenURI(newItemId, tokenURI_);
        emit MintNFT(newItemId, owner(), to_, tokenURI_, 1, fee_, rightsHolder_, 0);
        return newItemId;
    }
}


// Chain: POLYGON - File: contracts/ERC721/EnigmaNFT721.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
contract EnigmaNFT721 is BaseEnigmaNFT721, AuthorizedMintingNFT {
    ...
    function mint(
        ...
        return mintCustomized(tokenURI_, fee_, msg.sender, msg.sender, nonce, sign_);
    }
    ...
    function mintCustomized(
        ...
        _setTokenURI(newItemId, tokenURI_);
        _creator[newItemId] = msg.sender;
        emit MintNFT(newItemId, msg.sender, to_, tokenURI_, 1, fee_, rightsHolder_, nonce);
        return newItemId;
    }
}


// Chain: POLYGON - File: contracts/test/TestEnigmaMarket.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: contracts/market/EnigmaMarket.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: contracts/market/NFTMarketReserveAuction.sol
...
// Chain: POLYGON - File: @openzeppelin/contracts/introspection/IERC165.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/market/NFTMarketAuction.sol
// SPDX-License-Identifier: MIT OR Apache-2.0
...
// Chain: POLYGON - File: contracts/market/NFTMarketCore.sol
// SPDX-License-Identifier: MIT OR Apache-2.0
pragma solidity ^0.7.6;
...
// Chain: POLYGON - File: contracts/market/SendValueWithFallbackWithdraw.sol
// SPDX-License-Identifier: MIT OR Apache-2.0
...
// Chain: POLYGON - File: contracts/test/TestTradeV4.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: contracts/TransferProxy.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: @openzeppelin/contracts/math/SafeMath.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/token/ERC721/IERC721Metadata.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/token/ERC721/IERC721Enumerable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/introspection/ERC165.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/utils/EnumerableSet.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/utils/EnumerableMap.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/token/ERC1155/ERC1155.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/token/ERC1155/IERC1155MetadataURI.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/proxy/UpgradeableBeacon.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/transferGatekeeping/TransferGatekepper.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: contracts/interfaces/IWhitelist.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: contracts/interfaces/IWhitelistHandler.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: contracts/interfaces/IWyvernProxyRegistry.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: contracts/test/TestsWyvernProxyRegistry.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: contracts/transferGatekeeping/AccessControlBasedWhitelist.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: contracts/test/TestWhitelist.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: contracts/test/TestTransferGatekepper.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: @openzeppelin/contracts/proxy/ProxyAdmin.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/proxy/TransparentUpgradeableProxy.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/proxy/UpgradeableProxy.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/proxy/Proxy.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/proxy/TransparentUpgradeableProxy.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
...
// Chain: POLYGON - File: contracts/proxy/ProxyAdmin.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
...
// Chain: POLYGON - File: contracts/transferGatekeeping/TransferGatekeeperBeacon.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
...
// Chain: POLYGON - File: contracts/test/TestERC1155.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
...
// Chain: POLYGON - File: contracts/test/TestERC721.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.7.6;
...
// Chain: POLYGON - File: contracts/test/TestToken.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity 0.7.6;
