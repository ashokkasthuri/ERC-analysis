// Chain: POLYGON - File: /contracts/BlackFortKnights.sol
...
contract BlackFortKnights is ERC1155Supply, ERC1155URIStorage, Ownable, RoyaltiesV2Impl {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC1155, RoyaltiesV2Impl) returns (bool) {
        return (interfaceId == _INTERFACE_ID_ERC2981) ? true : super.supportsInterface(interfaceId);
    }

    function setURI(uint256 tokenId, string memory tokenURI) public onlyOwner {
        require(
            keccak256(abi.encodePacked(uri(tokenId))) == keccak256(abi.encodePacked(DEFAULT_URI)),
            "BlackFortKnights: you can set new URI only once"
        );
...
// Chain: POLYGON - File: /contracts/rarible/impl/RoyaltiesV2Impl.sol
// SPDX-License-Identifier: MIT
...
contract RoyaltiesV2Impl is AbstractRoyalties, RoyaltiesV2, IERC2981 {
     ...
     */
    bytes4 constant INTERFACE_ID_ROYALTIES = 0xcad96cca;
    ...
    function royaltyInfo(uint256 id, uint256 _salePrice) external override virtual view returns (address receiver, uint256 royaltyAmount) {
    ...
    function supportsInterface(bytes4 interfaceId) external virtual override view returns (bool) {
        return interfaceId == INTERFACE_ID_ROYALTIES;
    }

}


// Chain: POLYGON - File: /contracts/rarible/impl/AbstractRoyalties.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: /contracts/rarible/RoyaltiesV2.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: /contracts/rarible/LibRoyalties2981.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: /contracts/rarible/LibPart.sol
// SPDX-License-Identifier: MIT
