...
contract BucketBear is ERC1155Enumerable, OwnWithAuth, ERC1155URI {

    constructor() ERC1155Enumerable("Bucket Bear", "BB") {
        _setTokenToURI(1, "ipfs://QmRNh35tcMuJJj928gcPK6FCrmaBHRLytXkrRsJ6zgchEw/1.json");
        _setTokenToURI(2, "ipfs://QmRNh35tcMuJJj928gcPK6FCrmaBHRLytXkrRsJ6zgchEw/2.json");
        _setTokenToURI(3, "ipfs://QmRNh35tcMuJJj928gcPK6FCrmaBHRLytXkrRsJ6zgchEw/3.json");
        _setTokenToURI(4, "ipfs://QmRNh35tcMuJJj928gcPK6FCrmaBHRLytXkrRsJ6zgchEw/4.json");
