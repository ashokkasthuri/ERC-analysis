// Chain: POLYGON - File: contracts/RevealSuitsDigitalCollectibles.sol
...
contract RevealSuitsDigitalCollectibles is ERC1155, AccessControl, ERC1155Burnable {
    ...
    constructor() ERC1155("https://nft.zelus.io/Reveal-Suits-Digital-Collectibles/{id}") public {
        name = "Reveal Suits Digital Collectibles";
        symbol = "RSDC";
