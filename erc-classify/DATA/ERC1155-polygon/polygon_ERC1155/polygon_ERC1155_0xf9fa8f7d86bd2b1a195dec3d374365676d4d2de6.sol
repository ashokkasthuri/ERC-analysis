...
//
//    __                    ____             
//   / /  ___ ___ _____ ___/_  / ___ _______ 
//  / /__/ _ `/ // / -_) __// /_/ -_) __/ _ \
// /____/\_,_/\_, /\__/_/  /___/\__/_/  \___/
//           /___/                           
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0xCBe409d0f7E14F0546b50494Db55433e38e62059];
...
// File: contracts/LayerZeroContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract LayerZeroContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/T1eIXBWgMK3IhJc1PkdC/contract-metadata";
  }
