...
contract VelhallaCardRedeem is ERC1155Supply, Ownable {
    ...
    string public constant name = "Velhalla Comic Cards S#1";
    string public constant symbol = "VHCCS1";
...
// public
    ...
    function uri(uint256 _id) public override view returns (string memory) {
        ...
        string memory currentBaseURI = tokenURI[ID_GOLD_CARD_START * bookcount];
