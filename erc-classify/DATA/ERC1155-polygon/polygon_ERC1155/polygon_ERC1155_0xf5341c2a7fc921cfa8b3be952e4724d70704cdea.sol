// Chain: POLYGON - File: contracts/MitchMinterSupplyUpgradeable.sol
...
contract MitchMinter is ERC1155BurnableUpgradeable, ERC1155URIStorageUpgradeable, AccessControlUpgradeable, ERC1155SupplyUpgradeable {
    ...
    function withdrawTokens(address recipient) external onlyRole(DEFAULT_ADMIN_ROLE) {
        uint256 tokenBalance = paymentToken.balanceOf(address(this));
        if (tokenBalance > 0) {
            paymentToken.safeTransfer(recipient, tokenBalance);
        }
    }
    ...
    function withdrawNativeToken(address recipient) external payable onlyRole(DEFAULT_ADMIN_ROLE) {
...
// Chain: POLYGON - File: lib/openzeppelin-contracts-upgradeable/contracts/token/ERC1155/extensions/ERC1155URIStorageUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: lib/openzeppelin-contracts/contracts/utils/math/SafeMath.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: lib/openzeppelin-contracts/contracts/token/ERC20/extensions/draft-IERC20Permit.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: lib/openzeppelin-contracts-upgradeable/contracts/utils/math/SignedMathUpgradeable.sol
// SPDX-License-Identifier: MIT
