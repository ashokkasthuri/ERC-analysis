// Chain: POLYGON - File: PlanetOfTheCatsOpenEdition.sol
 ...
 * @notice This contract handles minting Planet of the Cats - Open Edition tokens.
 */
contract PlanetOfTheCatsOpenEdition is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xff9F6ff97B65B3dbd0D3b3fc71175677f0A8C2a4;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x38dCC5F67a39e1b6742f3D75608Dc6BB3CdF5bE8;
    ...
    address[] public payoutAddresses = [
        0x38dCC5F67a39e1b6742f3D75608Dc6BB3CdF5bE8
    ];
    ...
    string public name = "Planet of the Cats - Open Edition";
    string public symbol = "POTC";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeiaoemhdnx6lcqa6jeu264e2hm5bzgabntpfkwtt23ugs7cw2es4ku/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicMintsPerAddress[1] = 10000;
        tokenPublicSaleStartTime[1] = 1689883201;
        tokenPublicSaleEndTime[1] = 1689969600;
