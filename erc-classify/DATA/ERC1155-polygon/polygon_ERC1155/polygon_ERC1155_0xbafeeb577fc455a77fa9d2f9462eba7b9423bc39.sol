...
// Chain: POLYGON - File: contracts/EntryPass.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;
...
contract WarriorPasses is ERC1155, Ownable, ERC1155Burnable, ERC2981 {
    string public name;
    ...
    function _setTokenUri(uint256 tokenId, string memory _uri) private {
        _uris[tokenId] = _uri;
        emit URIs(tokenId, _uri);
    }
