// Chain: POLYGON - File: src/DiscountService/DiscountMinter.sol
 ...
 * @dev This contract is an ERC1155-based discount service that sits on top of a general minter.
 * It enables users to mint tokens with a discount, where the token ID represents the discount percentage for each minted item.
 * Note: this discount service will be created for each collection.
 */
contract DiscountMinter is Initializable, ERC1155Upgradeable, OwnableUpgradeable, PausableUpgradeable, ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable, UUPSUpgradeable {
     ...
     * and specifying the IPMinter contract address, token name, and symbol.
     ...
     */
    function initialize(address collection, string memory tokenName, string memory tokenSymbol) initializer public {
        __ERC1155_init(name);
        __Ownable_init();
        __Pausable_init();
        ...
        updateCollectionAddress(collection);
        name = tokenName;
        symbol = tokenSymbol;     
    }
        ...
        public onlyOwner
    {
        ...
        _setApprovalForAll(account, minterContract, true);
    }
        ...
        public onlyOwner
    {
        ...
        _setApprovalForAll(to, minterContract, true);
    }


    /**
     * @dev Updates the Collection contract address.
     * @param newAddress The new address for the Collection contract.
     */
    function updateCollectionAddress(address newAddress) public onlyOwner {
...
// Chain: POLYGON - File: lib/openzeppelin-contracts-upgradeable/contracts/security/PausableUpgradeable.sol
// SPDX-License-Identifier: MIT
