...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x50540ae1F6152f911A204877cFC5645AB9c7c80c];
...
// File: contracts/V4A9QrContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract V4A9QrContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/23sdlpMzxvSDJSWjJ5S9/contract-metadata";
  }
