...
contract Donuts is ERC1155, Ownable {
    string public name = "Donuts Collection";
    string public symbol = "New Collection Donuts";

    constructor()
        ERC1155(
            "QmP31WHnNCpmtwP3P8mE16DWUTskLKShjyL93AgNBp1LVH/{id}.json"
        )
    {}
