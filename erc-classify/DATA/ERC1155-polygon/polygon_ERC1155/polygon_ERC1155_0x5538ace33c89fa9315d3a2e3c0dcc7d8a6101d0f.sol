// Chain: POLYGON - File: /Library/WebServer/Documents/ethe/nft/contracts/SociosDT.sol
...
contract SociosDT is ERC1155Supply,  Ownable {
    ...
    //Purchase price
    uint256 public mintPrice = 3360000000000000000;
    // Carbon Credit Fee
    ...
    constructor(string memory _name, string memory _symbol) ERC1155("ipfs://QmXiqpUB6xaDuSVdppu7rNir9CXgsBfRVu2wnd2zuhsCqP/") {
        sdtName =_name;
        sdtSymbol = _symbol;
        saleOpen = false;
        redeemAllowed = false;
