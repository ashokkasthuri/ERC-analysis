...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x316A9094E6D98b95f71F39faF665Da617eFbe96c];
...
// File: contracts/R6X3XaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract R6X3XaContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/VfNpcqotZhzMejcxQdzv/contract-metadata";
  }
