...
// Chain: POLYGON - File: contracts/token2049.sol
...
contract TOKEN2049 is ERC1155, AccessControl, Ownable {
  bytes32 public constant MINTER = keccak256('MINTER');
  string public baseTokenURI =
    'https://magic.mypinata.cloud/ipfs/QmTkoiT4u1ALmiYGiTWMBjFavBqFfsATFmYASPFXSaqJgb/{id}.json';
  string public _contractURI = 'https://magic.mypinata.cloud/ipfs/QmQMFGjVMQQb5x581AL1xBC6xJDAeRbTJaLSq1jvPoKThe';
