...
contract EntryPass is ERC1155, Ownable, ERC1155Burnable {
    ...
    function mint(uint256 amount, string memory uri) public onlyOwner {
        tokenIDs = tokenIDs + 1;
    ...
    // mint batch items
    function mintBatch(uint256[] memory amounts, string[] memory uri)
        public
        onlyOwner
    {
