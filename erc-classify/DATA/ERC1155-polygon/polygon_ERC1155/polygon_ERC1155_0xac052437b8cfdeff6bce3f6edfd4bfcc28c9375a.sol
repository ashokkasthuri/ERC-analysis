// Chain: POLYGON - File: contracts/dummyTest/DummyTest.sol
//SPDX-License-Identifier: MIT
pragma solidity 0.8.9;

import "./DummyTestRoot.sol";

contract DummyTest is DummyTestRoot {
  address public childChainManager;

  constructor(string memory _uri, address _childChainManager) DummyTestRoot(_uri) {
...
// Chain: POLYGON - File: contracts/dummyTest/DummyTestRoot.sol
//SPDX-License-Identifier: MIT
pragma solidity 0.8.9;
...
contract DummyTestRoot is Ownable, ERC1155Supply {
  ...
  function distributeNFTs(
    ...
    require(_from == _msgSender() || isApprovedForAll(_from, _msgSender()), "DummyTest: caller is not owner nor approved");
