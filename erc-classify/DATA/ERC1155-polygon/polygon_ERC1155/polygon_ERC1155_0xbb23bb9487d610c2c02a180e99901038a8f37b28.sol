// Chain: POLYGON - File: FameLadySquadArtDropsTEST.sol
 ...
 * @notice This contract handles minting Fame Lady Squad Art Drops TEST tokens.
 */
contract FameLadySquadArtDropsTEST is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x06B88A93254747B1953C35D857dDCc1930cAB5b3;
    address public royaltyAddress = 0x9A5aAf145d11Dd36747CA3c14422d9714a3DE366;
    ...
    string public name = "Fame Lady Squad Art Drops TEST";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeib2jqpaj4jza6fyuvpjdn2voen6lzoro7p4wb7hqlstaum3cyqwhq/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicSaleStartTime[1] = 1676613600;
        tokenPublicSaleEndTime[1] = 1704002400;
        tokenUsePublicSaleTimes[1] = true;
        tokenMaxSupply[2] = 5;
        tokenPublicPrice[2] = 0.2 ether;
        tokenPublicMintsPerAddress[2] = 1;
        tokenPublicSaleStartTime[2] = 1676613600;
        tokenPublicSaleEndTime[2] = 1991948184;
