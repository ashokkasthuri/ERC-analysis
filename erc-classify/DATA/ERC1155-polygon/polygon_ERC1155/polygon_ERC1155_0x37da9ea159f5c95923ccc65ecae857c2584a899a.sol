// Chain: POLYGON - File: contracts/POAP.sol
pragma solidity ^0.8.0;

import "./ERC1155Tradable.sol";

contract POAP is ERC1155Tradable {
    mapping(address => bool) public minters;

    event SetMinter(address minter, bool enabled);

    constructor() ERC1155Tradable(
        "Upchain POAP",
        "POAP",
        "") {
    }
    ...
    function create(
        ...
        return _create(_initialOwner, _id, _initialSupply, _uri, _data);
    }
...
contract ERC1155Tradable is ContextMixin, ERC1155, NativeMetaTransaction, Ownable {
  ...
  function setOpenSeaProxyRegistry(address _proxyRegistryAddress) public onlyOwner {
...
// Chain: POLYGON - File: contracts/meta-transactions/Initializable.sol
// SPDX-License-Identifier: MIT
