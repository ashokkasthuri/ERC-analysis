...
// File: contracts/Ceshi1Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract Ceshi1Contract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "ceshi1";
    string public symbol = "cs1";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/4uUZ2dvKVDWMnmrW7WWQ/contract-metadata";
  }
