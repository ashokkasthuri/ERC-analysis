...
// Chain: POLYGON - File: contracts/FacetRegistry.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
contract FacetRegistry is ERC1155, IRegistry {
    ...
    function createFacetAddress(address addr, string memory meta) external {
        ...
        _mint(msg.sender, id, 1, bytes(meta));
        //mint one to the facet deployer
    }
    ...
    */
    ...
    function uri(uint256 tokenId) public view virtual override returns (string memory) {
        return string(metadata[tokenId]);
        //TODO switch to ERC1155URIStorage.sol
    }
    ...
    function _beforeTokenTransfer(
        ...
        uint256 id = ids[0];
        //TODO update for multiple token transfers
...
// Chain: POLYGON - File: contracts/interfaces/IRegistry.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
