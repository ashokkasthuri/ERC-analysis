...
contract RubyCollectionET is ERC1155, ERC2981, Ownable {
    ...
    constructor() ERC1155("ipfs://bafybeihvtoxpo2aizzugsc2ro7ju7tr4llnsmb7fkdhi2ifk54yvtxrf6y/{id}.json") {
        name = "Ruby Collection - Elizabeth Taylor";
        totalSupply = 80000;
        _setBaseURI("ipfs://bafybeihvtoxpo2aizzugsc2ro7ju7tr4llnsmb7fkdhi2ifk54yvtxrf6y/");
    ...
    function mint(address account, uint256 id, uint256 amount, bytes memory data)
        ...
        onlyOwner
    {
        require(id > 0 && id <= totalSupply, "Supply exceeds");
    ...
    function setBaseURI(string memory newBaseURI) external onlyOwner {
        require(bytes(newBaseURI).length > 0, "Empty string passed as parameter.");
    ...
    function uri(uint256 tokenId) override public view returns (string memory) {
        ...
        require(tokenId >= 1 && tokenId <= totalSupply, "ERC1155Metadata: URI query for nonexistent token");
