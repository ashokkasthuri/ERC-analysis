// Chain: POLYGON - File: contracts/BendoPass.sol
...
contract BendoPass is ERC1155, ERC1155Supply, Whitelist, Pausable {
    ...
    function mintBendo(uint8 amount) public whenNotPaused payable {
        ...
        require(totalSupply(ID_BENDO_PASS) + amount <= MAX_SUPPLY, "you can not mint more merch B");
...
// Chain: POLYGON - File: contracts/Whitelist.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
