...
contract NFTV1 is 
    ...
    event NFTUserMint(address indexed from, address indexed to, uint256 id, uint256 value, uint256 refrenceId );
    ...
    function mint(
        ...
        super._mint(to, _tokenId, 1, data);

        customTokenUri[_tokenId] = tokenUri;

        creators[ _tokenId ] = to;
        tokenHolders[ _tokenId ] = to; 

        emit NFTUserMint(_msgSender(), to, _tokenId, 1, refrenceId);
