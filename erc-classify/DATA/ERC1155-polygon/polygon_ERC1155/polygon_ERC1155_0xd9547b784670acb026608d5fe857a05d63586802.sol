...
// File: contracts/Ceshi2Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract Ceshi2Contract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "ceshi2";
    string public symbol = "ceshi2";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/IENSU4ieNTiL4CUSEKzX/contract-metadata";
  }
