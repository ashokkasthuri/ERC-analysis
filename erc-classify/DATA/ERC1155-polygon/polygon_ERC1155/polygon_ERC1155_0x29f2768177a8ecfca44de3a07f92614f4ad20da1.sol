// Chain: POLYGON - File: Starbucks.sol
 ...
 * @notice This contract handles minting Starbucks tokens.
 */
contract Starbucks is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x9e9ac0BdCCc9a1B47Db1C6182E6f0b0642508Cc0;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xDC4d9C5bB051e760D57a28C968c3b2eCED21A334;
    address[] public payoutAddresses = [
        0xDC4d9C5bB051e760D57a28C968c3b2eCED21A334
    ];
    ...
    string public name = "Starbucks";
    string public symbol = "StarbuckOdyssey";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeigblod3huj3lmd455gw5h7zei37gaqhwmlwgzupfu2nctnkfm4fl4/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[2] = 35000;
        tokenMaxSupply[3] = 5000;
        tokenMaxSupply[4] = 25000;
        tokenMaxSupply[5] = 2000;
        tokenMaxSupply[6] = 25000;
        tokenMaxSupply[7] = 4579;
        tokenMaxSupply[8] = 2354;
        require(
