// Chain: POLYGON - File: AltarOfEuropa.sol
 ...
 * @notice This contract handles minting Altar of Europa tokens.
 */
contract AltarOfEuropa is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x4b0Fb62FE1d59A8E47F2cbcCb138C7D8c92282A9;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x3dCA9a5755bB0305a0D8E25D324F0DF1fBBd8e11;
    ...
    address[] public payoutAddresses = [
        0x3dCA9a5755bB0305a0D8E25D324F0DF1fBBd8e11
    ];
    ...
    string public name = "Altar of Europa";
    ...
    uint96 public royaltyFee = 50;

    constructor(
        uint256 _heymintFeePerToken
    )
        ERC1155(
            "ipfs://bafybeiaum3yaxy5m5a6h4w3sseizi2q7trtwjjyf73vs57ltairzp6ryae/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicMintsPerAddress[4] = 1;
        tokenMaxSupply[5] = 1;
