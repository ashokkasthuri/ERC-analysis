...
// Chain: POLYGON - File: contracts/PawsClaus.sol
...
contract PawsClaus is ERC1155, AccessControl {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor()
        ERC1155(
            "https://link.storjshare.io/s/jupuai3bgzdswpdlqu2qm5xqq6sa/fantasy-witch/json/{id}.json"
        )
    {
        _grantRole(
            DEFAULT_ADMIN_ROLE,
    ...
    function uri(
        ...
        return
            string(
                abi.encodePacked(
                    "https://link.storjshare.io/s/jupuai3bgzdswpdlqu2qm5xqq6sa/fantasy-witch/json/",
