...
// Chain: POLYGON - File: contracts/Factory1155.sol
//SPDX-License-Identifier: MIT

pragma solidity 0.8.11;

import "./OwnTESTNft1155.sol";
...
contract Factory1155 {
    ...
    mapping(address => ContractDetails) public contractRegistry;
    ...
    function deploy(
        ...
        addr = address(
            new TESTDevUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        TESTDevUser1155Token token = TESTDevUser1155Token(address(addr));
        token.transferOwnership(msg.sender);

        contractRegistry[addr] = ContractDetails({
            owner: msg.sender,
            exists: true
        });
...
// Chain: POLYGON - File: contracts/OwnTESTNft1155.sol
// SPDX-License-Identifier: MIT
pragma solidity 0.8.11;
...
contract TESTDevUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
