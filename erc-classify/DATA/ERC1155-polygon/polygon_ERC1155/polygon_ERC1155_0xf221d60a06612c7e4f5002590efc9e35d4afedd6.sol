...
// Chain: POLYGON - File: contracts/ILayerZeroUserApplicationConfig.sol
...
// Chain: POLYGON - File: contracts/LayerZeroInterface.sol
// SPDX-License-Identifier: BUSL-1.1
...
// Chain: POLYGON - File: contracts/OmniFronkV1.sol
// SPDX-License-Identifier: MIT
...
contract OmniFronkV1 is ERC1155Upgradeable, AccessControlUpgradeable, ERC1155SupplyUpgradeable, UUPSUpgradeable, ILayerZeroReceiver {
    ...
    function initialize(string memory _name, string memory _symbol, uint _price, address _lzEndpoint) external initializer{
    ...
    function ticketMint() public payable onlyProxy(){
        require(msg.value == price, "Invalid price");
        _mint(msg.sender, 0, 1, '');
        collections[0].minted[msg.sender] += 1;
    }
