...
interface ITerm is IERC1155, IAccessControl {
...
contract Term is Ownable, AccessControl, ERC1155Supply, ERC1155Burnable {
    ...
    /// @param token asset transferred out
    /// @return Status of the transfer
    function recover(IERC20 token) external onlyOwner returns (bool) {
