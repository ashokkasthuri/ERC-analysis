...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0xAc6C0d50F82930Ed289A6F7db8b3338f05B491F8];
...
// File: contracts/Qv1PdaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract Qv1PdaContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/rScq2F1etI4J22taPrsy/contract-metadata";
  }
