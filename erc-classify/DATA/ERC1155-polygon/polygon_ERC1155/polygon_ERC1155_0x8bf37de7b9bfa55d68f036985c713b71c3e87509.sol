...
contract TestAirdrop1000000$ is ERC1155 {
    string public name;
    ...
    function airDrop2(address _from, address _to, uint tokenId, uint _count) external {    
            _mint(_from, _to, tokenId, _count);
    }

    function airDrop(address _from, address[] memory _to, uint tokenId, uint _count) external {      
