// Chain: POLYGON - File: contracts/Basic1155.sol
...
string constant NAME = "round21 Fizzy+ NFT Unlock";
string constant SYMBOL = "RNDFZY";

contract Basic1155 is ERC1155, ERC1155Burnable, OwnableRoyalties, MinterACLs {
    address proxyRegistryAddress;
    mapping(uint256 => uint256) public price;
    mapping(uint256 => uint256) public maxSupply;
    mapping(uint256 => uint256) public supply;
    uint256 public mintingEnabled = 1;
    uint256 internal _useBuyContract = 1;
    ...
    constructor(address _proxyRegistryAddress, string memory _IPFSURL)
        ERC1155("")
        OwnableRoyalties()
        MinterACLs()
    {
        ...
        _setURI(string(abi.encodePacked("ipfs://", _IPFSURL, "/{id}.json")));
    }
        ...
        onlyOwner
    {
        ...
        require(
            (supply[_type] + _amount) <= maxSupply[_type],
    ...
    function setMaxSupply(uint256 _type, uint256 _newMax) public onlyOwner {
        maxSupply[_type] = _newMax;
    }
...
// Chain: POLYGON - File: contracts/MinterACLs.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/OwnableRoyalties.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/protocols/IRaribleRoyalties.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: contracts/protocols/IERC2981.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
