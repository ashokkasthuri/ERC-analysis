...
// Chain: POLYGON - File: contracts/Nonces.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/Potion.sol
//SPDX-License-Identifier: MIT
...
/**
 * @title Potion NFT
 * @dev  ERC-1155 compatible contract. It represents potion items for Skies project.
 *
 */
...
contract Potion is ERC1155, AccessControl, EIP712("Potion", "1"), Nonces {
    ...
    bytes32 private constant PERMIT_MINT_TYPEHASH =
        keccak256(
            "PermitMint(address owner,uint256 tokenId,uint256 amount,uint256 value,uint256 nonce)"
        );
