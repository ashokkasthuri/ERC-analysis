// Chain: POLYGON - File: contracts/JoypolisGSNNFT.sol
...
contract JoypolisGSNNFT is Managable, ERC165, IERC1155, IERC1155MetadataURI, EIP712 {
    ...
    function _getUnclaimed(uint256 eventId) private view returns(uint256) {
        unchecked{
            ...
            uint256[] memory listId = new uint256[](listNftEvent.length+1);
            uint256[] memory remainingSupply = new uint256[](listNftEvent.length+1);

            for(uint256 a; a <= listNftEvent.length; a++){
                listId[a] = a;
                remainingSupply[a] = maxSupply(a) - totalSupply(a);
            }
...
// Chain: POLYGON - File: contracts/interface/IERC1155.sol
import "./IERC165.sol";
...
// Chain: POLYGON - File: contracts/interface/IERC1155Receiver.sol
import "./IERC165.sol";
...
// Chain: POLYGON - File: contracts/interface/IERC1155MetadataURI.sol
import "./IERC1155.sol";
...
// Chain: POLYGON - File: contracts/library/Address.sol
// SPDX-License-Identifier: none
...
// Chain: POLYGON - File: contracts/library/Counters.sol
...
// Chain: POLYGON - File: contracts/abstract/ERC165.sol
...
// Chain: POLYGON - File: contracts/abstract/Managable.sol
...
// Chain: POLYGON - File: contracts/abstract/Draft-EIP712.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/interface/IERC165.sol
// SPDX-License-Identifier: none
...
// Chain: POLYGON - File: contracts/abstract/BaseRelayRecipient.sol
...
// Chain: POLYGON - File: contracts/abstract/IRelayRecipient.sol
// SPDX-License-Identifier: none
...
// Chain: POLYGON - File: contracts/library/ECDSA.sol
// SPDX-License-Identifier: none
...
// Chain: POLYGON - File: contracts/library/Strings.sol
// SPDX-License-Identifier: none
