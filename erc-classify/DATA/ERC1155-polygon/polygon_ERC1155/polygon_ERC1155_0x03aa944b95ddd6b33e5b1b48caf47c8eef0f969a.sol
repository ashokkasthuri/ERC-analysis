...
// Chain: POLYGON - File: contracts/Artpass.sol
...
contract Artpass is ERC1155Burnable, IERC1155Mintable, Ownable {
    ...
    // setApprovalForAll を禁止する
    function setApprovalForAll(address, bool) public pure override {
        revert('Artpass: setApprovalForAll is disabled');
    }

    // isApprovedForAll を常に false を返すことで approve されてないことに強制する
