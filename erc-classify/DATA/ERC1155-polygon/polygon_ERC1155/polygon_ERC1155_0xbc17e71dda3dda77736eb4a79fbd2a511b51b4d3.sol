// Chain: POLYGON - File: contracts/KubaruSBTContractFactory.sol
...
import "./KubaruSBT.sol";

contract KubaruSBTContractFactory is AccessControl, Ownable {
    ...
    function create(string memory _name, string memory _symbol, address _minter) external {
        KubaruSBT kubaruSBT = new KubaruSBT(
            _name,
            _symbol,
            baseContractURI,
            msg.sender,
        ...
        emit Created(address(kubaruSBT), msg.sender, _minter);
    }
...
// Chain: POLYGON - File: contracts/KubaruSBT.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.17;

import './KubaruERC1155.sol';

contract KubaruSBT is KubaruERC1155 {
    // MaxSupply
