// Chain: POLYGON - File: contracts/FanTigerNFT_V2.sol
    ...
    OwnableUpgradeable
{
    ...
    mapping(uint256 => address) private nftTokenOwner;
    ...
    function initialize(string memory nftMetadataURI) public initializer {
    ...
    */
    ...
    function name() public pure returns (string memory) {
        string memory NftName = "FanTiger NFT Token";
        return NftName;
    }

    function symbol() public pure returns (string memory) {
        string memory NftSymbol = "FTGR";
        return NftSymbol;
    }
