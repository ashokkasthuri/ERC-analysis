// Chain: POLYGON - File: MegaCard.sol
 ...
 * @notice This contract handles minting Mega Card tokens.
 */
contract MegaCard is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xb5213F6fd3Ef9D4F6b5eBEE1dB0f6000d1D6C483;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xd75611bA84156769f7566B47E664E1390824E840;
    address[] public payoutAddresses = [
        0xd75611bA84156769f7566B47E664E1390824E840
    ];
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeifi6ovh4orefyf4ryrs44ndb7w6wzty52y3ywkqvormm6iklynu3i/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[777] = 4440;
        tokenPublicPrice[777] = 0 ether;
        tokenPublicMintsPerAddress[777] = 4440;
        tokenPresaleMaxSupply[777] = 4440;
        tokenPresalePrice[777] = 0 ether;
        tokenPresaleMintsPerAddress[777] = 0;
        require(
