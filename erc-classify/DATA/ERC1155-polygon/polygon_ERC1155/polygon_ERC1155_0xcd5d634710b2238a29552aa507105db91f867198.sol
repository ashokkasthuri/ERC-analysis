...
contract MonstresLuisant is ERC1155, AccessControl {
    ...
    string public baseUri =
        "https://ipfs.io/ipfs/bafybeicqjpqmcivyzytqi3yfgibw27dbqnigjkqqvvrjmuu4gok62xmbca/";
    string public constant name = "Monstres Luisant";
    ...
    function onlyOwnerCanMint(bool _toggle)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        onlyOwnerCan = _toggle;
    }
    ...
    {
        if (onlyOwnerCan) {
            if (msg.sender != Owner) revert OnlyOwnerCan();
        }

        uint256 _Id = nextId.current();
        nextId.increment();
