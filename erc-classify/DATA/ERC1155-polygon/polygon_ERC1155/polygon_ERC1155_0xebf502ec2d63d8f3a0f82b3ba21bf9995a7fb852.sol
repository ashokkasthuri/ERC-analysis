// Chain: POLYGON - File: /contracts/FLSSpecialProjects.sol
...
import './FLS1155Base.sol';

contract FLSSpecialProjects is Delegated, FLS1155Base{
  struct Token {
    uint burnPrice;
    uint mintPrice;
    uint balance;
  ...
  string public name = "Fame Lady Squad Special Projects";
  string public symbol = "FLS: SP";
  Token[] public tokens;
...
// Chain: POLYGON - File: /contracts/FLS1155Base.sol
// SPDX-License-Identifier: MIT
...
contract FLS1155Base is Context, ERC165, IERC1155, IERC1155MetadataURI {
...
// Chain: POLYGON - File: /contracts/Blimpie/Delegated.sol
