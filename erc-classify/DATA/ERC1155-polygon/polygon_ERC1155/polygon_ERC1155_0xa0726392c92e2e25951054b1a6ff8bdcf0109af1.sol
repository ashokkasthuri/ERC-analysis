...
//
//    ___                 _                    __         __  _        
//   / _ | __ _  ___ ____(_)______ ____    __ / /_ _____ / /_(_)______ 
//  / __ |/  ' \/ -_) __/ / __/ _ `/ _ \  / // / // (_-</ __/ / __/ -_)
// /_/ |_/_/_/_/\__/_/ /_/\__/\_,_/_//_/  \___/\_,_/___/\__/_/\__/\__/ 
//                                                                     
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0xdd5d6Fa8B5Eb8828CBadd7946A77FEaC2A8379B8];
...
// File: contracts/AmericanJusticeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract AmericanJusticeContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "American Justice";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Q2pxt243abfrQ84XZ4Gz/contract-metadata";
  }
