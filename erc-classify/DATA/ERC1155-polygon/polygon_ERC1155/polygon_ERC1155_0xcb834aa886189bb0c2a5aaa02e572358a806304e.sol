...
contract NFT is ERC1155Burnable, ERC2981, Ownable {
    ...
    string private _baseTokenURI = "https://sound-desert-upload-prod.s3.ap-northeast-1.amazonaws.com/artist/4nen2kumi/nft/";
    mapping(uint256 => uint256) public totalSupply;

    constructor() ERC1155("") {
      _setDefaultRoyalty(address(0xe0286090Fc1EC7fc00195f7849ad4AeFaF42ffc1), 1000);
    }
