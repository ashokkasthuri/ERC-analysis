...
contract MBASH is ERC1155URIStorage, Ownable, Operable,DefaultOperatorFilterer,ERC2981 {
    using Strings for string;

    string public name = 'MONSTER baSH NFT';
    string public symbol = 'MBASH';
    address internal baseWallet = 0xF2886928249dF3b179d9771CCb567E33935E5e33;
    constructor(
    ) ERC1155('') {
        _grantOperatorRole(msg.sender);
        _grantOperatorRole(baseWallet);
        _setDefaultRoyalty(baseWallet,0);
        _setBaseURI('https://arweave.net/tUjRp9uyBBZhpvw6sOTNht6ssVszO8GBKqwIlr2cI38/');
        initializeNFT(0, '0.json');
        initializeNFT(1, '1.json');
        initializeNFT(2, '2.json');
        initializeNFT(3, '3.json');
        initializeNFT(4, '4.json');
    }
