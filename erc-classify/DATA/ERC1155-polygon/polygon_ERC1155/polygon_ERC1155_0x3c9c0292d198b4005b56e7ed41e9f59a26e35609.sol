...
contract NFT is ERC1155Burnable, ERC2981, Ownable {
    ...
    string private _baseTokenURI = "https://sound-desert-assets.s3.ap-northeast-1.amazonaws.com/fes/asorock/nft/";
    mapping(uint256 => uint256) public totalSupply;

    constructor() ERC1155("") {
      _setDefaultRoyalty(address(0x51ED2A9860c9A7D51523E48BcA83eD20375BB202), 1000);
    }
