...
// File: contracts/DarkLegendsRewards.sol
...
/// @title Meta-Life: Dark legends rewards
/// @author Hando Masahashi
contract DarkLegendsRewards is ERC1155, Ownable, ReentrancyGuard {

    using Strings for uint256;
    string public baseURI = "";

    address payable public collector;
    uint256 public constant ID_DARK_ARMOR = 1;
    struct TokenReward {
        uint256 id;
        string name;
        uint256 totalSupply;
    ...
    constructor() ERC1155("") {
        // Thursday 11 April 2024 21:59:59
        addToken("dark-armor", true, true, 300, ID_DARK_ARMOR, 1712872799);
        baseURI = "https://metalegends.mypinata.cloud/ipfs/QmVamShyvFzpvpJBtGM5wW1yJQE6zYagC83zSaQg6wLspU/";
    }
