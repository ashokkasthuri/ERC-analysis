// Chain: POLYGON - File: @thirdweb-dev/contracts/eip/ERC1155.sol
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/eip/interface/IERC1155.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/eip/interface/IERC1155Metadata.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/eip/interface/IERC1155Receiver.sol
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/eip/interface/IERC165.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/eip/interface/IERC20.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/eip/interface/IERC2981.sol
// SPDX-License-Identifier: Apache 2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/BatchMintMetadata.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/ContractMetadata.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/DefaultOperatorFilterer.sol
// SPDX-License-Identifier: Apache 2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/DelayedReveal.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/Drop1155.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/LazyMint.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/Multicall.sol
// SPDX-License-Identifier: Apache 2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/OperatorFilterToggle.sol
// SPDX-License-Identifier: Apache 2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/OperatorFilterer.sol
// SPDX-License-Identifier: Apache 2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/Ownable.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/PrimarySale.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/Royalty.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/interface/IClaimCondition.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/interface/IClaimConditionMultiPhase.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/interface/IContractMetadata.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/interface/IDelayedReveal.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/interface/IDrop1155.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/interface/ILazyMint.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/interface/IMulticall.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/interface/IOperatorFilterRegistry.sol
// SPDX-License-Identifier: Apache 2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/interface/IOperatorFilterToggle.sol
// SPDX-License-Identifier: Apache 2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/interface/IOwnable.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/interface/IPrimarySale.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/interface/IRoyalty.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/external-deps/openzeppelin/token/ERC20/utils/SafeERC20.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/infra/interface/IWETH.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/lib/CurrencyTransferLib.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/lib/MerkleProof.sol
// SPDX-License-Identifier: Apache 2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/lib/TWAddress.sol
// SPDX-License-Identifier: Apache 2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/lib/TWStrings.sol
// SPDX-License-Identifier: Apache 2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: contracts/ERC1155Drop.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
    ...
    DefaultOperatorFilterer
{
    ...
    /**
     *  @notice Returns the current tokenId being minted based on sequential ordering of minting
     *  @dev tokenId of the current nft available to mint
     */
    uint256 public currentLevelMinting = 0;
    event MintingNextLevel(uint256 newLevel);
    ...
    function claim(
        ...
        uint256 tokenToMint = _tokenId;

        // Set the token that we are supposed to be minting based on current supplies
        if (totalSupply[0] <  claimCondition[0].conditions[getActiveClaimConditionId(0)].maxClaimableSupply) {
            tokenToMint = 0;
        } else if (totalSupply[1] < claimCondition[1].conditions[getActiveClaimConditionId(1)].maxClaimableSupply) {
            tokenToMint = 1;
        } else {
            tokenToMint = 2;
        }

        uint256 activeConditionId = getActiveClaimConditionId(tokenToMint);

        //Check if a user has already minted one of the nfts
        for (uint8 i = 0; i <= tokenToMint;  i++) {
            for (uint8 z = 0; z <= 1;  z++) {
            require(claimCondition[i].supplyClaimedByWallet[z][_dropMsgSender()] == 0, "You have already minted");
            }
        }
        _beforeClaim(tokenToMint, _receiver, _quantity, _currency, _pricePerToken, _allowlistProof, _data);
        ...
        // Update contract state.
        claimCondition[tokenToMint].conditions[activeConditionId].supplyClaimed += _quantity;
        claimCondition[tokenToMint].supplyClaimedByWallet[activeConditionId][_dropMsgSender()] += _quantity;

        // If there's a price, collect price.
        collectPriceOnClaim(tokenToMint, address(0), _quantity, _currency, _pricePerToken);

        // Mint the relevant NFTs to claimer.
        transferTokensOnClaim(_receiver, tokenToMint, _quantity);

        emit TokensClaimed(activeConditionId, _dropMsgSender(), _receiver, tokenToMint, _quantity);

        if (totalSupply[tokenToMint] == claimCondition[tokenToMint].conditions[activeConditionId].maxClaimableSupply) {
            currentLevelMinting = ++tokenToMint;
            emit MintingNextLevel(currentLevelMinting);
        }

        _afterClaim(tokenToMint, _receiver, _quantity, _currency, _pricePerToken, _allowlistProof, _data);
    }
