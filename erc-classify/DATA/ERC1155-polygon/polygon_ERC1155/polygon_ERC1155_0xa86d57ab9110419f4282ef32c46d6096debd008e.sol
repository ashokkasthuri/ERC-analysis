...
// Chain: POLYGON - File: contracts/project-halia-alpha-test.sol
...
contract ProjectHALIAAlphaTest is ERC1155, AccessControl, Ownable {
  bytes32 public constant MINTER = keccak256('MINTER');
  string public baseTokenURI =
    'https://bafybeicqi5p3eyi7ebqtwphhm6kjpclektsbigafmbaiwsqbnvr2zqiwae.ipfs.dweb.link/{id}.json';
  string public _contractURI = 'https://bafkreihmybqxtvssqvtim2awvhe76tb2bh3gav4jmjmaytvgsl7m5bnt4i.ipfs.dweb.link';
  uint256 public MAX_TOKENS = 1; // Supply of different token ids
  uint256 public MAX_TOKEN_SUPPLY = 150; // Supply of each token
