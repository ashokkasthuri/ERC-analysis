// Chain: POLYGON - File: MINDSKEY.sol
 ...
 * @notice This contract handles minting MINDS KEY tokens.
 */
contract MINDSKEY is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xDC626250934be27AF8A9abc7D62851C4955d91B0;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xeB171858CA40A88113cA09e98caC017F8Fde6689;
    ...
    address[] public payoutAddresses = [
        0x78B4060E093EfE050f44b5b9adfe481D33A2BA93
    ];
    ...
    string public name = "MINDS KEY";
    string public symbol = "MINDS KEY";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeidysgv6duu6a5e6ogmp34r5gi2gbv5hfb3maxxwiag3ttqbfvttqi/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[1] = 140;
        tokenPresaleMaxSupply[1] = 140;
        tokenPresalePrice[1] = 8 ether;
        tokenPresaleMintsPerAddress[1] = 8;
        require(
