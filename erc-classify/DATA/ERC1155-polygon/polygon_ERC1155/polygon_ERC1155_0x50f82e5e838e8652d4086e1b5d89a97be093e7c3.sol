// Chain: POLYGON - File: NekoPepeXB.sol
 ...
 * @notice This contract handles minting NekoPepeXB tokens.
 */
contract NekoPepeXB is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x76e54f4ed4A93eB0b1A3873b16614a5C5b3c13f9;
    ...
    string public name = "NekoPepeXB";
    string public symbol = "NPXB";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeiggxchxjjbrvtylfjwaft4nwcm66kx5hge7zb2m652ro3lrvzyhau/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicSaleStartTime[1] = 1690315200;
        tokenPublicSaleEndTime[1] = 1690401600;
