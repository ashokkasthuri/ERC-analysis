...
contract CSWorkshop is ERC1155, Ownable, Pausable {
  ...
  constructor()
    ERC1155(
      "https://gateway.pinata.cloud/ipfs/QmSmHxfec5ybJqg12dMmgzQe7HL4cQvWDiaA8peEaqihhc/{id}.json"
    )
  {
  ...
  function uri(uint256 _tokenId) public pure override returns (string memory) {
    return
      string(
        abi.encodePacked(
          "https://gateway.pinata.cloud/ipfs/QmSmHxfec5ybJqg12dMmgzQe7HL4cQvWDiaA8peEaqihhc/",
