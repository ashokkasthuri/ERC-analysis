...
// Chain: POLYGON - File: contracts/EarnAllianceBadgeV2.sol
// SPDX-License-Identifier: MIT
...
contract EarnAllianceBadgeV2 is Initializable, OwnableUpgradeable, PausableUpgradeable, ERC1155SupplyUpgradeable, UUPSUpgradeable, EIP712Upgradeable {
    ...
    /// @param badgeMintRequest Interface for tokenId, amount, address
    /// @return bool true or false, used to determine in badgeMint if address has completed tasks for badge
