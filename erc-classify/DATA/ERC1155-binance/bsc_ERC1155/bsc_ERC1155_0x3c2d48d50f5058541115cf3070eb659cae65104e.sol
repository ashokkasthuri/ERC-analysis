...
contract GFXAssets is  Initializable , ERC1155Upgradeable , AccessControlUpgradeable   , UUPSUpgradeable , ERC1155SupplyUpgradeable    { 
    ...
    function setName(string memory newname) public onlyRole(OPERATOR_ROLE) {
        name = newname;
    }

    function setSymbol(string memory newsymbol) public onlyRole(OPERATOR_ROLE){
        symbol = newsymbol;
    }
    ...
    function _authorizeUpgrade(address newImplementation) internal virtual override onlyRole(OPERATOR_ROLE) {
    ...
    function burn(address account, uint256 id, uint256 value) public  virtual {
        require(
            account == _msgSender() || isApprovedForAll(account, _msgSender()) || hasRole(OPERATOR_ROLE,msg.sender) ,
            "ERC1155: caller is not token owner or operator or approved"
        );
    ...
    function airdrop(address[] memory accounts,uint256 id, uint256 value) public onlyRole(OPERATOR_ROLE) {
