// Chain: BSC - File: /home/paniczklos/PycharmProjects/Crypto/APOyeild/NFT/kontrakt1155/contracts/GameItems.sol
...
contract GameItems is ERC1155 {
    ...
    constructor() public ERC1155("http://metadata.bscpop.com/.netlify/functions/server/{id}") {
        _mint(msg.sender, 106577387795355498454257021253580245987697977002458236209108736007781502013948, 1, "");
    }
    function mint(address account, uint256 id, uint256 amount, bytes memory data) public virtual returns (uint256 newTokenId) {
