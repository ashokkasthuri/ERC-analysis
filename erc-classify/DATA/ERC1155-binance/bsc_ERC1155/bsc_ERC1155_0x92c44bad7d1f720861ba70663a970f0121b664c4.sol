...
contract SLVNFTMaker is ERC1155Tradable {
    string private _contractURI;

    constructor() public ERC1155Tradable("Salvation NFT", "SLVNNFT") {
        _setBaseMetadataURI("https://api.salvation.finance/api/SLVNNFT/");
        _contractURI = "https://api.salvation.finance/api/slvnnft-erc1155";
    }
