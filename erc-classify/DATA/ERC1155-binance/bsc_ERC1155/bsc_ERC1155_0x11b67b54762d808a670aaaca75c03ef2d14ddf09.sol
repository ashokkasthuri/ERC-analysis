...
// File: @openzeppelin/contracts/token/BEP1155/BEP1155Receiver.sol
 ...
 */
abstract contract BEP1155Receiver is BEP165, IBEP1155Receiver {
    constructor() public {
        _registerInterface(
            BEP1155Receiver(0).onBEP1155Received.selector ^
            BEP1155Receiver(0).onBEP1155BatchReceived.selector
        );
    }
}
...
contract CommonConstants {
    bytes4 internal constant BEP1155_ACCEPTED = 0xf23a6e61; // bytes4(keccak256("onBEP1155Received(address,address,uint256,uint256,bytes)"))
    bytes4 internal constant BEP1155_BATCH_ACCEPTED = 0xbc197c81; // bytes4(keccak256("onBEP1155BatchReceived(address,address,uint256[],uint256[],bytes)"))
}
...
// File: @openzeppelin/contracts/token/BEP1155/IBEP1155MetadataURI.sol
...
// File: contracts/lib/BEP1155Base.sol
 ...
 * _Available since v3.1._
 */
contract BEP1155Base is Context, BEP165, IBEP1155, IBEP1155MetadataURI {
     ...
     */
    constructor() public {
        // register the supported interfaces to conform to BEP1155 via BEP165
        _registerInterface(_INTERFACE_ID_BEP1155);

        // register the supported interfaces to conform to BEP1155MetadataURI via BEP165
        ...
        returns (uint256[] memory)
    {
        ...
        for (uint256 i = 0; i < accounts.length; ++i) {
            require(
                ...
                "BEP1155: batch balance query for the zero address"
            );
...
/**
    Note: The BEP-165 identifier for this interface is 0x0e89341c.
*/
contract BEP1155Metadata_URI is HasTokenURI {
...
contract StoreBase is BEP165, Ownable, BEP1155Metadata_URI, BEP1155Base {
    // id => creator
