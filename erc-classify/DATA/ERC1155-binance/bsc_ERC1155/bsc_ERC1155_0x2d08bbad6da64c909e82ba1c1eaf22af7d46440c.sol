...
// Chain: BSC - File: contracts/GenesisNFT.sol
// SPDX-License-Identifier: MIT
...
contract GenesisNFT is ERC1155, Ownable {
    ...
    function mint(
        ...
        require(speControllerAddress != address(0x0), "Factory: zero address");
        require(
            speControllerAddress == _msgSender(),
            "Invalid factory address"
        );

        _mint(_sender, _tokenId, _mintAmount, "");
    }
