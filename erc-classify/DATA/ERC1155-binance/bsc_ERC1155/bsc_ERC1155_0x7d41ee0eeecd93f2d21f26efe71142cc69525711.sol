// Chain: BSC - File: /contracts/NFT1155_SpecialPieceVBG.sol
...
contract MetaSpecialPiece is ERC1155, AccessControl, Pausable, ERC1155Supply {
    ...
    constructor() ERC1155("https://nft.walk2valley.com/spv/metadata.json") {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(URI_SETTER_ROLE, msg.sender);
        _grantRole(PAUSER_ROLE, msg.sender);
        _grantRole(MINTER_ROLE, msg.sender);
        _name = "MetaSpecialPiece";
        _symbol = "SPV";
