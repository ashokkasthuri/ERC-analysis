// Chain: BSC - File: ERC1155GMImplementation.sol
...
import "ERC1155GMCore.sol";

/**
 * @dev ERC1155Creator implementation
 */
contract ERC1155GMImplementation is AdminControlUpgradeable, ERC1155Upgradeable, ERC1155GMCore {
     ...
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC1155Upgradeable, ERC1155GMCore, AdminControlUpgradeable) returns (bool) {
        return ERC1155GMCore.supportsInterface(interfaceId) || ERC1155Upgradeable.supportsInterface(interfaceId) || AdminControlUpgradeable.supportsInterface(interfaceId);
    }
...
// Chain: BSC - File: ERC1155Upgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: IERC1155Upgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: IERC165Upgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: IERC1155ReceiverUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: IERC1155MetadataURIUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: AddressUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: ContextUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: Initializable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: ERC165Upgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: AdminControlUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: OwnableUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: IAdminControl.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: ERC1155GMCore.sol
// SPDX-License-Identifier: MIT
...
import "IERC1155GMCore.sol";
import "GMCore.sol";

/**
 * @dev Core ERC1155 creator implementation
 */
abstract contract ERC1155GMCore is GMCore, IERC1155GMCore {
     ...
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(GMCore, IERC165) returns (bool) {
        return interfaceId == type(IERC1155GMCore).interfaceId || super.supportsInterface(interfaceId);
    }
}

// Chain: BSC - File: IERC1155CreatorExtensionApproveTransfer.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: IERC1155CreatorExtensionBurnable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: IERC1155CreatorMintPermissions.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: IERC1155GMCore.sol
// SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

import "IGMCreatorCore.sol";

/**
 * @dev Core ERC1155 creator interface
 */
interface IERC1155GMCore is IGMCreatorCore {
...
// Chain: BSC - File: IGMCreatorCore.sol
// SPDX-License-Identifier: MIT
 ...
 */
interface IGMCreatorCore is IERC165 {
 ...
 */
abstract contract GMCore is ReentrancyGuard, IGMCreatorCore, ERC165 {
     ...
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC165, IERC165) returns (bool) {
        return interfaceId == type(IGMCreatorCore).interfaceId || super.supportsInterface(interfaceId)
...
// Chain: BSC - File: ReentrancyGuard.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: ERC165Checker.sol
// SPDX-License-Identifier: MIT
