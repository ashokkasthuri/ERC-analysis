// Chain: BSC - File: contracts/AssetContractShared.sol
    ...
    Pausable
{
    ...
    /**
     * Override isApprovedForAll to whitelist user's FindingDodo proxy accounts to enable gas-free listings.
     */
    ...
    {
        // Whitelist FindingDodo proxy contracts for easy trading.
    ...
    /**
     * This is used instead of msg.sender as transactions won't be sent by the original token owner, but by FindingDodo.
     */
...
/**
 * @title AssetContract
 * AssetContract - A contract for easily creating non-fungible assets on FindingDodo.
 */
contract AssetContract is ERC1155Tradable {
    ...
    function findingDodoVersion() public pure returns (string memory) {
        return "2.1.0";
    }
    ...
    /**
     * Compat for factory interfaces on FindingDodo
 ...
 * FindingDodo shared asset contract - A contract for easily creating custom assets on FindingDodo
 */
