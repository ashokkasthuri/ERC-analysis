...
// Chain: BSC - File: contracts/Platinum.sol
// SPDX-License-Identifier: MIT
...
contract Platinum is ERC1155, AccessControl, ERC1155Burnable, ERC1155Supply {
    ...
    constructor() ERC1155("https://api.ombank.network/nft/platinum.json") {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(MINTER_ROLE, msg.sender);
        _symbol = "PlatinumNFT";
        _name = "PlatinumNFT";
        mint(msg.sender, 200000, "0x00");
    }
