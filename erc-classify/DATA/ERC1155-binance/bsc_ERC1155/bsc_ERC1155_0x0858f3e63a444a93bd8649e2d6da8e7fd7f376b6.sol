...
contract ERC1155Base is Ownable, ERC1155Metadata_URI, ERC1155 {
    ...
    constructor(string memory tokenURIPrefix) ERC1155Metadata_URI(tokenURIPrefix) public {
...
contract RealtiesToken is Ownable, ERC1155Base {
    string public name;
    string public symbol;

    constructor(string memory _name, string memory _symbol, string memory tokenURIPrefix) ERC1155Base(tokenURIPrefix) public {
        name = _name;
        symbol = _symbol;
