  ...
  UUPSUpgradeable
{
  ...
  */
  ...
  // contract logic
  function stackBuilding(uint256 buildingNftID) public onlyOwner {
  ...
  function stackApe(uint256 apeNftId) public onlyOwner {
    address sender = address(msg.sender);
  ...
  */
  function claimRewards(uint256 genericType) public {
    ...
    {
      totalRewards = 15 * apeTypeBaseRewards[genericType];
    }
