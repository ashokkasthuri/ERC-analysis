    ...
    UUPSUpgradeable
{
    ...
    function evolve(
        ...
        if (address(msg.sender) != this.owner()) {
            require(
                (block.timestamp - apeFarmingInitTimestamp[nftID]) >=
                    1209600,
    ...
    function stackedBuildingsManualFix(address owner, uint256 genericType) public onlyOwner {
      buildingOwnerByTypeBuildings[owner][genericType].pop();
    }
}
