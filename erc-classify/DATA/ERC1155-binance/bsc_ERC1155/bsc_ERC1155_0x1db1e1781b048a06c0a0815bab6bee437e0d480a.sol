...
// Chain: BSC - File: contracts/Gold.sol
// SPDX-License-Identifier: MIT
...
contract Gold is ERC1155, AccessControl, ERC1155Burnable, ERC1155Supply {
    ...
    constructor() ERC1155("https://api.ombank.network/nft/gold.json") {
