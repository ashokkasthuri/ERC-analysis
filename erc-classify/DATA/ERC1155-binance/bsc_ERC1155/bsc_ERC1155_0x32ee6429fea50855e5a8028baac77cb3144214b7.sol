...
// Chain: BSC - File: contracts/erc-1155/ERC1155.sol
/*
    ...
    PausableUpgradeable
{
    ...
    /**
     * Required minters array to not be empty on initialization.
     */
    error MintersArrayEmpty();
        ...
        initializer
    {
        ...
        if (_minters.length == 0) {
            revert MintersArrayEmpty();
        }
