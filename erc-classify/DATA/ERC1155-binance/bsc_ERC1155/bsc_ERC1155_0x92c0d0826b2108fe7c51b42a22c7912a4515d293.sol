...
contract Collection is Ownable, SignerRole, ERC1155Base {
    string public name;
...
contract LiquidiftyCollection is Collection {
    event CreateERC1155_v1(address indexed creator, string name, string symbol);

    constructor(string memory name, string memory symbol, string memory contractURI, string memory tokenURIPrefix, address signer) Collection(name, symbol, signer, contractURI, tokenURIPrefix) public {
