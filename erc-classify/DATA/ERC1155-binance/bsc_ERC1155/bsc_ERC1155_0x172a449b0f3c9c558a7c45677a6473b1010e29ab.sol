...
// Chain: BSC - File: contracts/SeasideParkHotelKing.sol
// SPDX-License-Identifier: MIT
...
contract SeasideParkHotelKing is ERC1155 {
    string public constant name = "Seaside Park Hotel King";
    string public constant symbol = "SPK";
    uint256 public constant totalSupply = 100;

    constructor() ERC1155("ipfs://bafybeiec7sbz26dx2dfabvjga7hzf756oehw3q5nrgrs2jteadrypbd2kq/metadata.json") {
    ...
    function uri(uint256 tokenId) override public pure returns (string memory) {
        return "ipfs://bafybeiec7sbz26dx2dfabvjga7hzf756oehw3q5nrgrs2jteadrypbd2kq/metadata.json";
    }
}