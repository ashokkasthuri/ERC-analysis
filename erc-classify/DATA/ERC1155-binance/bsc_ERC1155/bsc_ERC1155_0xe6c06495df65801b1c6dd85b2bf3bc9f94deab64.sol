// Chain: BSC - File: @passive-income/naas-erc-1155/contracts/NaaSPrivate.sol
...
contract NaaSPrivate is NaaS {
    ...
    function initialize(
        ...
        emit MinterApplied(_msgSender());
        minterDelay = 3600 * 24;

        super.initialize(_name, _symbol, _proxyRegistryAddress, _creatorsRegistry);
    }
    ...
    function mint(
        ...
        require(
            isMinter[data.minter],
            "ERC1155Minter: Minter set is not allowed to mint"
        );
    ...
    function addMinter(address minter) external onlyOwner {
        require(!isMinter[minter], "ERC1155Minter: Already a minter");
        require(
            minterPending[minter] == 0,
            "ERC1155Minter: Minter is already pending"
        );
    ...
    function applyMinter(address minter) external onlyOwner {
        require(
            ...
            "ERC1155Minter: Minter still pending"
        );
...
// Chain: BSC - File: @passive-income/naas-erc-1155/contracts/NaaS.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @passive-income/naas-erc-1155/contracts/abstracts/ERC1155/presets/ERC1155Tradeable.sol
// SPDX-License-Identifier: MIT
...
import "@passive-income/naas-royalties/contracts/abstracts/Royalties.sol";
    ...
    IERC1155Tradeable
{
    ...
    function mint(
        ...
        if (!exists(data.id)) {
            ...
            _setMaximumSupply(data.id, data.supply);
            _saveRoyalties(data.id, data.royalties);
            creatorsRegistry.saveCreators(data.id, data.creators);
            _setTokenURI(data.id, data.uri);
        }

        initializeCollection(data.collectionId, data.collectionUri, data.minter, data.creators);
        _mint(to, data.collectionId, data.id, amount, "");
    }
    ...
    function mintMultiple(
        ...
        require(
            data.minter == _msgSender() || isApprovedForAll(data.minter, _msgSender()),
            "ERC1155: caller is not owner nor approved"
        );
        require(ids.length > 0 && ids.length == _amounts.length, "ERC1155: Amounts are incorrect");

        bytes32 hash = LibERC1155Lazy.hash(data);
        
        for (uint256 idIdx = 0; idIdx < ids.length; idIdx++) {
            bool found = false;
            for (uint256 tokenIdx = 0; tokenIdx < data.collection.tokens.length; tokenIdx++) {
                LibERC1155Lazy.Token memory token = data.collection.tokens[tokenIdx];
                if (token.id != ids[idIdx]) continue;

                LibPart.Part[] memory tokenCreators = token.creators;
                if (tokenCreators.length == 0) tokenCreators = data.collection.creators;
                require(data.minter == tokenCreators[0].account, "Minter is not the first creator");

                LibPart.Part[] memory _royalties = token.royalties;
                if (_royalties.length == 0) _royalties = data.collection.royalties;
                ...
                if (!exists(token.id)) {
                    ...
                    creatorsRegistry.saveCreators(token.id, tokenCreators);
            ...
            require(found, string(abi.encodePacked("Token '", Strings.uint2str(ids[idIdx]), "' was not found")));
        }

        LibPart.Part[] memory colCreators = data.collection.creators;
        if (colCreators.length == 0) colCreators = data.collection.tokens[0].creators;
    ...
    function _validateCreators(
        ...
        if (_creators.length == 1 && (_creators[0].account == sender || isProxy(_creators[0].account, sender))) return;
    ...
    function initializeCollection(
        ...
        if (!collectionExists(id)) {
            ...
            require(isCreator, "Minter is not a creator of this collection");
        }
    }
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(IERC165Upgradeable, ERC1155Proxy, Royalties)
        returns (bool)
    {
        return
...
// Chain: BSC - File: @passive-income/naas-erc-1155/contracts/abstracts/ERC1155/extensions/ERC1155Proxy.sol
// SPDX-License-Identifier: MIT
    ...
    IERC1155Proxy
{
    ...
    {
        if (isProxy(_owner, _operator)) return true;
        return super.isApprovedForAll(_owner, _operator);
    }

    function isProxy(address _owner, address _operator)
        public
        view
        virtual
        override
    ...
    {
        return
            interfaceId == type(IERC1155Proxy).interfaceId ||
            super.supportsInterface(interfaceId);
    }
...
// Chain: BSC - File: @passive-income/naas-erc-1155/contracts/abstracts/ERC1155/extensions/ERC1155Collection.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @passive-income/naas-erc-1155/contracts/interfaces/ICreatorsRegistry.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @passive-income/naas-royalties/contracts/abstracts/Royalties.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @passive-income/naas-royalties/contracts/libraries/LibPart.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @passive-income/naas-erc-1155/contracts/interfaces/ERC1155/IERC1155Tradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @passive-income/naas-erc-1155/contracts/libraries/LibERC1155Lazy.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @passive-income/naas-erc-1155/contracts/abstracts/ERC1271/ERC1271Validator.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @passive-income/naas-erc-1155/contracts/utils/Strings.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @passive-income/naas-royalties/contracts/interfaces/IRoyalties.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @passive-income/naas-erc-1155/contracts/interfaces/ERC1155/IERC1155Proxy.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @passive-income/naas-erc-1155/contracts/interfaces/ERC1155/IERC1155Supply.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @passive-income/naas-erc-1155/contracts/libraries/LibERC1155Creators.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @passive-income/naas-erc-1155/contracts/abstracts/ERC1271/ERC1271.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @openzeppelin/contracts-upgradeable/utils/cryptography/draft-EIP712Upgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @openzeppelin/contracts-upgradeable/utils/cryptography/ECDSAUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @openzeppelin/contracts-upgradeable/interfaces/IERC1271Upgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @passive-income/naas-erc-1155/contracts/interfaces/ERC1155/IERC1155Collection.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @passive-income/naas-erc-1155/contracts/abstracts/ERC1155/extensions/ERC1155Capped.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @passive-income/naas-erc-1155/contracts/abstracts/ERC1155/extensions/ERC1155Supply.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @passive-income/naas-erc-1155/contracts/abstracts/ERC1155/extensions/ERC1155MintBurn.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @passive-income/naas-erc-1155/contracts/abstracts/ERC1155/extensions/ERC1155MetadataURI.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @passive-income/naas-erc-1155/contracts/abstracts/ERC1155/ERC1155.sol
// SPDX-License-Identifier: MIT
