// Chain: BSC - File: prod-contracts/ApesLandBSCv21.sol
  ...
  UUPSUpgradeable
{
  ...
  */
  function claimRewards(uint256 genericType) public {
    ...
    totalRewards += (block.timestamp - apeStartFarmingTimestamp[addressToApesType[sender][genericType][totalApesByType - 1]])
    ...
    apesInstance.setDeltaStack(addressToApesType[sender][genericType][totalApesByType - 1], block.timestamp - apeStartFarmingTimestamp[addressToApesType[sender][genericType][totalApesByType - 1]]);
    addressToApesType[sender][genericType].pop();
    // adjust rewards
