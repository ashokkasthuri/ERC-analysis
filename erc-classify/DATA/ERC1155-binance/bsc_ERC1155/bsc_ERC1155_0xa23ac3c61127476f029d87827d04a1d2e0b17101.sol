// Chain: BSC - File: contracts/NFT/DARTHNFT.sol
...
contract BEP1155Tradable is IBEP165, Ownable {
        ...
        returns (uint256 _tokenPrice)
    {
        ...
        powers[msg.sender] = (powers[msg.sender].add(settings[tokenId].pave))
            .div(2);
...
contract DARTHNFT is BEP1155Tradable {
    using Strings for string;
    using Address for address;
    ...
    constructor(address master)
        ...
        BEP1155Tradable(
            "$DARTHNFT Token",
            "$DARTHNFT",
            "ipfs://QmVLVZmABC4NQTCuxLsRm38dZNhyKkokT83dFKV6k9JYVM/"
        )
    {
