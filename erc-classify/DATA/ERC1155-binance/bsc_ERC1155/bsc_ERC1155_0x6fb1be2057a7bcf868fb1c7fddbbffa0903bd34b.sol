...
// Chain: BSC - File: contracts/RuebushGardensDeluxe.sol
// SPDX-License-Identifier: MIT
...
contract RuebushGardensDeluxe is ERC1155 {
    string public constant name = "Ruebush Gardens Deluxe";
    string public constant symbol = "RGD";
    uint256 public constant totalSupply = 100;

    constructor() ERC1155("ipfs://bafybeiellelwnedhrx4kyf7unwd2ehfzu3gdb7uugbiseiyf5k4i26rpzy/metadata.json") {
    ...
    function uri(uint256 tokenId) override public pure returns (string memory) {
        return "ipfs://bafybeiellelwnedhrx4kyf7unwd2ehfzu3gdb7uugbiseiyf5k4i26rpzy/metadata.json";
    }
}