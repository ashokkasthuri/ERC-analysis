// Chain: BSC - File: RumbleGo/RumbleGoNFT_ERC1155.sol
...
contract RumbleGoNFT is ERC1155, Ownable {
    string public name;
    ...
    function mintNFT(address toAddress) public onlyOwner {
        tokenIdCounter++;
        _mint(toAddress, tokenIdCounter, 1, "0x");

        emit NFTMinted(toAddress, tokenIdCounter, uri(tokenIdCounter));
    }
