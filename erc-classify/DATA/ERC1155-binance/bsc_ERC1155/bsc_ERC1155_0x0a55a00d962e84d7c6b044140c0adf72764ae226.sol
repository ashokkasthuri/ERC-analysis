// Chain: BSC - File: contracts/MultipleTransferNFT.sol
...
contract MultipleTransferNFT is ERC1155("https://jgnnft.com/api/nft1155") {

 

        function multipleTransfer(uint id, address[] memory addr) public{
                require(balanceOf(msg.sender, id) > 0, "NFT not found in this account");

                for(uint i=0; i<addr.length; i++){
                        safeTransferFrom(msg.sender, addr[i], id, 1, "");
                }
