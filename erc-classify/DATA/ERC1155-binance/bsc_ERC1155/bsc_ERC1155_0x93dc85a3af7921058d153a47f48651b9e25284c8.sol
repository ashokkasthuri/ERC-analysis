...
contract ABRANFT is ERC1155Tradable {
    constructor(address _proxyRegistryAddress) public ERC1155Tradable("ABRA NFT", "ABRANFT", _proxyRegistryAddress) {
        _setBaseMetadataURI("http://api.saffroncity.tech/");
    }
