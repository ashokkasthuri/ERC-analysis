 ...
 */
contract ERC1155Tradable is ERC1155, ERC1155MintBurn, ERC1155Metadata, Ownable, MinterRole, WhitelistAdminRole, IERC2981 {
  ...
  event DefultRoyaltyChanged(uint256 _royalty);
    ...
    _royaltyInfos[_id].creator = msg.sender;
  ...
  function royaltyInfo(uint256 _id) external view returns (address receiver, uint256 amount) {
...
contract ERC1155Token is ERC1155Tradable {
	...
	constructor() public ERC1155Tradable("ScRaTcH_P", "ScRaTcH_P") {
		_setBaseMetadataURI("https://raw.githubusercontent.com/nft-artist/nft/master/rapper/");
	}
