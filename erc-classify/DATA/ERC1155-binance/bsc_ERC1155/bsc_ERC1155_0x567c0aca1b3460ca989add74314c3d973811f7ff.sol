// Chain: BSC - File: contracts/token/ERC1155/ERC1155Burn.sol
...
contract ERC1155Burn is Ownable, ERC1155, ERC1155Burnable {
  ...
  constructor(
    ...
    require(_owner != address(0), "ERC1155: address is not zero");
    ...
    if (
      ...
      _mintToken(_owner, 0, amount, metadata);
    }
  }
  ...
  function mint(
    ...
    return _mintToken(owner_, id, amount, metadataURI);
  }
