...
contract Ticket is ERC1155 {
    ...
    function mintTicket(address _to, uint256 _amount) public {
        require(msg.sender == owner, "Only owner can mint tickets");
        _mint(_to, 0, _amount, "");
    }

    function mintMultipleTickets(address[] memory _to, uint256 _amount) public {
        for (uint256 i = 0; i < _to.length; ++i) {
            mintTicket(_to[i], _amount);
        }
    }
}
