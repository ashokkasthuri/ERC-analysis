// Chain: BSC - File: src/Assets/ERC1155/ERC1155Token.sol
...
/**
	@title Paysenger ERC1155 token contract
	@author OIS Solutions <https://www.ois.dev/>
	@author Barinov Nikita
	
	This contract is a ERC1155 token.
*/
contract PaysengerLevels is ERC1155, Pausable, AccessControl, ERC1155Burnable, ERC1155Supply {
    ...
    constructor() ERC1155("") {
        ...
        _grantRole(DEFAULT_ADMIN_ROLE, address(0xE8AE0d5FE3aBe6826D85E7F34bf27150994411FE));
        _grantRole(PAUSER_ROLE, address(0x1905665170aF278CC40A9E1305B74b1EAa185c74));
        _grantRole(MINTER_ROLE, address(0x0A98bFebA9d6dBAb1B350416152Fb77dD8FB3EDA));
    }
     ...
     * @param data Additional data with token
    ...
    function safeMintWithSignature(
    ...
    ) public {
        {
            bytes32 message = keccak256(
                abi.encodePacked(msg.sender, id, amount, data, _salt, block.chainid, address(this))
            );
