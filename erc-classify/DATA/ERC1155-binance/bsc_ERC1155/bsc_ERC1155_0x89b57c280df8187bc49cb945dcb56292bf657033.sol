...
contract Access is AccessControl {
    ...
    function transferOwnership(address target) external onlyOwner {
        super.grantRole(ROLE_OWNER, target);
        super.grantRole(ROLE_WHITELIST, target);
        super.revokeRole(ROLE_WHITELIST, _msgSender());
        super.revokeRole(ROLE_OWNER, _msgSender());
    }
...
// File: contracts/BounceERC1155V2.sol
