// Chain: BSC - File: @nfts2me/contracts/important/README.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
...
// Chain: BSC - File: @nfts2me/contracts/interfaces/IN2M_ERCBase.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: @nfts2me/contracts/interfaces/IN2M_ERCStorage.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: @nfts2me/contracts/interfaces/IN2MBeaconFactory.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: @nfts2me/contracts/interfaces/IN2MCrossFactory.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: @nfts2me/contracts/interfaces/IOperatorFilterRegistry.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: @nfts2me/contracts/ownable/NFTOwnableUpgradeable.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: @openzeppelin/contracts-upgradeable/governance/utils/IVotesUpgradeable.sol
...
// Chain: BSC - File: @openzeppelin/contracts-upgradeable/governance/utils/VotesUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @openzeppelin/contracts-upgradeable/token/ERC721/extensions/ERC721URIStorageUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @openzeppelin/contracts-upgradeable/token/ERC721/extensions/ERC721VotesUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @openzeppelin/contracts-upgradeable/utils/CheckpointsUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @openzeppelin/contracts-upgradeable/utils/math/SafeCastUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @openzeppelin/contracts/governance/utils/IVotes.sol
// SPDX-License-Identifier: MIT
// OpenZeppelin Contracts (last updated v4.5.0) (governance/utils/IVotes.sol)
pragma solidity ^0.8.0;
...
// Chain: BSC - File: contracts/beacon/N2MERC1155Upgradeable.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: contracts/beacon/N2MERC721Upgradeable.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: contracts/beacon/N2MUpgradeable.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: contracts/interfaces/IN2M_ERCBase.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: contracts/interfaces/IN2M_ERCCommon.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: contracts/interfaces/IN2M_ERCLibrary.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: contracts/interfaces/IN2M_ERCStorage.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: contracts/interfaces/IN2MBeaconFactory.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: contracts/interfaces/IN2MCrossFactory.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: contracts/interfaces/IN2MERC1155.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: contracts/interfaces/IN2MERC721.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: contracts/interfaces/IOperatorFilterRegistry.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: contracts/interfaces/IReverseRegistrar.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: contracts/N2MCommonStorage.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: contracts/N2MERC1155.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: contracts/N2MERC721.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: contracts/N2MTokenCommon.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: contracts/N2MVersion.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: contracts/ownable/NFTOwnableUpgradeable.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// Chain: BSC - File: contracts/TextUtils.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
