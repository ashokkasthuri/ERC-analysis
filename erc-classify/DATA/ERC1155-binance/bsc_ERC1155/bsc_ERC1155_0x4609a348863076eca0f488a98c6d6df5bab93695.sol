// Chain: BSC - File: contracts/MysteryBox.sol
...
contract NFTPMysteryBox is ERC1155, ReentrancyGuard, Ownable {
    ...
    event RevealRequest(address owner, uint256 collectionId, uint256 amount, uint256 nonceOffset);
    ...
    */
    function revealFulfill(address account, uint256 id, uint256 amount, uint256 seed) external onlyAdmin {
        require(balanceOf(account, id) >= amount, "Not enough MysteryBoxes");

        for(uint256 i=0; i<amount; i++) {
            _reveal(account, id, _random(account, seed * i));
        }
    }
    ...
    */
    function reveal(uint256 id, uint256 amount) external {
        ...
        emit RevealRequest(msg.sender, id, amount, nonceCounter);
    }
    ...
    */
    ...
    /**
    * @notice Executes the reveal of a MysteryBox and mints the final NFT
    * @param account box owner and NFT receiver
    * @param id collection id
    * @param rand random number to generate rarity and photo ID
    */
    ...
    */
    function _random(address from, uint256 seed) internal view returns (uint256){
        return uint256(keccak256(abi.encodePacked(block.difficulty, block.timestamp, blockhash(block.number + 2), from, seed)));
    }
...
// Chain: BSC - File: contracts/NFTPussies.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
contract PussiesNFT is IPussiesNFT, IERC721, ERC721Enumerable, Ownable {
...
// Chain: BSC - File: contracts/IPrices.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
// Chain: BSC - File: @openzeppelin/contracts/token/ERC721/extensions/ERC721Enumerable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @openzeppelin/contracts/token/ERC721/extensions/IERC721Enumerable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @openzeppelin/contracts/interfaces/IERC165.sol
// SPDX-License-Identifier: MIT
