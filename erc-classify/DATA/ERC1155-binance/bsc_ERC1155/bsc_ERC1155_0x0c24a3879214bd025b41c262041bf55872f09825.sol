...
contract NfterriumNomad is Initializable, ERC1155Upgradeable, IERC2981Upgradeable, AccessControlUpgradeable, PausableUpgradeable, ERC1155BurnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC1155_init("https://nfterrium.com/nomad/{id}.json");
    ...
    function mintNomad(address _wallet) public onlyRole(MINTER_ROLE) {
        mint(_wallet, totalSupply, 1, "");
        tokenOwners[_wallet].push(totalSupply);
        totalSupply += 1;
    }
