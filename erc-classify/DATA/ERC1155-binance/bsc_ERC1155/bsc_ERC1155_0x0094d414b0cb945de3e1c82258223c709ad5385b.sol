// Chain: BSC - File: /contracts/NFT1155_Peice_11.sol
...
contract EggPiecesCBS11 is ERC1155, AccessControl, Pausable, ERC1155Supply {
    ...
    uint256 public constant EGG_PEICES = 11;
    uint256[] public tokenIDs=[EGG_PEICES];
    constructor() ERC1155("https://nft.cowboysnake.com/nep/metadata/{id}.json") {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(URI_SETTER_ROLE, msg.sender);
        _grantRole(PAUSER_ROLE, msg.sender);
        _grantRole(MINTER_ROLE, msg.sender);
        _name = "NFT Egg Pieces 11";
        _symbol = "NEP11";
