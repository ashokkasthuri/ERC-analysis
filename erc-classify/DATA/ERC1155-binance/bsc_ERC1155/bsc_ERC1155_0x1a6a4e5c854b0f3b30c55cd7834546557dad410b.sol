...
// Chain: BSC - File: contracts/tokens/extensions/ERC1155JrscGameUpgradeable.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
contract ERC1155JrscGameUpgradeable is ERC1155Upgradeable, ERC1155JrscCollectableUpgradeable {
    ...
    function hunt(uint256[] calldata sauriaIds, uint8 enemyId) external {
        ...
        if (lotteryResult <= uint8(COMBAT_LUCK[enemyId])){
            ...
            REWARDS_MANAGER.RecordReward(msg.sender, uint8(COMBAT_REWARD[enemyId]) * 1 ether );
        } else {
            // LOST
...
// Chain: BSC - File: contracts/tokens/extensions/JurassicConstants.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
