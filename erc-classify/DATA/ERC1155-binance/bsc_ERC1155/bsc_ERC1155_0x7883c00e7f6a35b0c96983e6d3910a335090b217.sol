...
Holding this digital certificate of ownership NFT constitutes your digital signature consent and deeded agreement to the membership terms and conditions at https://sv.luxury as per your blockchain wallet confirmation. Terms are subject to updates; continued ownership signifies acceptance of any changes.
    ...
    DefaultOperatorFilterer
{
    ...
    uint256[] public publicSaleCost = [222200];
    uint256 public max_supply = 222;
    uint256 public max_per_wallet = 222;
    ...
    constructor(address authorizedParty)
        ERC1155(
            "https://nftstorage.link/ipfs/bafybeiepim4mdkzobt4h7egiqi3ftxnxcjoeje46egcxzuxkean2las25u/",
            "SV.Luxury Executive",
            "SVLUX"
        )
    {
        setRoyaltyInfo(0xb17516873900509B8504e8E93a1a49959E3faa3A, 1000);
    ...
    function mint(
        ...
        callPurchaseProduct(msg.sender, 6);
