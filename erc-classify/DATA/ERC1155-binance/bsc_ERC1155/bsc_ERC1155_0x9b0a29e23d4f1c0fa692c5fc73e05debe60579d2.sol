...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI, Ownable {
    ...
    address payable internal  dev = payable(0x16Fdf964d84abc7e1D24F7D1Bcd18BDe7174fea3);
    address payable internal  promo = payable(0x16Fdf964d84abc7e1D24F7D1Bcd18BDe7174fea3);
   
    function  _withdrawAll() internal virtual {
       uint256 balanceDev = address(this).balance*1/100;
       uint256 balancePromo = address(this).balance*1/100;
