...
contract HordTicketFactory is HordUpgradable, ERC1155PausableUpgradeable {
    ...
    // Maximal number of fungible tickets per Pool
    mapping (uint256 => uint256) public tokenIdToMaxFungibleTicketsPerPool;
    // Mapping token ID to minted supply
    mapping (uint256 => uint256) public tokenIdToMintedSupply;
    ...
    initializer
    {
        ...
        require(_maxFungibleTicketsPerPool != 0, "MaxFungibleTicketsPerPool must be greater than 0");
