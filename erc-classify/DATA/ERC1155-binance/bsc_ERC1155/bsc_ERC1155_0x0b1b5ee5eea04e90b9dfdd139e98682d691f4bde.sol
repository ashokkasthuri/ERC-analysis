// Chain: BSC - File: /contracts/TrueNFT.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
import "@openzeppelin/contracts/token/ERC1155/presets/ERC1155PresetMinterPauser.sol";
contract TrueNFT is ERC1155PresetMinterPauser {
    constructor() ERC1155PresetMinterPauser("http://nft.szqishikeji.com/item/{id}")  {
        uint256 CARD = 0;
        uint256 premint = 20000;

        mint(_msgSender(),CARD,premint,"");
    }
