...
// Chain: BSC - File: contracts/commons/EarlyBird.sol
// SPDX-License-Identifier: MIT
...
abstract contract EarlyBird is IEarlyBird {
    ...
    bool public earlyBirdRound = false;
...
// Chain: BSC - File: contracts/commons/ExternalEarlyBird.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.4;
...
abstract contract ExternalEarlyBird {
    ...
    address public constant earlyBird = 0x50c69647aA9D2Ab9E0686Ab5FDDD2Ab45843D1Dc;
...
// Chain: BSC - File: contracts/interface/ISoulBoundPen.sol
//SPDX-License-Identifier: MIT
pragma solidity ^0.8.4;
...
// Chain: BSC - File: contracts/v2/SoulBoundPen.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.4;
...
import "../commons/ExternalEarlyBird.sol";
import "../interface/ISoulBoundPen.sol";
...
contract SoulBoundPen is ISoulBoundPen, Initializable, UUPSUpgradeable, ERC1155Upgradeable, PausableUpgradeable, AccessControlUpgradeable, ReentrancyGuardUpgradeable, ExternalEarlyBird {
    ...
    function mint(uint256 id_) external override callerIsUser nonReentrant whenNotPaused onlyEarlyBird {
        ...
        IERC20(usdt).safeTransferFrom(msg.sender, address(this), levelPrice[id_]);
    ...
    function upgrade(uint256 next_) external override callerIsUser nonReentrant whenNotPaused onlyEarlyBird {
        ...
        IERC20(usdt).safeTransferFrom(msg.sender, address(this), price);
