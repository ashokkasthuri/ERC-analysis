...
// Chain: BSC - File: contracts/common/meta-transactions/ContentMixin.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: contracts/common/meta-transactions/EIP712Base.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: contracts/common/meta-transactions/Initializable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: contracts/common/meta-transactions/NativeMetaTransaction.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: contracts/Factory.sol
// SPDX-License-Identifier: MIT
...
contract Factory is ERC1155, Ownable, ERC1155Burnable, ERC1155Supply, ContextMixin, NativeMetaTransaction {
    ...
    constructor(address router) ERC1155("https://firefoxesport.net/option/{id}.json") {
        _router = router;
    }
