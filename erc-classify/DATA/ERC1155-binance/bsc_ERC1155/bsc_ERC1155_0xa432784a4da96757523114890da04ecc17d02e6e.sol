// Chain: BSC - File: MintywayERC1155.sol
...
contract MintywayERC1155Token is Ownable, ERC1155, IMintywayRoyalty {
    ...
    function mint(
        ...
        require(msg.value >= _mintPrice, "CollectionToken: mint costs 0.001 BNB");
        require(
            nonces[_nonce] == false,
...
// Chain: BSC - File: IMintywayRoyalty.sol
// SPDX-License-Identifier: UNLICENSED
