// File: Contracts\1155nft\SafeMath.sol
...
// File: Contracts\1155nft\IERC165.sol
...
// File: Contracts\1155nft\IERC1155.sol
...
interface IERC1155 is IERC165 {
     ...
     * `approved`.
     */
    event ApprovalForId(address indexed account, address indexed operator, uint256 id, uint256 amount);
    /**
     * @dev Emitted when `account` grants or revokes permission to `operator` to transfer their tokens, according to
     * `approved`.
     */
    ...
    /**
     * @dev Returns the amount of ids owned by `account`.
     *
     * Requirements:
     *
     * - `account` cannot be the zero address.
     */
    function holderTokenIds(address account) external view returns (uint256);
    ...
    /**
     * @dev Returns the amount of tokens of token type `id` allow `spender` by owner.
     *
     * Requirements:
     *
     * - `operator` cannot be the zero address.
     */
    function allowance(address owner, address operator, uint256 id) external view returns (uint256);
...
// File: Contracts\1155nft\IERC1155Receiver.sol
...
// File: Contracts\1155nft\IERC1155MetadataURI.sol
...
// File: Contracts\1155nft\Address.sol
...
// File: Contracts\1155nft\Context.sol
...
// File: Contracts\1155nft\ERC165.sol
...
// File: Contracts\1155nft\EnumerableSet.sol
...
// File: Contracts\1155nft\ERC1155.sol
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    // Mapping from token ID to approved amount for address 
    ...
    function tokenIdOfOwnerByIndex(address owner, uint256 index) public view override returns (uint256) {
    ...
    function holderTokenIds(address account) public view override returns (uint256) {
        require(account != address(0), "ERC1155: balance query for the zero address");
        return _holderTokens[account].length();
    }

    /**
     * @dev {IERC1155-allowance}.
     *
     * Requirements:
     *
     * - `account` cannot be the zero address.
     */
    function allowance(address owner, address operator, uint256 id) public view virtual override returns (uint256) {
        require(owner != address(0) && operator != address(0), "ERC1155: allowance query for the zero address");
        return _allowances[owner][operator][id];
    }
    ...
    function approve(address operator, uint256 id, uint256 amount) public virtual override {
        ...
        _allowances[_msgSender()][operator][id] = amount;
        emit ApprovalForId(_msgSender(), operator, id, amount);
    }
    ...
    function _mint(
        ...
        if (_balances[id][account] == 0) {
            _holderTokens[account].addSet(id);
        }
    ...
    function _mintBatch(
        ...
        for (uint256 i = 0; i < ids.length; i++) {
            if (_balances[ids[i]][to] == 0) {
                _holderTokens[to].addSet(ids[i]);
            }
...
// File: Contracts\1155nft\ERC1155Supply.sol
...
// File: Contracts\1155nft\Ownable.sol
...
// File: Contracts\1155nft\MinterRole.sol
...
// File: Contracts\1155nft\Game1155.sol

// contracts/GameItems.sol
pragma solidity ^0.8.0;
contract Game1155 is ERC1155Supply, MinterRole {
     ...
     * @dev Mint NFTs. Only the  minter can call it.
     */
    function batchMintCheck(uint256[] memory tokenIds, uint256[] memory amounts) view internal returns(bool, uint256, string memory) {
