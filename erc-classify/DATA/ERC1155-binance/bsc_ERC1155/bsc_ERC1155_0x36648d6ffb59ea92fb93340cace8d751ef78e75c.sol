// Chain: BSC - File: StarNFTNaiveFactory.sol
/*
...
contract StarNFTNaiveFactory {
    ...
    /* ============ Constructor ============ */
    constructor(address _contract_manager, address _treasury_manager, string memory _base_uri) {
