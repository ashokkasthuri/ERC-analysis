// Chain: BSC - File: contracts/ItemFacet.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;

import {ERC1155} from "./abstract/ERC1155.sol";
import {IERC1155} from "./interfaces/IERC1155.sol";
import {Ownable} from "./abstract/Ownable.sol";

contract ItemFacet is ERC1155, Ownable {

    address payable private _owner;

    constructor() ERC1155("https://dwriterss.io/api/{id}.json") {
    ...
    function ItemAccess() public onlyOwner {
    ...
    function mint(address to, uint256 id, uint256 amount, bytes memory data) public isAllowed {
        _mint(to, id, amount, data);
    }

    function burn(address from, uint256 id, uint256 amount) public isAllowed {
        _burn(from, id, amount);
    }

    function setApprovalForAll(address from, bool approved) public override virtual isAllowed {
        _setApprovalForAll(from, address(this), approved);
    }

    function isApprovedForAll(address account) public view virtual returns (bool) {
        return isApprovedForAll(account, address(this));
    }

    function safeTransferFrom(address from, address to, uint256 id, uint256 amount, bytes memory data) public virtual override isAllowed {
        require(
    ...
    function safeBatchTransferFrom(
        ...
        bytes calldata data
    ) public virtual override isAllowed {
        // require(false, "Not use this");
    }

}

// Chain: BSC - File: contracts/abstract/ERC1155.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: contracts/abstract/Ownable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: contracts/interfaces/IERC1155Receiver.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: contracts/interfaces/IERC1155MetadataURI.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: contracts/abstract/ERC165.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: contracts/interfaces/IERC165.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
