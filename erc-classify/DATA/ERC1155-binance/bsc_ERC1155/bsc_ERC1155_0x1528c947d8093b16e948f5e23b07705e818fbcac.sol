...
contract Nft1155 is Context, AccessControlEnumerable, ERC1155Burnable {
    ...
    function updateTokenURI(uint256 tokenId, string memory uri) public {
        require(
            ...
            "Nft1155: must have default admin role to updateTokenURI"
        );
        _setURI(tokenId, uri);
    }
    ...
    function mint(
        ...
        require(
            ...
            "Nft1155: must have minter role to mint"
        );
    ...
    function mintBatch(
        ...
        require(
            ...
            "Nft1155: ids and uris length mismatch"
        );
...
// Chain: BSC - File: contracts/IERC1155Burnable.sol
...
// Chain: BSC - File: contracts/IERC1155Mintable.sol
