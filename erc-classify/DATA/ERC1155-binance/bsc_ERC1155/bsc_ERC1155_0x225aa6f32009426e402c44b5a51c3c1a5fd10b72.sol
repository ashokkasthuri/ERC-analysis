...
interface MARKETRUNEInterface {
    ...
    function changeCodeMap(uint256, string calldata) external view returns (bool);
}

contract MARKETRUNE is ERC1155, Ownable,ReentrancyGuard {
