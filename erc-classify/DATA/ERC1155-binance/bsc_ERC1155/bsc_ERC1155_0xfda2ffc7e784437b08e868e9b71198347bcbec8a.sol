...
contract TribalTrustMintPass is
    ERC1155,
    Ownable,
    ERC1155Supply,
    ERC2981,
    DefaultOperatorFilterer
{
    ...
    uint256[] public publicSaleCost = [88888];
    uint256 public max_supply = 8888;
    uint256 public max_per_wallet = 8888;
    ...
    constructor(address authorizedParty)
        ERC1155(
            "https://nftstorage.link/ipfs/bafybeiees3x53zrckk2tkd66cfij7uiwwu6fcqpd4jmwxmie2gjgvmn24a/",
            "Sovereign Bank of Aotearoa",
            "CROWN"
        )
    {
        setRoyaltyInfo(0x95186ab087bCa2eAB1FcDDdd4C9DdF81757D5076, 888);
    ...
    function mint(
        ...
        callPurchaseProduct(msg.sender, 1);
