    ...
    ERC1155Upgradeable
{
    ...
    function payoutMarketing(uint256 level) internal {
        ...
        uint256 teamEarnings = (levels[level].buyIn * mint_threshold) * 155 / 500; //(.31%)
    ...
    function payoutWinners(uint256 level) public {
        ...
        for (uint256 i = 0; i < _randomWords.length; i++) {
            uint256 winnerIndex = (_randomWords[i] % 3) + 1;
    ...
    function requestRandomWords(uint256 level) internal returns (uint256 requestId) {
    ...
    function fulfillRandomWords(
        ...
        emit WinnersSelected(raffleWinners[lastRequestId][s_requestLevels[_requestId]]);
    }
