...
// Source: 0x437b846d29cc094d42d1ce501b589c62203e91b9
// Contract Name: GoldpayCoin
// This is a flattened version of all source files
// Generated on: 2026-05-06 13:21:35
...
================================================================================
// FILE: contracts/GoldpayCoin.sol
================================================================================
...
contract GoldpayCoin is Initializable, UUPSUpgradeable, ERC20PermitUpgradeable, OwnableUpgradeable, WithBlockedList {
    ...
    function mint(address _destination, uint256 _amount) public onlyOwner {
        require(ERC20Upgradeable.totalSupply() + _amount <= cap(), "ERC20Capped: cap exceeded");
