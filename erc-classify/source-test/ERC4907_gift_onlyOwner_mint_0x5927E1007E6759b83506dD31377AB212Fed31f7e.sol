 ...
 * @notice This contract handles minting Charm Origins : Linda tokens.
 */
contract CharmOriginsLinda is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    uint256 public PRESALE_MAX_SUPPLY = 9639;
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC721A("Charm Origins : Linda", "CHARM")
        RevokableOperatorFilterer(
        ...
        onlyOwner
    {
        ...
        //Ashok- Should the recievers approval is not needed before gift ?
