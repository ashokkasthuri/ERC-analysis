// File: contracts/Gallery_x_TeamBreakThru.sol
...
contract Gallery_x_TeamBreakThru is ERC1155Burnable, Ownable, DefaultOperatorFilterer {
    string public name = "Gallery_x_TeamBreakThru";
    string public symbol = "GTBT";
    string public contractUri = "https://gallery.teambreakthru.net/contract";
    ...
    constructor() ERC1155("https://gallery.teambreakthru.net/metadata/token_{id}") {
        idTracker.increment();
    }
