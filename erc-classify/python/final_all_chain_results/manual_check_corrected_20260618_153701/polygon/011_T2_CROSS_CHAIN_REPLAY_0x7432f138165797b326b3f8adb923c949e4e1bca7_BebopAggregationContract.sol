...
// Address: 0x7432f138165797b326b3f8adb923c949e4e1bca7
// Contract Name: BebopAggregationContract
...
// ============================================================
// FILE: src/contracts/bebop_aggregation_contract.sol
// ============================================================
// SPDX-License-Identifier: MIT
...
contract BebopAggregationContract is IBebopAggregationContract {
    ...
    function validateMakerSignature(
        ...
        if (signature.signatureType == SignatureType.EIP712) {
            ...
            require(IERC1271(signature.walletAddress).isValidSignature(hash, signature.signatureBytes) == EIP1271_MAGICVALUE, "Invalid Maker EIP 1271 Signature");
    ...
    function assertAndInvalidateAggregateOrder(
        ...
        require(msg.sender != taker, "Taker can't submit order");
...
// ============================================================
// FILE: src/contracts/interface/bebop_aggregation_contract.sol
// ============================================================
// SPDX-License-Identifier: MIT
...
// ============================================================
// FILE: src/contracts/token/Address.sol
// ============================================================
// SPDX-License-Identifier: MIT
...
// ============================================================
// FILE: src/contracts/token/ERC20/draft-IERC20Permit.sol
// ============================================================
// SPDX-License-Identifier: MIT
...
// ============================================================
// FILE: src/contracts/token/ERC20/IERC20.sol
// ============================================================
// SPDX-License-Identifier: MIT
...
// ============================================================
// FILE: src/contracts/token/ERC20/SafeER20.sol
// ============================================================
pragma solidity ^0.8.0;
