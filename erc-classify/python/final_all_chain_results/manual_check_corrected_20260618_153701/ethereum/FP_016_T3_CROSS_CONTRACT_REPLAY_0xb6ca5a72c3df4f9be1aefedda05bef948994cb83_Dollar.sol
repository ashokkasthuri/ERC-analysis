...
// Address: 0xb6ca5a72c3df4f9be1aefedda05bef948994cb83
// Contract Name: Dollar
...
/*
    Copyright 2019 dYdX Trading Inc.
    Copyright 2020 Active Set Dollar Finance
...
library Constants {
    ...
    uint256 private constant BOOTSTRAPPING_PRICE = 124e16; // 1.24 USDC
    ...
    /* Bonding */
    uint256 private constant INITIAL_STAKE_MULTIPLE = 1e6; // 100 ASD -> 100M ASDS
    ...
    uint256 private constant EPOCH_START = 1609444800;
    ...
    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE = 5e18; // 10 ASD for reward
    ...
    address private constant TREASURY_ADDRESS = address(0x77441D0C50dEbc923c66a6f88C12eF06A42317E9);
...
contract Dollar is IDollar, MinterRole, ERC20Detailed, Permittable, ERC20Burnable  {
    ...
    constructor()
    ERC20Detailed("Active Set Dollar Finance", "ASD", 18)
    Permittable()
    public
    { }
