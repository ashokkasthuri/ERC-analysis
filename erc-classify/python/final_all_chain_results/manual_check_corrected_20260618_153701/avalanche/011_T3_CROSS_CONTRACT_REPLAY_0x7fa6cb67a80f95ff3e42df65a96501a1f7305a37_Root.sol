...
// Address: 0x7fa6cb67a80f95ff3e42df65a96501a1f7305a37
// Contract Name: Root
...
contract Root is UpgradeabilityProxy {
    ...
    {
        // Separate out contract size
        // Create the dollar, oracle, and pool
        address _dollar = address(new Dollar());

        Oracle _oracle = new Oracle(_dollar);
        _oracle.setup();
        _oracle.capture();

        address _pool = address(
            new Pool(address(this), _dollar, _oracle.curvePool())
        );
...
// ============================================================
// FILE: ./contracts/interface/IUSDC.sol
// ============================================================
/*
    Copyright 2020 Empty Set Squad <emptysetsquad@protonmail.com>
...
// ============================================================
// FILE: ./contracts/interface/IDollar.sol
// ============================================================
/*
    Copyright 2020 Empty Set Squad <emptysetsquad@protonmail.com>
...
// ============================================================
// FILE: ./contracts/pool/PoolSetters.sol
// ============================================================
/*
    Copyright 2020 Empty Set Squad <emptysetsquad@protonmail.com>
...
// ============================================================
// FILE: ./contracts/pool/PoolState.sol
// ============================================================
/*
    Copyright 2020 Empty Set Squad <emptysetsquad@protonmail.com>
...
// ============================================================
// FILE: ./contracts/pool/PoolGetters.sol
// ============================================================
/*
    Copyright 2020 Empty Set Squad <emptysetsquad@protonmail.com>
...
// ============================================================
// FILE: ./contracts/pool/Liquidity.sol
// ============================================================
/*
    Copyright 2020 Empty Set Squad <emptysetsquad@protonmail.com>
