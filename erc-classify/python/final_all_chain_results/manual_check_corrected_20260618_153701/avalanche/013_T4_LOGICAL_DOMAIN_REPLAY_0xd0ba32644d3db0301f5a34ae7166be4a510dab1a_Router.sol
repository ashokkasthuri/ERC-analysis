...
// Address: 0xd0ba32644d3db0301f5a34ae7166be4a510dab1a
...
// ============================================================
// FILE: contracts/proxy/FlakeRouter.sol
// ============================================================
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;
...
library _Address {
    ...
    function functionDelegateCall(address target, bytes memory data) internal returns (bytes memory) {
        require(isContract(target), "delegatecall to non-contract");
...
contract FlakeRouter {
    ...
    function _admin() internal view returns (address) {
        return _StorageSlot.getAddressSlot(_ADMIN_SLOT).value;
    }

    function _setAdmin(address newAdmin) internal {
        _StorageSlot.getAddressSlot(_ADMIN_SLOT).value = newAdmin;
    }

    function _implementation() internal view returns (address) {
        return _StorageSlot.getAddressSlot(_IMPLEMENTATION_SLOT).value;
    }

    function _setImplementation(address newImplementation) internal {
        require(_Address.isContract(newImplementation), "impl !contract");
        _StorageSlot.getAddressSlot(_IMPLEMENTATION_SLOT).value = newImplementation;
    }
    ...
    function _upgradeToAndCall(address newImplementation, bytes memory data) internal {
        ...
        if (data.length > 0) {
            _Address.functionDelegateCall(newImplementation, data);
        }
    }
...
contract Router is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function executeSwap(
        ...
        _executeSwapInternal(_target, _data, _tokenIn, _tokenOut, _amountIn, emptySweep);
    }
    ...
    function executeSwapAdvanced(
        ...
        _executeSwapInternal(_target, _data, _tokenIn, _tokenOut, _amountIn, _extraSweepTokens);
    }
    ...
    function _executeInternal(
        ...
        require(_target == _targetAddress(), "Target not allowed");
        if (_tokenIn != address(0)) {
        ...
        require(success, string(abi.encodePacked("Swap Call Failed: ", returnData)));
        ...
        if (ethBalanceAfter > _exec.ethBalanceBefore) {
            uint256 ethDelta = ethBalanceAfter - _exec.ethBalanceBefore;
        ...
        if (_tokenOut != address(0) && _tokenOut != _tokenIn && _isContract(_tokenOut)) {
            ...
            if (tokenOutBalanceAfter > _exec.tokenOutBalanceBefore) {
                uint256 tokenOutDelta = tokenOutBalanceAfter - _exec.tokenOutBalanceBefore;
        ...
        emit SwapExecuted(msg.sender, _tokenIn, _tokenOut, _amountIn);
    }
