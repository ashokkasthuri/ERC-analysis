// Chain: AVALANCHE - File: contracts/Legitimate1155NFTDistribution.sol
...
contract Legitimate1155NFTDistribution is ERC1155, AccessControl {
    ...
    string public name = "0n1ForceJP x monsta 381 PoM";

    // METADATA
    string public nftTitle = "Proof-of-Meet : 0N1FORCE x monsta 381"; // Title of the NFT collection
    string public nftDescription = "What is Proof-of-Meet? Now that you have owned the Digital Tshirt, it\'s time to physically interact by giving verifiable credentials meaning your friend met you, at this time this place. You will also be able to contribute to the community by wearing this Digital Tshirt, wherever and whenever. All you need to do is wear the Digital Tshirt and let your friends tap the name tag(NFC) with your cell phone.\nA TAP TO DIVE INTO ANOTHER DIGITAL"; // Description in string or markdown format
    string public nftAnimationUri = ""; // IPFS or HTTP URL
    string public nftImageUri = "https://ipfs.legitimate.tech/ipfs/Qmc4QxdXmnKwDZoGFSy9m22E2QNDWKGfYF2YBxzQyYe8NZ"; // IPFS or HTTP URL
...
// Chain: AVALANCHE - File: @openzeppelin/contracts/utils/Base64.sol
