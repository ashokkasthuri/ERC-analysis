...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x0Bd488DfF5A3069A9446234Ba00938395B93ae6F];
...
// File: contracts/X5000Web3BoxairdropContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract X5000Web3BoxairdropContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "5000 WEB3BOX AIR DROP";
    string public symbol = "5000 USDT";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/kpbwN3bx00dVhwjqV5mX/contract-metadata";
  }
