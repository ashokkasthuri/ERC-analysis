 ...
 */
contract TokenReceipt is Context, ERC165, IERC1155, IERC1155MetadataURI {
    using Address for address;

    address public constant VAULT_ADDRESS = 0x9Fa1EC982790743623681a19956BA9ddcf3C0EC6;
    address public constant UNDERLYING_NFT_ADDRESS = 0x86935F11C86623deC8a25696E1C19a8659CbF95d;
    string public constant NAME = "Gotchi Vault Deposits Gotchis";
    string public constant SYMBOL = "GVDG";
    ...
    modifier onlyVault{
        require(msg.sender == VAULT_ADDRESS, "only Vault may call");
        _;
    }
    ...
    function uri(uint256 _tokenId) public view virtual override returns (string memory) {
        return IERC721Metadata(UNDERLYING_NFT_ADDRESS).tokenURI(_tokenId);
    }
    ...
    function isApprovedForAll(address account, address operator) public view virtual override returns (bool) {
        ...
        return (_operatorApprovals[account][operator]) || (msg.sender == VAULT_ADDRESS);
    }
