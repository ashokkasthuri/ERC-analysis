...
// Chain: POLYGON - File: contracts/interfaces/IDiamondCut.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: contracts/interfaces/INusaMarketplace.sol
...
// Chain: POLYGON - File: contracts/interfaces/IPlatformFee.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: contracts/interfaces/ISignatureMintERC1155.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: contracts/interfaces/IWETH.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: contracts/libraries/LibAppStorage.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.11;
...
// Chain: POLYGON - File: contracts/libraries/LibCurrencyTransfer.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.11;
...
// Chain: POLYGON - File: contracts/libraries/LibDiamond.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: contracts/libraries/LibMeta.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.11;
...
// Chain: POLYGON - File: contracts/NusaNFT.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.11;
    ...
    SignatureMintERC1155Upgradeable
{
    ...
    */
    ...
    function batchCreate(
        ...
        uint256 _qty,
        string[] memory _uris
    ) external onlyMintersOrOwner {
        require(_qty <= 500, "NusaNFT#batchCreate: QTY_EXCEEDS_LIMIT");
        require(_qty == _uris.length, "NusaNFT#batchCreate: INVALID_QTY");

        uint256 startTokenId = nextTokenId_;
        uint256 lastTokenId;
        for (uint256 i = 0; i < _qty; i++) {
            _creators[nextTokenId_] = _to;
            _setURI(nextTokenId_, _uris[i]);
            lastTokenId = nextTokenId_;

            nextTokenId_ += 1;
        }
        
        emit TokenBatchCreated(startTokenId, lastTokenId);
    }
        ...
        returns (address signer)
    {
        ...
        if (_req.tokenId == type(uint256).max || _req.tokenId == nextIdToMint) {
            tokenIdToMint = nextIdToMint;
    ...
    function _canSignMintRequest(address _signer) internal view virtual returns (bool) {
        return hasRole(ADMIN_SIGNER_ROLE, _signer) || _signer == owner();
    }
    ...
    function registerVoucher(uint256 _tokenIdStart, uint256 _tokenIdEnd, bytes32 rootHash) public onlyMintersOrOwner {
        // require(_creators[_tokenId] == msg.sender || owner() == msg.sender, "Only creator and ");
        for (uint256 i = _tokenIdStart; i <= _tokenIdEnd; i++) {
            _rootHashVoucher[i] = rootHash;
        }
    }
...
// Chain: POLYGON - File: contracts/SignatureMintERC1155Upgradeable.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
