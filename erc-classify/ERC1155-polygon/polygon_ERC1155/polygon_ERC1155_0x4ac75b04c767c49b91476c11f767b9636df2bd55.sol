...
contract Vertigos is ERC1155, Ownable {
    string public name = "Vertigos";
    string public symbol = "Vertigos";

    constructor()
        ERC1155(
            "ipfs://QmbRgeziEd8S9Qkbsd8C7CJh3jCSWsKesjGvew1bXCD3CX/{id}.json"
        )
    {}
