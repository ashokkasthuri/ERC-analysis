// Chain: POLYGON - File: contracts/Dropverse.sol
//SPDX-License-Identifier: Unlicense
pragma solidity ^0.8.0;

/// @title:  Dropverse Contract v2
/// @author: dropverse.com

import "./DropverseCreator.sol";
...
contract DropverseContractv2 is DropverseCreator 
{
    constructor(string memory name_, string memory uri_) DropverseCreator(name_, uri_) {}

    function safeTransfer(address to, uint256 id, uint256 amount, bytes memory data) public virtual 
    {
        return safeTransferFrom(_msgSender(), to, id, amount, data);
    }

    function safeBatchTransfer(address to,uint256[] memory ids, uint256[] memory amounts, bytes memory data) public virtual 
    {
        return safeBatchTransferFrom(_msgSender(), to, ids, amounts, data);
    }
} 

// Chain: POLYGON - File: contracts/DropverseCreator.sol
//SPDX-License-Identifier: Unlicense
pragma solidity ^0.8.0;

import "@openzeppelin/contracts/token/ERC1155/ERC1155.sol";
import "@manifold/access/AdminControl.sol";
import "@manifold/core/ERC1155CreatorCore.sol";
import "./NativeMetaTransaction.sol";

abstract contract DropverseCreator is AdminControl, ERC1155, ERC1155CreatorCore, ContextMixin, NativeMetaTransaction 
{
...
// Chain: POLYGON - File: @manifold/access/AdminControl.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @manifold/core/ERC1155CreatorCore.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/NativeMetaTransaction.sol
//SPDX-License-Identifier: Unlicense
pragma solidity ^0.8.0;
...
contract EIP712Base is Initializable 
{
    ...
    /**
     * Accept message hash and returns hash message in EIP712 compatible form so that it
...
// Chain: POLYGON - File: @manifold/access/IAdminControl.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @manifold/permissions/ERC1155/IERC1155CreatorMintPermissions.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @manifold/core/IERC1155CreatorCore.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @manifold/core/CreatorCore.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @manifold/extensions/ICreatorExtensionTokenURI.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @manifold/core/ICreatorCore.sol
// SPDX-License-Identifier: MIT
