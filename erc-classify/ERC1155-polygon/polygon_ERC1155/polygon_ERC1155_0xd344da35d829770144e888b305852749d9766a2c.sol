// Chain: POLYGON - File: @thirdweb-dev/contracts/base/ERC1155LazyMint.sol
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/extension/interface/IClaimableERC1155.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: @thirdweb-dev/contracts/openzeppelin-presets/security/ReentrancyGuard.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/LZMNT.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
contract LZMNT is ERC1155LazyMint, PrimarySale {
    constructor(
        address _defaultAdmin,
        string memory _name,
        string memory _symbol,
    ...
    // Override _canSetPrimarySaleRecipient function
    function _canSetPrimarySaleRecipient()
        ...
        returns (bool)
    {
        // You can implement your own logic here for who can set primary sale recipient
        // For example, only the contract owner can set the recipient
        return msg.sender == owner();
    }
}