...
// Chain: POLYGON - File: contracts/TulipArtAirdropInvite.sol
// SPDX-License-Identifier: MIT
...
contract TulipArtAirdropInvite is ERC1155, Ownable {
    using SafeMath for uint256;

    // Unique url. There is only image for the whole invitation collection
    ...
    constructor(
        ...
        address payable firstMintTo
    ) ERC1155(_metadataURI) {
        metadataURI = _metadataURI;
        name = _name;
        _mint(firstMintTo, 1, 1, "");
    }

    function batchMintAndAssign(address[] memory addresses) public onlyOwner {
        require(
