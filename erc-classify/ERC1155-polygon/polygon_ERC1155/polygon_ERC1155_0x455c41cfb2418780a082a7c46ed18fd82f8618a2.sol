// Chain: POLYGON - File: contracts/factories/Factory1155.sol
...
// Chain: POLYGON - File: contracts/factories/Factory721.sol
// SPDX-License-Identifier: None
pragma solidity =0.8.13;
...
// Chain: POLYGON - File: contracts/vaults/Vault1155.sol
// SPDX-License-Identifier: None
pragma solidity =0.8.13;
...
// Chain: POLYGON - File: contracts/interfaces/IMarket.sol
// SPDX-License-Identifier: None
pragma solidity =0.8.13;
...
// Chain: POLYGON - File: contracts/vaults/Vault721.sol
// SPDX-License-Identifier: None
pragma solidity =0.8.13;
...
// Chain: POLYGON - File: contracts/libraries/Detector.sol
// SPDX-License-Identifier: None
pragma solidity =0.8.13;
...
// Chain: POLYGON - File: contracts/wraps/Wrap721.sol
// SPDX-License-Identifier: None
pragma solidity =0.8.13;
...
// Chain: POLYGON - File: contracts/interfaces/IWrap.sol
// SPDX-License-Identifier: None
pragma solidity =0.8.13;
...
// Chain: POLYGON - File: contracts/libraries/RentaFiSVG.sol
// SPDX-License-Identifier: None
pragma solidity =0.8.13;
...
// Chain: POLYGON - File: contracts/ERC4907/IERC4907.sol
...
// Chain: POLYGON - File: contracts/wraps/Wrap1155.sol
// SPDX-License-Identifier: None
pragma solidity =0.8.13;
    ...
    for (uint256 x = 0; x < _userToLocks[id][account].length; x++) {
      ...
      for (uint256 i = 0; i < _rents.length; i++) {
        if (
          ...
          _rents[i].rentalStartTime <= block.timestamp &&
          block.timestamp <= _rents[i].rentalExpireTime
