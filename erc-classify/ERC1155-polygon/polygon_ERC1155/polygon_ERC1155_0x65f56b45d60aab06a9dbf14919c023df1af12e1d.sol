...
// Chain: POLYGON - File: contracts/DraconicDazzle.sol
...
contract DraconicDazzle is ERC1155, AccessControl {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor()
        ERC1155(
            "https://link.storjshare.io/s/jwwe5vsaggyusl6opi2xj7nyy6ga/draconic-dazzle/json/{id}.json"
        )
    {
        _grantRole(
            DEFAULT_ADMIN_ROLE,
            0x46d960CA7117C72B96dbFB45ea44557f890Ff238
        );
    ...
    function uri(
        ...
        return
            string(
                abi.encodePacked(
                    "https://link.storjshare.io/s/jwwe5vsaggyusl6opi2xj7nyy6ga/draconic-dazzle/json/",
    ...
    function setMinter(address _to) public onlyRole(DEFAULT_ADMIN_ROLE) {
