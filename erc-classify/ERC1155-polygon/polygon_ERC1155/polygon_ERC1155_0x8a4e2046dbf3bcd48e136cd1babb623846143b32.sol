...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0xa2C88170C2B2461176E971A781Bd16d4a4388433];
...
// File: contracts/ArkhamsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract ArkhamsContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "ARKHAMS";
    string public symbol = "ARKMS";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/4JV0q39zKuwkSdupobuW/contract-metadata";
  }
