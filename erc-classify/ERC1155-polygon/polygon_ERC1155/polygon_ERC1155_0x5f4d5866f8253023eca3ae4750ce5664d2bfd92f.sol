// Chain: POLYGON - File: MindsCoin.sol
 ...
 * @notice This contract handles minting Minds Coin tokens.
 */
contract MindsCoin is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xC92F4458826Ea5A52B4871D7AD4099E57fB47701;
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeidwlbv3nqg7qooya7zd6aatdipdd5v5pdxcdtoykaqfgw7frzqdja/{id}"
        )
        RevokableOperatorFilterer(
