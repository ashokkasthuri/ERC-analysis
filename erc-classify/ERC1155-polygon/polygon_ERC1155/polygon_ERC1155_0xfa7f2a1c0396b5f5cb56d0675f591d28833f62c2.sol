// Chain: POLYGON - File: src/UGCCraftableObjectFactory.sol
...
contract UGCCraftableObjectFactory is Context, MultiOwner {
    ...
    // Initializes the contract by setting a `craftLogic` address.
...
// Chain: POLYGON - File: src/utils/MultiOwner.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: src/object/UGCCraftableObject.sol
// SPDX-License-Identifier: MIT
...
contract UGCCraftableObject is BaseUGCCraftableObject, ReentrancyGuard, ERC1155Supply {
    ...
    function setMaxClaimable(uint256 tokenid, uint256 maxClaimable) public override onlyOwner {
        supplys[tokenid] = maxClaimable;
    }
    ...
    function getObject(address to, uint256 tokenid, uint256 amount) external override onlyOwner nonReentrant {
        ...
        if ((super.totalSupply(tokenid) + amount) > supplys[tokenid]) revert ReachMaxClaimable();
        // Mint the token
...
// Chain: POLYGON - File: src/utils/BaseUGCCraftableObject.sol
// SPDX-License-Identifier: MIT
...
abstract contract BaseUGCCraftableObject is MultiOwner {
    ...
    mapping(uint256 tokenid => uint256) public supplys;
