...
// Chain: POLYGON - File: @openzeppelin/contracts-upgradeable/token/ERC1155/utils/ERC1155ReceiverUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/interfaces/draft-IERC2612.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/interfaces/IERC1155Receiver.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/interfaces/IERC1363.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/interfaces/IERC1820Registry.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/interfaces/IERC20.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/interfaces/IERC20Metadata.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/interfaces/IERC2612.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/proxy/beacon/BeaconProxy.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/proxy/beacon/UpgradeableBeacon.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/utils/Create2.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/utils/introspection/ERC165Checker.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/utils/introspection/IERC1820Registry.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @openzeppelin/contracts/utils/structs/BitMaps.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: @uniswap/v3-core/contracts/interfaces/IUniswapV3Factory.sol
...
// Chain: POLYGON - File: @uniswap/v3-core/contracts/interfaces/IUniswapV3Pool.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// Chain: POLYGON - File: @uniswap/v3-core/contracts/interfaces/pool/IUniswapV3PoolActions.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// Chain: POLYGON - File: @uniswap/v3-core/contracts/interfaces/pool/IUniswapV3PoolDerivedState.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// Chain: POLYGON - File: @uniswap/v3-core/contracts/interfaces/pool/IUniswapV3PoolEvents.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// Chain: POLYGON - File: @uniswap/v3-core/contracts/interfaces/pool/IUniswapV3PoolImmutables.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// Chain: POLYGON - File: @uniswap/v3-core/contracts/interfaces/pool/IUniswapV3PoolOwnerActions.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// Chain: POLYGON - File: @uniswap/v3-core/contracts/interfaces/pool/IUniswapV3PoolState.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// Chain: POLYGON - File: contracts/interfaces/core/IJasmineEAT.sol
...
// Chain: POLYGON - File: contracts/interfaces/core/IJasmineMinter.sol
// SPDX-License-Identifier: BUSL-1.1
...
// Chain: POLYGON - File: contracts/interfaces/core/IJasmineOracle.sol
// SPDX-License-Identifier: BUSL-1.1
...
// Chain: POLYGON - File: contracts/interfaces/ERC/IERC1046.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/interfaces/ERC/IERC6093.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/interfaces/errors/JasmineErrors.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/interfaces/IJasmineFeeManager.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/interfaces/IJasminePool.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/interfaces/IJasminePoolFactory.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/interfaces/IRetirementRecipient.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/interfaces/IRetirementService.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/interfaces/pool/IEATBackedPool.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/interfaces/pool/IFeePool.sol
// SPDX-License-Identifier: MIT
...
interface IJasmineFeePool is IEATBackedPool, IRetireablePool {
     ...
     * 
     * @param from JLT holder to retire from
...
// Chain: POLYGON - File: contracts/interfaces/pool/IQualifiedPool.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/interfaces/pool/IRetireablePool.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/JasminePool.sol
// SPDX-License-Identifier: BUSL-1.1
...
// Chain: POLYGON - File: contracts/JasminePoolFactory.sol
// SPDX-License-Identifier: BUSL-1.1
...
// Chain: POLYGON - File: contracts/JasmineRetirementService.sol
// SPDX-License-Identifier: BUSL-1.1
...
// Chain: POLYGON - File: contracts/libraries/ArrayUtils.sol
// SPDX-License-Identifier: BUSL-1.1
...
// Chain: POLYGON - File: contracts/libraries/Calldata.sol
// SPDX-License-Identifier: BUSL-1.1
...
// Chain: POLYGON - File: contracts/libraries/PoolPolicy.sol
// SPDX-License-Identifier: BUSL-1.1
...
// Chain: POLYGON - File: contracts/libraries/StructuredLinkedList.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/pools/core/implementations/EATManager.sol
// SPDX-License-Identifier: BUSL-1.1
...
// Chain: POLYGON - File: contracts/pools/core/implementations/ERC20.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/pools/core/implementations/ERC20Permit.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/pools/core/JasmineBasePool.sol
// SPDX-License-Identifier: BUSL-1.1
...
// Chain: POLYGON - File: contracts/pools/extensions/JasmineFeePool.sol
// SPDX-License-Identifier: BUSL-1.1
