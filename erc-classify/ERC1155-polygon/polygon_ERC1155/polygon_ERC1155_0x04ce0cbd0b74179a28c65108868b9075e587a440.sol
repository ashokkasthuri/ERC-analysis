...
// Chain: POLYGON - File: contracts/NEO_reward_Tokens.sol
// SPDX-License-Identifier: MIT
...
contract NEO_reward_Tokens is ERC1155, Ownable, ERC1155Supply {
    ...
    constructor(uint256[] memory ids, uint256[] memory amounts) ERC1155("") {
        name = "NEO Rewards NFT";
        symbol = "NR";
        baseTokenURI = "ipfs://QmTAMDRxn4DAwa4L9D1yx9uL2nNh6hYprpRE29auSU5KMM/token/";
    ...
    function uri(uint256 _id) public view override returns (string memory) {
        return
            bytes(baseTokenURI).length > 0
                ? string(
                    abi.encodePacked(baseTokenURI, _id.toString(), ".json")
                )
                : "";
    }
}