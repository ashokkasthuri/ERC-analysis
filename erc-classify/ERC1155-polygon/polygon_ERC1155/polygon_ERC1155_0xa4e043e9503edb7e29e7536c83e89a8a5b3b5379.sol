// Chain: POLYGON - File: TreeOfSaviour.sol
 ...
 * @notice This contract handles minting TreeOfSaviour tokens.
 */
contract TreeOfSaviour is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x9b72E39d190b0e043Bd5ec439a0fC29B76D7b3Df;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x79FfDf7dBd30e12414D8A451eac31c8fe8BdB282;
    ...
    address[] public payoutAddresses = [
        0x79FfDf7dBd30e12414D8A451eac31c8fe8BdB282
    ];
    ...
    string public name = "TreeOfSaviour";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeigjow3q3sfsi6lyl4sswgdu7pdwuuq56cra22qjt57zp4xcv5642i/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[9] = 10000;
        tokenPublicPrice[9] = 0 ether;
        tokenPublicMintsPerAddress[9] = 10000;
        require(
