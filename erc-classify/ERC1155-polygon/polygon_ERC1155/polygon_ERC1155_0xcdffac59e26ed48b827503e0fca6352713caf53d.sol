...
// Chain: POLYGON - File: @openzeppelin/contracts-upgradeable/token/ERC20/extensions/draft-IERC20PermitUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: contracts/extension/DefaultOperatorFiltererUpgradeable.sol
...
// Chain: POLYGON - File: contracts/extension/interface/IOperatorFilterRegistry.sol
// SPDX-License-Identifier: Apache 2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: contracts/extension/interface/IOperatorFilterToggle.sol
// SPDX-License-Identifier: Apache 2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: contracts/extension/interface/IOwnable.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: contracts/extension/interface/IPlatformFees.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: contracts/extension/interface/IPrimarySale.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: contracts/extension/interface/IRoyalty.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: contracts/extension/interface/ITBT.sol
//SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: contracts/extension/OperatorFiltererUpgradeable.sol
// SPDX-License-Identifier: Apache 2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: contracts/extension/OperatorFilterToggle.sol
// SPDX-License-Identifier: Apache 2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: contracts/extension/TimeboundToken.sol
//SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: contracts/interfaces/IDecirContract.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: contracts/interfaces/token/ITokenERC1155.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: contracts/lib/Config.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
// Chain: POLYGON - File: contracts/v2/ERC1155Contract.sol
//SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
    ...
    TimeboundToken
{
    ...
    function mintTo(uint256 _tokenId, uint256 _quantity, address _to) external {
        require(_tokenId > 0, "Invalid token id");
        require(_tokenId <= nfts[_tokenId].maxSupply, "Sold out");

        IERC20Upgradeable token = IERC20Upgradeable(usdc);
        uint256 price = nfts[_tokenId].price * 10 ** 6;
    ...
    function mint(
        ...
        if (_tokenId <= initialSupply) {
            ...
            require(
                msg.value >= ((nfts[_tokenId].price * 10 ** 18) * _quantity),
                "Insufficient amount."
            );
        }
    ...
    function withdrawToken(
        ...
        // Sending commission
        SafeERC20Upgradeable.safeTransfer(token, _feeRecipient, _salesFee);
        emit ERC20PaymentReleased(token, _receiver, _salesFee);
        ...
        emit ERC20PaymentReleased(token, _receiver, (balance - _salesFee));
    }
