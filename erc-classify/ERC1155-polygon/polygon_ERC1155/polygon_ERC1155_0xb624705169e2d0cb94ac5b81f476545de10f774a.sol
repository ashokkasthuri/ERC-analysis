...
// Chain: POLYGON - File: contracts/interfaces/ICarbonContractRegistry.sol
...
// Chain: POLYGON - File: contracts/interfaces/IProject.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.13;
...
// Chain: POLYGON - File: contracts/Project.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.13;
...
/// @custom:oz-upgrades-unsafe-allow constructor
	...
	function debaseRetirementTCO2(
		...
		for (uint256 i = 0; i < accounts.length; i++) {
			uint256 retiredAmount = retirementMapping[tokenIds[i]].amount;
			require(retiredAmount < (10**decimals) && retiredAmount > 0, 'Balance must be greater than 0');
			retirementMapping[tokenIds[i]].amount = retiredAmount*(10**decimals);
		}
	}
...
// Chain: POLYGON - File: contracts/ProjectStorage.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.13;
...
// Chain: POLYGON - File: contracts/types/ProjectTypes.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.13;
...
// Chain: POLYGON - File: contracts/utils/CustomSignaturesTypes.sol
...
// Chain: POLYGON - File: contracts/utils/CustomSignaturesUpgradeable.sol
// SPDX-FileCopyrightText: 2023 Mojoflower
//
// SPDX-License-Identifier: UNLICENSED
