// Chain: POLYGON - File: NFT_1155.sol
...
contract NFT1155 is ERC1155Upgradeable, AccessControlUpgradeable {
    ...
    function __NFT1155_init_unchained(string memory _name,
        string memory _symbol)
        public
        initializer
    {
    ...
    function add(uint256 ids) external onlyOperatorRole {
...
// Chain: POLYGON - File: AccessControlUpgradeable.sol
...
// Chain: POLYGON - File: IAccessControlUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: SafeMathUpgradeable.sol
// SPDX-License-Identifier: MIT
