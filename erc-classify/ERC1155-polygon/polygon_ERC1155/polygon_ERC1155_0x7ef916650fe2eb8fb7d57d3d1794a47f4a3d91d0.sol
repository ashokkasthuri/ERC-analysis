// Chain: POLYGON - File: solidity/contracts/CKNFT.sol
...
contract CKNFT is ERC1155, Ownable, Pausable {
    ...
    uint256 public constant MAX_TOKEN_ID_PLUS_ONE = 2; // 2 tokens numbered 1 and 2 inclusive
    ...
    constructor()
        ERC1155(
            "ipfs://QmW78Zg2BE6ALivG196ER1M63PvWLujCoQyVzHP8zdB8oS/{id}.json"
        )
    {
        contractUri = "ipfs://QmdKUPi12Yyf5TJvURkwbhYYTveBVKtiHSF6uNy5ejVMc4"; // json contract metadata file for OpenSea
