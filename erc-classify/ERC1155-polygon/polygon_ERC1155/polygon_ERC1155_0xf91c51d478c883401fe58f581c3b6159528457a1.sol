...
// Chain: POLYGON - File: contracts/MonsterVarille.sol
...
contract MonsterVarille is ERC1155, AccessControl {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor()
        ERC1155(
            "https://ipfs.io/ipfs/QmPWxqKST2eCA6xnaUEeDLE2op4AL9a3i3yz78CeqJ6mrW/{id}.json"
        )
    {
        _grantRole(
            DEFAULT_ADMIN_ROLE,
    ...
    function uri(
        ...
        return
            string(
                abi.encodePacked(
                    "https://ipfs.io/ipfs/QmPWxqKST2eCA6xnaUEeDLE2op4AL9a3i3yz78CeqJ6mrW/",
