...
contract NFTCollection is ERC1155, Ownable {
    ...
    string public name = "NAME"; //the token mame
    string public symbol = "SMBL"; //the token symbol

    Counters.Counter private _tokenIdCounter;
//    mapping(address => uint256) public mintedWallets; //mapping of wallets that have minted

    constructor() ERC1155("https://bafybeif3gvx34fa44rontk5btvvxbm3orncoqhpprqmvmd5urqexauiyby.ipfs.w3s.link/metadata_nft.json") {}
