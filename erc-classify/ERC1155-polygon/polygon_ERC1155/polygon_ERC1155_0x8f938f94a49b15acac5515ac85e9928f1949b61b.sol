// Chain: POLYGON - File: contracts/JerichoArtifacts.sol
...
// Chain: POLYGON - File: contracts/utils/CustomAttributes.sol
// SPDX-License-Identifier: MIT
pragma solidity 0.8.9;
...
contract CustomAttributes is ERC1155, ERC1155Burnable, AccessControl {
    ...
    function forcedBurn(
        ...
        burn(addressToBurn, tokenId, value);
    }
...
// Chain: POLYGON - File: contracts/libs/Base64.sol
// SPDX-License-Identifier: MIT
pragma solidity 0.8.9;
...
// Chain: POLYGON - File: contracts/libs/Counters.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
