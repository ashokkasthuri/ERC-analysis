...
// Chain: POLYGON - File: contracts/VoteEscrow.sol
// SPDX-License-Identifier: MIT
...
contract VoteEscrow is ERC1155, Ownable {
    ...
    uint256 immutable wager = 5 ether;
    ...
    constructor(uint32 validators, bytes32 root, string memory URI) ERC1155(URI) {
    ...
    function withdraw() external onlyOwner {
        ...
        require(block.timestamp >= gameEndTime + 2 days, "Cannot withdraw until 2 days after game end");
