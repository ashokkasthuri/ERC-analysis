// Chain: POLYGON - File: openzeppelin-solidity/contracts/access/Ownable.sol
...
// Chain: POLYGON - File: openzeppelin-solidity/contracts/token/ERC1155/ERC1155.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: openzeppelin-solidity/contracts/token/ERC1155/IERC1155.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: openzeppelin-solidity/contracts/token/ERC1155/IERC1155Receiver.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: openzeppelin-solidity/contracts/token/ERC1155/extensions/IERC1155MetadataURI.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: openzeppelin-solidity/contracts/utils/Address.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: openzeppelin-solidity/contracts/utils/Context.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: openzeppelin-solidity/contracts/utils/introspection/ERC165.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: openzeppelin-solidity/contracts/utils/introspection/IERC165.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: /contracts/AirBimtoy.sol
// SPDX-License-Identifier: MIT
    ...
    Ownable
{
    ...
    // token name/symbol
    string constant private _name   = "Air Bimtoy";
    string constant private _symbol = "Bimtoy.AirDrop";
     ...
     */
    function editToken(uint256 id, uint56 maxSupply, string memory ipfsHash)
        public onlyOwner validTokenId(id)
    {
        require(maxSupply >= _tokens[id].totalSupply, 'max must exceed total');
        _tokens[id].maxSupply = maxSupply;
     ...
     */
    function create(uint256 amount, uint56 maxSupply, string memory ipfsHash)
        public onlyOwner
    {
        ...
        // add token
        Token memory token = Token(maxSupply, 0);
        _tokens.push(token);
    ...
    function airdrop(uint256 id, 
            address[] calldata wallets, uint256[] calldata amounts)
        external isMinter
    {
        require(wallets.length == amounts.length, "invalid inputs");
        uint256 count = wallets.length;
        for (uint256 i = 0; i < count; ++i) {
            _mint(wallets[i], id, amounts[i], "");
        }
    }
