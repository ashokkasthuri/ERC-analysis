// Chain: POLYGON - File: contracts/core/PIXLandmark.sol
...
contract PIXLandmark is IPIXLandmark, ERC1155SupplyUpgradeable, OwnableUpgradeable {
    ...
    function initialize() external initializer {
        ...
        s_name = "PIX Landmark Mock";
        s_symbol = "PIXLandMock";
    }
    ...
    function batchMint(
        ...
        require(
            _walletAddresses.length == _tokenIds.length && _walletAddresses.length == _amounts.length,
...
// Chain: POLYGON - File: contracts/interfaces/IPIXLandmark.sol
//SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.0;
