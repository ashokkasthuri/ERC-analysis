// Chain: POLYGON - File: contracts/SpaziosAssets.sol
...
/// @custom:security-contact zetta.plus.info@gmail.com
contract SpaziosAssets is ERC1155, AccessControl, ERC1155Pausable, ERC1155Burnable, ERC1155Supply {
    bytes32 public constant URI_SETTER_ROLE = keccak256("URI_SETTER_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    mapping(uint256 id => uint256) public maxSupply;
    ...
    function setMaxSupply(uint256 _id, uint256 _maxSupply) public onlyRole(MINTER_ROLE) {
        require(totalSupply(_id) <= _maxSupply, "Error, amount already minted exceeds new max supply.");
    ...
    {
        emit Log(0);
        require((totalSupply(id) + amount) <= maxSupply[id], "Error, amount to mint exceeds max supply");
