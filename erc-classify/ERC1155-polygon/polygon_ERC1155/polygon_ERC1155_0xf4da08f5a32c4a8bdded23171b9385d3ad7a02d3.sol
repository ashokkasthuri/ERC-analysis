...
// File: contracts/PocketDemonsSContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract PocketDemonsSContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Pocket Demons S";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/0kmqdYy9oJTKuB0P4L5c/contract-metadata";
  }
