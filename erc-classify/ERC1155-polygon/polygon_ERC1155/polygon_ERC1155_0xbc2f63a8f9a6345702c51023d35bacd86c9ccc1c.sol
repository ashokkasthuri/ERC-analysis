...
// Chain: POLYGON - File: contracts/interfaces/IMetadataResolver.sol
// SPDX-License-Identifier: MIT
// @author: NFT Studios
...
// Chain: POLYGON - File: contracts/libraries/Lockable.sol
// SPDX-License-Identifier: MIT
// @author: NFT Studios
...
// Chain: POLYGON - File: contracts/libraries/ProtectedMintBurn.sol
// SPDX-License-Identifier: MIT
// @author: NFT Studios
...
// Chain: POLYGON - File: contracts/libraries/SignatureProtected.sol
// SPDX-License-Identifier: MIT
// @author: NFT Studios
...
// Chain: POLYGON - File: contracts/MetaverseBackpackCoTickets.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.18;
...
contract MetaverseBackpackCoTickets is Base1155, SignatureProtected {

    event ClaimFullfilled(uint256 indexed orderId);

    constructor(uint96 _royalty, string memory _name, string memory _symbol, address _signer) Base1155(_royalty, _name, _symbol) SignatureProtected(_signer) {}
    ...
    function claim(
        ...
        validateSignature(abi.encodePacked(_orderId, _ids, _amounts), signature);
...
// Chain: POLYGON - File: contracts/tokens/Base1155.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.18;
...
// Chain: POLYGON - File: operator-filter-registry/src/DefaultOperatorFilterer.sol
// SPDX-License-Identifier: MIT
...
// Chain: POLYGON - File: operator-filter-registry/src/OperatorFilterer.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.13;
