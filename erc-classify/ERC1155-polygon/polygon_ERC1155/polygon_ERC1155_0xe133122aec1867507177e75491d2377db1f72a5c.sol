// Chain: POLYGON - File: contracts/TokenV2.sol
    ...
    BasicMetaTransaction
{
    ...
    event MintedExistingPropertyToken(uint256 indexed estateId, uint256 amount);
    ...
    function mintExistingToken(
        ...
        require(
            _estateId < tokenID && tokenInfo[_estateId].minted == true,
            "Invalid estateId"
        );
        emit MintedExistingPropertyToken(_estateId, _amount);
        _mint(_propOwnerAddress, _estateId, _amount, "");
    }
...
// Chain: POLYGON - File: contracts/helper/BasicMetaTransaction.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
