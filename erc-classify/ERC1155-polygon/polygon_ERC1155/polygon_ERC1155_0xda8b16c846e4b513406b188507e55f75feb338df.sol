...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x29192a8923CaB74570d3502b71B47d2b38691C5e,0xF7BF779d92CAac2762838Cc98c52C39a06A1b72D];
  uint256[] public payableFees = [25,75];
...
// File: contracts/PocketDemonsGContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract PocketDemonsGContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Pocket Demons G";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/BuZZ2Px7KRL4ozQ4rAMK/contract-metadata";
  }
