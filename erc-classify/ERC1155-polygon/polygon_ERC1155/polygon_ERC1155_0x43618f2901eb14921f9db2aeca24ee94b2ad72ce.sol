// Chain: POLYGON - File: HibikiRunTomoNight2023InTokyo.sol
 ...
 * @notice This contract handles minting Hibiki Run Tomo Night 2023 in Tokyo tokens.
 */
contract HibikiRunTomoNight2023InTokyo is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x79d84FF7026ab3F93609D618eFDE71A04778CF32;
    address public royaltyAddress = 0x86997066efDb6c388a807fC2B063c76Db5D7d3bE;
    address[] public payoutAddresses = [
        0x86997066efDb6c388a807fC2B063c76Db5D7d3bE
    ];
    ...
    string public name = "Hibiki Run Tomo Night 2023 in Tokyo";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeifb6t7kgvg3biz2bzj5l3doy3fnuhnleafahfbzonvgrdxswmlmcq/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[333] = 150;
        tokenPresaleMaxSupply[333] = 150;
        tokenPresalePrice[333] = 20 ether;
        tokenPresaleMintsPerAddress[333] = 1;
        tokenPresaleSaleStartTime[333] = 1676637000;
        tokenPresaleSaleEndTime[333] = 1677540600;
        tokenUsePresaleTimes[333] = true;
        require(
