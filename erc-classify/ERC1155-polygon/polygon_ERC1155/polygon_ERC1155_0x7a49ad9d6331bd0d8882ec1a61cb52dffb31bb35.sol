// Chain: POLYGON - File: setup.sol
// SPDX-License-Identifier: APACHE 2.0

/*
 * Web3 innovation will continue to evolve because of the ongoing sharing of
 * information and protocols. Thank you to Team Horizon Blockchain Game Inc.
 * for Niftyswap protocol. The time they spent creating this protocol has
 * saved countless hours for many people.
 *
 * LICENSE
 *
 * Copyright (c) 2022-present CyberKongz 
 *
...
import "NiftyswapFactory20.sol";
import "NiftyswapFactory.sol";

contract KongswapFactory20 is NiftyswapFactory20{
	constructor(address _admin) NiftyswapFactory20(_admin) {

	}
}

contract KongswapFactory is NiftyswapFactory{
}



// Chain: POLYGON - File: NiftyswapFactory20.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity 0.7.4;
...
// Chain: POLYGON - File: NiftyswapExchange20.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity 0.7.4;
...
// Chain: POLYGON - File: INiftyswapExchange20.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity 0.7.4;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: ReentrancyGuard.sol
...
// Chain: POLYGON - File: DelegatedOwnable.sol
pragma solidity 0.7.4;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: IOwnable.sol
pragma solidity 0.7.4;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: IERC2981.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity 0.7.4;
import "IERC165.sol";
...
// Chain: POLYGON - File: IERC1155Metadata.sol
pragma solidity ^0.7.4;
...
// Chain: POLYGON - File: IDelegatedERC1155Metadata.sol
pragma solidity ^0.7.4;
...
// Chain: POLYGON - File: IERC1155TokenReceiver.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity 0.7.4;
...
// Chain: POLYGON - File: ERC1155MintBurn.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity 0.7.4;
import "ERC1155.sol";
...
// Chain: POLYGON - File: SafeMath.sol
pragma solidity 0.7.4;
...
// Chain: POLYGON - File: TransferHelper.sol
...
// Chain: POLYGON - File: Ownable.sol
pragma solidity 0.7.4;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: INiftyswapFactory20.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity 0.7.4;
...
// Chain: POLYGON - File: NiftyswapFactory.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity 0.7.4;
...
// Chain: POLYGON - File: NiftyswapExchange.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity 0.7.4;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: INiftyswapExchange.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity 0.7.4;
pragma experimental ABIEncoderV2;
...
// Chain: POLYGON - File: INiftyswapFactory.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity 0.7.4;
