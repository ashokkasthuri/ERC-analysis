...
contract SAPPOROPARCO is ERC1155Supply, ERC1155Burnable, Ownable, AccessControl {
  ...
  string internal royaltyURI = "https://harti.mypinata.cloud/ipfs/QmTtzVWXgpW2ufBDzrnJYRCVaPSAHhzUpNXjuEtydUqPn3/royalty.json";
  ...
  function airdrop(uint256 _dropNumber, address[] calldata _list) external onlyRole(ADMIN){
  ...
  function supportsInterface(bytes4 interfaceId) public view override(ERC1155, AccessControl) 
  returns(bool) {
