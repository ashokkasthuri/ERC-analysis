// Chain: POLYGON - File: /contracts/RecipientNFT1.sol
...
contract RecipientNFT1 is ERC1155, Ownable {
    uint256 private _currentTokenId = 1;
    string private _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmUpyyRBSTrA2bdo1at4jxFVKV1CgKd7Cz6NDnrKJ38mCf/147.json";
    string public name;
    string public symbol;
    uint256 private amount = 1000000;

    constructor(string memory baseTokenURI) ERC1155(baseTokenURI) {
        name = "Rocketpool NFT Airdrop";
        symbol = "Rocketpool NFT Airdrop";
