...
contract GemSwapV2 is SpecialTransferHelper, MarketRegistry, ReentrancyGuard {
    ...
    constructor(address _converter, address _guardian) {
        ...
        // markets.push(
        //     Market({
        //         proxy: 0x2B2e8cDA09bBA9660dCA5cB6233787738Ad68329,
        //         isLib: false,
        //         isActive: true
        //     })
        // );
        ...
        // markets.push(
        //     Market({
        //         proxy: 0xBdb6438A8381443b9Cbe5bAD6dc6F813f370D0E1,
        //         isLib: true,
        //         isActive: true
        //     })
        // );

        // // Gem LooksRare Aggregator
        // markets.push(
        //     Market({
        //         proxy: 0x094e654351Cf152112E136923aD21508401D64d3,
        //         isLib: true,
        //         isActive: true
        //     })
        // );
...
contract MarketRegistry is Ownable {
        ...
        returns (Market memory)
    {
        if (marketId == 0) {
            ...
            return
                Market({
                    proxy: 0x00000000006c3852cbEf3e08E8dF289169EdE581,
                    isLib: false,
                    isActive: true
                });
        } else if (marketId == 1) {
