// Chain: POLYGON - File: ALLINNFTTalkShowCollectibles.sol
 ...
 * @notice This contract handles minting ALL IN NFT Talk Show Collectibles tokens.
 */
contract ALLINNFTTalkShowCollectibles is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x250f97205A9Ab11a442F0caCe32aEb2555b08e98;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xa6c2c4644021D08aB13c6AcEC7EB1f17a89952DA;
    address[] public payoutAddresses = [
        0xa6c2c4644021D08aB13c6AcEC7EB1f17a89952DA
    ];
    ...
    string public name = "ALL IN NFT Talk Show Collectibles";
    string public symbol = "AINTKC";
    ...
    uint96 public royaltyFee = 770;

    constructor(
        uint256 _heymintFeePerToken
    )
        ERC1155(
            "ipfs://bafybeie4xsgirknnuymd3dmi4unuxsadrwxqqs3ilvn6pxbtln4zhmboce/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[12] = 10000;
        tokenPublicPrice[12] = 7 ether;
        tokenPublicMintsPerAddress[12] = 10000;
        tokenPublicSaleStartTime[12] = 1685876400;
        tokenPublicSaleEndTime[12] = 1686432600;
        tokenUsePublicSaleTimes[12] = true;
        tokenPresaleMaxSupply[12] = 10000;
        tokenPresalePrice[12] = 0 ether;
        tokenPresaleMintsPerAddress[12] = 1;
        tokenPresaleSaleStartTime[12] = 1685869200;
        tokenPresaleSaleEndTime[12] = 1685876400;
        tokenUsePresaleTimes[12] = true;
        tokenPublicPrice[13] = 0 ether;
        tokenPublicMintsPerAddress[13] = 0;
        tokenPresaleMaxSupply[13] = 0;
        tokenPresalePrice[13] = 0 ether;
        tokenPresaleMintsPerAddress[13] = 0;
        tokenPublicPrice[14] = 0 ether;
