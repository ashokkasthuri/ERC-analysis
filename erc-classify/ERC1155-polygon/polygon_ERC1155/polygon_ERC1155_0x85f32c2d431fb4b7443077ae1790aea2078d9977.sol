...
// Chain: POLYGON - File: contracts/AscionAgents.sol
// SPDX-License-Identifier: MIT
...
contract AscionAgents is UniqueCollection {

    // Constructor to initialize Collection
    constructor(address _owner, address _forwarder)
    UniqueCollection("Ascion: Agents", "ASC_AGENTS", "https://meta.ascion.space/agents/" , "https://meta.ascion.space/collections/agents.json", _owner, _forwarder) {
    }
}
