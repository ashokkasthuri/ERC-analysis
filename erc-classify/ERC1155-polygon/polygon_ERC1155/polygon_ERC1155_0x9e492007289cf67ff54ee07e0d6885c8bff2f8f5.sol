...
// File @openzeppelin/contracts-upgradeable/token/ERC1155/IERC1155Upgradeable.sol@v4.9.5
...
// File @openzeppelin/contracts-upgradeable/token/ERC1155/extensions/IERC1155MetadataURIUpgradeable.sol@v4.9.5
...
// File @openzeppelin/contracts-upgradeable/token/ERC1155/IERC1155ReceiverUpgradeable.sol@v4.9.5
...
// File @openzeppelin/contracts-upgradeable/token/ERC1155/ERC1155Upgradeable.sol@v4.9.5
...
// File contracts/Matr1xFireAssetCollection.sol
...
contract Matr1xFireAssetCollection is
    Initializable,
    ERC1155Upgradeable,
    ...
    UUPSUpgradeable
{
    ...
    function initialize() initializer public{
        ...
        _name = "Matr1x Fire Asset Collection";
        _symbol = "MFAC";
    ...
    function setBlocklist(address[] calldata addresses, bool[] calldata isBlocks)
        public 
        onlyRole(BLOCKER_ROLE) 
    {
        for(uint256 i = 0; i < addresses.length;){
            blocklists[addresses[i]] = isBlocks[i];
            unchecked {
                ++i;
            }
        }
    ...
    {
        require(!blocklists[operator] && !blocklists[from] && !blocklists[to], "Blocked");
