...
// Chain: POLYGON - File: contracts/common/EvPointAirdrop.sol
// SPDX-License-Identifier: MIT
...
/**
 * @dev EvPointAirdrop is an ERC1155 Collection that gives its holders access to Every Finance points "EvPoints".
 * Each token Id gives access to a specified amount of EvPoints.
 * Evpoints will be converted to EVERY tokens after its release.
 */

contract EvPointAirdrop is
    ERC1155,
    ERC1155Burnable,
    ERC1155Supply,
    AccessControlEnumerable,
    Pausable
{
    ...
    event SetURI(uint256 _id, string _newuri);

    constructor(address admin_, string memory uri_) ERC1155(uri_) {
    ...
    function mint(
        ...
        uint256 _value,
        bytes memory _data
    ) external whenNotPaused onlyRole(MINTER) {
