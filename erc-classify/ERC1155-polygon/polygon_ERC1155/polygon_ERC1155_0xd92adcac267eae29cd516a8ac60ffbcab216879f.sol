// Chain: POLYGON - File: HibikiRunTomoNight2023InOsaka.sol
 ...
 * @notice This contract handles minting Hibiki Run Tomo Night 2023 in Osaka tokens.
 */
contract HibikiRunTomoNight2023InOsaka is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x00E6B9f1571D088412533Ea053EC8EbEBA0dd016;
    ...
    string public name = "Hibiki Run Tomo Night 2023 in Osaka";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeiakosh4lrzxbnf7cprviufy2s5wdhxt2kq4gwoyipiz3phccvlfl4/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicPrice[702] = 20 ether;
        tokenPublicMintsPerAddress[702] = 0;
        require(
