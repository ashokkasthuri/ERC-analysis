...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0xFB60Ea2CbC991911814284dccaEeAa1C4B38A96d];
...
// File: contracts/X2Jw7UdContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract X2Jw7UdContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/jVx6II4jNYtSp4B7KPUC/contract-metadata";
  }
