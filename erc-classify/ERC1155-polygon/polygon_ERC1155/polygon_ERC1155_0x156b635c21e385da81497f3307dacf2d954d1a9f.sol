// Chain: POLYGON - File: src/object/CraftableObject.sol
...
contract CraftableObject is BaseObject, ERC1155Supply {
    ...
    event RemovedFromWhitelist(address indexed sender, address UnWhitelistedAddress);
    ...
    function craftObject(address to, uint256 tokenid, uint256 amount) external nonReentrant onlyCraftLogic {
...
// Chain: POLYGON - File: src/utils/BaseObject.sol
// SPDX-License-Identifier: MIT
