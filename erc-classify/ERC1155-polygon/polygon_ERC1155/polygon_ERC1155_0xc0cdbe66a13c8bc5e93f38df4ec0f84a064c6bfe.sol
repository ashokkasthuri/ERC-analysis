// Chain: POLYGON - File: contracts/CSWorkshop.sol
...
contract CSWorkshop is ERC1155, Ownable, Pausable {
  uint8 constant SERIES_ONE_COMMON_ONE = 111;
  uint8 constant SERIES_ONE_COMMON_TWO = 112;

  uint8 constant SERIES_ONE_RARE_ONE = 121;
  uint8 constant SERIES_ONE_RARE_TWO = 122;

  constructor()
    ERC1155(
      "https://gateway.pinata.cloud/ipfs/QmSjQyp9j6c35Rr5J69gkZFfdxrKTfq65csDW5Dr695849/{id}.json"
    )
  {
    mint(SERIES_ONE_COMMON_ONE, 600);
    mint(SERIES_ONE_COMMON_TWO, 600);
    mint(SERIES_ONE_RARE_ONE, 300);
    mint(SERIES_ONE_RARE_TWO, 300);
  }
  ...
  function uri(uint256 _tokenId) public pure override returns (string memory) {
    return
      string(
        abi.encodePacked(
          "https://gateway.pinata.cloud/ipfs/QmSjQyp9j6c35Rr5J69gkZFfdxrKTfq65csDW5Dr695849/",
