...
contract Medallions is ERC1155, OwnableRoles {
    ...
    uint256 public constant MAX_MINT_AMOUNT = 1000; // Example limit
    ...
    function Airdrop(
        ...
        require(amount > 0 && amount <= MAX_MINT_AMOUNT, "Mint: Invalid amount");
    ...
    function burn(address from, uint256 id, uint256 amount) external { 
        ...
        if (msg.sender == _authorizedContract) {
            ...
            // Example: Check if 'from' has approved the caller to burn tokens on their behalf
            require(
