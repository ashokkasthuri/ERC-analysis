// Chain: POLYGON - File: /contracts/RebelKidsOriginals.sol
...
contract RebelKidsOriginals is ERC1155, Ownable {

    constructor () ERC1155("https://storage.googleapis.com/rebelkids/originals/meta/{id}") {
    }
    ...
    function airdrop(uint tokenId, address[] calldata addresses) external onlyOwner {
