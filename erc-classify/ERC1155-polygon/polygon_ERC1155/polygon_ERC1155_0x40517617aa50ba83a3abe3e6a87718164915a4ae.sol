...
// Chain: POLYGON - File: contracts/AlienGhost.sol
...
contract AlienGhost is ERC1155, AccessControl {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor()
        ERC1155(
            "https://link.storjshare.io/s/juppunb6afr3p4vvj27azcej5tlq/alien/json/{id}.json"
        )
    {
        _grantRole(
            DEFAULT_ADMIN_ROLE,
            0x9232c8865Ce5FB02BDa1f3bdA780E157a960aF83
        );
    ...
    function uri(
        ...
        return
            string(
                abi.encodePacked(
                    "https://link.storjshare.io/s/juppunb6afr3p4vvj27azcej5tlq/alien/json/",
