...
// Chain: POLYGON - File: contracts/SemiFungibleCollection.sol
// SPDX-License-Identifier: MIT
    ...
    ERC1155SupplyUpgradeable
{
    ...
    function mint(uint256 _tokenId, uint256 _amount) public {
        ...
        uint256 platformFeeAmount = (transferAmount * platformFee) / 10000;
        uint256 userAmount = transferAmount - platformFeeAmount;
        ...
        IERC20Upgradeable(ommi).transfer(owner(), userAmount);
        // Send token to secondary receiver addresses
        IERC20Upgradeable(ommi).transfer(
            platformFeeReceiver,
            platformFeeAmount
        );
