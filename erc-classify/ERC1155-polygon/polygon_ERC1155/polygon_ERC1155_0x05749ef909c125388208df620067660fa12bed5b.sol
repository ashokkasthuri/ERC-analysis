...
// Chain: POLYGON - File: contracts/mock/BCSWL.sol
// SPDX-License-Identifier: MIT
...
contract BCSWL is ERC1155, ERC1155Supply, Ownable {

    uint256 constant private maxSupply = 5000;
    uint256 constant private tokenId = 1;
    string constant public name = "Blockchain Sports Football WL";
    string constant public symbol = "BCSWL";

    string private baseUri;

    mapping(address => bool) private claimed;

    constructor(string memory uri_) ERC1155(uri_) { baseUri = uri_; }
    ...
    function mint() external {
        require(!claimed[msg.sender], "You can only mint one NFT");
        require(totalSupply(tokenId) < maxSupply, "Not enough nfts to mint");
