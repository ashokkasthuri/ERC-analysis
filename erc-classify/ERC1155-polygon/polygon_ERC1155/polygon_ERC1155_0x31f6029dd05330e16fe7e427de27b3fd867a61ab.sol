...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0xf0019E7aFc3E61D94C27EaBBA9C981180A513190];
...
// File: contracts/Q1M71XContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract Q1M71XContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/diJ3jtzGAKS4kNnRs54S/contract-metadata";
  }
