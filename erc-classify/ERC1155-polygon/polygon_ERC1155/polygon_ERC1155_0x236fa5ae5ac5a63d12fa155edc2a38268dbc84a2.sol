...
// Chain: POLYGON - File: contracts/ByteBananas.sol
...
contract ByteBananas is ERC1155, AccessControl {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor()
        ERC1155(
            "https://link.storjshare.io/s/juvzr4eobkw2kj5xhvbj552kv3yq/byte-bananas/json/{id}.json"
        )
    {
        _grantRole(
            DEFAULT_ADMIN_ROLE,
    ...
    function uri(
        ...
        return
            string(
                abi.encodePacked(
                    "https://link.storjshare.io/s/juvzr4eobkw2kj5xhvbj552kv3yq/byte-bananas/json/",
