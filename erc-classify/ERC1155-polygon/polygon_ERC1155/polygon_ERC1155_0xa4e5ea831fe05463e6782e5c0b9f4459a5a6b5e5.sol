...
/// @custom:security-contact security@crewman.art
contract Simples is ERC1155, Ownable, Pausable, ContextMixin  {
    ...
    function uri(uint256 _tokenId) override public pure returns (string memory) {
        return string(
            abi.encodePacked(
            "ipfs://bafybeihrlmb6fb5bzdbvex5v2q5bighsjky3scnv7ize43ypya2z42njxy/",
