...
// Chain: POLYGON - File: contracts/Polygon2_0Pass.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
contract Polygon2_0AirdropPass is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    ...
    string public symbol = "maticdrops.com";
 
    constructor()
        ERC1155("https://ipfs.io/ipfs/QmaDw1SMxsgPGggdc17Kswc25i3jpQMtpbBu1d7ksst3v3/{id}.json")
    {}

    function uri(uint256 _tokenid) override public pure returns (string memory) {
        return string(
            abi.encodePacked(
                "https://ipfs.io/ipfs/QmaDw1SMxsgPGggdc17Kswc25i3jpQMtpbBu1d7ksst3v3/",
    ...
    function contractURI() public pure returns(string memory) {
        return "https://ipfs.io/ipfs/QmaDw1SMxsgPGggdc17Kswc25i3jpQMtpbBu1d7ksst3v3/collection.json";
    }
    ...
    function airdropPass(uint256 tokenId, address[] calldata recipients) external onlyOwner {
