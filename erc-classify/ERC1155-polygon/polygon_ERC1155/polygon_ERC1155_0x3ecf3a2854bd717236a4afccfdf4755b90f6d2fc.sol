 ...
 * @notice This contract handles minting RISPOL tokens.
 */
contract RISPOL is
    ERC1155Supply,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x09e9240f546dA7195b83aCf305851B768Cd7a501;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xb3F7Bd0Dfd9ed82323289B02EbF72452c19c6565;
    ...
    address[] public payoutAddresses = [
        0xb3F7Bd0Dfd9ed82323289B02EbF72452c19c6565
    ];
    ...
    string public name = "RISPOL";
    string public symbol = "RIS";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeiacic73g3c4wzpijm3i42lxyp7iw7juda3pblkg756tmw47dqlli4/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicSaleStartTime[1] = 1687651200;
        tokenPublicSaleEndTime[1] = 1688054400;
