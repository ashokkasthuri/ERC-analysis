...
// Chain: POLYGON - File: contracts/PiDragon.sol
// SPDX-License-Identifier: MIT
...
contract PiDragon is ERC1155, ERC2981, Ownable, ERC1155Burnable, ERC1155Supply {
    mapping(uint256 => uint256) private _maxSupply;

    string public name = "Pi Dragon";

    constructor(
        uint96 _feeNumerator
    ) ERC1155("https://media.pidragon.me/assets/{id}.json") {
    ...
    function mint(
        ...
        require(
            _maxSupply[id] == 0 || totalSupply(id) < _maxSupply[id],
            "PiDragon: can't mint"
        );
