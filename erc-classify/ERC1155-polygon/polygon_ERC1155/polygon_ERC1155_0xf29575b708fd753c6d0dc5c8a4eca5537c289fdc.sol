...
// File: contracts/MetaMeNFTNYC2022.sol
...
contract MetaMeNFTNYC2022 is ERC1155, Ownable, ERC1155Supply, Pausable {
    
  string public name;
  string public symbol;

  uint256 public walletMintAmount = 1;

  mapping(uint => string) public tokenURI;
  mapping(address =>uint ) private NftPerWallet;

  string  public mytokenURI= "ipfs://QmaafkBKxE8gGdZv3kxaZZpqT9QLWpjSZtBdkpRYB54ReE/" ;

    uint256 private constant Robot1 = 1;

  constructor() ERC1155("")  {
    name = "MetaMeNFTNYC2022";
    symbol = "METAMENFTNYC2022";
  }
...
// pause modifier - whenNotPaused - in place
