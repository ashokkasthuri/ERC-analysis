...
// Chain: POLYGON - File: src/GoConference2023KyotoGoNFT.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
contract GoConference2023KyotoGoNFT is ERC1155LazyMint {
     ...
     *  @dev             Checks a request to claim NFTs against a custom condition.
     *
     *  @param claimer   Caller of the claim function.
     *  @param tokenId   The tokenId of the lazy minted NFT to mint.
     *  @param quantity  The number of NFTs being claimed.
     */
    function verifyClaim(
        address claimer,
        uint256 tokenId,
