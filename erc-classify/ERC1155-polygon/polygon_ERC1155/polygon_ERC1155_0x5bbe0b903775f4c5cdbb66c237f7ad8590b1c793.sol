...
// File: contracts/ValireumLicence.sol
...
contract ValireumLicence is ERC1155, Ownable {
  ...
  constructor() ERC1155("") {
    ...
    tokenData[0] = TokenInfo(79000000000000000000, 1000, 0, "https://valireum.net/metadata/licences/founder.json");
    tokenData[1] = TokenInfo(49000000000000000000, 5000, 0, "https://valireum.net/metadata/licences/craftmaster.json");
    tokenData[2] = TokenInfo(29000000000000000000, 10000, 0, "https://valireum.net/metadata/licences/exchanger.json");
    tokenData[3] = TokenInfo(79000000000000000000, 10**18, 0, "https://valireum.net/metadata/licences/premium.json");
    tokenData[4] = TokenInfo(49000000000000000000, 10**18, 0, "https://valireum.net/metadata/licences/standard.json");
