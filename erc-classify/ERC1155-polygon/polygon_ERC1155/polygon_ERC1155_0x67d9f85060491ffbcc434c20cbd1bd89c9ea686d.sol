...
contract BEAMS_JAPAN_THE_SITES is ERC1155Enumerable, OwnControll, ERC721URIPerToken {

    address public metadata;
    bool public useMetadata;

    constructor() ERC1155Enumerable("BEAMS_JAPAN_THE_SITES", "BJTS") {
        _setTokenToURI(1, "ipfs://QmeMsNw5ySMbAjgVYhNZDWH2iyfkS9esuDkPUYJmnjikVP");
    ...
    function safeTransferFrom(address from_, address to_, uint256 id_, uint256 amount_, bytes memory data_) public virtual override onlyAdmin("ADMIN") {
        super.safeTransferFrom(from_, to_, id_, amount_, data_);
    }

    function safeBatchTransferFrom(address from_, address to_, uint256[] memory ids_, uint256[] memory amounts_, bytes memory data_) public virtual override onlyAdmin("ADMIN") {
