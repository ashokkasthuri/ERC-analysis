...
// Chain: POLYGON - File: contracts/Coin.sol
// SPDX-License-Identifier: MIT
...
contract Coin is ERC1155, ERC1155Burnable, Ownable(msg.sender), Pausable {
    uint256 public constant TOKEN_ID = 1; // Fixed token ID
    ...
    constructor(string memory name_, string memory symbol_, string memory base_uri) ERC1155(base_uri) {
        _name = name_;
        _symbol = symbol_;
