...
contract MonsterGeads is ERC1155, AccessControl {
    ...
    string public constant Name = "MonsterGeads";
    ...
    function onlyOwnerCanMint(bool _toggle) external onlyRole(ADMIN_ROLE) {
    ...
    function setOwenr(address _newOwner) public onlyRole(ADMIN_ROLE) {
        Owner = _newOwner;
    }
}