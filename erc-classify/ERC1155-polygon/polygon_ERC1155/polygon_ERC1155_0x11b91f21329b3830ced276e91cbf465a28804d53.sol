...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    function forceTransferFrom(
        ...
        _forceTransferFrom(from, to, id, amount, data);
    }
...
contract NFT is ERC1155Burnable, ERC2981, Ownable {
    ...
    string private _baseTokenURI = "https://d1tzqlpa5utiea.cloudfront.net/harmony_music/1155/";
    mapping(uint256 => uint256) public totalSupply;

    constructor() ERC1155("") {
        _setDefaultRoyalty(address(0x1152F94Fb5aD200C45501a8c07a2490606DAe0ed), 1000);
    }
