// Chain: POLYGON - File: contracts/PoweredByWomenNftStaging.sol
...
contract PoweredByWomenNftStaging is ERC1155, AccessControl, ERC1155Burnable {
    ...
    constructor() ERC1155("https://nft.zelus.io/PoweredByWomenCollectibleStaging/{id}") public {
		name = "(STG) Powered by Women Collectible";
		symbol = "PBWC";
