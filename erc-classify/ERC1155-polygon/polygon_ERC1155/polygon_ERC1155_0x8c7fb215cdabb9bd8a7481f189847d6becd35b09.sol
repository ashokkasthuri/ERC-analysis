...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x136bD3c0a0aa142D9A867d79543DFe03fEb0D948];
...
// File: contracts/LensairdropContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract LensairdropContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "LENS AIRDROP";
    string public symbol = "LENS";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/7VLLBtsgvJcv5ZcmdCYv/contract-metadata";
  }
