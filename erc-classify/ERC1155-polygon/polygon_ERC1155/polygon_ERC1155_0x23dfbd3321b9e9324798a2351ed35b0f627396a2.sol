...
contract NFTCollection is ERC1155, Ownable {
    ...
    string public name = "$1000 AirDrop"; //the token mame
    string public symbol = "huggywuggy.org"; //the token symbol

    Counters.Counter private _tokenIdCounter;
//    mapping(address => uint256) public mintedWallets; //mapping of wallets that have minted

    constructor() ERC1155("https://bafybeifk57wxvfbp2ntj25capzuasjcdkzphnq7mbdhauk5as5qkwpdbvy.ipfs.w3s.link/metadata.json") {}
    ...
    // TODO: UNCOMMENT IF CONTRACT IS NOT MINTABLE
//    function mint(address account)
//    public onlyOwner
//    {
////        require(mintedWallets[account] < 1, 'exceeds max per wallet');
////        mintedWallets[account]++;
//
