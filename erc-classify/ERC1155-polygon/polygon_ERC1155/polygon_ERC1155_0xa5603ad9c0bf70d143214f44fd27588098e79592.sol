...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x61Db696Da7047b76c7e9804a9a50CC1F68Caf5cB];
...
// File: contracts/CryptoMsicaClassicEp102Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract CryptoMsicaClassicEp102Contract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Crypto Msica Classic Ep102";
    string public symbol = "CMCEp102";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Z3qVsUnCxBOp4bLMsN8F/contract-metadata";
  }
