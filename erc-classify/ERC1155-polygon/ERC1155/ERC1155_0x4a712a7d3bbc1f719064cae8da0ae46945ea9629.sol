...
// File: contracts/voltargetBTC/common/Management.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/voltargetBTC/sigmaBTC/ManagementSigmaBTC.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.4;
 ...
 * @notice Implementation of the contract ManagementSigmaBTC.
 */

contract ManagementSigmaBTC is Management {
	constructor(
		address admin_,
		address manager_,
		address treasury_
