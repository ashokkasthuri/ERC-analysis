...
// File: contracts/abstract/ERC721BUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/abstract/LockRegistry.sol
...
abstract contract LockRegistry is OwnableUpgradeable {
...
// File: contracts/interfaces/IValeria.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.17;
...
// File: contracts/ValeriaUpgradeableV2.sol
// SPDX-License-Identifier: MIT
pragma solidity 0.8.17;
    ...
    IValeria
{
    ...
    function _upgradeLands(
        ...
        // Transfer tokens to sink wallet from `sender`, normally hot wallet or delegate
        IERC20(tokenContract).transferFrom(sender, sinkWallet, requiredPayment);
        ...
        for (; i < upgradeAmount; ) {
            ...
            require(
                _isApprovedOrOwner(owner, tokenId) &&
                    !metadata[tokenId].upgraded,
                "!owner or !approved or upgraded"
            );
    ...
    function upgradeLands(uint256[] calldata tokenIds) external payable {
        _upgradeLands(tokenIds, _msgSender(), _msgSender());
    }
    ...
    function delegateUpgradeLands(
        ...
        _upgradeLands(tokenIds, _msgSender(), vault);
    }
