...
// Chain: AVALANCHE - File: contracts/internal-upgradeable/ERC1155URIStorageUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: contracts/internal-upgradeable/PaymenProcessingUpgradeable.sol
// SPDX-License-Identifier: MIT
...
abstract contract PaymenProcessingUpgradeable is OwnableUpgradeable {
    ...
    function configPaymentPercentage(
        FeeInfo calldata clientInfo_,
        FeeInfo calldata systemInfo_,
        uint96 affiliatePercentageInBps_
    ) external onlyOwner {
        if (
            clientInfo_.percentageInBps + systemInfo_.percentageInBps + affiliatePercentageInBps_ !=
            HUNDER_PERCENT_IN_BPS
        ) revert Payment__InvalidPercentage();
    ...
    function _calculateAmounts(
        ...
        uint256 clientPercentage = clientInfo.percentageInBps;
        ...
        if (affiliate_ != address(0)) {
            ...
            emit ReferralBonus(affiliate_, affiliateAmount);
        }

        systemAmount = total_ - primarySaleAmount - affiliateAmount;
    }
...
// Chain: AVALANCHE - File: contracts/internal-upgradeable/PresaleOracleUpgradeable.sol
// SPDX-License-Identifier: MIT
pragma solidity 0.8.21;
...
abstract contract PresaleOracleUpgradeable is Initializable {
    ...
    function _getFiatPrice() internal view returns (uint256) {
...
// Chain: AVALANCHE - File: contracts/MyToken.sol
// SPDX-License-Identifier: MIT
pragma solidity 0.8.21;
...
import {PaymenProcessingUpgradeable} from "./internal-upgradeable/PaymenProcessingUpgradeable.sol";
import {FixedPointMathLib} from "./libraries/FixedPointMathLib.sol";
    ...
    PaymenProcessingUpgradeable
{
    ...
    event PreSaleInfo(uint256 id, uint256 tokenPrice, uint256 netPrice);
    ...
    mapping(uint256 => PresaleInfo) private _presaleDetails;
    mapping(uint256 => uint256) private _maxSupply;
    mapping(uint256 => uint256) private _netPrice;
    ...
    function initialize(
        uint256 id_,
        PresaleInfo calldata presaleInfo_,
        FeeInfo calldata clientInfo_,
        FeeInfo calldata systemInfo_,
        address paymentToken_,
        ...
        _setPresale(id_, presaleInfo_, 0);
        clientInfo = clientInfo_;
        systemInfo = systemInfo_;
        affiliatePercentageInBps = 0;
    }
    ...
    function setPresale(uint256 id_, PresaleInfo calldata presaleInfo_, uint256 netPrice_, uint256 maxSupply_) external onlyOwner {
        if (presaleInfo_.tokenPrice == 0) revert InvalidPrice();

        if (presaleInfo_.endTime < presaleInfo_.startTime) revert InvalidTimeRange();
        _maxSupply[id_] = maxSupply_;
        _netPrice[id_] = netPrice_;
        _setPresale(id_, presaleInfo_, netPrice_);
    }
    ...
    function _setPresale(uint256 id_, PresaleInfo calldata presaleInfo_, uint256 netPrice_) internal {
        _presaleDetails[id_] = presaleInfo_;

        emit PreSaleInfo(id_, presaleInfo_.tokenPrice, netPrice_);
    }

    function setPriceFeeds(address token_, PriceFeed memory priceFeed_) external onlyOwner {
    ...
    function _buy(
        ...
        uint256 netAmount_ = _getTokenUsdAmount(paymentToken_, _netPrice[id_] * quantity_);
        _tokensSold[id_] += quantity_;
        _processPayment(paymentToken_, paymentAmount_, netAmount_, sender_, referrer_);
        
        if (totalSupply(id_) + quantity_ > _maxSupply[id_]) revert();

        _mint(recipient_, id_, quantity_, bytes("0x")); 
    ...
    function getPresaleInfo(
        uint256 id
    ) external view returns (uint256 tokensSold, uint256 maxSupply, uint256 price, uint256 startTime, uint256 endTime) {
        PresaleInfo memory presaleInfo = _presaleDetails[id];

        return (_tokensSold[id], _maxSupply[id] ,presaleInfo.tokenPrice, presaleInfo.startTime, presaleInfo.endTime);
    }
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts-upgradeable/contracts/access/OwnableUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts-upgradeable/contracts/proxy/utils/Initializable.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts-upgradeable/contracts/proxy/utils/UUPSUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts-upgradeable/contracts/token/ERC1155/ERC1155Upgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts-upgradeable/contracts/token/ERC1155/extensions/ERC1155BurnableUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts-upgradeable/contracts/token/ERC1155/extensions/ERC1155PausableUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts-upgradeable/contracts/token/ERC1155/extensions/ERC1155SupplyUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts-upgradeable/contracts/utils/ContextUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts-upgradeable/contracts/utils/introspection/ERC165Upgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts-upgradeable/contracts/utils/PausableUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts/contracts/interfaces/draft-IERC1822.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts/contracts/interfaces/draft-IERC6093.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts/contracts/proxy/beacon/IBeacon.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts/contracts/proxy/ERC1967/ERC1967Utils.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts/contracts/token/ERC1155/extensions/IERC1155MetadataURI.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts/contracts/token/ERC1155/IERC1155.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts/contracts/token/ERC1155/IERC1155Receiver.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts/contracts/utils/Address.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts/contracts/utils/Arrays.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts/contracts/utils/introspection/IERC165.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts/contracts/utils/math/Math.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts/contracts/utils/math/SignedMath.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts/contracts/utils/StorageSlot.sol
// SPDX-License-Identifier: MIT
...
// Chain: AVALANCHE - File: lib/openzeppelin-contracts/contracts/utils/Strings.sol
// SPDX-License-Identifier: MIT
