...
// File: @layerzerolabs/solidity-examples/contracts/token/onft/IONFT1155.sol
// SPDX-License-Identifier: MIT
...
// File: @layerzerolabs/solidity-examples/contracts/token/onft/IONFT1155Core.sol
// SPDX-License-Identifier: MIT
...
// File: @layerzerolabs/solidity-examples/contracts/token/onft/ONFT1155.sol
// SPDX-License-Identifier: MIT
...
// File: @layerzerolabs/solidity-examples/contracts/token/onft/ONFT1155Core.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/battlepass/ONFT1155UriMinterProxy.sol
// SPDX-License-Identifier: MIT

pragma solidity 0.8.17;

import { ONFT1155Core } from "@layerzerolabs/solidity-examples/contracts/token/onft/ONFT1155.sol";
...
contract ONFT1155UriMinterProxy is
    IReceiverVerifier,
    ONFT1155Core,
    ERC1155Holder
{
    ...
    ERC1155Invoke public immutable erc1155;
    ...
    /**
     * @notice Sets token uris
     * @dev Only callable by the owner.
     * @param _tokenIds token ids
     * @param _tokenUris token uris
     */
    function setTokenUris(
        ...
        emit TokenUrisSet(_tokenIds, _tokenUris);
    }
     ...
     * @param _tokenIds Token ids received
     * @param _tokenQuantities Amount of each token received
    ...
    function handleInvoke(
        ...
        erc1155.burnBatch(address(this), _tokenIds, _tokenQuantities);
    ...
    function _debitFrom(
        ...
        erc1155.burnBatch(address(this), _tokenIds, _amounts);
    }
    ...
    function _creditTo(
        ...
        for (uint256 i = 0; i < _tokenIds.length; i++) {
            uris[i] = tokenUris[_tokenIds[i]];
        }

        erc1155.mintBatch(_toAddress, _tokenIds, _amounts, uris, "");
    }
}


// File: contracts/nfts/ERC1155Invoke.sol
// SPDX-License-Identifier: MIT
pragma solidity 0.8.17;
    ...
    ReentrancyGuard
{
    ...
    function uri(
        ...
        return string(abi.encodePacked(baseURI, tokenSuffix[_tokenId]));
    }
