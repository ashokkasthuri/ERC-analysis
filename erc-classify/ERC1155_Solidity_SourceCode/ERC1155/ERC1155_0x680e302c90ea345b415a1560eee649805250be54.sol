 ...
 * @author BaseLabs
 */
contract FFSTI is ERC1155, Ownable, FlexibleOperatorFilterer {
    error ErrInvalidArgument();

    string public name = "FFSTI";
    string public symbol = "FFSTI";
    ...
    function airdrop(
        ...
        if (accounts_.length == 0) revert ErrInvalidArgument();
        unchecked {
            for (uint256 i = 0; i < accounts_.length; ++i) {
                _mint(accounts_[i], tokenId_, 1, "");
            }
        }
    }
...
// File: contracts/library/opensea-operatorfilter/v1/FlexibleOperatorFilterer.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/library/opensea-operatorfilter/v1/IOperatorFilterRegistry.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.13;
...
// File: contracts/library/opensea-operatorfilter/v1/OperatorFilterer.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.13;
