...
// File: contracts/mock/eBitMock.sol
// SPDX-License-Identifier: MIT
...
contract EBitMock is ERC20, ERC20Permit {
    constructor() ERC20("eBit Mock", "EBITM") ERC20Permit("eBit Mock") {
        _mint(msg.sender, 100000000 * 10 ** decimals());
    }
}

// File: contracts/nft/eBitVIP.sol
// SPDX-License-Identifier: MIT
// Compatible with OpenZeppelin Contracts ^5.0.0
pragma solidity ^0.8.20;
...
contract EBitVIP is ERC1155, Ownable, ERC1155Pausable, ERC1155Supply {

    string private _baseUri = "https://bafybeih2cy3mwrg4c4x67kqwwnnope5aukuqekobr4nchqod2pfj2csfya.ipfs.dweb.link/";
...
// File: contracts/protocol/eBitDistributor.sol
// SPDX-License-Identifier: MIT
...
contract EbitMiningDistributor is AccessControl {
    ...
    IERC20 public constant eBitToken =
        IERC20(0x4F14ba78A51925EE934c373a2cf56b2d8da63f7F); // 0x4F14ba78A51925EE934c373a2cf56b2d8da63f7F Mainnet
    ...
    function addController(address _controller)
        ...
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        _grantRole("CONTROLLER", _controller);
    }

    function unlockMinedEbit(address _user, uint256 _amountToUnlock)
        external
    ...
    function claimMinedEbit(address _claimant, uint256 _amount) external {
        require(
