// File: @nfts2me/contracts/important/README.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
...
// File: @nfts2me/contracts/interfaces/IN2M_ERCBase.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// File: @nfts2me/contracts/interfaces/IN2M_ERCStorage.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// File: @nfts2me/contracts/interfaces/IN2MBeaconFactory.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// File: @nfts2me/contracts/interfaces/IN2MCrossFactory.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// File: @nfts2me/contracts/interfaces/IOperatorFilterRegistry.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// File: @nfts2me/contracts/ownable/NFTOwnableUpgradeable.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// File: contracts/beacon/N2MERC1155Upgradeable.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// File: contracts/beacon/N2MERC721Upgradeable.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// File: contracts/beacon/N2MUpgradeable.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// File: contracts/interfaces/IN2M_ERCBase.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// File: contracts/interfaces/IN2M_ERCCommon.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// File: contracts/interfaces/IN2M_ERCLibrary.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// File: contracts/interfaces/IN2M_ERCStorage.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// File: contracts/interfaces/IN2MBeaconFactory.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// File: contracts/interfaces/IN2MERC1155.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// File: contracts/interfaces/IN2MERC721.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// File: contracts/interfaces/IReverseRegistrar.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// File: contracts/N2MCommonStorage.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// File: contracts/N2MTokenCommon.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
...
// File: contracts/ownable/NFTOwnableUpgradeable.sol
/** ---------------------------------------------------------------------------- //
 *                                                                               //
 *                                       .:::.                                   //
 *                                    .:::::::.                                  //
