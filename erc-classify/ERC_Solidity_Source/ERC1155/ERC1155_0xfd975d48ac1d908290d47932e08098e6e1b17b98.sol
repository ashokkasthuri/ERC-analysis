// File: contracts/noox-protocol/badge/BadgeV3.sol
    ...
    UUPSUpgradeable
{
    ...
    uint256 internal constant CHAIN_ID_OFFSET_MULTIPLIER = PUBLISHER_OFFSET_MULTIPLIER / uint256(2)**16;
...
/// @custom:oz-upgrades-unsafe-allow constructor
    ...
    function initialize(string memory _initUri) public initializer {
        ...
        _uri = _initUri;
        _chainId = uint256(uint16(block.chainid));
    }
    ...
    function wasPublished(uint256 badgeId) public view virtual returns (bool) {
    ...
    function getCurrentTokenIdForTest() public view virtual returns (uint256) {
    ...
    function _getFullUri(uint256 badgeId) internal virtual view returns (string memory) {
    ...
    function _publish(address publisher, string memory ipfsHash) internal virtual {
        _tokenIds.increment();
        uint256 newTokenId = _tokenIds.current();
        // owner (160) / Chain ID (16) / Counter Token ID (80)
        uint256 _badgeId = uint256(uint160(publisher)) * PUBLISHER_OFFSET_MULTIPLIER + // Publisher
            _chainId * CHAIN_ID_OFFSET_MULTIPLIER + // Chain ID
...
// File: contracts/noox-protocol/utils/Utils.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.2;
