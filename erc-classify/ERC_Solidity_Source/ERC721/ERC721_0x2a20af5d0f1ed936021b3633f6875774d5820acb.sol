...
// File: contracts/ERC-1155/Messina1155.sol
...
// File: contracts/ERC-1155/REC1155Snapshot.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/interfaces/IMessina1155.sol
// SPDX-License-Identifier: Apache 2
...
// File: contracts/interfaces/IMFTsManager.sol
// SPDX-License-Identifier: Apache 2
...
// File: contracts/interfaces/IMFTv2.sol
// SPDX-License-Identifier: Apache 2
    ...
    for (uint256 i = 0; i < ids.length; ++i) {
      ...
      if (from != address(0)) {
        if (balanceOf(from, ids[i]) == amounts[i]) {
          ...
          if (holders[ids[i]].length > index && holders[ids[i]][index] == from) {
