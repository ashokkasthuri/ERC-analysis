...
// File: src/auctions/AuctionEnums.sol
...
// File: src/auctions/AuctionStructs.sol
...
// File: src/auctions/IXAuction.sol
// SPDX-License-Identifier: UNLICENCED
pragma solidity 0.8.20;
...
// File: src/base/XNFTRoyaltyBase.sol
// SPDX-License-Identifier: UNLICENCED
...
// File: src/x-droids/Interfaces.sol
// SPDX-License-Identifier: UNLICENCED
...
// File: src/x-pods/XPodAuctions.sol
/*
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
@@      @@@,    @@@@@(     @@@    @/   &#       @        .@@@@@@  *@@@@@@@@@@* %@@@
@@        V.    @@@@@      @@@     /    @       @         %@@@        @@,        @@
