...
// File: contracts/AquarelleBioGenerativeAssets.sol
...
contract AquarelleBioGenerativeAssets is ERC721URIStorage, IERC721Enumerable, ERC721Enumerable, ERC2981, PaymentSplitter, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    address contractAddress;
    // the AquarelleAccessPass contract
    address accessPassContractAddress;

    constructor(address marketplaceAddress, 
                address deployedAQGPContractAddress,
                address[] memory _payees,
                uint256[] memory _shares) ERC721("Aquarelle Bio Generative Assets", "AQGB") PaymentSplitter(_payees, _shares) {
        contractAddress = marketplaceAddress;
        accessPassContractAddress = deployedAQGPContractAddress;
    }
    
    function contractURI() public view returns (string memory) {
        return "https://api.stage.adiem.com/synerative/aquarellebga";
    }
