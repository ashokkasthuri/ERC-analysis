...
// File: contracts/extensions/AirDropable.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.4;
...
// File: contracts/extensions/Burnable.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.4;
import "../libraries/CustomErrors.sol";
import "../libraries/BPS.sol";
...
abstract contract Burnable is ERC721LACore {
    ...
    function burnRedeemEditionTokens(
        ...
        whenPublicMintOpened(_editionId);
        ERC721State.ERC721LAState storage state = ERC721State
            ._getERC721LAState();
...
// File: contracts/extensions/IAccessControl.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.4;
...
// File: contracts/extensions/IAirDropable.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.4;
...
// File: contracts/extensions/IERC4906.sol
...
// File: contracts/extensions/IWhitelistable.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.4;
...
// File: contracts/extensions/LAInitializable.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.4;
...
// File: contracts/extensions/Whitelistable.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.4;
import "../libraries/BPS.sol";
import "../libraries/CustomErrors.sol";
...
import "../libraries/WhitelistableUtils.sol";
...
abstract contract Whitelistable is IWhitelistable, ERC721LACore {
    ...
    function whitelistMint(
        ...
        if (
            ...
            !WhitelistableUtils.isXCardHolder(
                xCardTokenId,
                state._xCardContractAddress
            )
        ) {
        ...
        WhitelistableUtils.whitelistMintAllowed(
            xCardTokenId,
            state._xCardContractAddress
        );
...
// File: contracts/extensions/WhitelistableState.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.4;
...
// File: contracts/extensions/Winter.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.4;
...
// File: contracts/extensions/WithOperatorRegistry.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.4;
import "../libraries/CustomErrors.sol";
...
// File: contracts/extensions/WithOperatorRegistryState.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.4;
import "operator-filter-registry/src/IOperatorFilterRegistry.sol";
...
// File: contracts/libraries/BitMaps/BitMaps.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.4;
...
// File: contracts/libraries/BitMaps/BitScan.sol
// SPDX-License-Identifier: UNLICENSED
/**
...
// File: contracts/libraries/BPS.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.4;
...
// File: contracts/libraries/LANFTUtils.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.4;
...
// File: contracts/libraries/WhitelistableUtils.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
library WhitelistableUtils {
    ...
    function whitelistMintAllowed(
        ...
        if (isXCardHolder(xCardTokenId, xCardContractAddress)) {
            if (
                !ILiveArtXcard(xCardContractAddress).isValidBlockNumber(
                    xCardTokenId
                )
            ) {
                revert CustomErrors.NotAllowed();
...
// File: contracts/platform/royalties/IRoyaltiesRegistry.sol
// SPDX-License-Identifier: UNLICENSED
...
// File: contracts/platform/royalties/RoyaltiesState.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.4;
...
// File: contracts/platform/royalties/specs/IRarible.sol
// SPDX-License-Identifier: UNLICENSED
...
// File: contracts/tokens/ERC721LA.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.4;
...
// File: contracts/tokens/ERC721LACore.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.4;
    ...
    IERC4906
{
    ...
    address public constant XCARD_MAINNET_ADDRESS =
    ...
    function initialize(
        ...
        _setWinterWallet(0xa8C10eC49dF815e73A881ABbE0Aa7b210f39E2Df);
        _initOperatorRegsitry();
    }
    ...
    function tokenURI(
        ...
        if (
            address(this) == 0x899568485f55eeed34BA4fB10f197d45Ae19C3Cb &&
    ...
    function whenPublicMintOpened(uint256 editionId) public view {
    ...
    function getXCardContractAddress() public view override returns (address) {
        ERC721State.ERC721LAState storage state = ERC721State
            ._getERC721LAState();
        address xCardContractAddress = state._xCardContractAddress;

        if (xCardContractAddress != address(0)) {
            return xCardContractAddress;
        }

        return XCARD_MAINNET_ADDRESS;
    }
}


// File: contracts/tokens/ERC721State.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.4;
...
// File: contracts/tokens/IERC721Events.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.4;
import "../libraries/BitMaps/BitMaps.sol";
import "../platform/royalties/IRoyaltiesRegistry.sol";
...
// File: contracts/tokens/IERC721LA.sol
// SPDX-License-Identifier: UNLICENSED
import "../libraries/BitMaps/BitMaps.sol";
import "../platform/royalties/IRoyaltiesRegistry.sol";
import "./IERC721Events.sol";
