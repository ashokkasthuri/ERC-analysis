// File: contracts/implementations/DropuERC721AReference.sol
// SPDX-License-Identifier: MIT
pragma solidity 0.8.18;

/**
 * @title Dropu ERC721A Function Reference
 ...
 */
contract DropuERC721AReference {
    struct BaseConfig {
    ...
    function defaultDropuFeePerToken() external view returns (uint256) {}

    function dropuFeePerToken() external view returns (uint256) {}

    function setDropuFeePerToken(uint256 _dropuFeePerToken) external {}

    function dropuPayoutAddress() external view returns (address) {}
    ...
    function setUserPayPlatformFee(bool _userPayPlatformFee) external {} 
    ...
    function dropuAdminAddress() external view returns (address) {}
    ...
    function getDefaultCreditCardMintAddresses()
        external
        pure
        returns (address[] memory _creditCardMintAddresses)
    {}

    function setDefaultCreditCardMintAddresses(
