...
contract JourneyAIdentitiesII is Ownable, ERC721A, PaymentSplitter, DefaultOperatorFilterer {
    ...
    uint public  MAX_SUPPLY = 218;
    uint public  MAX_TOTAL_PUBLIC = 218;
    uint public  MAX_TOTAL_WL = 218;
    ...
    constructor(uint96 _royaltyFeesInBips, address[] memory _team, uint[] memory _teamShares, string memory _baseURI) ERC721A("JourneyAIdentities II", "JRNYAI")
