...
contract DEVISBASED is ERCX {
    using Strings for uint256;
    string public dataURI;
    string public baseTokenURI;
    
    uint8 private constant _decimals = 18;
    uint256 private constant _totalTokens = 100;
    uint256 private constant _tokensPerNFT = 1;
    string private constant _name = "DEV IS BASED";
    string private constant _ticker = "$DEV404";
    ...
    require(id < _nextTokenId(), "DEV404: URI query for nonexistent token");

    string memory image;

    if (id < 40) { // 0-39: 40% Rarity
        image = "https://based404.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmouse.4133a5c9.png&w=3840&q=75";
    } else if (id < 70) { // 40-69: 30% Rarity
        image = "https://based404.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fkeyboard.b98ce7af.png&w=3840&q=75";
    } else if (id < 90) { // 70-89: 20% Rarity
        image = "https://based404.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fscreen.79c48804.png&w=3840&q=75";
    } else if (id < 99) { // 90-98: 9% Rarity
        image = "https://based404.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flaptop.ff381e1d.png&w=3840&q=75";
    } else if (id == 99) { // 99: 1% Rarity
        image = "https://based404.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcomputer.e2585c59.png&w=3840&q=75";
    } else {
        revert("ERCX: Invalid ID");
    }

    string memory jsonPreImage = string(abi.encodePacked('{"name": "BASED404 #', id.toString(), '","description":"Distributing 75% of UniV3 LP and Opensea fees among all $DEV404 stakers.","external_url":"https://based404.com","image":"', image, '"}'));
    return string(abi.encodePacked("data:application/json;utf8,", jsonPreImage));
}
