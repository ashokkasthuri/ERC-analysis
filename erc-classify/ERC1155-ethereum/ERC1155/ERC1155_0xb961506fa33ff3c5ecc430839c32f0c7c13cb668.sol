...
// File: contracts/external/MigrateIncentives.sol
// SPDX-License-Identifier: GPL-3.0-only
pragma solidity =0.7.6;
pragma abicoder v2;
...
// File: contracts/internal/balances/protocols/AaveHandler.sol
// SPDX-License-Identifier: GPL-3.0-only
pragma solidity =0.7.6;
pragma abicoder v2;
...
// File: contracts/internal/markets/AssetRate.sol
// SPDX-License-Identifier: GPL-3.0-only
pragma solidity =0.7.6;
pragma abicoder v2;
...
// File: interfaces/aave/IAToken.sol
// SPDX-License-Identifier: GPL-3.0-only
pragma solidity >=0.7.6;
