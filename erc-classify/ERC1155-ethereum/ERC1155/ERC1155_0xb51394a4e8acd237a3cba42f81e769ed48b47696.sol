...
// File: contracts/interfaces/IRental.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
interface ITicket {
    ...
    function setCDS(address _cds) external;

    function setMiner(address _miner) external;
}


// File: contracts/PausableV2.sol
...
contract Ticket is ERC1155(""), ITicket, IRental, IERC1155Receiver, PausableV2 {
    ...
    * */
    ...
    function setCDS(address _cds) external onlyOwner {
        require(cds == address(0));
        cds = _cds;
    }
