...
// File: src/protocols/vinox/lib/types.sol
...
// File: src/protocols/vinox/tokens/WineNFT.sol
// SPDX-License-Identifier: MIT
...
contract WineNFT is ERC1155Base, ERC1155Supply, Ownable {
    ...
    function _beforeTokenTransfer(
        ...
        uint256[] memory amounts,
        bytes memory data
    ) internal override(ERC1155Base, ERC1155Supply) {
        super._beforeTokenTransfer(operator, from, to, ids, amounts, data);
    }
}

// File: src/tokens/ERC1155Base.sol
// SPDX-License-Identifier: MIT
...
abstract contract ERC1155Base is ERC1155Burnable, Pausable {
    /**
     * @dev See {ERC1155-_beforeTokenTransfer}.
     *
     * Requirements:
