...
contract TyraniteDrill is ERC1155, Ownable {
  ...
  function teamDist (address team1,address team2,address team3,address team4) public onlyOwner{
    if (dist == true) revert ("One Time Use Only");
    _mint(team1,1,6,"CE0");
    _mint(team2,1,3,"F4TM4N");
    _mint(team3,1,3,"Cr0w");
    _mint(team4,1,3,"NJ0RDR");
    totalSupply+=15;
    dist = true;
