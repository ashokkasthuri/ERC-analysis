...
// File: contracts/Ether Dos ft. Ghost of Makaveli by Hashtag Daddy.sol

pragma solidity ^0.8.17;

contract EtherDosftGhostofMakavelibyHashtagDaddy is ERC1155, Ownable, ERC1155Burnable, ERC1155Supply, ReentrancyGuard, ERC2981, DefaultOperatorFilterer {
    ...
    /// @notice Mapping for token uri.
    mapping(uint256 => string) private _tokenUri;

    string private _name = "Ether Dos ft Ghost of Makaveli by Hashtag Daddy";

    string private _symbol = "EDFGOMBHD";
     ...
     * Function mints entered amount of NFT tokenId to the recipient.
     */
    ...
    /**
     * @notice Smart contract owner only function.
     * Functions batch mints NFT tokenIds and their respective amounts to the recipient.
     */
    function mintBatch(address recipient, uint256[] memory tokenIds, uint256[] memory amounts) public onlyOwner {
        _mintBatch(recipient, tokenIds, amounts, "");
    }

    /**
     * @notice Smart contract owner only function.
     * Function sets the uri of a tokenId.
     */
    ...
    /// @notice Function returns whether interfaceId is supported, gives true or false response.
    function supportsInterface(bytes4 interfaceId) public view virtual override (ERC1155, ERC2981) returns (bool) {
        return super.supportsInterface(interfaceId);
    }

    /// @notice Function returns the uri of the tokenId.
