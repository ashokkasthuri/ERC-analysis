...
contract ERC1155G is Context, ERC165, ERC2981, IERC1155, IERC1155MetadataURI {
    ...
    mapping(uint256 => bool) public is_locked_supply;
    ...
    function _set_locked_supply_tokens(
        uint256 _tokenid,
        bool _is_locked_supply
    ) internal {
        is_locked_supply[_tokenid] = _is_locked_supply;
    }
    ...
    function _mint(
        ...
        require(!is_locked_supply[id], "This token is not open for mint!");
    ...
    function _mintBatch(
        ...
        for (uint256 i = 0; i < ids.length; i++) {
            require(
                !is_locked_supply[ids[i]],
                "This token is not open for mint!"
            );
