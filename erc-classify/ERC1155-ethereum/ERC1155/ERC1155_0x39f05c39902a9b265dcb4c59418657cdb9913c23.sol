...
// File: contracts/nfts/interfaces/IParallelAlphaInvokeProxy.sol
// SPDX-License-Identifier: MIT
pragma solidity 0.8.17;

interface IParallelAlphaProxy {
    /**
...
// File: contracts/nfts/ParallelAlphaInvokeProxy.sol
// SPDX-License-Identifier: MIT

pragma solidity 0.8.17;

import { ONFT1155Core, IONFT1155Core } from "@layerzerolabs/solidity-examples/contracts/token/onft/ONFT1155Core.sol";
...
contract ParallelAlphaProxy is
    IParallelAlphaProxy,
    Ownable,
    ONFT1155Core,
    ERC1155Holder
{
    ...
    /// @param _parallelAlpha parallel alpha address
    constructor(
        address _lzEndpoint,
