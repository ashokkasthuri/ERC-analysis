...
// File: contracts/SupercuteArtifacts.sol
//SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
contract SupercuteArtifacts is ERC1155Supply, Ownable,OperatorFilterer,ERC2981 {
    ...
    constructor(
    ) ERC1155("Supercute Artifacts") {
        setURI(0,"https://supercuteworld-artifacts.s3.amazonaws.com/metadata/0.json");
    ...
    function mint(uint256 _id, bytes memory signature,uint expirationTimestamp,uint256 maxSupply) external  {
        bytes32 hash = keccak256(abi.encodePacked(msg.sender, _id, maxSupply,expirationTimestamp,nonce,"ARTIFACTS"));
