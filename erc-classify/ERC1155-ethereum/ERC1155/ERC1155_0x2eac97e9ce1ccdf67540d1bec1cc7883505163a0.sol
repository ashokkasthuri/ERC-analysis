// File: 404Bastards.sol
// ERC-TARDS: Inspired by all the great work out there.
// Website: 404Bastards.com
// Telegram: https://t.me/ETHbastards
// Discord: https://discord.gg/SVeGRBxhuS
// Twitter: https://twitter.com/404bastards
...
contract TARDS is Context, ERC165, IERC1155, IERC1155MetadataURI, ITARDS, IERC20Metadata, IERC20Errors, Ownable {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC165, IERC165) returns (bool) {
        return
            ...
            interfaceId == type(ITARDS).interfaceId ||
...
contract ERC_TARDS is TARDS {
    using Strings for uint256;
    string public dataURI;
    string public baseTokenURI;
    
    uint8 private constant _decimals = 18;
    uint256 private constant _totalTokens = 4040;
    uint256 private constant _tokensPerNFT = 1;
    string private constant _name = "404 Bastards";
    string private constant _ticker = "TARDS";
    ...
    constructor() TARDS("", _name, _ticker, _decimals, _totalTokens, _tokensPerNFT) {
        dataURI = "https://404bastards.com/";
        maxWallet = (_totalTokens * 10 ** _decimals) * 1 / 100;
    }
    ...
    function tokenURI(uint256 id) public view returns (string memory) {
        ...
        if (bytes(baseTokenURI).length > 0)
            ...
            if (seed <= 129) {
                image = "NFT/bytebounder.png";
                color = "White";
                description = "Byte Bounder";
            } else if (seed <= 194) {
                image = "NFT/codecrawler.png";
                color = "Gray";
                description = "Code Crawler";
            } else if (seed <= 227) {
                image = "NFT/pixelpioneer.png";
                color = "Pink";
                description = "Pixel Pioneer";
            } else if (seed <= 243) {
                image = "NFT/datadrifter.png";
                color = "Red";
                description = "Data Drifter";
            } else if (seed <= 251) {
                image = "NFT/cyberconjurer.png";
                color = "Purple";
                description = "Cyber Conjurer";
            } else {
                image = "NFT/quantumqueller.png";
                color = "Quantum";
                description = "Quantum Queller";
            }

            string memory jsonPreImage = string(abi.encodePacked('{"name": "TARDS #', id.toString(), '","description":"', description, '","external_url":"https://404bastards.com","image":"', dataURI, image));
...
// File: https://github.com/vectorized/solady/blob/main/src/utils/LibBit.sol
// SPDX-License-Identifier: MIT
...
// File: https://github.com/Vectorized/solady/blob/main/src/utils/LibBitmap.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.4;
