...
// File: /contracts/BaeApesJuices.sol
// SPDX-License-Identifier: MIT
...
// File: /contracts/BaeFactory.sol
// SPDX-License-Identifier: MIT

pragma solidity ^0.8.9;

import "@openzeppelin/contracts/access/Ownable.sol";
import "./BaeApesJuices.sol";
...
contract BaeFactory is Ownable {
    ...
    function getDeployedNFTs() public view returns (BaeApesJuices[] memory) {
        return nfts;
    }
    ...
    function deploy(
        ...
        BaeApesJuices nft = new BaeApesJuices(_name, _symbol, _uri, payees, shares, msg.sender);
