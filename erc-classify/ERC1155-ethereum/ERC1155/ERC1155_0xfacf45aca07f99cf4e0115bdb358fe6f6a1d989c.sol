...
// File: contracts/aspen/api/agreement/IAgreement.sol
...
// File: contracts/aspen/api/baseURI/IUpdateBaseURI.sol
// SPDX-License-Identifier: Apache-2.0
...
// File: contracts/aspen/api/config/IGlobalConfig.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/api/config/IOperatorFilterersConfig.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/api/config/IPlatformFeeConfig.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/api/config/ITieredPricing.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/api/config/types/OperatorFiltererDataTypes.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/api/config/types/TieredPricingDataTypes.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/api/deploy/types/DropFactoryDataTypes.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/api/errors/IDropErrors.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/api/errors/ITermsErrors.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/api/IAspenFeatures.sol
// SPDX-License-Identifier: Apache-2.0
...
// File: contracts/aspen/api/IAspenVersioned.sol
// SPDX-License-Identifier: Apache-2.0
...
// File: contracts/aspen/api/impl/IAspenERC1155Drop.sol
// SPDX-License-Identifier: Apache 2.0
...
// File: contracts/aspen/api/IMulticallable.sol
// SPDX-License-Identifier: Apache-2.0
...
// File: contracts/aspen/api/issuance/ICedarSFTIssuance.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
interface ICedarSFTIssuanceV0 is IDropClaimConditionV0 {
     ...
     *  @param quantity                       The quantity of NFTs to claim.
     */
    function issue(address receiver, uint256 tokenId, uint256 quantity) external;
}
...
interface IDelegatedSFTIssuanceV0 is IDropClaimConditionV1 {
    ...
    function getClaimConditionById(
        uint256 _tokenId,
        uint256 _conditionId
    ) external view returns (ClaimCondition memory conditions);
...
interface IDelegatedSFTIssuanceV1 is IDelegatedSFTIssuanceV0 {
    function getTransferTimesForToken(
        address owner,
        uint256 tokenId
    ) external view returns (uint256[] memory quantityOfTokens, uint256[] memory transferableAt);

    function getIssueBufferSizeForAddressAndToken(
        address _tokenOwner,
        uint256 _tokenId
...
interface IRestrictedSFTIssuanceV4 is IDropClaimConditionV1 {
    ...
    function issueWithinPhase(address receiver, uint256 tokenId, uint256 quantity) external;
...
interface IRestrictedSFTIssuanceV5 is IDropClaimConditionV1 {
    ...
    function chargebackWithdrawal(address owner, uint256 tokenId, uint256 quantity) external;
...
interface IRestrictedSFTIssuanceV6 is IRestrictedSFTIssuanceV5 {
    function batchIssue(address[] memory _receivers, uint256[] memory _tokenIds, uint256[] memory _quantities) external;

    function batchIssueWithinPhase(
...
// File: contracts/aspen/api/issuance/IDropClaimCondition.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/api/issuance/ISFTClaimCount.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/api/issuance/ISFTLimitSupply.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/api/issuance/ISFTSupply.sol
// SPDX-License-Identifier: Apache-2.0
...
// File: contracts/aspen/api/lazymint/ILazyMint.sol
// SPDX-License-Identifier: Apache-2.0
...
// File: contracts/aspen/api/metadata/IContractMetadata.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/api/metadata/ISFTMetadata.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/api/ownable/IOwnable.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/api/pausable/IPausable.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/api/primarysale/IPrimarySale.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8.0;
...
// File: contracts/aspen/api/royalties/IPlatformFee.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/api/royalties/IRoyalty.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/api/standard/IERC1155.sol
// SPDX-License-Identifier: Apache-2.0
...
// File: contracts/aspen/api/standard/IERC2981.sol
// SPDX-License-Identifier: Apache-2.0
...
// File: contracts/aspen/api/standard/IERC4906.sol
// SPDX-License-Identifier: Apache-2.0
...
// File: contracts/aspen/drop/AspenERC1155Drop.sol
// SPDX-License-Identifier: Apache-2.0
...
// File: contracts/aspen/drop/AspenERC1155DropLogic.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/drop/AspenERC1155DropStorage.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/drop/extension/operatorFilterer/DefaultOperatorFiltererUpgradeable.sol
// SPDX-License-Identifier: Apache 2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/drop/extension/operatorFilterer/interfaces/IOperatorFilterRegistry.sol
// SPDX-License-Identifier: Apache 2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/drop/extension/operatorFilterer/OperatorFiltererUpgradeable.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8;
...
// File: contracts/aspen/drop/extension/operatorFilterer/OperatorFilterToggle.sol
// SPDX-License-Identifier: Apache 2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/drop/extension/operatorFilterer/UpdateableDefaultOperatorFiltererUpgradeable.sol
// SPDX-License-Identifier: Apache 2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/drop/interfaces/IWETH.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/drop/lib/CurrencyTransferLib.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/drop/lib/FeeType.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/drop/lib/MerkleProof.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/aspen/drop/openzeppelin-presets/metatx/ERC2771ContextUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/aspen/drop/types/DropERC1155DataTypes.sol
// SPDX-License-Identifier: Apache-2.0
pragma solidity ^0.8;
...
// File: contracts/aspen/generated/impl/BaseAspenERC1155DropV4.sol
// SPDX-License-Identifier: Apache-2.0
...
// File: contracts/aspen/terms/lib/TermsLogic.sol
// SPDX-License-Identifier: Apache-2.0
...
// File: contracts/aspen/terms/types/TermsDataTypes.sol
// SPDX-License-Identifier: Apache-2.0
