...
contract MetaDriver is ERC1155, Ownable, DefaultOperatorFilterer {
    string public name = "Meta Driver";
    string public symbol = "METAD";
    string private hiddenURI = "ipfs://QmUXDKTsnoxs13ZQ9ynxF2s54XmzSMbqhR7dFAaQPGMotn/hidden.json";
    uint256 public collectionEndID = 777;
    uint256 private cost = 0.02 ether;
    uint256 public maxMintAmount = 3;
    uint256 public maxBatchMintAmount = 3;
    ...
    */
    ...
    function isValid(bytes32[] calldata proof, uint _fromBatch, bytes32 leaf) public view returns (bool) {
        require(MerkleProof.verify(proof, rootForBatch[_fromBatch], leaf), "Verification Failed");
