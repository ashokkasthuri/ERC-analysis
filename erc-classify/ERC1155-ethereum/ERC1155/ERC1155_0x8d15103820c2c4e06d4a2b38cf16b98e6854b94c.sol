...
contract FreakyPass is ERC1155, ERC1155Supply, Manageable, DefaultOperatorFilterer {
    ...
    uint8 constant public MAX_TOKENS_PRIVATE_SALE = 1;
    ...
    uint256 public privateSaleTokenPrice = 0.4 ether;
    uint256 public whitelistSaleTokenPrice = 0.4 ether;

    uint32 public privateSaleStartTime = 1671714000;
    uint32 public whitelistSaleStartTime = 1682337600;
...
// File: utils/operator_filterer/DefaultOperatorFilterer.sol
// SPDX-License-Identifier: MIT
...
// File: utils/operator_filterer/OperatorFilterer.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.13;
...
// File: utils/operator_filterer/IOperatorFilterRegistry.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.13;
