// File: lib/openzeppelin-contracts-upgradeable/contracts/interfaces/IERC3156FlashBorrowerUpgradeable.sol
...
// File: lib/openzeppelin-contracts-upgradeable/contracts/interfaces/IERC3156FlashLenderUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// File: lib/openzeppelin-contracts-upgradeable/contracts/token/ERC1155/utils/ERC1155ReceiverUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// File: lib/openzeppelin-contracts-upgradeable/contracts/utils/Create2Upgradeable.sol
// SPDX-License-Identifier: MIT
...
// File: src/custom/InventoryStakingDescriptor.sol
...
// File: src/custom/OwnableUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// File: src/custom/proxy/IBeacon.sol
// SPDX-License-Identifier: MIT
...
// File: src/custom/tokens/ERC20/ERC20FlashMintUpgradeable.sol
// SPDX-License-Identifier: MIT
...
// File: src/custom/tokens/ERC20/ERC20Upgradeable.sol
// SPDX-License-Identifier: MIT
...
// File: src/interfaces/external/IPermitAllowanceTransfer.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
// File: src/interfaces/IDelegateRegistry.sol
...
// File: src/interfaces/INFTXEligibility.sol
// SPDX-License-Identifier: MIT
...
// File: src/interfaces/INFTXEligibilityManager.sol
// SPDX-License-Identifier: MIT
...
// File: src/interfaces/INFTXFeeDistributorV3.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
// File: src/interfaces/INFTXInventoryStakingV3.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
// File: src/interfaces/INFTXRouter.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
// File: src/interfaces/INFTXVaultFactoryV3.sol
// SPDX-License-Identifier: MIT
...
// File: src/interfaces/INFTXVaultV3.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
// File: src/interfaces/ITimelockExcludeList.sol
// SPDX-License-Identifier: MIT
...
// File: src/lib/ExponentialPremium.sol
// SPDX-License-Identifier: MIT
...
// File: src/NFTXVaultUpgradeableV3.sol
// SPDX-License-Identifier: MIT
pragma solidity =0.8.15;
    ...
    ERC1155HolderUpgradeable
{
    ...
    function redeem(
        ...
        (
            ...
            address[] memory depositors
        ) = _withdrawNFTsTo(idsOut, to, _vaultFactory);
        ...
        ethFees = _chargeAndDistributeFeesForRedeem(
            ethOrWethAmt,
            msg.value > 0,
            deductFees ? totalVaultFee : 0, // only bypass vault redeem fees if !deductFees. Premium still gets charged
            netVTokenPremium,
            vTokenPremiums,
            depositors
        );
    ...
    function shutdown(
        ...
        _withdrawNFTsTo(tokenIds, recipient, vaultFactory);
        ...
        )
    {
        ...
        uint256 premiumMax = _vaultFactory.premiumMax();
        uint256 premiumDuration = _vaultFactory.premiumDuration();
    ...
    function _chargeAndDistributeFeesForRedeem(
        ...
        uint256 vTokenPriceInETH;
        INFTXFeeDistributorV3 feeDistributor;

        // only query TWAP if required
        if (totalVaultFees > 0 || netVTokenPremium > 0) {
            (vTokenPriceInETH, feeDistributor) = _vTokenToETH(
                vaultFactory,
                BASE // 1 vToken
            );

            // pool exists and we have a TWAP
            if (vTokenPriceInETH > 0) {
                uint256 vaultETHFees = (totalVaultFees * vTokenPriceInETH) /
                    BASE;
                ...
                if (netVTokenPremium > 0) {
                    netETHPremium =
                        (netVTokenPremium * vTokenPriceInETH) /
                        BASE;
...
// File: src/uniswap/v3-core/interfaces/callback/IUniswapV3SwapCallback.sol
// SPDX-License-Identifier: GPL-2.0-or-later
...
// File: src/uniswap/v3-core/interfaces/IUniswapV3Factory.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// File: src/uniswap/v3-core/interfaces/IUniswapV3Pool.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// File: src/uniswap/v3-core/interfaces/pool/IUniswapV3PoolActions.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// File: src/uniswap/v3-core/interfaces/pool/IUniswapV3PoolDerivedState.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// File: src/uniswap/v3-core/interfaces/pool/IUniswapV3PoolErrors.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// File: src/uniswap/v3-core/interfaces/pool/IUniswapV3PoolEvents.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// File: src/uniswap/v3-core/interfaces/pool/IUniswapV3PoolImmutables.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// File: src/uniswap/v3-core/interfaces/pool/IUniswapV3PoolOwnerActions.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// File: src/uniswap/v3-core/interfaces/pool/IUniswapV3PoolState.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// File: src/uniswap/v3-core/libraries/FixedPoint96.sol
// SPDX-License-Identifier: GPL-2.0-or-later
...
// File: src/uniswap/v3-core/libraries/FullMath.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
// File: src/uniswap/v3-core/libraries/SafeCast.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// File: src/uniswap/v3-core/libraries/TickMath.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity ^0.8.0;
...
// File: src/uniswap/v3-periphery/base/BlockTimestamp.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity =0.8.15;
...
// File: src/uniswap/v3-periphery/base/Multicall.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity =0.8.15;
pragma abicoder v2;
...
// File: src/uniswap/v3-periphery/base/PeripheryImmutableState.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity =0.8.15;
...
// File: src/uniswap/v3-periphery/base/PeripheryPayments.sol
// SPDX-License-Identifier: GPL-2.0-or-later
...
// File: src/uniswap/v3-periphery/base/PeripheryPaymentsWithFee.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.7.5;
...
// File: src/uniswap/v3-periphery/base/PeripheryValidation.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity =0.8.15;
...
// File: src/uniswap/v3-periphery/base/SelfPermit.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// File: src/uniswap/v3-periphery/interfaces/external/IERC20PermitAllowed.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// File: src/uniswap/v3-periphery/interfaces/external/IWETH9.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity ^0.8.0;
...
// File: src/uniswap/v3-periphery/interfaces/IERC721Permit.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.7.5;
...
// File: src/uniswap/v3-periphery/interfaces/IMulticall.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.7.5;
pragma abicoder v2;
...
// File: src/uniswap/v3-periphery/interfaces/INonfungiblePositionManager.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.7.5;
pragma abicoder v2;
...
// File: src/uniswap/v3-periphery/interfaces/IPeripheryImmutableState.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// File: src/uniswap/v3-periphery/interfaces/IPeripheryPayments.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.7.5;
...
// File: src/uniswap/v3-periphery/interfaces/IPeripheryPaymentsWithFee.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.7.5;
...
// File: src/uniswap/v3-periphery/interfaces/IPoolInitializer.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.7.5;
pragma abicoder v2;
...
// File: src/uniswap/v3-periphery/interfaces/IQuoterV2.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.7.5;
pragma abicoder v2;
...
// File: src/uniswap/v3-periphery/interfaces/ISelfPermit.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.7.5;
...
// File: src/uniswap/v3-periphery/interfaces/ISwapRouter.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity ^0.8.0;
...
// File: src/uniswap/v3-periphery/libraries/base64.sol
// SPDX-License-Identifier: MIT
...
// File: src/uniswap/v3-periphery/libraries/BytesLib.sol
// SPDX-License-Identifier: GPL-2.0-or-later
/*
...
// File: src/uniswap/v3-periphery/libraries/CallbackValidation.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity ^0.8.0;
...
// File: src/uniswap/v3-periphery/libraries/HexStrings.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
// File: src/uniswap/v3-periphery/libraries/Path.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.6.0;
...
// File: src/uniswap/v3-periphery/libraries/PoolAddress.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// File: src/uniswap/v3-periphery/libraries/TransferHelper.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.6.0;
...
// File: src/uniswap/v3-periphery/SwapRouter.sol
// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity =0.8.15;
pragma abicoder v2;
