...
// File: /contracts/INumberSupply.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;

interface INumberSupply {
    function getNumber(uint256 startIndex) external returns (uint256) ;
}
