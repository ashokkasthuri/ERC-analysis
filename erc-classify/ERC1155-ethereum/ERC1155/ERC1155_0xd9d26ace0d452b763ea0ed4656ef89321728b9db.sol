 ...
 * @notice This contract handles minting arenaRPG tokens.
 */
contract ArenaRPG is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x6051ACEB988579d6293Cf938363E115114FA9b41;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xC2662C709482E1b5d118a3406Dc86F01602BBD28;
    address[] public payoutAddresses = [
        0xC2662C709482E1b5d118a3406Dc86F01602BBD28
    ];
    ...
    uint96 public royaltyFee = 210;

    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeihg3dbwk4hutwnn2mhtuqwwzuocc6znqqwojr5w5yar7pmmfktzbe/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[100] = 100;
        tokenPublicPrice[100] = 0.02 ether;
        tokenPublicMintsPerAddress[100] = 2;
        require(
