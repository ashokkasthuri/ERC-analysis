...
// File: contracts/ERC1155Upgradable.sol
// SPDX-License-Identifier: CLOSED - Pending Licensing Audit
...
contract ERC1155Upgradable is ERC165, IERC1155MetadataURI, IsSerializedUpgradable, Clonable, ERC2981Royalties, UpgradableERC1155, OperatorFiltererUpgradeable {
    ...
    function mintBatch(address[] memory to, uint256[] memory ids, uint256[] memory amounts, bytes[] memory serialNumbers, bool silent) public onlyOwner {
        _mintBatch(to, ids, amounts, serialNumbers, silent);
    }
    ...
    function _mintSilent(address account, uint256 id, uint256 amount, bytes memory serialNumber) internal virtual {
        if (isSerialized()) {
            for (uint i = 0; i < amount; i++) {
                if (overloadSerial){
                    require(toUint256(serialNumber, 0) != 0, "Must provide serial number");
    ...
    function _mintBatch(address[] memory to, uint256[] memory ids, uint256[] memory amounts, bytes[] memory serialNumbers, bool silent) internal virtual {
        ...
        for (uint i = 0; i < ids.length; i++) {
            ...
            !silent ? _mint(to[i], ids[i], amounts[i], _serialNumber): _mintSilent(to[i], ids[i], amounts[i], _serialNumber);
        }        
    }
...
// File: contracts/EventableERC1155.sol
// SPDX-License-Identifier: CLOSED - Pending Licensing Audit
pragma solidity ^0.8.4;
...
// File: contracts/HasRegistration.sol
// SPDX-License-Identifier: CLOSED - Pending Licensing Audit
pragma solidity ^0.8.4;
...
// File: contracts/IHandlerCallback.sol
// SPDX-License-Identifier: CLOSED - Pending Licensing Audit
pragma solidity ^0.8.4;
...
// File: contracts/IsBypassable.sol
// SPDX-License-Identifier: CLOSED - Pending Licensing Audit
pragma solidity ^0.8.4;
...
// File: contracts/IsClaimable.sol
// SPDX-License-Identifier: CLOSED - Pending Licensing Audit
pragma solidity ^0.8.4;
import "./OwnableUpgradeable.sol";
...
// File: contracts/IsSerializedUpgradable.sol
// SPDX-License-Identifier: CLOSED - Pending Licensing Audit
pragma solidity ^0.8.4;
...
// File: contracts/UpgradableERC1155.sol
// SPDX-License-Identifier: CLOSED - Pending Licensing Audit
pragma solidity ^0.8.4;
