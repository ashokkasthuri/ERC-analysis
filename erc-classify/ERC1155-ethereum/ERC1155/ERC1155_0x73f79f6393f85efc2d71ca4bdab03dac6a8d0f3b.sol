    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x90926B8CCb6dd565950F2955f81921725b3a394f;
    address public royaltyAddress = 0x243AEdEa472a851a8e530303283cfb3dB200e9e3;
    address[] public payoutAddresses = [
        0x243AEdEa472a851a8e530303283cfb3dB200e9e3
    ];
    ...
    string public symbol = "Chain Farmers";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeibcyqubx6f5sqeiznbafkimi25jndsp7pl5vmdp77tho7gayodkyu/{id}"
        )
        RevokableOperatorFilterer(
