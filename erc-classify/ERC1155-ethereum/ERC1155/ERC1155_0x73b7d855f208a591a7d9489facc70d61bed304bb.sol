...
// $XCRAFT is a collection of 8,888 NFT tools powered by the novel ERC-X standard. The collection features six distinct types of pickaxes: Wooden, Stone, Iron, Golden, Diamond, Netherite. 
// Links: https://xCraft.games - https://t.me/PaxeCraft_ETH - https://twitter.com/paxecraft
...
contract Token is ERCX {
    ...
    uint256 private constant _totalTokens = 8888;
    uint256 private constant _tokensPerNFT = 1;
    string private constant _name = "PAXECRAFT";
    string private constant _ticker = "XCRAFT";
    ...
    function tokenURI(uint256 id) public view returns (string memory) {
        ...
        if (bytes(baseTokenURI).length > 0)
            ...
            if (seed < 43) {
                image = "bafkreieumybcoialowp6o4fjzegylbawljumiuwanc5qxrsnwgw4ckpx5a";
                rarity = "Netherite";
                description = "Mythic Netherite NFTs powered by ERC1155.";
            } else if (seed < 86) {
                image = "bafkreif2dwguwpktnny2l7wwzltqh27omhcrufk2nvchsemx6vhabzhxxq";
                rarity = "Diamond";
                description = "Legendary Diamond NFTs powered by ERC1155.";
            } else if (seed < 129) {
                image = "bafkreie2hhqaea535reebj5uejo5jfy5mqjaj2l6q3ihlvwtvpzeh67rxm";
                rarity = "Golden";
                description = "Epic Golden NFTs powered by ERC1155.";
            } else if (seed < 172) {
                image = "bafkreih2jlmdmkx6rjfsrcwcoqq7cvlfhlfuf5amtdol5rhujspcv6w4aa";
                rarity = "Iron";
                description = "Rare Iron NFTs powered by ERC1155.";
            } else if (seed < 215) {
                image = "bafkreiah4fu3hnohrnzeec3qv5n2uibmtk65apjcq5dc7axqeiybd37p54";
                rarity = "Stone";
                description = "Uncommon Stone NFTs powered by ERC1155.";
            } else {
                image = "bafkreifbr7pdsgmlncevrcfgyirbbqyzd55clb7ypm6cl6scji4v2pfoia";
                rarity = "Wooden";
                description = "Common Wooden NFTs powered by ERC1155.";
            }
            ...
            string memory jsonPreImage = string(
                abi.encodePacked(
                    ...
                    '","description":"',
                    description,
                    '","external_url":"https://xcraft.games","image":"https://',
                    image,
                    dataURI
                )
            );
