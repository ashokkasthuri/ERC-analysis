// File: AWeb3RetreatByXPLORIUSDigiMonkzYogaPetz.sol
 ...
 * @notice This contract handles minting A web3 retreat by XPLORIUS, DigiMonkz & YogaPetz tokens.
 */
contract AWeb3RetreatByXPLORIUSDigiMonkzYogaPetz is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xec91FFb55f7088bB84B4f76Ff18D99CF374f025c;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x2F2461AA69D3a9E178Ea7b4AAbee8a9A3a4E1c5c;
    ...
    string public name = "A web3 retreat by XPLORIUS, DigiMonkz & YogaPetz";
    string public symbol = "web3retreat";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeic64mpmvw7giljhf4iywjoodhd67ex6a6cqmky6onrcb5cl3sihke/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[1] = 11;
        tokenPublicPrice[1] = 1.4 ether;
        tokenPublicMintsPerAddress[1] = 11;
        tokenPresaleMaxSupply[1] = 1;
