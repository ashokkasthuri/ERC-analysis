 ...
 * @notice This contract handles minting Opependulum tokens.
 */
contract Opependulum is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x9b2bcB41723Bcf4e017D3238D6EcA5c915c4a789;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xA5195567Bd108718B80673Cb6c5c6Ba96f110a01;
    ...
    address[] public payoutAddresses = [
        0xA5195567Bd108718B80673Cb6c5c6Ba96f110a01
    ];
    ...
    string public name = "Opependulum";
    string public symbol = "ppndl";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeicw2vqiektaxz4roocomx2zifxgzaeo2leohygapd2ryrpryqgxzi/{id}"
        )
        RevokableOperatorFilterer(
