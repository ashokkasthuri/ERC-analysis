...
library Counters {
    ...
    function incrementBy(Counter storage counter, uint256 count) internal {
        uint256 value = counter._value;
        require(
            value + count <= type(uint256).max,
...
// File: contracts/ERC1155URIStorageUpgradeable.sol
...
// File: contracts/Interfaces/INF3CommunityCard.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.9;
...
// File: contracts/NF3CommunityCard.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.9;
...
import "./Counters.sol";
import "./Interfaces/INF3CommunityCard.sol";
