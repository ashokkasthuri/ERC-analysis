...
contract BULLYMFTERC1155 is ERC69_1155 {
    constructor(
        string memory name,
        ...
        uint256 tokenAmount,
        uint256 maxSupply
    ) ERC69_1155(name, symbol, baseURI, erc20Token, tokenAmount, maxSupply) {}
}
    ...
    ReentrancyGuard
{
    ...
    function unwrap(uint256 amount_) public virtual nonReentrant {
        ...
        _erc20Token.transfer(msg.sender, _tokenAmount * amount_);
