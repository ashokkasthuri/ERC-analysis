...
// File: contracts/ERC1155PresetMinter.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/ERC1155SupplyWithAll.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
// File: contracts/MonorixLads.sol
// SPDX-License-Identifier: MIT
...
contract MonorixLads is ERC1155PresetMinter, ReentrancyGuard {
  ...
  function mintBatch(
    ...
    for (uint256 i = from; i < to; i++) {
      require(totalSupply() + amount <= maxSupply, 'Max supply exceeded!');
      _mint(_msgSender(), i, amount, '');
    }
  }

  function uri(uint256 _tokenID) public view override returns (string memory) {
    require(exists(_tokenID), 'nonexistent token');
