...
contract Avatars is Base1155 {
    ...
    ) external onlyOwner mintIsNotLocked {
        require(_tos.length == _amounts.length, "ERC1155: tos and amounts length mismatch");

        for (uint i; i < _tos.length; i++) {
            _mint(_tos[i], _tokenId, _amounts[i], "");
        }
    }
}


// File: contracts/interfaces/IMetadataResolver.sol
// SPDX-License-Identifier: MIT
// @author: NFT Studios
...
// File: contracts/libraries/ProtectedMintBurn.sol
// SPDX-License-Identifier: MIT
// @author: NFT Studios
...
// File: contracts/tokens/Base1155.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.18;
...
contract Base1155 is ERC1155, ERC2981, Ownable, Lockable, ProtectedMintBurn {
