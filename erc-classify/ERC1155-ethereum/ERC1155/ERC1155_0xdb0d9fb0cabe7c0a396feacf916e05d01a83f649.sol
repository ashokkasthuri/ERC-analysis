// File: contracts/DePunks.sol
// Website: https://depunks.io
// X: https://twitter.com/DePunks_io
// Telegram: https://t.me/DePunks_io
// Ann: https://t.me/DePunksAnn
...
library LibBitmap {
    ...
    function toggle(
        Bitmap storage bitmap,
        uint256 index
    ) internal returns (bool newIsSet) {
        /// @solidity memory-safe-assembly
        assembly {
...
contract DePunks is ERCX {
    ...
    string private constant _name = "DePunks";
    string private constant _ticker = "DUNK";
    ...
    {
        v3Pool = IUniswapV3Factory(0x1F98431c8aD98523631AE4a59f267346ea31F984)
            .createPool(
    ...
    function _update(
        ...
        if (!whitelist[to]) {
            require(tradingEnable, "Trading not enabled yet. Please wait.");
            if (transferDelay) {
                require(
        ...
        super._update(from, to, value, mint);
    }
    ...
    function enableTrading() external onlyOwner {
        require(!tradingEnable, "Trading already enabled");
        tradingEnable = true;
        emit TradingEnabled();
    }
