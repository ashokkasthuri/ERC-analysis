...
// File: contracts/OpenMint/ERC1155Collection.sol
// SPDX-License-Identifier: MIT
    ...
    ERC1155URIStorage
{
    ...
    function mint(
        ...
        _mint(_account, tokenId, _amount, _data);
...
// File: contracts/OpenMint/ERC1155Deployer.sol
...
contract ERC1155Deployer {
  ...
  function deploy() external {
       ERC1155Collection erc1155 = new ERC1155Collection(msg.sender);
       emit ContractDeployed(address(erc1155) , msg.sender);
  }
