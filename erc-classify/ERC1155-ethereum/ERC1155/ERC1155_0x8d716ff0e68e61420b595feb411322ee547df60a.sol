...
contract AIFUN is ERCX {
    ...
    string private constant _name = "AIFUN";
    string private constant _ticker = "AIFUN";
    ...
    function tokenURI(uint256 id) public view returns (string memory) {
        ...
        if (bytes(baseTokenURI).length > 0)
            ...
            if (seed <= 63) {
                image = "QmTYJqiBrUxkYiiLs6yvwDSA2JuCdWqk5SsdWjWvYqA9T5";
                color = "before";
                description = "before coin";
            } else if (seed <= 127) {
                image = "QmY7Z1LVzDqjR9JRHLFE6bWB2iJfehDW7ieFXPLBDUn1yj";
                color = "now1";
                description = "now coin";
            } else if (seed <= 191) {
                image = "QmSQkcnRwhGjis28MQPbw1khGPx8w1WKhcqMfG3YmsQQFU";
                color = "now2";
                description = "now coin";
            } else if (seed <= 255) {
                image = "QmarNBoQNxHcknMH7DrW1T5LhJCDuNhbUrUennNDg6XUM2";
                color = "future";
                description = "future";
            }

            string memory jsonPreImage = string(abi.encodePacked('{"name": "AIFUN #', id.toString(), '","description":"', description, '","external_url":"https://www.aicoin.com/","image":"', dataURI, image));
