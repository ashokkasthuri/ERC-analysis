...
// File: contracts/AccessExtension.sol
// SPDX-License-Identifier: MIT
...
contract COA is TokenExtension, AccessExtension {
    ...
    function cloneCertificate(address to_, uint256 tokenId_) public isOwnerOrAuthorized(tokenId_) {
        ...
        _cloneCertificate(to_, tokenId_);
    }
...
// File: contracts/TokenExtension.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.17;
...
contract TokenExtension is ERC1155 {
     ...
     */
    function _cloneCertificate(address to_, uint256 tokenId_) internal certificateExists(tokenId_) {
        // mint the token
        _mint(to_, tokenId_, 1, "");
    }
