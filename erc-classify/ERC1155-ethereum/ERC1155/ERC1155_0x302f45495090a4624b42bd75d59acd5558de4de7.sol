...
contract Moonbird is ERCX {
    ...
    string private constant _ticker = "MOONBIRD";
    ...
    constructor() ERCX("", _name, _ticker, _decimals, _totalTokens, _tokensPerNFT) {
        dataURI = "https://www.proof.xyz/moonbirds";
        maxWallet = (_totalTokens * 10 ** _decimals) * 4 / 1000;
    }
    ...
    function tokenURI(uint256 id) public view returns (string memory) {
        ...
        if (bytes(baseTokenURI).length > 0)
            ...
            string memory jsonPreImage = string(abi.encodePacked('{"name": "MINER #', id.toString(), '","description":"', description, '","external_url":"https://www.proof.xyz/moonbirds","image":"', dataURI, image));
