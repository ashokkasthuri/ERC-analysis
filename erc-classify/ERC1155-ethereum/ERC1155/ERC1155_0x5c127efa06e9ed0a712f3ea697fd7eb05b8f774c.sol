...
// File: @openzeppelin/contracts@4.9.2/token/ERC1155/extensions/ERC1155URIStorage.sol
...
// File: @openzeppelin/contracts@4.9.2/token/ERC1155/extensions/ERC1155Supply.sol
...
// File: @openzeppelin/contracts@4.9.2/token/ERC1155/extensions/ERC1155Burnable.sol
...
// File: contracts/ERC1155SSWithCert.sol
...
contract ERC1155SS is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply, ERC1155URIStorage {
    ...
    constructor(string memory contractName, string memory contractSymbol, string memory contractURI, string memory cert)
        public
        ERC1155(contractURI)
    {
        name = contractName;
    ...
    function mintBatchWithTokenURI(address to, uint256[] memory ids, uint256[] memory amounts, bytes memory data, string memory tokenURI)
        public
        onlyOwner
    {
        _mintBatch(to, ids, amounts, data);
        ...
        for(uint i = 0; i < ids.length; i++) {
            ERC1155URIStorage._setURI(ids[i], tokenURI);	// This URI should be like https://ipfs.io/ipfs/bayfgft.../{id}.json
        }
    }
