 ...
 * @notice This contract handles minting NFGem tokens.
 */
contract NFGem is
    ERC1155Supply,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x2AA9A8709fef6d954304F71Da01278039D9f17eA;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xd816F4416d58B31FF4398C57bb274063930c5c2f;
    ...
    address[] public payoutAddresses = [
        0xd816F4416d58B31FF4398C57bb274063930c5c2f
    ];
    ...
    string public name = "NFGem";
    string public symbol = "NFGM";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeig2htaezagenddutq47zddf4l7vwvswvvdrzx6uskzctyn33cbfoy/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[1] = 10;
        tokenPublicPrice[1] = 3.9 ether;
        tokenPublicMintsPerAddress[1] = 10;
        tokenMaxSupply[2] = 10;
        tokenPresaleMaxSupply[2] = 10;
        tokenPresalePrice[2] = 1.88 ether;
