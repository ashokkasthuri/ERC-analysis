// Chain: BSC - File: contracts/GoodFood/GoodFoodNFT.sol
...
contract GoodFoodNFT is ERC1155 {
    address private _admin;

    mapping(address => bool) _minters;

    constructor() ERC1155("https://statics.goodfood.thebarkingdog.tw/api/item/{id}.json") {
        _admin = msg.sender;
    }
