// Chain: BSC - File: contracts/OnAvaxArtFactoryPrivate.sol
// SPDX-License-Identifier: MIT

pragma solidity 0.6.12;

import "@openzeppelin/contracts/access/Ownable.sol";
import "./OnAvaxArtTradablePrivate.sol";

contract OnAvaxArtFactoryPrivate is Ownable {
    ...
    */
    ...
    /// @notice Method for deploy new OnAvaxArtTradablePrivate contract
        ...
        returns (address)
    {
        ...
        OnAvaxArtTradablePrivate nft = new OnAvaxArtTradablePrivate(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
...
// Chain: BSC - File: contracts/OnAvaxArtTradablePrivate.sol
// SPDX-License-Identifier: MIT
