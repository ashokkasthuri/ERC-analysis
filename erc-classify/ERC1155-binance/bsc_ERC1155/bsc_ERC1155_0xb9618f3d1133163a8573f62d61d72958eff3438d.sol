    ...
    IERC721Receiver
{
    ...
    event MetadataServicesSet(address newMetadataService);
    ...
    function setMetadataService(IMetadataService _newMetadataService)
        ...
        onlyOwner()
    {
        require(address(_newMetadataService) != address(0), "address can not be zero!");
        emit MetadataServicesSet(address(_newMetadataService));
...
// Chain: BSC - File: contracts/registry/SID.sol
pragma solidity >=0.8.4;
...
// Chain: BSC - File: contracts/bnbregistrar/IBaseRegistrar.sol
import "../registry/SID.sol";
...
// Chain: BSC - File: contracts/wrapper/BytesUtil.sol
//SPDX-License-Identifier: MIT
pragma solidity >=0.8.4;
