// Chain: BSC - File: contracts/deployable/Weapons.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.8;

import "../common/DealeableSecondGen.sol";

contract Weapons is DealeableSecondGen {
    ...
    constructor(string memory _uri, address _vault, uint256 _offset) DealeableSecondGen(_uri, _vault, "VULCANO::NFT::WEAPONS", _offset) {
        _durabilityMap[0] = 20;
        _durabilityMap[1] = 15;
        _durabilityMap[2] = 10;
        _durabilityMap[3] = 5;
...
// Chain: BSC - File: contracts/common/DealeableSecondGen.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.8;
...
// Chain: BSC - File: contracts/common/Roles.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.8;
...
// Chain: BSC - File: contracts/common/ERC1155.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.8;
...
// Chain: BSC - File: interfaces/IStorage.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.8;
