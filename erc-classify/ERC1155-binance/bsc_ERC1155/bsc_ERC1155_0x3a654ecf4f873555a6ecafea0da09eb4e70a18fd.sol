...
// Chain: BSC - File: contracts/HPPTsemi1TypeC.sol
// SPDX-License-Identifier: MIT
...
contract HPPTsemi1TypeC is ERC1155 {
    string public constant name = "HPP Tsemi-1. Type C";
    string public constant symbol = "HT1C";
    uint256 public constant totalSupply = 500;

    constructor() ERC1155("ipfs://bafybeiagbwbgobp7rsajeyswgmcz2ol7dxryoxwubabeazmdjj2i7zgbbe/metadata.json") {
    ...
    function uri(uint256 tokenId) override public pure returns (string memory) {
        return "ipfs://bafybeiagbwbgobp7rsajeyswgmcz2ol7dxryoxwubabeazmdjj2i7zgbbe/metadata.json";
    }
}