// Chain: BSC - File: contracts/CyberCityBoxes.sol
...
/**
 * @title CyberCityBoxes
 */
contract CyberCityBoxes is ERC1155Supply, Ownable {
    ...
    // @dev Minting only one time, then ownership will be lost.
    function mintBatch(
        address _to,
        uint256[] memory _ids,
    ...
    function _lockMinting() private {
        bytes4 FUNC_SELECTOR = bytes4(keccak256("renounceOwnership()"));
