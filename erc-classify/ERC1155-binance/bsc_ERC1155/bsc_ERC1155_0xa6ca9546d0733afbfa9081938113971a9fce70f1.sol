// Chain: BSC - File: /contracts/Launchpad1155.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.8.4;

import "./token/ERC1155.sol";

contract Launchpad1155 is ERC1155 {
...
// Chain: BSC - File: /contracts/token/utils/ERC165.sol
// SPDX-License-Identifier:UNLICENSED
...
// Chain: BSC - File: /contracts/token/utils/Context.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.8.0;
...
// Chain: BSC - File: /contracts/token/interfaces/IERC165.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.8.4;
...
// Chain: BSC - File: /contracts/token/interfaces/IERC1155Receiver.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.8.0;
...
// Chain: BSC - File: /contracts/token/interfaces/IERC1155.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.8.0;
...
contract ERC1155 is Context, ERC165, IERC1155 {
    ...
    */
    ...
    function _burnBatch(address account, uint256[] memory tokenIds, uint256[] memory amounts) internal virtual {
        ...
        for (uint i = 0; i < tokenIds.length; i++) {
            _balances[tokenIds[i]][account] = _balances[tokenIds[i]][account].sub(amounts[i]);
        }
...
// Chain: BSC - File: /contracts/libraries/SafeMath.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.8.4;
...
// Chain: BSC - File: /contracts/libraries/EnumerableMap.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.8.4;
...
// Chain: BSC - File: /contracts/libraries/Address.sol
// SPDX-License-Identifier:UNLICENSED
pragma solidity ^0.8.4;
