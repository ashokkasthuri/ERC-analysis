// Chain: BSC - File: contracts/OneMove.sol
...
contract OneMove is Ownable, ERC1155Holder, ERC721Holder, ReentrancyGuard {
    ...
    event DepositBurnShoebox(uint256 uid, address account, uint256 tokenId);
    ...
    function depositBurnShoebox(uint256 uid, uint256 _tokenId) external {
        nftShoebox.safeTransferFrom(msg.sender, address(this), _tokenId);
        emit DepositBurnShoebox(uid, msg.sender, _tokenId);
    }
...
// Chain: BSC - File: erc721a/contracts/IERC721A.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: erc721a/contracts/extensions/IERC721AQueryable.sol
// SPDX-License-Identifier: MIT
// ERC721A Contracts v3.3.0
// Creator: Chiru Labs
