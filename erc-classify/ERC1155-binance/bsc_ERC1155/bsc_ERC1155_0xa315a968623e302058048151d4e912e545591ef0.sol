// Chain: BSC - File: contracts/marketplace/OnChERC1155.sol
...
contract HerityNFTExtended is ERC1155, OnChOwnableWithWhitelist {
    ...
    function mintFor(address ownerAddress, uint256 amount, uint256 collectionId) public returns (uint) {
        _tokenIds.increment();
        uint256 tokenId = _tokenIds.current();

        _mint(ownerAddress, tokenId, amount, "");
    ...
    function setBaseURI(string memory baseURI_) external whitelistedOnly returns (bool) {
        _baseURIExtended = baseURI_;
        return true;
    }

    function setMarketplaceAddress(address marketplaceAddress_) external whitelistedOnly returns (bool) {
...
// Chain: BSC - File: contracts/common/OnChOwnableWithWhitelist.sol
// SPDX-License-Identifier: MIT
