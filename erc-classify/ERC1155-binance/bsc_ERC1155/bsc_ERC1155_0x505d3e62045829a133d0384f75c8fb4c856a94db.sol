// Chain: BSC - File: contracts/TicketMachine.sol
...
contract TicketMachine is ERC1155, ERC1155URIStorage, ReentrancyGuard {
    using Address for address;
    ...
    function issue(string memory _tokenURI) external nonReentrant  {
        tokenOwnerCount += 1;
    ...
    function setURI(uint256 tokenId, string memory _tokenURI) external nonReentrant {
