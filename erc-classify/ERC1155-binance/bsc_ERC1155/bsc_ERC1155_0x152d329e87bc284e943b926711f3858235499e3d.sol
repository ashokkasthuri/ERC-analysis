// Chain: BSC - File: /contracts/Accessories.sol
...
contract Accessories is BaseERC1155WithRoyalties {
	...
	function _getIndex(uint256[] memory prefix, uint256 n) internal view returns (uint256 index) {
		...
		uint256 r = TalienUtils.getRandomVariation(nonce, prefix[n - 1]) + 1;

		// Find index of ceiling of r in prefix array
		index = TalienUtils.findCeil(prefix, r, 0, n - 1);
...
// Chain: BSC - File: /contracts/library/TalienUtils.sol
...
// Chain: BSC - File: /contracts/interfaces/IVersionedContract.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
// Chain: BSC - File: /contracts/interfaces/IERC2981.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: /contracts/BaseERC1155WithRoyalties.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
	...
	*/
	...
	function initialize_BaseERC1155WithRoyalties(
		...
		require(
			...
			'BaseERC1155WithRoyalties: INVALID_ROYALTY_FEE'
		);
	...
	function updateRoyaltyReceiver(address _newReceiver) external virtual onlyOperator {
		require(
			...
			'BaseERC1155WithRoyalties: INVALID_ROYALTY_RECEIVER'
		);
...
// Chain: BSC - File: /contracts/BaseERC1155.sol
// SPDX-License-Identifier: MIT
