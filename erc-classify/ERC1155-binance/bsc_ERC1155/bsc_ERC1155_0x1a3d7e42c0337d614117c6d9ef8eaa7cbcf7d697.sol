...
contract MyToken is ERC1155, Ownable {
    ...
    uint256[] public mintRate = [25000000000000000 wei, 75000000000000000 wei, 125000000000000000 wei, 250000000000000000 wei, 750000000000000000 wei, 1200000000000000000 wei, 2500000000000000000 wei, 12000000000000000000 wei];
    ...
    public
    {
    require(id <= minted.length, "Token doesn't exist");
    ...
    function setCost(uint256 _newCost, uint256 _id) public onlyOwner {
        mintRate[_id - 1] = _newCost;
    }

    function getCost(uint256 _id) public view returns (uint256){
        return mintRate[_id - 1];
    }
