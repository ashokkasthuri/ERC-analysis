...
// Chain: BSC - File: contracts/ERC1155Minter.sol
...
contract ERC1155Minter is IERC1155Minter, ERC1155URIStorage, ERC2981, Ownable {
    ...
    function mint(
        ...
        _setTokenRoyalty(_tokenId, creator, royalty);
    }
    ...
    function getRoyalty(
        ...
        return royaltyInfo(id, salePrice);
    }
}


// Chain: BSC - File: contracts/Interface/IERC1155Minter.sol
// SPDX-License-Identifier: Unlicense
pragma solidity 0.8.20;
