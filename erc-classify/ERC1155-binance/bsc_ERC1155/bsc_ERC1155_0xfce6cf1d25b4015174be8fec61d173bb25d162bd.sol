...
contract testBase is testAccessControl,ERC1155{
    ...
    string memory itemName,uint16 gameId,bytes memory data)public virtual onlyPartner{
        ...
        ItemAttr memory attr = 
            ItemAttr(itemName,gameId,itemType,false,1,genes,strength,intelligence,agility,health,
    ...
    // string itemName,uint16 gameId,bytes memory data)public virtual onlyPartner(){
    //     Game memory game = games[gameId];
    //     if (allowNFTFlag == false) {
    //         require(game.manager == _msgSender(),"Base: msgsender not manager!");
    //     }
