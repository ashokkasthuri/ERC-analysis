...
contract Gold is ERC1155, Ownable {

    constructor() ERC1155("ipfs://QmULNUtTnqToKZi1FMajp3vxN24471D7CmswmPzbJaHefP/{id}.json") {
        _mint(msg.sender, 0, 3000,"");
        _mint(msg.sender, 1, 3000, "");
        _mint(msg.sender, 2, 3000, "");
        _mint(msg.sender, 3, 3000, "");
        _mint(msg.sender, 4, 3000, "");
        _mint(msg.sender, 5, 3000, "");
        _mint(msg.sender, 6, 3000, "");
        _mint(msg.sender, 7, 3000, "");
        _mint(msg.sender, 8, 3000, "");
        _mint(msg.sender, 9, 3000, "");
        _mint(msg.sender, 10, 3000, "");
    }
