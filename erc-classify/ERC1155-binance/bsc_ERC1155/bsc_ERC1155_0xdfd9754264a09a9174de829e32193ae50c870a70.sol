// Chain: BSC - File: contracts/mocks/ERC1155Mock.sol
...
contract ERC1155Mock is Ownable, ERC1155Burnable {
    constructor()
        ERC1155(
            "https://metatest.mypinata.cloud/ipfs/QmSCHWnwKp4PMgwwiNwJMttt8zr7J9qwUXEYNvfoWQtYrM/{id}"
        )
    {}
    ...
    function mint(
        ...
        require(id >= 0 && id < 3, "id must be between 0 and 2");
