...
// Chain: BSC - File: contracts/CompetitionTickets.sol
// SPDX-License-Identifier: MIT
...
contract CompetitionTickets is ERC1155, ERC1155Burnable, AccessControl, Pausable {
    bytes32 public constant HANDLER_ROLE = keccak256("HANDLER_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");

    constructor(address default_admin) ERC1155("") {
        _grantRole(DEFAULT_ADMIN_ROLE, default_admin);
        _grantRole(PAUSER_ROLE, default_admin);
    }
        ...
        override
    {
        require(
            ...
            "CompetitionTickets: transfer between non-zero addresses not allowed"
        );
