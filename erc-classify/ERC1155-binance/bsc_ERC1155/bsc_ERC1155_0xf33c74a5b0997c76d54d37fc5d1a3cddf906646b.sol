    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(
        ...
        numWords = 5; // testing with 3 prod = 60 generate 60 random numbers
    ...
    function payoutMarketingAndReferrals(uint256 level) internal {
        ...
        uint256 teamEarnings = ((levels[level].buyIn * totalSupply) * 29) / 100; //(29%)
    ...
    function airdropUsdcWinnings(
        ...
        for (uint256 i = 0; i < totalWinners; i++) {
            ...
            if (i < bottom) {
                ...
                totalUSDCEarningsByLevel[winner][_level] +=
                    firstFiftyShare /
                    bottom;
    ...
    function airdropWinnings(
        ...
        for (uint256 i = 0; i < totalWinners; i++) {
            ...
            if (i < bottom) {
                ...
                totalTokenEarnings[winner] += firstFiftyShare / bottom;
                totalTokenEarningsByLevel[winner][_level] +=
                    firstFiftyShare /
                    bottom;
            } else if (i < (bottom + middle)) {
                faucet.airdrop(winner, nextFiveShare / middle);
                totalTokenEarnings[winner] += nextFiveShare / middle;
                totalTokenEarningsByLevel[winner][_level] +=
                    nextFiveShare /
                    middle;
            } else {
                ...
                totalTokenEarnings[winner] += shares[
                    (i - (bottom + middle)) - 1
                ];
    ...
    function recycleEntries(uint256 _level) internal {
        ...
        delete raffleEntries[_level][level.currentRaffle];
