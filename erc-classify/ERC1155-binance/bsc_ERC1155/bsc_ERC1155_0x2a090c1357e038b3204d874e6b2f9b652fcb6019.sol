...
// Chain: BSC - File: contracts/HPPTsemi1TypeE.sol
// SPDX-License-Identifier: MIT
...
contract HPPTsemi1TypeE is ERC1155 {
    string public constant name = "HPP Tsemi-1. Type E";
    string public constant symbol = "HT1E";
    uint256 public constant totalSupply = 50;

    constructor() ERC1155("ipfs://bafybeigmkmhqjxonu5qokby4dc2vx2xbl2s336ut2tsauxzkimy2gcfjxi/metadata.json") {
    ...
    function uri(uint256 tokenId) override public pure returns (string memory) {
        return "ipfs://bafybeigmkmhqjxonu5qokby4dc2vx2xbl2s336ut2tsauxzkimy2gcfjxi/metadata.json";
    }
}