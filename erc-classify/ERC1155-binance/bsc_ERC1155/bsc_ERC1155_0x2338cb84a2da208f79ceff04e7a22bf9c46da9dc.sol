...
// Chain: BSC - File: contracts/NituNFT.sol
// SPDX-License-Identifier: MIT
...
contract NituNFT is ERC1155, AccessControl, ERC1155Supply {
    bytes32 public constant OWNER_ROLE = keccak256("OWNER_ROLE");

    uint256 public constant TOKEN_ID = 1;

    address public ADMIN = 0x5f2192f495af8e4A102059379f46C596906690F2;

    string private _name = "NituNFT";
    string private _symbol = "N-NFT";

    constructor() ERC1155("") {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(OWNER_ROLE, 0x2B069a31A67b963e56f752081515E9307c6823B3);
    }
    ...
    function mint(uint256 amount, bytes memory data) public {
        ...
        _mint(ADMIN, TOKEN_ID, amount, data);
    }
