...
// File: EconomicDefenseEducationNetwork.sol
...
contract EconomicDefenseEducationNetwork is
    ERC1155,
    Ownable,
    ERC1155Supply,
    ERC2981,
    DefaultOperatorFilterer
{
    ...
    uint256[] public publicSaleCost = [2222];
    ...
    constructor()
        ERC1155(
            "https://bafybeigay7kxazxpctw6h32oucafqnwg3ronvdbce3kom7akewhipsnlvu.ipfs.nftstorage.link/",
            "Economic Defense Education Network",
            "EDEN"
        )
    {
    ...
    function mint(
        ...
        if (msg.sender != owner()) {
            ...
            require(msg.value >= getCostInBNB(id) * quantity,
                "You do not have enough tokens to perform the transaction");    
        }

        callPurchaseProduct(msg.sender, 2);
