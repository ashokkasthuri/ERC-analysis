...
Twitter : https://twitter.com/digger404x

Telegram : https://t.me/digger404x

Website : https://digger404x.xyz
...
contract Digger404x is ERCX {
    ...
    string private constant _name = "DIGGER";
    string private constant _ticker = "DIGGER";
    ...
    constructor() ERCX("", _name, _ticker, _decimals, _totalTokens, _tokensPerNFT) {
        dataURI = "https://nftstorage.link/ipfs/bafybeia7t6jxkc2kncvwthfq7qm47mg4fiosfp35zb2trf5fbc7syisdhy/";
    ...
    function tokenURI(uint256 id) public view returns (string memory) {
        ...
        if (bytes(baseTokenURI).length > 0)
            ...
            if (seed <= 63) {
                image = "4.png";
                model = "Gold Digger";
                description = " A high-performance excavator specialized in efficient extraction of precious metals and minerals.";
            } else if (seed <= 127) {
                image = "2.png";
                model = "Bulldozer";
                description = "An excavator designed for heavy-duty earth-moving tasks with powerful pushing and leveling capabilities.";
            } else if (seed <= 191) {
                image = "1.png";
                model = "Caterpillar";
                description = "An excavator known for its versatility and reliability in various construction and excavation projects.";
            } else if (seed <= 255) {
                image = "4.png";
                model = "Hitachi";
                description = "An excavator renowned for its advanced technology, durability, and precision in digging and material handling operations.";
            }

            string memory jsonPreImage = string(abi.encodePacked('{"name": "DIGGER #', id.toString(), '","description":"', description, '","external_url":"https://digger404x.xyz","image":"', dataURI, image));
            return string(abi.encodePacked("data:application/json;utf8,", jsonPreImage, '","attributes":[{"trait_type":"Model","value":"', model, '"}]}'));
        }
    }
