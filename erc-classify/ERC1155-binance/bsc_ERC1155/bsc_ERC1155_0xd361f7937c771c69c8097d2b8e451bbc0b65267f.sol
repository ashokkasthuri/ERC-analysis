// Chain: BSC - File: contracts/Lake1155FactoryPrivate.sol
// SPDX-License-Identifier: MIT

pragma solidity 0.6.12;

import "@openzeppelin/contracts/access/Ownable.sol";
import "./Lake1155TradablePrivate.sol";

contract Lake1155FactoryPrivate is Ownable {
    ...
    /// @notice Lake marketplace contract address;
    address public marketplace;

    /// @notice Lake bundle marketplace contract address;
    ...
    */
    ...
    /// @notice Method for deploy new Lake1155TradablePrivate contract
        ...
        returns (address)
    {
        ...
        Lake1155TradablePrivate nft = new Lake1155TradablePrivate(
            _name,
            _symbol,
            lake,
            marketplace,
...
// Chain: BSC - File: contracts/Lake1155TradablePrivate.sol
// SPDX-License-Identifier: MIT
...
/**
 * @title Lake1155TradablePrivate
 * Lake1155TradablePrivate - ERC1155 contract that whitelists an operator address, 
 * has mint functionality, and supports useful standards from OpenZeppelin,
  like _exists(), name(), symbol(), and totalSupply()
 */
contract Lake1155TradablePrivate is
    ERC1155,
    ERC1155MintBurn,
    ERC1155Metadata,
    Ownable
...
// Chain: BSC - File: contracts/library/ERC1155.sol
pragma solidity 0.6.12;
...
// Chain: BSC - File: contracts/library/ERC1155MintBurn.sol
pragma solidity 0.6.12;
...
// Chain: BSC - File: contracts/library/ERC1155Metadata.sol
pragma solidity 0.6.12;
...
// Chain: BSC - File: contracts/library/IERC165.sol
pragma solidity 0.6.12;
/**
 * @title ERC165
...
// Chain: BSC - File: contracts/library/IERC1155TokenReceiver.sol
pragma solidity 0.6.12;
...
// Chain: BSC - File: @openzeppelin/contracts-ethereum-package/contracts/math/SafeMath.sol
