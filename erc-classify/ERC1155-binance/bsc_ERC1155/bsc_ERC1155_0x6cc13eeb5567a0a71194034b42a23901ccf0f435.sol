// Chain: BSC - File: /contracts/collection/ERC1155BLSCustom.sol
...
contract ERC1155BLSCustom is OwnableUpgradeable, ERC1155BurnableUpgradeable, ERC1155Lazy, HasContractURI {

    event CreateERC1155BLS(address owner, string name, string symbol);
    ...
    function __ERC1155BLS_init(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI) external initializer {
        ...
        __ERC1155BLS_init_unchained(_name, _symbol);
        _setBaseURI(baseURI);

        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(MINTER_ROLE, _msgSender());

        emit CreateERC1155BLS(_msgSender(), _name, _symbol);
    }

    function __ERC1155BLS_init_unchained(string memory _name, string memory _symbol) internal initializer {
        name = _name;
        symbol = _symbol;
    }
    ...
    function mintAndTransfer(LibERC1155LazyMint.Mint1155Data memory data, address to, uint256 _amount) public override {
        require(
            hasRole(MINTER_ROLE, data.creators[0].account),
            "Creator must have minter role to mint"
        );
    ...
    function _msgSender() internal view override(ERC1155Lazy, ContextUpgradeable) returns (address) {
        return msg.sender;
    }

    function _msgData() internal view override(ERC1155Lazy, ContextUpgradeable) returns (bytes calldata) {
...
// Chain: BSC - File: /contracts/utils/Strings.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: /contracts/utils/EnumerableSet.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: /contracts/utils/Context.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: /contracts/royalties/RoyaltiesV2Impl.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: /contracts/royalties/LibRoyaltiesV2.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: /contracts/royalties/AbstractRoyalties.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: /contracts/royalties-upgradeable/RoyaltiesV2Upgradeable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: /contracts/lazy-mint/erc-1155/LibERC1155LazyMint.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: /contracts/lazy-mint/erc-1155/IERC1155LazyMint.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: /contracts/erc-1271/ERC1271Validator.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: /contracts/erc-1271/ERC1271.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: /contracts/collection/Mint1155Validator.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: /contracts/collection/ERC1155Lazy.sol
// SPDX-License-Identifier: MIT
...
abstract contract ERC1155Lazy is IERC1155LazyMint, AccessControlEnumerable, ERC1155BaseURI, Mint1155Validator, RoyaltiesV2Upgradeable, RoyaltiesV2Impl {
...
// Chain: BSC - File: /contracts/collection/ERC1155BaseURI.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: /contracts/access/AccessControlEnumerable.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: /contracts/access/AccessControl.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: /contracts/RoyaltiesV2.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: /contracts/LibPart.sol
...
// Chain: BSC - File: /contracts/HasContractURI.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: /contracts/ERC165.sol
// SPDX-License-Identifier: MIT
...
// Chain: BSC - File: @openzeppelin/contracts-upgradeable/utils/introspection/ERC165StorageUpgradeable.sol
// SPDX-License-Identifier: MIT
