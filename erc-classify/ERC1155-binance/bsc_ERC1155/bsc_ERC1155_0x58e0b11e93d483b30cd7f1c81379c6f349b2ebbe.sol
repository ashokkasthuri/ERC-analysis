...
contract TreeBank1155V1 is Initializable,BEP1155Upgradeable, OwnableUpgradeable, BEP1155BurnableUpgradeable {
   event Approve(
    ...
    function initialize() public initializer {
        BEP1155Upgradeable.__BEP1155_init("", "Tree Bank Nft", "TBNF");
        __Ownable_init();
         _tid = 1;
    ...
    function mint(uint256 id, uint256 value, uint256 royal, uint256 nooftoken, string memory ipfsname,
        string memory ipfsimage,
         string memory ipfsmetadata, uint256 charity ) public {
        ...
        )
    {
        ...
        uint256 char = pBEPent(amount, _char);
