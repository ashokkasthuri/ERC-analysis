    ...
    WhitelistAdminRole
{
    ...
    constructor(string memory _name, string memory _symbol) public {
        ...
        mintFeeAmount = 0.01*10**18;
        mintFeeAddr = 0xaAB66cee7438bd5D5A3F4cd617BaFF107ba637bE;
        ZOO_FEE = 10**18;
        maxMintSupply = 10;
    }
    ...
    function getMaxMintSupply() public view returns (uint256) {
        return maxMintSupply;
    }
    
    function setMaxMintSupply(uint256 _maxMintSupply) public onlyOwner {
        require(maxMintSupply != _maxMintSupply, 'Not need update');
    ...
    function create(
        ...
        require(_maxSupply <= maxMintSupply, 'max supply too large');
...
// File: contracts/KingLive1155.sol
...
contract KingLive1155 is ERC1155Tradable {
    constructor() public ERC1155Tradable("KingLive1155", "KL1155") {
        _setBaseMetadataURI("https://nft.v2.kinglive.tv/ipfs");
    }
}