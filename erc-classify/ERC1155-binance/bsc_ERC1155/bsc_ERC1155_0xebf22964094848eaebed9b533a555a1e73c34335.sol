...
// Chain: BSC - File: contracts/ERC1155Tickets.sol
//SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
contract ERC1155Tickets is ERC1155, AccessControl {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    string public name = "WORLD BIOHACK SUMMIT";
    string public symbol = "WBHS";
    ...
    function mintTicket(string memory tokenURI, uint256 amount)
        public
