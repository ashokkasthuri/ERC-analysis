// Chain: BSC - File: contracts/PiTeam.sol
...
contract PiTeam is ERC1155, Ownable {
    ...
    function safeTransfer(address to, uint256 id, uint256 amount) external {
        _safeTransferFrom(_msgSender(), to, id, amount, "");
    }
