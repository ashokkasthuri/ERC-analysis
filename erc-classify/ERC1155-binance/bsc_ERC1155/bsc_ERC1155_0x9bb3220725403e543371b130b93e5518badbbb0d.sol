// Chain: BSC - File: contracts/NFT1155.sol
...
contract AngelItems is ERC1155,Ownable {
    string public baseURI;
    uint256 public constant ANGELBOOT = 0;
    uint256 public constant ANGELGUARD = 1;
    uint256 public constant ANGELAMULET = 2;
    uint256 public constant ARESAMULET = 3;
    uint256 public constant ARESRING = 4;

    constructor() ERC1155("URL"){
        baseURI = "https://nft.crypterium.game/items/j/";
        _mint(msg.sender, ANGELBOOT, 10, "");
        _mint(msg.sender, ANGELGUARD, 10, "");
        _mint(msg.sender, ANGELAMULET, 100, "");
        _mint(msg.sender, ARESAMULET, 100, "");
        _mint(msg.sender, ARESRING, 100, "");
    }
