// Chain: BSC - File: /contracts/PEPEAirdrop.sol
...
contract PEPEAirdrop is ERC1155, Ownable {
    constructor()
        ERC1155("https://ipfs.apillon.io/ipfs/QmevQ1xJohmwDdxn4a5J5UNMSaHfVC4B7VeHDPt4vJNfAY")
        Ownable(msg.sender)
    {}
    ...
    function minToAll(address[] memory toList,uint256 id) public onlyOwner {
        for (uint256 i = 0; i < toList.length; i++) {
            _mint(toList[i], id, 1, "0x");
        }
    }
}
