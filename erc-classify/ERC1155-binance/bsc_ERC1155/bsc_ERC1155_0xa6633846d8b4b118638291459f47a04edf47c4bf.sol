...
*/
contract PaysengerLevels is ERC1155, AccessControl, ERC1155Burnable, ERC1155Supply {
    ...
    function setTokenUri(uint256 id, string calldata _uri) public onlyRole(ADMIN_ROLE) {
        tokenURIs[id] = _uri;
        emit URISet(id, _uri);
    }
