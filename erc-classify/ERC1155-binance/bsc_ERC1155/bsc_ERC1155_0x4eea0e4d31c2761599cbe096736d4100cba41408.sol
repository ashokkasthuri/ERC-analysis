// Chain: BSC - File: contracts/Greeter.sol
//SPDX-License-Identifier: Unlicense
pragma solidity ^0.8.0;

import "@openzeppelin/contracts/token/ERC1155/ERC1155.sol";

contract Greeter is ERC1155{
       uint256 public constant ticket = 0;
 
    constructor()  ERC1155("https://ipfs.io/ipfs/QmYGgEFqTRkWvNZ6u7gfk9HDdh55bQAbYVyc16TF1zX658/69") {
        emit TransferSingle(msg.sender, 0x0000000000000000000000000000000000000000, 0x0000000000000000000000000000000000000000, 0, 0);
        emit URI("https://ipfs.io/ipfs/QmYGgEFqTRkWvNZ6u7gfk9HDdh55bQAbYVyc16TF1zX658/69", 0);
            _mint(msg.sender, ticket, 100, "");
emit TransferSingle(msg.sender, 0x0000000000000000000000000000000000000000, msg.sender, 0, 100);
