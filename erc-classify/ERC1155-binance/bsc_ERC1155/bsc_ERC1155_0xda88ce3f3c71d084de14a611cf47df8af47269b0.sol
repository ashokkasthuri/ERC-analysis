// Chain: BSC - File: contracts/DiscoBurnNFT.sol
...
contract DiscoBurnNFT is ERC1155Supply, Ownable, AccessControl {
...
contract DiscoBurnNFTAirdrop is Ownable, Pausable, ERC1155Holder, AccessControl, ReentrancyGuard {
    ...
    address public ownerWallet = 0x29ADa2cDbA1bbEBF05CF821405827c42d2929444;
    address public devWallet = 0xD38b67DB7De0Ee53e6bEf96e2940ED8E6bb702c3;
    ...
    constructor(address _dbtNFT) {
        ...
        grantRole(SUPPLIER_ROLE, _dbtNFT);
    }
