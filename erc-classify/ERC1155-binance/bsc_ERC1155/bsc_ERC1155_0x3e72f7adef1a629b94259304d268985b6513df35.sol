...
// File @openzeppelin/contracts/token/BEP1155/IBEP1155.sol@v3.3.0
...
// File @openzeppelin/contracts/token/BEP1155/IBEP1155MetadataURI.sol@v3.3.0
...
// File @openzeppelin/contracts/token/BEP1155/IBEP1155Receiver.sol@v3.3.0
...
// File @openzeppelin/contracts/token/BEP1155/BEP1155.sol@v3.3.0
...
contract BEP1155 is Context, ERC165, IBEP1155, IBEP1155MetadataURI {
    ...
    constructor (string memory uri_) public{
        ...
        // register the supported interfaces to conform to BEP1155 via ERC165
        _registerInterface(_INTERFACE_ID_BEP1155);

        // register the supported interfaces to conform to BEP1155MetadataURI via ERC165
        ...
        override
    {
        ...
        _balances[id][from] = _balances[id][from].sub(amount, "BEP1155: insufficient balance for transfer");
    ...
    function _mint(address account, uint256 id, uint256 amount, bytes memory data, address creator) internal virtual {
        ...
        require(isCreator[creator][id], "BEP1155: Not Creator");
        address operator = _msgSender();
    ...
    function _mintBatch(address to, uint256[] memory ids, uint256[] memory amounts, bytes memory data, address creator) internal virtual {
        ...
        for (uint i = 0; i < ids.length; i++) {
            require(isCreator[creator][ids[i]], "BEP1155: Not Creator");
    ...
    function _burn(address account, uint256 id, uint256 amount,address creator) internal virtual {
        ...
        require(isCreator[creator][id], "BEP1155: user not creator");
        address operator = _msgSender();
...
contract BEP1155Token is BEP1155, Ownable, ReentrancyGuard {
    constructor() BEP1155("https://gennix.github.io/BEP1155/api/mainnet/token/{id}.json") public{}
    ...
    function setCreator(address creator, uint256 id) public nonReentrant onlyOwner{
        ...
        creators[creators.length - 1] = creator;
